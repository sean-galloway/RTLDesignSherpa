...
//
// Formal proof for apb4_slave_cg -- clock-gated apb4_slave wrapper
//
// Properties verified:
...
module formal_apb4_slave_cg (
    ...
    // P2: PREADY pulses (apb4_slave FSM design)
    always @(posedge clk) begin
    ...
    // apb4_slave_cg plus r_wakeup flop in amba_clock_gate_ctrl).
