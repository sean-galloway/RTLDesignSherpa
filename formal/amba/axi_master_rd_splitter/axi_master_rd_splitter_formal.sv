...
//
// Yosys-compatible copy of axi_master_rd_splitter.sv
...
(
    ...
    always_comb begin
        if (r_split_state == IDLE) begin
            split_fifo_din = {fub_araddr, fub_arid,
