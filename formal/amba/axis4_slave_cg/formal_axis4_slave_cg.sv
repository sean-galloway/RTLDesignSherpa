...
// Formal wrapper for axis4_slave_cg

`include "reset_defs.svh"

module formal_axis4_slave_cg (
    input logic clk,
    input logic rst_n
);
...
// ======================================================================
// Bound wake-coverage checker for axis4_slave_cg
// ======================================================================
module axis4_slave_cg_wake_checker (
    input logic aclk,
    input logic aresetn,
...
bind axis4_slave_cg axis4_slave_cg_wake_checker u_wake_check (
    .aclk            (aclk),
    .aresetn         (aresetn),
    .s_axis_tvalid   (s_axis_tvalid),
    .fub_axis_tvalid (fub_axis_tvalid),
