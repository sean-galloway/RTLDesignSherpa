...
//
// Formal proof for apb5_slave_cdc_cg -- single clock model (pclk=aclk)
//
// This module wraps apb5_slave_cdc with a single pclk-domain clock gate.
// The wakeup signal uses cmd_valid/rsp_valid (aclk domain) directly in
// pclk domain -- a CDC violation invisible under single-clock model.
// See KNOWN_BUG.md.
//
// Properties verified:
...
module formal_apb5_slave_cdc_cg (
    input logic clk,
    input logic rst_n
);
