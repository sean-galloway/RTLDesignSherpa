...
3. **PeakRDL registers** -- peakrdl_to_cmdrsp + stream_regs (PeakRDL-generated, 0x100-0x3FF)
4. **Register mapping** -- stream_config_block
5. **DMA core** -- stream_core (conditionally monitors enabled/disabled)
6. **Monitor bus** -- monbus_axil_group (AXI-Lite conversion)
