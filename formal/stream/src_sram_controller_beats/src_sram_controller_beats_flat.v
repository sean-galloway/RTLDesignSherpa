...
module src_sram_controller_beats (
	...
	initial if (NC > 128) begin
		$display("Fatal [%0t] /mnt/data/github/RTLDesignSherpa/projects/components/rapids/rtl/macro_beats/src_sram_controller_beats.sv:99:13 - src_sram_controller_beats.<unnamed_block>.<unnamed_block>\n msg: ", $time, "src_sram_controller: NUM_CHANNELS=%0d exceeds maximum of 128", NC);
		$finish(1);
	end
