...
//
// Formal wrapper for snk_sram_controller_unit_beats (yosys-compatible)
// Run with: sby snk_sram_controller_unit_beats.sby

module formal_snk_sram_controller_unit_beats #(
