...
module snk_sram_controller_beats (
	...
	initial if (NC > 128) begin
		$display("Fatal [%0t] /mnt/data/github/RTLDesignSherpa/projects/components/dmas/rapids/rtl/macro_beats/snk_sram_controller_beats.sv:116:13 - snk_sram_controller_beats.<unnamed_block>.<unnamed_block>\n msg: ", $time, "snk_sram_controller_beats: NUM_CHANNELS=%0d exceeds maximum of 128", NC);
		$finish(1);
	end
	sram_controller #(
		.NUM_CHANNELS(NC),
