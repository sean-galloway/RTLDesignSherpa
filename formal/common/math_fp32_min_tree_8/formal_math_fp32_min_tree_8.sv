...
module formal_math_fp32_min_tree_8 (
    ...
    wire w_nan_min_0 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d0 = (w_nan_d0 | w_nan_min_0) ? 1'b1 :
        (min_val[31] != d0[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d0[30:0]) :
        (min_val[30:0] >= d0[30:0]);
    wire w_nan_d1 = (d1[30:23] == 8'hFF) & (d1[22:0] != 23'h0);
    wire w_nan_min_1 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d1 = (w_nan_d1 | w_nan_min_1) ? 1'b1 :
        (min_val[31] != d1[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d1[30:0]) :
        (min_val[30:0] >= d1[30:0]);
    wire w_nan_d2 = (d2[30:23] == 8'hFF) & (d2[22:0] != 23'h0);
    wire w_nan_min_2 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d2 = (w_nan_d2 | w_nan_min_2) ? 1'b1 :
        (min_val[31] != d2[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d2[30:0]) :
        (min_val[30:0] >= d2[30:0]);
    wire w_nan_d3 = (d3[30:23] == 8'hFF) & (d3[22:0] != 23'h0);
    wire w_nan_min_3 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d3 = (w_nan_d3 | w_nan_min_3) ? 1'b1 :
        (min_val[31] != d3[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d3[30:0]) :
        (min_val[30:0] >= d3[30:0]);
    wire w_nan_d4 = (d4[30:23] == 8'hFF) & (d4[22:0] != 23'h0);
    wire w_nan_min_4 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d4 = (w_nan_d4 | w_nan_min_4) ? 1'b1 :
        (min_val[31] != d4[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d4[30:0]) :
        (min_val[30:0] >= d4[30:0]);
    wire w_nan_d5 = (d5[30:23] == 8'hFF) & (d5[22:0] != 23'h0);
    wire w_nan_min_5 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d5 = (w_nan_d5 | w_nan_min_5) ? 1'b1 :
        (min_val[31] != d5[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d5[30:0]) :
        (min_val[30:0] >= d5[30:0]);
    wire w_nan_d6 = (d6[30:23] == 8'hFF) & (d6[22:0] != 23'h0);
    wire w_nan_min_6 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d6 = (w_nan_d6 | w_nan_min_6) ? 1'b1 :
        (min_val[31] != d6[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d6[30:0]) :
        (min_val[30:0] >= d6[30:0]);
    wire w_nan_d7 = (d7[30:23] == 8'hFF) & (d7[22:0] != 23'h0);
    wire w_nan_min_7 = (min_val[30:23] == 8'hFF) & (min_val[22:0] != 23'h0);
    wire w_le_d7 = (w_nan_d7 | w_nan_min_7) ? 1'b1 :
        (min_val[31] != d7[31]) ? min_val[31] :
        (min_val[31] == 1'b0) ? (min_val[30:0] <= d7[30:0]) :
        (min_val[30:0] >= d7[30:0]);
