...
//
// Formal verification wrapper for math_fp32_softmax_8
//
// Verifies:
...
module formal_math_fp32_softmax_8 (
    input logic clk,
    input logic rst_n
);
    ...
    // sv2v turns `logic [31:0] i_data [8]` into `[255:0]`. Element i
    // is bits [32*(7-i) +: 32]: sv2v packs element 0 at the MSB end
