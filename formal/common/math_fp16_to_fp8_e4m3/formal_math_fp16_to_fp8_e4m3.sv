...
//
// Formal verification wrapper for math_fp16_to_fp8_e4m3
//
// Verifies lossy FP16 -> FP8_E4M3 downconversion properties:
//   - Sign preservation
...
module formal_math_fp16_to_fp8_e4m3 (
    input logic clk
);
