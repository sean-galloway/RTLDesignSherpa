...
//
// Formal wrapper for math_fp8_e4m3_min
// Proves FP8_E4M3 Min: output is one of inputs, NaN handling, commutativity

module formal_math_fp8_e4m3_min (
    input logic clk
);
