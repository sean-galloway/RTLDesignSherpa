...
//
// Formal wrapper for math_fp8_e4m3_max
// Proves FP8_E4M3 Max: output is one of inputs, NaN handling, commutativity

module formal_math_fp8_e4m3_max (
    input logic clk
);
    ...
    // Field extraction
    wire w_sign_a = a[7];
    wire [4-1:0] w_exp_a = a[6:3];
    wire [3-1:0] w_mant_a = a[2:0];
    wire w_sign_b = b[7];
    wire [4-1:0] w_exp_b = b[6:3];
    wire [3-1:0] w_mant_b = b[2:0];
