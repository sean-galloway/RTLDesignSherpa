...
//
// Formal verification wrapper for math_fp16_max_tree_8

`timescale 1ns / 1ps

module formal_math_fp16_max_tree_8 (
    input logic clk
);
    ...
    wire w_nan_max_0 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d0 = (w_nan_d0 | w_nan_max_0) ? 1'b1 :
        (max_val[15] != d0[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d0[14:0]) :
        (max_val[14:0] <= d0[14:0]);
    wire w_nan_d1 = (d1[14:10] == 5'h1F) & (d1[9:0] != 10'h0);
    wire w_nan_max_1 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d1 = (w_nan_d1 | w_nan_max_1) ? 1'b1 :
        (max_val[15] != d1[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d1[14:0]) :
        (max_val[14:0] <= d1[14:0]);
    wire w_nan_d2 = (d2[14:10] == 5'h1F) & (d2[9:0] != 10'h0);
    wire w_nan_max_2 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d2 = (w_nan_d2 | w_nan_max_2) ? 1'b1 :
        (max_val[15] != d2[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d2[14:0]) :
        (max_val[14:0] <= d2[14:0]);
    wire w_nan_d3 = (d3[14:10] == 5'h1F) & (d3[9:0] != 10'h0);
    wire w_nan_max_3 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d3 = (w_nan_d3 | w_nan_max_3) ? 1'b1 :
        (max_val[15] != d3[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d3[14:0]) :
        (max_val[14:0] <= d3[14:0]);
    wire w_nan_d4 = (d4[14:10] == 5'h1F) & (d4[9:0] != 10'h0);
    wire w_nan_max_4 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d4 = (w_nan_d4 | w_nan_max_4) ? 1'b1 :
        (max_val[15] != d4[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d4[14:0]) :
        (max_val[14:0] <= d4[14:0]);
    wire w_nan_d5 = (d5[14:10] == 5'h1F) & (d5[9:0] != 10'h0);
    wire w_nan_max_5 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d5 = (w_nan_d5 | w_nan_max_5) ? 1'b1 :
        (max_val[15] != d5[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d5[14:0]) :
        (max_val[14:0] <= d5[14:0]);
    wire w_nan_d6 = (d6[14:10] == 5'h1F) & (d6[9:0] != 10'h0);
    wire w_nan_max_6 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d6 = (w_nan_d6 | w_nan_max_6) ? 1'b1 :
        (max_val[15] != d6[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d6[14:0]) :
        (max_val[14:0] <= d6[14:0]);
    wire w_nan_d7 = (d7[14:10] == 5'h1F) & (d7[9:0] != 10'h0);
    wire w_nan_max_7 = (max_val[14:10] == 5'h1F) & (max_val[9:0] != 10'h0);
    wire w_ge_d7 = (w_nan_d7 | w_nan_max_7) ? 1'b1 :
        (max_val[15] != d7[15]) ? ~max_val[15] :
        (max_val[15] == 1'b0) ? (max_val[14:0] >= d7[14:0]) :
        (max_val[14:0] <= d7[14:0]);
