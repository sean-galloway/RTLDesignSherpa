...
//
// Formal wrapper for math_fp8_e5m2_max
// Proves FP8_E5M2 Max: output is one of inputs, NaN handling, commutativity

module formal_math_fp8_e5m2_max (
    input logic clk
);
