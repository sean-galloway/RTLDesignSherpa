// Yosys-compatible version of math_bf16_min_tree_8
...
// Level 0: 8 -> 4
wire w_l0_0_a_nan = (i_data_0[14:7] == 8'hFF) & (i_data_0[6:0] != 7'h0);
wire w_l0_0_b_nan = (i_data_1[14:7] == 8'hFF) & (i_data_1[6:0] != 7'h0);
...
wire w_l0_1_a_nan = (i_data_2[14:7] == 8'hFF) & (i_data_2[6:0] != 7'h0);
wire w_l0_1_b_nan = (i_data_3[14:7] == 8'hFF) & (i_data_3[6:0] != 7'h0);
...
wire w_l0_2_a_nan = (i_data_4[14:7] == 8'hFF) & (i_data_4[6:0] != 7'h0);
wire w_l0_2_b_nan = (i_data_5[14:7] == 8'hFF) & (i_data_5[6:0] != 7'h0);
...
wire w_l0_3_a_nan = (i_data_6[14:7] == 8'hFF) & (i_data_6[6:0] != 7'h0);
wire w_l0_3_b_nan = (i_data_7[14:7] == 8'hFF) & (i_data_7[6:0] != 7'h0);
...
// Level 1: 4 -> 2
wire w_l1_0_a_nan = (w_l0_0_result[14:7] == 8'hFF) & (w_l0_0_result[6:0] != 7'h0);
wire w_l1_0_b_nan = (w_l0_1_result[14:7] == 8'hFF) & (w_l0_1_result[6:0] != 7'h0);
...
wire w_l1_1_a_nan = (w_l0_2_result[14:7] == 8'hFF) & (w_l0_2_result[6:0] != 7'h0);
wire w_l1_1_b_nan = (w_l0_3_result[14:7] == 8'hFF) & (w_l0_3_result[6:0] != 7'h0);
...
// Level 2: 2 -> 1
wire w_l2_0_a_nan = (w_l1_0_result[14:7] == 8'hFF) & (w_l1_0_result[6:0] != 7'h0);
wire w_l2_0_b_nan = (w_l1_1_result[14:7] == 8'hFF) & (w_l1_1_result[6:0] != 7'h0);
