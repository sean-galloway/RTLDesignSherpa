...
//
// Formal wrapper for math_multiplier_wallace_tree_008
// Proves 8-bit Wallace tree multiplier: product == a * b

module formal_math_multiplier_wallace_tree_008 #(
    parameter int N = 8
) (
    input logic clk
);
    ...
    // Instantiate DUT
    math_multiplier_wallace_tree_008 #(.N(N)) dut (
        .i_multiplier  (a),
        .i_multiplicand(b),
        .ow_product    (product)
    );
