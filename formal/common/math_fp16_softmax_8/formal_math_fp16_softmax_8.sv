...
//
// Formal verification wrapper for math_fp16_softmax_8
//
// Verifies:
...
module formal_math_fp16_softmax_8 (
    input logic clk,
    input logic rst_n
);
    ...
    // =========================================================================
    logic                 w_valid_out;
    logic [127:0] w_result;

    math_fp16_softmax_8 dut (
        .i_clk     (clk),
        .i_rst_n   (rst_n),
        .i_valid   (valid_in),
        .i_data    (data_in),
