...
//
// Formal wrapper for math_adder_brent_kung_grouppg_032
// Proves the 32-bit group PG tree correctly computes carry chain outputs
// by comparing against a ripple-carry reference model.

module formal_math_adder_brent_kung_grouppg_032 (
    input logic clk
);
