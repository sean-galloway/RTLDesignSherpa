...
//
// Formal wrapper for math_multiplier_dadda_4to2_008
// Proves 8-bit Dadda 4:2 compressor multiplier: product == a * b

module formal_math_multiplier_dadda_4to2_008 #(
    parameter int N = 8
) (
    input logic clk
);
    ...
    // Instantiate DUT
    math_multiplier_dadda_4to2_008 #(.N(N)) dut (
        .i_multiplier  (a),
        .i_multiplicand(b),
        .ow_product    (product)
    );
