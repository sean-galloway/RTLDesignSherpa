...
module formal_math_bf16_max_tree_8 (
    ...
    wire w_nan_max_0 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
    ...
    wire w_nan_max_1 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
    ...
    wire w_nan_max_2 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
    ...
    wire w_nan_max_3 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
    ...
    wire w_nan_max_4 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
    ...
    wire w_nan_max_5 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
    ...
    wire w_nan_max_6 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
    ...
    wire w_nan_max_7 = (max_val[14:7] == 8'hFF) & (max_val[6:0] != 7'h0);
