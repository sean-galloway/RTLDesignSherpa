...
//
// Formal wrapper for math_bf16_max
// Proves BF16 Max: output is one of inputs, NaN handling, commutativity

module formal_math_bf16_max (
    input logic clk
);
    ...
    // Field extraction
    wire w_sign_a = a[15];
    wire [8-1:0] w_exp_a = a[14:7];
    wire [7-1:0] w_mant_a = a[6:0];
    wire w_sign_b = b[15];
    wire [8-1:0] w_exp_b = b[14:7];
    wire [7-1:0] w_mant_b = b[6:0];
