...
//
// Formal wrapper for math_adder_brent_kung_032 (32-bit Brent-Kung adder)
// Proves: {carry, sum} == a + b + cin

module formal_math_adder_brent_kung_032 #(
    parameter int N = 32
) (
    input logic clk
);
    ...
    math_adder_brent_kung_032 #(.N(N)) dut (
        .i_a     (a),
        .i_b     (b),
        .i_c     (cin),
        .ow_sum  (sum),
    ...
    always @(posedge clk)
        cp_cin_propagate: cover (a == {N{1'b1}} && b == '0 && cin == 1'b1 && carry == 1'b1);
