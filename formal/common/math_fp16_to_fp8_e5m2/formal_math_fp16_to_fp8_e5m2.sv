...
//
// Formal verification wrapper for math_fp16_to_fp8_e5m2
//
// Verifies lossy FP16 -> FP8_E5M2 downconversion properties:
//   - Sign preservation
//   - NaN propagation
...
module formal_math_fp16_to_fp8_e5m2 (
    input logic clk
);
    ...
    always @(posedge clk) begin
        ...
        // c_underflow removed: FP16 and E5M2 share the same bias (15),
        // so FP16 normal values never underflow to E5M2
