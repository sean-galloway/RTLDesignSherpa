...
//
// Formal verification wrapper for math_bf16_to_fp8_e5m2
//
// Verifies lossy BF16 -> FP8_E5M2 downconversion properties:
//   - Sign preservation
//   - NaN propagation
...
module formal_math_bf16_to_fp8_e5m2 (
    input logic clk
);
