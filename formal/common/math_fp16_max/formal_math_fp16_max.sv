...
//
// Formal wrapper for math_fp16_max
// Proves FP16 Max: output is one of inputs, NaN handling, commutativity

module formal_math_fp16_max (
    input logic clk
);

    // Free inputs
    (* anyconst *) logic [16-1:0] a;
    (* anyconst *) logic [16-1:0] b;
    logic [16-1:0] result;
    logic [16-1:0] result_swapped;
    ...
    // Field extraction
    wire w_sign_a = a[15];
    wire [5-1:0] w_exp_a = a[14:10];
    wire [10-1:0] w_mant_a = a[9:0];
    wire w_sign_b = b[15];
    wire [5-1:0] w_exp_b = b[14:10];
    wire [10-1:0] w_mant_b = b[9:0];
