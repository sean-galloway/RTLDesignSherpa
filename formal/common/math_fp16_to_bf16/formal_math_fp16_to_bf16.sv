...
//
// Formal verification wrapper for math_fp16_to_bf16
//
// Verifies FP16 -> BF16 conversion properties (lossy mantissa truncation):
//   - Sign preservation
...
module formal_math_fp16_to_bf16 (
    input logic clk
);
    ...
    always @(posedge clk) begin
        ...
        // c_overflow removed: FP16 exp range [1..30] + bias diff 112 = BF16 [113..142],
        // which never exceeds 254, so overflow is unreachable
