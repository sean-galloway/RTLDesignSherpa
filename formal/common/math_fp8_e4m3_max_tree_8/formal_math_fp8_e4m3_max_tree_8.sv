...
//
// Formal verification wrapper for math_fp8_e4m3_max_tree_8

`timescale 1ns / 1ps

module formal_math_fp8_e4m3_max_tree_8 (
    input logic clk
);
    ...
    wire w_nan_max_0 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
    ...
    wire w_nan_max_1 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
    ...
    wire w_nan_max_2 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
    ...
    wire w_nan_max_3 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
    ...
    wire w_nan_max_4 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
    ...
    wire w_nan_max_5 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
    ...
    wire w_nan_max_6 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
    ...
    wire w_nan_max_7 = (max_val[6:3] == 4'hF) & (max_val[2:0] == 3'h7);
