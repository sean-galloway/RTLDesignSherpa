...
//
// Formal verification wrapper for math_fp8_e4m3_min_tree_8

`timescale 1ns / 1ps

module formal_math_fp8_e4m3_min_tree_8 (
    input logic clk
);
    ...
    wire w_nan_d0 = (d0[6:3] == 4'hF) & (d0[2:0] == 3'h7);
    wire w_nan_min_0 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
    wire w_le_d0 = (w_nan_d0 | w_nan_min_0) ? 1'b1 :
        (min_val[7] != d0[7]) ? min_val[7] :
        (min_val[7] == 1'b0) ? (min_val[6:0] <= d0[6:0]) :
        (min_val[6:0] >= d0[6:0]);
    wire w_nan_d1 = (d1[6:3] == 4'hF) & (d1[2:0] == 3'h7);
    wire w_nan_min_1 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
    wire w_le_d1 = (w_nan_d1 | w_nan_min_1) ? 1'b1 :
        (min_val[7] != d1[7]) ? min_val[7] :
        (min_val[7] == 1'b0) ? (min_val[6:0] <= d1[6:0]) :
        (min_val[6:0] >= d1[6:0]);
    wire w_nan_d2 = (d2[6:3] == 4'hF) & (d2[2:0] == 3'h7);
    wire w_nan_min_2 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
    wire w_le_d2 = (w_nan_d2 | w_nan_min_2) ? 1'b1 :
        (min_val[7] != d2[7]) ? min_val[7] :
        (min_val[7] == 1'b0) ? (min_val[6:0] <= d2[6:0]) :
        (min_val[6:0] >= d2[6:0]);
    wire w_nan_d3 = (d3[6:3] == 4'hF) & (d3[2:0] == 3'h7);
    wire w_nan_min_3 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
    wire w_le_d3 = (w_nan_d3 | w_nan_min_3) ? 1'b1 :
        (min_val[7] != d3[7]) ? min_val[7] :
        (min_val[7] == 1'b0) ? (min_val[6:0] <= d3[6:0]) :
        (min_val[6:0] >= d3[6:0]);
    wire w_nan_d4 = (d4[6:3] == 4'hF) & (d4[2:0] == 3'h7);
    wire w_nan_min_4 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
    wire w_le_d4 = (w_nan_d4 | w_nan_min_4) ? 1'b1 :
        (min_val[7] != d4[7]) ? min_val[7] :
        (min_val[7] == 1'b0) ? (min_val[6:0] <= d4[6:0]) :
        (min_val[6:0] >= d4[6:0]);
    wire w_nan_d5 = (d5[6:3] == 4'hF) & (d5[2:0] == 3'h7);
    wire w_nan_min_5 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
    wire w_le_d5 = (w_nan_d5 | w_nan_min_5) ? 1'b1 :
        (min_val[7] != d5[7]) ? min_val[7] :
        (min_val[7] == 1'b0) ? (min_val[6:0] <= d5[6:0]) :
        (min_val[6:0] >= d5[6:0]);
    wire w_nan_d6 = (d6[6:3] == 4'hF) & (d6[2:0] == 3'h7);
    wire w_nan_min_6 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
    wire w_le_d6 = (w_nan_d6 | w_nan_min_6) ? 1'b1 :
        (min_val[7] != d6[7]) ? min_val[7] :
        (min_val[7] == 1'b0) ? (min_val[6:0] <= d6[6:0]) :
        (min_val[6:0] >= d6[6:0]);
    wire w_nan_d7 = (d7[6:3] == 4'hF) & (d7[2:0] == 3'h7);
    wire w_nan_min_7 = (min_val[6:3] == 4'hF) & (min_val[2:0] == 3'h7);
