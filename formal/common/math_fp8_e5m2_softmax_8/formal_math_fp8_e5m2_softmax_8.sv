...
//
// Formal verification wrapper for math_fp8_e5m2_softmax_8
//
// Verifies:
...
module formal_math_fp8_e5m2_softmax_8 (
    input logic clk,
    input logic rst_n
);
    ...
    // sv2v turns `logic [7:0] i_data [8]` into `[63:0]`. Element i
    // is bits [8*(7-i) +: 8]: sv2v packs element 0 at the MSB end
