...
//
// Formal verification wrapper for math_fp32_comparator
//
// Verifies:
...
module formal_math_fp32_comparator (
    input logic clk
);
    ...
    wire a_zero = (a[30:0] == 31'h0);
    wire b_zero = (b[30:0] == 31'h0);
    ...
    always @(posedge clk) begin
        ...
        c_zero_eq: cover (a_zero && b_zero && a[31] != b[31]);
    end
