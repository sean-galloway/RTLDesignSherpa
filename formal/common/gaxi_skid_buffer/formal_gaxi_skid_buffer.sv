...
//
// Formal wrapper for gaxi_skid_buffer (yosys-compatible)
// Proves FIFO-like invariants: count tracking, full/empty flags, no data loss.

module formal_gaxi_skid_buffer #(
