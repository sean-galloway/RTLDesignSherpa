...
module axil4_to_wb4_core (
	...
	parameter signed [31:0] SIDE_DEPTH = 8;
	parameter [1:0] RTY_RESP = 2'b10;
	...
	always @(*) begin
		if (_sv2v_0)
			;
		case (rsp_status)
			sv2v_cast_C2FF6(sv2v_cast_1AA03(2'b01)): w_resp = 2'b10;
			sv2v_cast_C2FF6(sv2v_cast_1AA03(2'b10)): w_resp = RTY_RESP;
			default: w_resp = 2'b00;
		endcase
	end
	wire w_rsp_hs;
	...
	assign w_rsp_hs = rsp_valid && (!w_side_rd_valid || (w_side_head_we ? fub_bready : fub_rready));
