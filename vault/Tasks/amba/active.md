...
Verification as built: `val/amba/test_axi_monitor_lite.py` 8/8 at full
...
first. The lite's own suite covers the four classes it emits, the drop
count and the refused count. The observers and STREAM have not been
switched; that is per-instance and theirs to decide.
