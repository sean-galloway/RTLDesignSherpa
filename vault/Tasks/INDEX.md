...
|---|---|---|---|
| [amba](amba/INDEX.md) | **migrated** | AXI/APB/AXIS, monitors, monbus. Sub-area [amba/monitor-lite](amba/monitor-lite/INDEX.md) for `rtl/amba/monitor/axi_monitor_lite.sv` (2026-09-25) | — |
...
| [delta](projects/components/delta/INDEX.md) | **migrated** | AXI-Stream crossbar generator | 16 items 2026-09-25: TASK-001/002 closed (spec landed in ch02, their ch04/ch05 paths never existed), TASK-016 closed, 003-015 open |
...
| [hive](projects/components/hive/INDEX.md) | **migrated** | 1 VexRiscv + 16 SERV cores | 25 items 2026-09-25: TASK-025 closed, 001-024 open. Early spec phase -- zero RTL, zero tests |
...
| [nexysa7](nexysa7/INDEX.md) | **started** | board campaigns + characterization flows | NEXYS-001 (consistent flow Makefiles). timing_characterization migrated 2026-09-25 to [projects/asic-trials/timing_characterization](projects/asic-trials/timing_characterization/INDEX.md) -- it is not a NexysA7 area any more; cdc_counter_display CDC_DEMO_TODO still to fold in |
| formal | **no area, by decision** | formal proof backlog | All five open items in [FORMAL_TODO.md](../../formal/FORMAL_TODO.md) were STALE (verified 2026-09-25): TASK-090/091/092/093 closed in [amba](amba/closed.md) 2026-09-11, `formal/stream/Makefile` exists since 2026-09-18. Zero open items, so no area was created. That file stays put -- eleven pages cite it and it holds measured status, not tasks |
