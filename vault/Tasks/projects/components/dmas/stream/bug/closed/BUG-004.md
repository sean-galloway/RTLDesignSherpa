...
`scheduler` (depth 35) was still running when this was written -- it had been
grinding a single SMT query at step 26 for 11 minutes, CPU-bound rather than
hung. If it fails deeper it means a fourth ready term I did not find, and this
reopens.
