---
title: RLB/pit_8254 tasks
summary: Task rollup for the 8254 programmable interval timer block (retro_legacy_blocks/rtl/pit_8254).
---

# RLB/pit_8254 — task rollup
...
Block: the 8254 programmable interval timer. RTL under
`projects/components/retro_legacy_blocks/rtl/pit_8254/`; MAS spec under
`projects/components/retro_legacy_blocks/docs/pit_8254_mas/`.
...
IDs are scoped to THIS sub-area AND its lane: `RLB/pit_8254 BUG-001` and
`RLB/hpet BUG-001` are different bugs. Cite one from outside as "RLB/pit_8254 BUG-001".
