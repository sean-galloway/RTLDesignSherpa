...
**Next ID: RLB-010** — never recycle a number, even when its task closed.
...
| open | 4 | RLB-006 (test scrub), RLB-007 (RDL relocation), RLB-008 (ioapic residual features), RLB-009 (pm_acpi residual features) |
