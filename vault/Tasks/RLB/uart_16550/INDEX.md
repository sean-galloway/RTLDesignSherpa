---
title: RLB/uart_16550 tasks
summary: Task rollup for the 16550 UART block (retro_legacy_blocks/rtl/uart_16550).
---

# RLB/uart_16550 — task rollup
...
Block: the 16550 UART. RTL under
`projects/components/retro_legacy_blocks/rtl/uart_16550/`; MAS spec under
`projects/components/retro_legacy_blocks/docs/uart_16550_mas/`.
...
IDs are scoped to THIS sub-area AND its lane: `RLB/uart_16550 BUG-001` and
`RLB/hpet BUG-001` are different bugs. Cite one from outside as "RLB/uart_16550 BUG-001".
