---
title: RLB/pic_8259 tasks
summary: Task rollup for the 8259 programmable interrupt controller block (retro_legacy_blocks/rtl/pic_8259).
---

# RLB/pic_8259 — task rollup
...
Block: the 8259 programmable interrupt controller. RTL under
`projects/components/retro_legacy_blocks/rtl/pic_8259/`; MAS spec under
`projects/components/retro_legacy_blocks/docs/pic_8259_mas/`.
...
IDs are scoped to THIS sub-area AND its lane: `RLB/pic_8259 BUG-001` and
`RLB/hpet BUG-001` are different bugs. Cite one from outside as "RLB/pic_8259 BUG-001".
