---
title: RLB/ioapic tasks
summary: Task rollup for the I/O APIC block (retro_legacy_blocks/rtl/ioapic).
---

# RLB/ioapic — task rollup
...
Block: the I/O APIC. RTL under
`projects/components/retro_legacy_blocks/rtl/ioapic/`; MAS spec under
...
IDs are scoped to THIS sub-area AND its lane: `RLB/ioapic BUG-001` and
`RLB/hpet BUG-001` are different bugs. Cite one from outside as "RLB/ioapic BUG-001".
