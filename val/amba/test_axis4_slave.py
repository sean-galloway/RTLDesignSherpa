...
Test runner for the axis4_slave.sv module using the CocoTB framework.
Tests various AXIS configurations and validates stream transactions.

The axis4_slave converts standard AXIS slave interface to FUB-side AXIS signals
...
def test_axis4_slave(request, skid_depth, data_width, id_width, dest_width, user_width):
