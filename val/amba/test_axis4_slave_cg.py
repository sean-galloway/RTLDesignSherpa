...
Test runner for the axis4_slave_cg module using the CocoTB framework.
                ...
                for cycle in range(0, power_measurement_cycles, 50):  # Transfer every 50 cycles
                    if cycle + 20 < power_measurement_cycles:  # Ensure we don't exceed measurement period
                        try:
                            ...
                            packet = tb.axis4_master.create_packet(data=data, last=1)
...
def test_axis4_slave_cg(skid_depth, data_width, id_width, dest_width, user_width, test_level, cg_test_mode):
