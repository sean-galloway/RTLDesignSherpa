...
#
# Module: test_axil5_slave_rd_mon_cg
# Purpose: AXIL5 Slave Read Monitor CG Integration Test
#
...
AXIL5 Slave Read Monitor CG Integration Test

Thin wrapper that uses the reusable AXIL5SlaveMonitorTB testbench class.
Tests the clock-gated version of the AXIL5 slave read monitor.
...
async def axil5_slave_rd_mon_cg_test(dut):
    """AXIL5 slave read monitor CG integration test"""
...
def test_axil5_slave_rd_mon_cg(test_level):
    """
    ...
    dut_name = "axil5_slave_rd_mon_cg"
    reg_level = os.environ.get("REG_LEVEL", "FUNC").upper()
    ...
    # Verilog sources (includes axil5_slave_rd_mon which the CG version instantiates)
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/axil5_slave_rd_mon_cg.f")
