...
#
# Module: test_axi5_slave_rd_mon
# Purpose: AXI5 Slave Read Monitor Integration Test
#
...
All test logic is in bin/CocoTBFramework/tbclasses/axi5/monitor/axi5_slave_monitor_tb.py
"""
...
def test_axi5_slave_rd_mon(id_width, addr_width, data_width, user_width, max_trans, skid_ar, skid_r, test_level):
    """
    Integration test runner for AXI5 slave read monitor.
