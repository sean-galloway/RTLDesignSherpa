...
def _trans_mgr_sources(rtl_dict):
    ...
    return [
        os.path.join(rtl_dict['rtl_monitor'], "monitor_trans_cam.sv"),
        os.path.join(rtl_dict['rtl_monitor'], "axi_monitor_trans_mgr.sv"),
    ]
...
async def axi4_master_rd_mon_wavedrom_test(dut):
    ...
    from TBClasses.wavedrom_user.axi4 import (
