...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , aclk_hs{vlSymsp->TOP.aclk_hs}
    , aresetn_hs{vlSymsp->TOP.aresetn_hs}
    ...
    , cfg_hp_enable{vlSymsp->TOP.cfg_hp_enable}
    , cfg_prefetch_enable{vlSymsp->TOP.cfg_prefetch_enable}
    , cfg_prefetch_depth{vlSymsp->TOP.cfg_prefetch_depth}
    , cfg_burst_optimize{vlSymsp->TOP.cfg_burst_optimize}
    , cfg_pipeline_mode{vlSymsp->TOP.cfg_pipeline_mode}
    , cfg_qos_enable{vlSymsp->TOP.cfg_qos_enable}
    , cfg_qos_high_threshold{vlSymsp->TOP.cfg_qos_high_threshold}
    , cfg_qos_low_threshold{vlSymsp->TOP.cfg_qos_low_threshold}
    , cfg_ml_filter_enable{vlSymsp->TOP.cfg_ml_filter_enable}
    , cfg_ml_filter_mode{vlSymsp->TOP.cfg_ml_filter_mode}
    ...
    , cfg_cg_adaptive{vlSymsp->TOP.cfg_cg_adaptive}
    , cfg_cg_perf_threshold{vlSymsp->TOP.cfg_cg_perf_threshold}
    ...
    , hp_overload_error{vlSymsp->TOP.hp_overload_error}
    , qos_violation_error{vlSymsp->TOP.qos_violation_error}
    , cfg_timeout_cycles{vlSymsp->TOP.cfg_timeout_cycles}
    , cfg_qos_timeout_cycles{vlSymsp->TOP.cfg_qos_timeout_cycles}
    ...
    , utilization_percent{vlSymsp->TOP.utilization_percent}
    , latency_histogram{vlSymsp->TOP.latency_histogram}
    , qos_histogram{vlSymsp->TOP.qos_histogram}
    , cg_efficiency_percent{vlSymsp->TOP.cg_efficiency_percent}
    ...
    , cfg_ml_filter_threshold{vlSymsp->TOP.cfg_ml_filter_threshold}
    , transaction_count{vlSymsp->TOP.transaction_count}
    , avg_latency_cycles{vlSymsp->TOP.avg_latency_cycles}
    , peak_latency_cycles{vlSymsp->TOP.peak_latency_cycles}
    , throughput_mbps{vlSymsp->TOP.throughput_mbps}
    , qos_high_count{vlSymsp->TOP.qos_high_count}
    , qos_low_count{vlSymsp->TOP.qos_low_count}
    , qos_violation_count{vlSymsp->TOP.qos_violation_count}
