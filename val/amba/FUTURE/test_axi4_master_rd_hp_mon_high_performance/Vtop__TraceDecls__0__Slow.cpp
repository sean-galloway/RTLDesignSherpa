...
void Vtop___024root__traceDeclTypesSub0(VerilatedFst* tracep) {
    {
        ...
        = {"0", "1", "10", "11", "100", "101"};
        tracep->declDTypeEnum(1, "monitor_pkg::transaction_state_t", 6, 3, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                ...
                                "1010", "1011", "1100", 
                                "1101", "1110", "1111"};
        tracep->declDTypeEnum(2, "monitor_pkg::axi_timeout_code_t", 16, 4, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                ...
                                "1010", "1011", "1100", 
                                "1101", "1110", "1111"};
        tracep->declDTypeEnum(3, "monitor_pkg::axi_completion_code_t", 16, 4, __VenumItemNames, __VenumItemValues);
    }
    {
        const char* __VenumItemNames[]
        ...
        = {"0", "1", "10", "11", "100", "101", "110", 
                                ...
                                "1010", "1011", "1100", 
                                "1101", "1110", "1111"};
        tracep->declDTypeEnum(4, "monitor_pkg::axi_error_code_t", 16, 4, __VenumItemNames, __VenumItemValues);
    }
}
