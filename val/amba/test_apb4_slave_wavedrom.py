...
from TBClasses.amba.apb4_slave_wavedrom_tb import ComprehensiveAPBSlaveTB
...
async def comprehensive_apb4_slave_test(dut):
...
def test_comprehensive_apb4_slave(request, addr_width, data_width, depth):
