...
#
# Module: test_cdc_4_phase_handshake
# Purpose: CDC 4-Phase Handshake Main Test - test_cdc_4_phase_handshake.py
#
...
"""
CDC 4-Phase Handshake Main Test - test_cdc_4_phase_handshake.py

Main test file that should be placed in the tests directory.
This integrates the CDC 4-phase handshake testbench with sophisticated features.
"""
...
from TBClasses.amba.cdc_4_phase_handshake import CDC4PhaseHandshakeTB
from TBClasses.shared.utilities import get_paths, create_view_cmd
from TBClasses.shared.filelist_utils import get_sources_from_filelist


@cocotb.test(timeout_time=30, timeout_unit="ms")
async def cdc_4_phase_handshake_test(dut):
    """CDC 4-phase handshake test with sophisticated patterns and analysis"""
...
def test_cdc_4_phase_handshake(request, params):
    """
    CDC 4-phase handshake test with comprehensive validation.
    ...
    dut_name = "cdc_4_phase_handshake"
    toplevel = dut_name

    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/cdc_4_phase_handshake.f")
    ...
    print(f"\n{'='*80}")
    print(f"CDC 4-Phase Handshake Test: {test_level.upper()}")
