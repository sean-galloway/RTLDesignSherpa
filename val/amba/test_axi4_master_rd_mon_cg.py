...
#
# Module: test_axi4_master_rd_mon_cg
# Purpose: AXI4 Master Read Monitor CG Integration Test
#
...
"""
AXI4 Master Read Monitor CG Integration Test

Thin wrapper that uses the reusable AXI4MasterMonitorTB testbench class.
Tests the clock-gated version of the AXI4 master read monitor.
...
async def axi4_master_rd_mon_cg_test(dut):
    """AXI4 master read monitor CG integration test"""
...
def test_axi4_master_rd_mon_cg(id_width, addr_width, data_width, user_width, max_trans, skid_ar, skid_r, test_level):
    """
    Integration test runner for AXI4 master read monitor CG.
    ...
    dut_name = "axi4_master_rd_mon_cg"
    ...
    # Verilog sources (includes axi4_master_rd_mon which the CG version instantiates)
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_axi4'], "axi4_master_rd_mon.sv"),  # Base monitor (instantiated by CG)
