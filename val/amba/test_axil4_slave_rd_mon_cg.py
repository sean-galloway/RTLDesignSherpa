...
#
# Module: test_axil4_slave_rd_mon_cg
# Purpose: AXIL4 Slave Read Monitor CG Integration Test
#
...
Tests the clock-gated version of the AXIL4 slave read monitor.
...
async def axil4_slave_rd_mon_cg_test(dut):
    """AXIL4 slave read monitor CG integration test"""
...
def test_axil4_slave_rd_mon_cg(test_level):
    """Integration test runner for AXIL4 slave read monitor CG"""
    ...
    dut_name = "axil4_slave_rd_mon_cg"
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_axil4'], "axil4_slave_rd_mon.sv"),  # Base monitor (instantiated by CG)
