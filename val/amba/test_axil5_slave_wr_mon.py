...
#
# Module: test_axil5_slave_wr_mon
# Purpose: AXIL5 Slave Write Monitor Integration Test
#
...
AXIL5 Slave Write Monitor Integration Test
...
async def axil5_slave_wr_mon_test(dut):
    """AXIL5 slave write monitor integration test"""
...
def test_axil5_slave_wr_mon(test_level):
    """
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/axil5_slave_wr_mon.f")
