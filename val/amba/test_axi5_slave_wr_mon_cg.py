...
#
# Module: test_axi5_slave_wr_mon_cg
# Purpose: AXI5 Slave Write Monitor with Clock Gating Integration Test
#
...
"""
AXI5 Slave Write Monitor with Clock Gating Integration Test

Tests the clock-gated version of the AXI5 slave write monitor.
"""
...
async def axi5_slave_wr_mon_cg_test(dut):
    """AXI5 slave write monitor clock-gated integration test"""
...
def test_axi5_slave_wr_mon_cg(id_width, addr_width, data_width, user_width, max_trans, skid_aw, skid_w, skid_b, test_level):
    """Integration test runner for AXI5 slave write monitor with clock gating."""
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_axi5'], "axi5_slave_wr_cg.sv"),
        ...
        os.path.join(rtl_dict['rtl_axi5'], "axi5_slave_wr_mon.sv"),
