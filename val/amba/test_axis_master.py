...
Test runner for the axis_master.sv module using the CocoTB framework.
Tests various AXIS configurations and validates stream transactions.

The axis_master converts FUB-side AXIS signals to standard AXIS master interface
...
def test_axis_master(request, skid_depth, data_width, id_width, dest_width, user_width):
