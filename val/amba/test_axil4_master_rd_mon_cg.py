...
#
# Module: test_axil4_master_rd_mon_cg
# Purpose: AXIL4 Master Read Monitor CG Integration Test
#
...
"""
AXIL4 Master Read Monitor CG Integration Test

Thin wrapper that uses the reusable AXIL4MasterMonitorTB testbench class.
Tests the clock-gated version of the AXIL4 master read monitor.
...
async def axil4_master_rd_mon_cg_test(dut):
    """AXIL4 master read monitor CG integration test"""
