...
Test runner for the axis_master_cg module using the CocoTB framework.
...
from CocoTBFramework.tbclasses.axis4.axis_master_cg_tb import AXISMasterCGTB
...
def generate_axis_cg_params():
    ...
    if debug_mode:
        return [
            (4, 32, 8, 4, 1, 'gate', 'comprehensive'),
            (4, 32, 8, 4, 1, 'func', 'comprehensive'),
        ]
...
def test_axis_master_cg(skid_depth, data_width, id_width, dest_width, user_width, test_level, cg_test_mode):
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_axis'], "axis_master.sv"),  # Base module
