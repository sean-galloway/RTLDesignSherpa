...
from TBClasses.amba.apb4_slave_cdc_cg_tb import APBSlaveCDCCGTB
...
def test_apb4_slave_cdc_cg_robust(request, addr_width, data_width, depth, cg_idle_count_width):
