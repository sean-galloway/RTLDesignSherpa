...
#
# Module: test_monbus_wb4_axil4_group
...
Test suite for `rtl/amba/monitor/monbus_wb4_axil4_group.sv` -- the
...
The reusable TB class lives at
  bin/TBClasses/amba/monbus_wb4_axil4_group/monbus_wb4_axil4_group_tb.py
...
# rtl/amba/monitor/monbus_wb4_axil4_group.sv module the test targets).
from TBClasses.amba.monbus_wb4_axil4_group.monbus_wb4_axil4_group_tb import MonbusWb4AxilGroupTB
...
async def cocotb_test_monbus_wb4_axil4_group(dut):
...
def generate_monbus_axil_axil_test_params():
    """Generate test parameters for monbus_wb4_axil4_group tests.
...
def test_monbus_wb4_axil4_group(request, test_type, fifo_depth_err, fifo_depth_write, addr_width, num_protocols, s_axil_data_width):
    ...
    dut_name = "monbus_wb4_axil4_group"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/monbus_wb4_axil4_group.f")
    ...
    cmd_filename = create_view_cmd(log_dir, log_path, sim_build, 'test_monbus_wb4_axil4_group', test_name_plus_params)
    ...
    try:
        run(
            ...
            toplevel=dut_name,
            module='test_monbus_wb4_axil4_group',
            testcase="cocotb_test_monbus_wb4_axil4_group",
