...
#
# Module: test_axi5_slave_rd_mon_cg
# Purpose: AXI5 Slave Read Monitor with Clock Gating Integration Test
#
...
"""
AXI5 Slave Read Monitor with Clock Gating Integration Test

Tests the clock-gated version of the AXI5 slave read monitor.
"""
...
async def axi5_slave_rd_mon_cg_test(dut):
    """AXI5 slave read monitor clock-gated integration test"""
...
def test_axi5_slave_rd_mon_cg(id_width, addr_width, data_width, user_width, max_trans, skid_ar, skid_r, test_level):
    """Integration test runner for AXI5 slave read monitor with clock gating."""
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_axi5'], "axi5_slave_rd_cg.sv"),
        ...
        os.path.join(rtl_dict['rtl_axi5'], "axi5_slave_rd_mon.sv"),
    ...
    print(f"\n{'='*80}")
    print(f"AXI5 Slave Read Monitor CG Integration Test")
