...
#
# Module: test_axi5_master_wr_mon
# Purpose: AXI5 Master Write Monitor Integration Test
#
...
"""
AXI5 Master Write Monitor Integration Test

Thin wrapper that uses the reusable AXI5MasterMonitorTB testbench class.
All test logic is in bin/TBClasses/axi5/monitor/axi5_master_monitor_tb.py
"""
...
async def axi5_master_wr_mon_test(dut):
    """AXI5 master write monitor integration test"""
...
def test_axi5_master_wr_mon(id_width, addr_width, data_width, user_width, max_trans, skid_aw, skid_w, skid_b, test_level):
    """
    Integration test runner for AXI5 master write monitor.
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/axi5_master_wr_mon.f")
    ...
    print(f"\n{'='*80}")
    print(f"AXI5 Master Write Monitor Integration Test")
