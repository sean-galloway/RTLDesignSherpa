...
#
# Module: test_axil5_master_rd_mon_cg
# Purpose: AXIL5 Master Read Monitor CG Integration Test
#
...
AXIL5 Master Read Monitor CG Integration Test

Thin wrapper that uses the reusable AXIL5MasterMonitorTB testbench class.
Tests the clock-gated version of the AXIL5 master read monitor.
All test logic is in bin/TBClasses/axil5/monitor/axil5_master_monitor_tb.py
"""
...
async def axil5_master_rd_mon_cg_test(dut):
    """AXIL5 master read monitor CG integration test"""
    ...
    tb = AXIL5MasterMonitorTB(dut, is_write=False, aclk=dut.aclk, aresetn=dut.aresetn)
...
def test_axil5_master_rd_mon_cg(test_level):
    """
    ...
    dut_name = "axil5_master_rd_mon_cg"
    reg_level = os.environ.get("REG_LEVEL", "FUNC").upper()
    ...
    # Verilog sources (includes axil5_master_rd_mon which the CG version instantiates)
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/axil5_master_rd_mon_cg.f")
