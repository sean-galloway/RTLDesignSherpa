...
#
# Module: test_axil5_master_rd_mon
# Purpose: AXIL5 Master Read Monitor Integration Test
#
...
AXIL5 Master Read Monitor Integration Test
...
async def axil5_master_rd_mon_test(dut):
    """AXIL5 master read monitor integration test"""
...
def test_axil5_master_rd_mon(test_level):
    """
    Integration test runner for AXIL5 master read monitor.
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/axil5_master_rd_mon.f")
