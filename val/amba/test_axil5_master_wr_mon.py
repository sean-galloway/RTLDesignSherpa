...
#
# Module: test_axil5_master_wr_mon
# Purpose: AXIL5 Master Write Monitor Integration Test
#
...
AXIL5 Master Write Monitor Integration Test
...
async def axil5_master_wr_mon_test(dut):
...
def test_axil5_master_wr_mon(test_level):
    """
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path="rtl/amba/filelists/axil5_master_wr_mon.f")
