...
#
# Module: test_math_adder_full
# Purpose: Test for the full adder module.
#
...
"""
Test for the full adder module.
"""
import os
import sys
import random
...
async def adder_test(dut):
    """Test the full adder completely"""
    tb = AdderTB(dut)
...
def test_math_adder_full(request):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/common/filelists/math_adder_full.f'
    )
