...
#
# Module: test_math_adder_carry_save_nbit
# Purpose: Test for the N-bit carry save adder module.
#
...
"""
Test for the N-bit carry save adder module.
"""
import os
import sys
import random
...
def get_width_params():
    ...
    if reg_level == 'GATE':
        ...
        return [4, 6, 8]  # FULL: All widths

@cocotb.test(timeout_time=1, timeout_unit="ms")
async def adder_test(dut):
    """Test the N-bit carry save adder"""
    tb = AdderTB(dut)
...
def test_math_adder_carry_save_nbit(request, n):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/common/filelists/math_adder_carry_save_nbit.f'
    )
