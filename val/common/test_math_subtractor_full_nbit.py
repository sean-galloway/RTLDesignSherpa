...
#
# Module: test_math_subtractor_full_nbit
# Purpose: Test for the full N-bit subtractor module.
#
...
async def subtractor_test(dut):
    """Test the full N-bit subtractor"""
    tb = SubtractorTB(dut)
...
def test_math_subtractor_full_nbit(request, n):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/common/filelists/math_subtractor_full_nbit.f'
    )
