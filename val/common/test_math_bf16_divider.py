...
#
# Module: test_math_bf16_divider
# Purpose: Test for the BF16 divider module.
#
...
"""
Test for the BF16 divider module.
...
- Quantizer-specific division patterns (127/max)
"""
import os
import random
import pytest
...
from CocoTBFramework.tbclasses.common.bf16_testing import BF16DividerTB


def get_bf16_divider_params():
    """Generate BF16 divider test parameters based on REG_LEVEL."""
...
async def bf16_divider_test(dut):
    """Test the BF16 divider"""
    tb = BF16DividerTB(dut)
...
@pytest.mark.parametrize("params", get_bf16_divider_params())
def test_math_bf16_divider(request, params):
    """PyTest function to run the cocotb test for BF16 divider."""
    # Get all of the directory and module information
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({
        'rtl_cmn': 'rtl/common'
    })

    dut_name = "math_bf16_divider"
    toplevel = dut_name
    ...
    verilog_sources = [
        os.path.join(rtl_dict['rtl_cmn'], "math_bf16_divider.sv"),
    ]
