...
#
# Module: test_math_bf16_to_int
# Purpose: Test for the BF16 to INT8 converter module.
#
...
"""
Test for the BF16 to INT8 converter module.
...
from CocoTBFramework.tbclasses.common.bf16_testing import BF16ToIntTB
...
def test_math_bf16_to_int(request, params):
    """PyTest function to run the cocotb test for BF16 to INT8 converter."""
    # Get all of the directory and module information
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({
        'rtl_cmn': 'rtl/common'
    })

    dut_name = "math_bf16_to_int"
    toplevel = dut_name
    ...
    verilog_sources = [
        os.path.join(rtl_dict['rtl_cmn'], "math_bf16_to_int.sv"),
    ]
