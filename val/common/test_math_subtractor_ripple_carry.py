...
#
# Module: test_math_subtractor_ripple_carry
# Purpose: Test for the ripple carry subtractor module.
#
...
"""
Test for the ripple carry subtractor module.
"""
import os
import sys
import random
...
def get_width_params():
    ...
    if reg_level == 'GATE':
        ...
        return [4, 8, 16]  # FULL: All widths


@cocotb.test(timeout_time=1, timeout_unit="ms")
async def subtractor_test(dut):
    """Test the ripple carry subtractor"""
    tb = SubtractorTB(dut)
...
def test_math_subtractor_ripple_carry(request, n):
    ...
    dut_name = "math_subtractor_ripple_carry"
    toplevel = dut_name

    # Get verilog sources and includes from filelist
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/common/filelists/math_subtractor_ripple_carry.f'
    )
