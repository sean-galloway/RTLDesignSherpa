...
def test_math_fp8_e4m3_multiplier(request, params):
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_cmn'], "math_fp8_e4m3_mantissa_mult.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_fp8_e4m3_exponent_adder.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_fp8_e4m3_multiplier.sv"),
    ]
