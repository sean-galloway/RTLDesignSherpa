...
#
# Module: test_math_adder_kogge_stone_nbit
# Purpose: Test for the Kogge-Stone N-bit adder module.
#
...
def test_math_adder_kogge_stone_nbit(request, n):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/common/filelists/math_adder_kogge_stone_nbit.f'
    )
