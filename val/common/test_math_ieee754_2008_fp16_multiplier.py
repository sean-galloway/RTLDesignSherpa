...
#
# Module: test_math_ieee754_2008_fp16_multiplier
# Purpose: Test for the FP16 floating-point multiplier module
#
...
"""
Test for the FP16 floating-point multiplier module.
"""
import os
import random
import pytest
...
def get_fp16_multiplier_params():
...
async def fp16_multiplier_test(dut):
    """Test the FP16 multiplier"""
    tb = FPMultiplierTB(dut, FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_fp16_multiplier_params())
def test_math_ieee754_2008_fp16_multiplier(request, params):
    """PyTest wrapper for FP16 multiplier."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common'})
    dut_name = "math_ieee754_2008_fp16_multiplier"
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_cmn'], "math_adder_han_carlson_022.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_multiplier_dadda_4to2_011.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_ieee754_2008_fp16_mantissa_mult.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_ieee754_2008_fp16_exponent_adder.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_ieee754_2008_fp16_multiplier.sv"),
    ]
