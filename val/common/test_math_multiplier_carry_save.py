...
#
# Module: test_math_multiplier_carry_save
# Purpose: Test for the carry-save multiplier module.
#
...
def test_math_multiplier_carry_save(request, params):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/common/filelists/math_multiplier_carry_save.f'
    )
    ...
    test_name_plus_params = f"test_{dut_name}_W{t_width:03d}_{t_name}_{reg_level}"
