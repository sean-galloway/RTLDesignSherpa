...
#
# Module: test_math_adder_brent_kung
# Purpose: Test for the 8-bit Brent-Kung adder module.
#
...
def get_width_params():
    ...
    if reg_level == 'GATE':
        return [8]  # GATE: Minimal - just 8-bit
    elif reg_level == 'FUNC':
        return [8, 16]  # FUNC: Small and medium widths
    else:  # FULL
        return [8, 16, 32]  # FULL: All widths
