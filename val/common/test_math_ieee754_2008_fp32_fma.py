...
def test_math_ieee754_2008_fp32_fma(request, params):
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_cmn'], "math_multiplier_dadda_4to2_024.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_adder_han_carlson_072.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_ieee754_2008_fp32_mantissa_mult.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_ieee754_2008_fp32_exponent_adder.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_ieee754_2008_fp32_fma.sv"),
    ]
