...
#
# Module: test_math_adder_full_nbit
# Purpose: Test for the N-bit full adder module.
#
...
"""
Test for the N-bit full adder module.
"""
import os
import sys
import random
...
def test_math_adder_full_nbit(request, n):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/common/filelists/math_adder_full_nbit.f'
    )
