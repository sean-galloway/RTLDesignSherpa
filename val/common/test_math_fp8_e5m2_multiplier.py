...
def test_math_fp8_e5m2_multiplier(request, params):
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_cmn'], "math_fp8_e5m2_mantissa_mult.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_fp8_e5m2_exponent_adder.sv"),
        os.path.join(rtl_dict['rtl_cmn'], "math_fp8_e5m2_multiplier.sv"),
    ]
