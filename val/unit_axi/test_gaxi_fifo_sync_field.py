...
from CocoTBFramework.tbclasses.gaxi_buffer_field import GaxiFieldBufferTB
...
def test_gaxi_fifo_sync_field(request, addr_width, ctrl_width, data_width, depth, mode):
