...
async def fifo_field_test(dut):
    '''Test the axi_fifo_sync_field component'''
...
def test_axi_fifo_sync_field(request, addr_width, ctrl_width, data_width, depth, mode):
    ...
    test_name_plus_params = f"test_fifo_field_aw{aw_str}_cw{cw_str}_dw{dw_str}_d{d_str}_{mode}"
