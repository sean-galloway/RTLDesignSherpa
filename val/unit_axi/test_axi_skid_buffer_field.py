...
def test_axi_skid_buffer_field(request, addr_width, ctrl_width, data_width, depth, mode):
    ...
    test_name_plus_params = f"test_skid_buffer_field_aw{aw_str}_cw{cw_str}_dw{dw_str}_d{d_str}"
