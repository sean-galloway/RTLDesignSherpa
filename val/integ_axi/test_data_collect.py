"""
Test file for data_collect module
"""
import os
import random
...
from CocoTBFramework.tbclasses.data_collect_tb import DataCollectTB


@cocotb.test(timeout_time=5, timeout_unit="ms")
async def data_collect_simple_test(dut):
...
def test_data_collect(request, data_width, id_width, fifo_depth):
...
if __name__ == "__main__":
    for params in generate_test_params():
        data_width, id_width, fifo_depth = params
        test_data_collect(None, data_width, id_width, fifo_depth)
