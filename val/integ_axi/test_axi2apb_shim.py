...
def test_axi2abp_shim(request, id_width, addr_width, data_width, user_width, apb_addr_width, apb_data_width):
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_axi'], "axi_gen_addr.sv"),
        os.path.join(rtl_dict['rtl_axi'], "axi2apb_convert.sv"),

        os.path.join(rtl_dict['rtl_axi'], "axi_slave_wr_stub.sv"),
        os.path.join(rtl_dict['rtl_axi'], "axi_slave_rd_stub.sv"),
        os.path.join(rtl_dict['rtl_axi'], "axi_slave_stub.sv"),
