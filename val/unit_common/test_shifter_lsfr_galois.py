...
class ShifterLFSRGaloisTB(TBBase):
    ...
    def simulate_galois_lfsr(self, seed, taps, cycles):
        """
        Simulate a Galois LFSR in software for reference
        ...
        for _ in range(cycles - 1):
            ...
            # If LSB was 1, XOR with tap positions
            if lsb:
                lfsr ^= tap_mask
    ...
    async def test_basic_operation(self):
        ...
        # Load a seed value
        seed = 0xFF & self.MAX_DATA  # For Galois LFSR, commonly initialized to all 1's
    ...
    async def test_seed_loading(self):
        ...
        seeds = [
            0xFF & self.MAX_DATA,  # All ones (common for Galois)
        ...
        for seed in seeds:
            ...
            cycles = 5
            expected_sequence = self.simulate_galois_lfsr(seed, [self.WIDTH, self.WIDTH//2, 2, 1], cycles)
    ...
    async def test_cycle_detection(self):
        ...
        seed = 0xFF & self.MAX_DATA  # All ones
        await self.load_seed(seed)
