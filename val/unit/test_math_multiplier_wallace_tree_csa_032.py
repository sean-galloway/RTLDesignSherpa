...
import logging
log = logging.getLogger('cocotb_log_math_multiplier_wallace_tree_csa_032')
log.setLevel(logging.DEBUG)
# Create a file handler that logs even debug messages
fh = logging.FileHandler('cocotb_log_math_multiplier_wallace_tree_csa_032.log')
...
@cocotb.test()
def multiplier_wallace_tree_csa_32_test(dut): 
...
tf = TestFactory(multiplier_wallace_tree_csa_32_test)
tf.generate_tests()
...
def test_math_multiplier_wallace_tree_csa_032(request, n):
    dut = "math_multiplier_wallace_tree_csa_032"
    module = os.path.splitext(os.path.basename(__file__))[0]  # The name of this file
    toplevel = "math_multiplier_wallace_tree_csa_032"   

    verilog_sources = [
        os.path.join(rtl_dir, "math_adder_half.sv"),
        os.path.join(rtl_dir, "math_adder_carry_save.sv"),
        os.path.join(rtl_dir, "math_multiplier_wallace_tree_csa_032.sv"),
