...
import logging
log = logging.getLogger('cocotb_log_dataint_crc')
log.setLevel(logging.DEBUG)
# Create a file handler that logs even debug messages
fh = logging.FileHandler('cocotb_log_dataint_crc.log')
...
@pytest.mark.parametrize("algo_name, data_width, crc_width, poly, poly_init, refin, refout, xorout", [('CRC-8', 8, 8, "8'h07", "8'h00", 0, 0, "8'h00")])
