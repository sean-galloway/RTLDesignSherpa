...
import logging
log = logging.getLogger('cocotb_log_shifter_lfsr')
log.setLevel(logging.DEBUG)
# Create a file handler that logs even debug messages
fh = logging.FileHandler('cocotb_log_shifter_lfsr.log')
...
def test_shifter_lfsr(request, width):
    dut = "shifter_lfsr"
    module = os.path.splitext(os.path.basename(__file__))[0]  # The name of this file
    toplevel = "shifter_lfsr"   

    verilog_sources = [
        os.path.join(rtl_dir, "shifter_lfsr.sv"),
