...
def test_math_multiplier_dadda_tree_016(request, n):
    dut_name = "math_multiplier_dadda_tree_016"
    module = os.path.splitext(os.path.basename(__file__))[0]  # The name of this file
    toplevel = "math_multiplier_dadda_tree_016"   
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dir, "math_multiplier_dadda_tree_016.sv"),
