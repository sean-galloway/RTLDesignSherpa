...
@pytest.mark.parametrize("depth, data_width, almost_wr_margin, almost_rd_margin", [(8, 8, 2, 2)])
def test_fifo_async(request, depth, data_width, almost_wr_margin, almost_rd_margin):
    dut = "fifo_async"
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dir, "fifo_async.sv"),
