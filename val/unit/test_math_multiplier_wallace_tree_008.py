...
import logging
log = logging.getLogger('cocotb_log_math_multiplier_wallace_tree_008')
log.setLevel(logging.DEBUG)
# Create a file handler that logs even debug messages
fh = logging.FileHandler('cocotb_log_math_multiplier_wallace_tree_008.log')
...
def test_math_multiplier_wallace_tree_008(request, n):
    dut = "math_multiplier_wallace_tree_008"
    module = os.path.splitext(os.path.basename(__file__))[0]  # The name of this file
    toplevel = "math_multiplier_wallace_tree_008"   

    verilog_sources = [
        os.path.join(rtl_dir, "math_adder_half.sv"),
        os.path.join(rtl_dir, "math_adder_full.sv"),
        os.path.join(rtl_dir, "math_multiplier_wallace_tree_008.sv"),
