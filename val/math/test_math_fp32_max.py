...
#
# Module: test_math_fp32_max
# Purpose: Test for the FP32 max module
#
...
async def fp32_max_test(dut):
    """Test the FP32 max"""
    tb = FPMaxMinTB(dut, FORMATS['fp32'], is_max=True)
...
@pytest.mark.parametrize("params", get_fp32_max_params())
def test_math_fp32_max(request, params):
    """PyTest wrapper for FP32 max."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp32_max"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp32_max.f'
