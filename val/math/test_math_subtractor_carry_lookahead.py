...
#
# Module: test_math_subtractor_carry_lookahead
# Purpose: Test for the carry lookahead subtractor module.
#
...
def test_math_subtractor_carry_lookahead(request, n):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='rtl/math/filelists/math_subtractor_carry_lookahead.f'
    )
