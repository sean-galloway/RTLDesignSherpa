...
#
# Module: test_math_fp16_tanh
# Purpose: Test for the FP16 tanh module
#
...
async def fp16_tanh_test(dut):
    """Test the FP16 tanh"""
    tb = FPTanhTB(dut, FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_fp16_tanh_params())
def test_math_fp16_tanh(request, params):
    """PyTest wrapper for FP16 tanh."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_tanh"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp16_tanh.f'
