...
#
# Module: test_math_fp16_min
# Purpose: Test for the FP16 min module
#
...
async def fp16_min_test(dut):
    """Test the FP16 min"""
    tb = FPMaxMinTB(dut, FORMATS['fp16'], is_max=False)
...
@pytest.mark.parametrize("params", get_fp16_min_params())
def test_math_fp16_min(request, params):
    """PyTest wrapper for FP16 min."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_min"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp16_min.f'
