...
#
# Module: test_math_fp16_comparator
# Purpose: Test for the FP16 comparator module
#
...
"""
Test for the FP16 comparator module.
"""
import os
import random
import pytest
...
def get_fp16_comparator_params():
...
async def fp16_comparator_test(dut):
    """Test the FP16 comparator"""
    tb = FPComparatorTB(dut, FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_fp16_comparator_params())
def test_math_fp16_comparator(request, params):
    """PyTest wrapper for FP16 comparator."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_comparator"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp16_comparator.f'
