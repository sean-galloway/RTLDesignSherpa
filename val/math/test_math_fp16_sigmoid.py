...
#
# Module: test_math_fp16_sigmoid
# Purpose: Test for the FP16 sigmoid module
#
...
"""
Test for the FP16 sigmoid module.
"""
import os
import random
import pytest
...
async def fp16_sigmoid_test(dut):
    """Test the FP16 sigmoid"""
    tb = FPSigmoidTB(dut, FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_fp16_sigmoid_params())
def test_math_fp16_sigmoid(request, params):
    """PyTest wrapper for FP16 sigmoid."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_sigmoid"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp16_sigmoid.f'
