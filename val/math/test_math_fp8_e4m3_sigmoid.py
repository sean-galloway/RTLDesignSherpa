...
#
# Module: test_math_fp8_e4m3_sigmoid
# Purpose: Test for the FP8 E4M3 sigmoid module
#
...
"""
Test for the FP8 E4M3 sigmoid module.
"""
import os
import random
import pytest
...
def get_fp8_e4m3_sigmoid_params():
...
async def fp8_e4m3_sigmoid_test(dut):
    """Test the FP8 E4M3 sigmoid"""
    tb = FPSigmoidTB(dut, FORMATS['fp8_e4m3'])
...
@pytest.mark.parametrize("params", get_fp8_e4m3_sigmoid_params())
def test_math_fp8_e4m3_sigmoid(request, params):
    """PyTest wrapper for FP8 E4M3 sigmoid."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e4m3_sigmoid"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e4m3_sigmoid.f'
