...
#
# Module: test_math_fp8_e5m2_max
# Purpose: Test for the FP8 E5M2 max module
#
...
"""
Test for the FP8 E5M2 max module.
"""
import os
import random
import pytest
...
async def fp8_e5m2_max_test(dut):
    """Test the FP8 E5M2 max"""
    tb = FPMaxMinTB(dut, FORMATS['fp8_e5m2'], is_max=True)
...
@pytest.mark.parametrize("params", get_fp8_e5m2_max_params())
def test_math_fp8_e5m2_max(request, params):
    """PyTest wrapper for FP8 E5M2 max."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e5m2_max"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e5m2_max.f'
