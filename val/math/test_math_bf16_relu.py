...
#
# Module: test_math_bf16_relu
# Purpose: Test for the BF16 relu module
#
...
async def bf16_relu_test(dut):
    """Test the BF16 relu"""
    tb = FPReluTB(dut, FORMATS['bf16'])
...
@pytest.mark.parametrize("params", get_bf16_relu_params())
def test_math_bf16_relu(request, params):
    """PyTest wrapper for BF16 relu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_bf16_relu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_bf16_relu.f'
