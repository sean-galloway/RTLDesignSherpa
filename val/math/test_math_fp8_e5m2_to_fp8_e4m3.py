...
#
# Module: test_math_fp8_e5m2_to_fp8_e4m3
# Purpose: Test for FP8_E5M2 to FP8_E4M3 conversion
#
...
"""
Test for FP8_E5M2 to FP8_E4M3 format conversion.
"""
import os
import random
import pytest
...
def test_math_fp8_e5m2_to_fp8_e4m3(request, params):
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e5m2_to_fp8_e4m3"
    ...
    verilog_sources = [os.path.join(rtl_dict['rtl_math'], "math_fp8_e5m2_to_fp8_e4m3.sv")]
