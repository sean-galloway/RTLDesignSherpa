...
#
# Module: test_math_fp8_e4m3_tanh
# Purpose: Test for the FP8 E4M3 tanh module
#
...
"""
Test for the FP8 E4M3 tanh module.
"""
import os
import random
import pytest
...
async def fp8_e4m3_tanh_test(dut):
    """Test the FP8 E4M3 tanh"""
    tb = FPTanhTB(dut, FORMATS['fp8_e4m3'])
...
@pytest.mark.parametrize("params", get_fp8_e4m3_tanh_params())
def test_math_fp8_e4m3_tanh(request, params):
    """PyTest wrapper for FP8 E4M3 tanh."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e4m3_tanh"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e4m3_tanh.f'
