...
#
# Module: test_math_fp8_e4m3_fma
# Purpose: Test for the FP8_E4M3 floating-point fma module
#
...
"""
Test for the FP8_E4M3 floating-point fma module.
"""
import os
import random
import pytest
...
async def fp8_e4m3_fma_test(dut):
    """Test the FP8_E4M3 fma"""
    tb = FPFMATB(dut, FORMATS['fp8_e4m3'])
...
@pytest.mark.parametrize("params", get_fp8_e4m3_fma_params())
def test_math_fp8_e4m3_fma(request, params):
    """PyTest wrapper for FP8_E4M3 fma."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e4m3_fma"
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_math'], "math_fp8_e4m3_fma.sv"),
    ]
