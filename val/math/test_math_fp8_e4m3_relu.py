...
#
# Module: test_math_fp8_e4m3_relu
# Purpose: Test for the FP8 E4M3 relu module
#
...
"""
Test for the FP8 E4M3 relu module.
"""
import os
import random
import pytest
...
async def fp8_e4m3_relu_test(dut):
    """Test the FP8 E4M3 relu"""
    tb = FPReluTB(dut, FORMATS['fp8_e4m3'])
...
@pytest.mark.parametrize("params", get_fp8_e4m3_relu_params())
def test_math_fp8_e4m3_relu(request, params):
    """PyTest wrapper for FP8 E4M3 relu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e4m3_relu"
    ...
    verilog_sources = [
        os.path.join(rtl_dict['rtl_math'], "math_fp8_e4m3_relu.sv"),
    ]
