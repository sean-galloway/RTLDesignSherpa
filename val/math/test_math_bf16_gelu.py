...
#
# Module: test_math_bf16_gelu
# Purpose: Test for the BF16 gelu module
#
...
async def bf16_gelu_test(dut):
    """Test the BF16 gelu"""
    tb = FPGeluTB(dut, FORMATS['bf16'])
...
@pytest.mark.parametrize("params", get_bf16_gelu_params())
def test_math_bf16_gelu(request, params):
    """PyTest wrapper for BF16 gelu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_bf16_gelu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_bf16_gelu.f'
