...
#
# Module: test_math_fp16_max
# Purpose: Test for the FP16 max module
#
...
async def fp16_max_test(dut):
    """Test the FP16 max"""
    tb = FPMaxMinTB(dut, FORMATS['fp16'], is_max=True)
...
@pytest.mark.parametrize("params", get_fp16_max_params())
def test_math_fp16_max(request, params):
    """PyTest wrapper for FP16 max."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_max"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp16_max.f'
