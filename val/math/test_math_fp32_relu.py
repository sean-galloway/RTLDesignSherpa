...
#
# Module: test_math_fp32_relu
# Purpose: Test for the FP32 relu module
#
...
async def fp32_relu_test(dut):
    """Test the FP32 relu"""
    tb = FPReluTB(dut, FORMATS['fp32'])
...
@pytest.mark.parametrize("params", get_fp32_relu_params())
def test_math_fp32_relu(request, params):
    """PyTest wrapper for FP32 relu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp32_relu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp32_relu.f'
