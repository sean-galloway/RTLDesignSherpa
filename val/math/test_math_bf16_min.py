...
#
# Module: test_math_bf16_min
# Purpose: Test for the BF16 min module
#
...
async def bf16_min_test(dut):
    """Test the BF16 min"""
    tb = FPMaxMinTB(dut, FORMATS['bf16'], is_max=False)
...
@pytest.mark.parametrize("params", get_bf16_min_params())
def test_math_bf16_min(request, params):
    """PyTest wrapper for BF16 min."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_bf16_min"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_bf16_min.f'
