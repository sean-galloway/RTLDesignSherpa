...
#
# Module: test_math_fp8_e4m3_gelu
# Purpose: Test for the FP8 E4M3 gelu module
#
...
"""
Test for the FP8 E4M3 gelu module.
"""
import os
import random
import pytest
...
async def fp8_e4m3_gelu_test(dut):
    """Test the FP8 E4M3 gelu"""
    tb = FPGeluTB(dut, FORMATS['fp8_e4m3'])
...
@pytest.mark.parametrize("params", get_fp8_e4m3_gelu_params())
def test_math_fp8_e4m3_gelu(request, params):
    """PyTest wrapper for FP8 E4M3 gelu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e4m3_gelu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e4m3_gelu.f'
