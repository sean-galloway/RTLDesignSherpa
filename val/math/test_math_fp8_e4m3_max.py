...
#
# Module: test_math_fp8_e4m3_max
# Purpose: Test for the FP8 E4M3 max module
#
...
"""
Test for the FP8 E4M3 max module.
"""
import os
import random
import pytest
...
async def fp8_e4m3_max_test(dut):
    """Test the FP8 E4M3 max"""
    tb = FPMaxMinTB(dut, FORMATS['fp8_e4m3'], is_max=True)
...
@pytest.mark.parametrize("params", get_fp8_e4m3_max_params())
def test_math_fp8_e4m3_max(request, params):
    """PyTest wrapper for FP8 E4M3 max."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e4m3_max"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e4m3_max.f'
