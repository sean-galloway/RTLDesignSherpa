...
#
# Module: test_math_bf16_silu
# Purpose: Test for the BF16 silu module
#
...
async def bf16_silu_test(dut):
    """Test the BF16 silu"""
    tb = FPSiluTB(dut, FORMATS['bf16'])
...
@pytest.mark.parametrize("params", get_bf16_silu_params())
def test_math_bf16_silu(request, params):
    """PyTest wrapper for BF16 silu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_bf16_silu"
    ...
    verilog_sources = [
        os.path.join(rtl_dict['rtl_math'], "math_bf16_silu.sv"),
    ]
