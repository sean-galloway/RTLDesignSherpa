...
#
# Module: test_math_fp16_silu
# Purpose: Test for the FP16 silu module
#
...
async def fp16_silu_test(dut):
    """Test the FP16 silu"""
    tb = FPSiluTB(dut, FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_fp16_silu_params())
def test_math_fp16_silu(request, params):
    """PyTest wrapper for FP16 silu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_silu"
    ...
    verilog_sources = [
        os.path.join(rtl_dict['rtl_math'], "math_fp16_silu.sv"),
    ]
