...
#
# Module: test_math_bf16_max
# Purpose: Test for the BF16 max module
#
...
async def bf16_max_test(dut):
    """Test the BF16 max"""
    tb = FPMaxMinTB(dut, FORMATS['bf16'], is_max=True)
...
@pytest.mark.parametrize("params", get_bf16_max_params())
def test_math_bf16_max(request, params):
    """PyTest wrapper for BF16 max."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_bf16_max"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_bf16_max.f'
