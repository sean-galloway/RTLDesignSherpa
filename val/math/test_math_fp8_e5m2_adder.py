...
#
# Module: test_math_fp8_e5m2_adder
# Purpose: Test for the FP8_E5M2 floating-point adder module
#
...
"""
Test for the FP8_E5M2 floating-point adder module.
"""
import os
import random
import pytest
...
async def fp8_e5m2_adder_test(dut):
    """Test the FP8_E5M2 adder"""
    tb = FPAdderTB(dut, FORMATS['fp8_e5m2'])
...
@pytest.mark.parametrize("params", get_fp8_e5m2_adder_params())
def test_math_fp8_e5m2_adder(request, params):
    """PyTest wrapper for FP8_E5M2 adder."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e5m2_adder"
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_math'], "math_fp8_e5m2_adder.sv"),
    ]
