...
#
# Module: test_math_fp32_clamp
# Purpose: Test for the FP32 clamp module
#
...
"""
Test for the FP32 clamp module.
"""
import os
import random
import pytest
...
async def fp32_clamp_test(dut):
    """Test the FP32 clamp"""
    tb = FPClampTB(dut, FORMATS['fp32'])
...
@pytest.mark.parametrize("params", get_fp32_clamp_params())
def test_math_fp32_clamp(request, params):
    """PyTest wrapper for FP32 clamp."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp32_clamp"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp32_clamp.f'
