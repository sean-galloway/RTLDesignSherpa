...
#
# Module: test_math_bf16_to_fp16
# Purpose: Test for BF16 to FP16 conversion
#
...
"""
Test for BF16 to FP16 format conversion.
"""
import os
import random
import pytest
...
async def bf16_to_fp16_test(dut):
    tb = FPConversionTB(dut, FORMATS['bf16'], FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_bf16_to_fp16_params())
def test_math_bf16_to_fp16(request, params):
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_bf16_to_fp16"
    ...
    verilog_sources = [os.path.join(rtl_dict['rtl_math'], "math_bf16_to_fp16.sv")]
