...
#
# Module: test_math_fp8_e5m2_min
# Purpose: Test for the FP8 E5M2 min module
#
...
"""
Test for the FP8 E5M2 min module.
"""
import os
import random
import pytest
...
async def fp8_e5m2_min_test(dut):
    """Test the FP8 E5M2 min"""
    tb = FPMaxMinTB(dut, FORMATS['fp8_e5m2'], is_max=False)
...
@pytest.mark.parametrize("params", get_fp8_e5m2_min_params())
def test_math_fp8_e5m2_min(request, params):
    """PyTest wrapper for FP8 E5M2 min."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e5m2_min"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e5m2_min.f'
