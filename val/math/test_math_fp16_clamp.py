...
#
# Module: test_math_fp16_clamp
# Purpose: Test for the FP16 clamp module
#
...
"""
Test for the FP16 clamp module.
"""
import os
import random
import pytest
...
async def fp16_clamp_test(dut):
    """Test the FP16 clamp"""
    tb = FPClampTB(dut, FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_fp16_clamp_params())
def test_math_fp16_clamp(request, params):
    """PyTest wrapper for FP16 clamp."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_clamp"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp16_clamp.f'
