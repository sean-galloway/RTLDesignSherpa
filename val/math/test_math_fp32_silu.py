...
#
# Module: test_math_fp32_silu
# Purpose: Test for the FP32 silu module
#
...
async def fp32_silu_test(dut):
    """Test the FP32 silu"""
    tb = FPSiluTB(dut, FORMATS['fp32'])
...
@pytest.mark.parametrize("params", get_fp32_silu_params())
def test_math_fp32_silu(request, params):
    """PyTest wrapper for FP32 silu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp32_silu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp32_silu.f'
