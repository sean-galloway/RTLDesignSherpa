...
# Purpose: Test for the BF16 comparator module
#
...
"""
Test for the BF16 comparator module.
"""
import os
import random
import pytest
...
def get_bf16_comparator_params():
...
async def bf16_comparator_test(dut):
    ...
    tb = FPComparatorTB(dut, FORMATS['bf16'])
...
@pytest.mark.parametrize("params", get_bf16_comparator_params())
def test_math_bf16_comparator(request, params):
    """PyTest wrapper for BF16 comparator."""
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_bf16_comparator.f'
