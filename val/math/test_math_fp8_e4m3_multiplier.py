...
#
# Module: test_math_fp8_e4m3_multiplier
# Purpose: Test for the FP8_E4M3 floating-point multiplier module
#
...
"""
Test for the FP8_E4M3 floating-point multiplier module.
"""
import os
import random
import pytest
...
def get_fp8_e4m3_multiplier_params():
...
async def fp8_e4m3_multiplier_test(dut):
    """Test the FP8_E4M3 multiplier"""
    tb = FPMultiplierTB(dut, FORMATS['fp8_e4m3'])
...
@pytest.mark.parametrize("params", get_fp8_e4m3_multiplier_params())
def test_math_fp8_e4m3_multiplier(request, params):
    """PyTest wrapper for FP8_E4M3 multiplier."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e4m3_multiplier"
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_math'], "math_fp8_e4m3_mantissa_mult.sv"),
        os.path.join(rtl_dict['rtl_math'], "math_fp8_e4m3_exponent_adder.sv"),
        os.path.join(rtl_dict['rtl_math'], "math_fp8_e4m3_multiplier.sv"),
    ]
