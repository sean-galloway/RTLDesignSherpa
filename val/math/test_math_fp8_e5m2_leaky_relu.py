...
#
# Module: test_math_fp8_e5m2_leaky_relu
# Purpose: Test for the FP8 E5M2 leaky_relu module
#
...
"""
Test for the FP8 E5M2 leaky_relu module.
"""
import os
import random
import pytest
...
def get_fp8_e5m2_leaky_relu_params():
...
async def fp8_e5m2_leaky_relu_test(dut):
    """Test the FP8 E5M2 leaky_relu"""
    tb = FPLeakyReluTB(dut, FORMATS['fp8_e5m2'])
...
@pytest.mark.parametrize("params", get_fp8_e5m2_leaky_relu_params())
def test_math_fp8_e5m2_leaky_relu(request, params):
    """PyTest wrapper for FP8 E5M2 leaky_relu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e5m2_leaky_relu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e5m2_leaky_relu.f'
