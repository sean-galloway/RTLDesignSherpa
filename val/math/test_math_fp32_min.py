...
#
# Module: test_math_fp32_min
# Purpose: Test for the FP32 min module
#
...
async def fp32_min_test(dut):
    """Test the FP32 min"""
    tb = FPMaxMinTB(dut, FORMATS['fp32'], is_max=False)
...
@pytest.mark.parametrize("params", get_fp32_min_params())
def test_math_fp32_min(request, params):
    """PyTest wrapper for FP32 min."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp32_min"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp32_min.f'
