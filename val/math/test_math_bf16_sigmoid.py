...
#
# Module: test_math_bf16_sigmoid
# Purpose: Test for the BF16 sigmoid module
#
...
"""
Test for the BF16 sigmoid module.
"""
import os
import random
import pytest
...
async def bf16_sigmoid_test(dut):
    """Test the BF16 sigmoid"""
    tb = FPSigmoidTB(dut, FORMATS['bf16'])
...
@pytest.mark.parametrize("params", get_bf16_sigmoid_params())
def test_math_bf16_sigmoid(request, params):
    """PyTest wrapper for BF16 sigmoid."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_bf16_sigmoid"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_bf16_sigmoid.f'
