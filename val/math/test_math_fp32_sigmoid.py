...
#
# Module: test_math_fp32_sigmoid
# Purpose: Test for the FP32 sigmoid module
#
...
"""
Test for the FP32 sigmoid module.
"""
import os
import random
import pytest
...
async def fp32_sigmoid_test(dut):
    """Test the FP32 sigmoid"""
    tb = FPSigmoidTB(dut, FORMATS['fp32'])
...
@pytest.mark.parametrize("params", get_fp32_sigmoid_params())
def test_math_fp32_sigmoid(request, params):
    """PyTest wrapper for FP32 sigmoid."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp32_sigmoid"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp32_sigmoid.f'
