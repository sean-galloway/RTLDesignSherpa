...
#
# Module: test_math_fp8_e5m2_clamp
# Purpose: Test for the FP8 E5M2 clamp module
#
...
"""
Test for the FP8 E5M2 clamp module.
"""
import os
import random
import pytest
...
async def fp8_e5m2_clamp_test(dut):
    """Test the FP8 E5M2 clamp"""
    tb = FPClampTB(dut, FORMATS['fp8_e5m2'])
...
@pytest.mark.parametrize("params", get_fp8_e5m2_clamp_params())
def test_math_fp8_e5m2_clamp(request, params):
    """PyTest wrapper for FP8 E5M2 clamp."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp8_e5m2_clamp"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp8_e5m2_clamp.f'
