...
#
# Module: test_math_fp16_gelu
# Purpose: Test for the FP16 gelu module
#
...
async def fp16_gelu_test(dut):
    """Test the FP16 gelu"""
    tb = FPGeluTB(dut, FORMATS['fp16'])
...
@pytest.mark.parametrize("params", get_fp16_gelu_params())
def test_math_fp16_gelu(request, params):
    """PyTest wrapper for FP16 gelu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp16_gelu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp16_gelu.f'
