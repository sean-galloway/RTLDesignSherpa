...
#
# Module: test_math_fp32_gelu
# Purpose: Test for the FP32 gelu module
#
...
async def fp32_gelu_test(dut):
    """Test the FP32 gelu"""
    tb = FPGeluTB(dut, FORMATS['fp32'])
...
@pytest.mark.parametrize("params", get_fp32_gelu_params())
def test_math_fp32_gelu(request, params):
    """PyTest wrapper for FP32 gelu."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({'rtl_cmn': 'rtl/common',
        'rtl_math': 'rtl/math'})
    dut_name = "math_fp32_gelu"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        ...
        filelist_path='rtl/math/filelists/math_fp32_gelu.f'
