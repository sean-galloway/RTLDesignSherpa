...
def test_fifo_buffer_field(request, addr_width, ctrl_width, data_width, depth, wr_clk_period, rd_clk_period, mode):
    ...
    test_name_plus_params = f"test_{dut_name}_buffer_field_aw{aw_str}_cw{cw_str}_dw{dw_str}_d{d_str}_wcl{wcl_str}_rcl{rcl_str}_{mode}"
