...
test-bridge:
	...
	@cd projects/components/bridge/dv/tests && REG_LEVEL=FUNC $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-bridge-gate
test-bridge-gate:
	@echo "=== bridge GATE (serial) ==="
	@cd projects/components/bridge/dv/tests && REG_LEVEL=GATE $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py
...
test-bridge-full:
	...
	@cd projects/components/bridge/dv/tests && REG_LEVEL=FULL $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-bridge-gate-waves
test-bridge-gate-waves:
	@echo "=== bridge GATE (serial + waves) ==="
	@cd projects/components/bridge/dv/tests && REG_LEVEL=GATE WAVES=1 $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-bridge-func-waves
test-bridge-func-waves:
	@echo "=== bridge FUNC (serial + waves) ==="
	@cd projects/components/bridge/dv/tests && REG_LEVEL=FUNC WAVES=1 $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-bridge-full-waves
test-bridge-full-waves:
	@echo "=== bridge FULL (serial + waves) ==="
	@cd projects/components/bridge/dv/tests && REG_LEVEL=FULL WAVES=1 $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py
...
test-converters:
	...
	@cd projects/components/converters/dv/tests && REG_LEVEL=FUNC $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-converters-gate
test-converters-gate:
	@echo "=== converters GATE (parallel) ==="
	@cd projects/components/converters/dv/tests && REG_LEVEL=GATE $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py
...
test-converters-full:
	...
	@cd projects/components/converters/dv/tests && REG_LEVEL=FULL $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-converters-gate-waves
test-converters-gate-waves:
	@echo "=== converters GATE (parallel + waves) ==="
	@cd projects/components/converters/dv/tests && REG_LEVEL=GATE WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-converters-func-waves
test-converters-func-waves:
	@echo "=== converters FUNC (parallel + waves) ==="
	@cd projects/components/converters/dv/tests && REG_LEVEL=FUNC WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-converters-full-waves
test-converters-full-waves:
	@echo "=== converters FULL (parallel + waves) ==="
	@cd projects/components/converters/dv/tests && REG_LEVEL=FULL WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-converters-gate-serial
test-converters-gate-serial:
	@echo "=== converters GATE (serial) ==="
	@cd projects/components/converters/dv/tests && REG_LEVEL=GATE $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-converters-func-serial
test-converters-func-serial:
	@echo "=== converters FUNC (serial) ==="
	@cd projects/components/converters/dv/tests && REG_LEVEL=FUNC $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-converters-full-serial
test-converters-full-serial:
	@echo "=== converters FULL (serial) ==="
	@cd projects/components/converters/dv/tests && REG_LEVEL=FULL $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py
...
test-apb-xbar:
	...
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=FUNC $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-apb-xbar-gate
test-apb-xbar-gate:
	@echo "=== apb-xbar GATE (parallel) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=GATE $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py
...
test-apb-xbar-full:
	...
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=FULL $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-apb-xbar-gate-waves
test-apb-xbar-gate-waves:
	@echo "=== apb-xbar GATE (parallel + waves) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=GATE WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-apb-xbar-func-waves
test-apb-xbar-func-waves:
	@echo "=== apb-xbar FUNC (parallel + waves) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=FUNC WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-apb-xbar-full-waves
test-apb-xbar-full-waves:
	@echo "=== apb-xbar FULL (parallel + waves) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=FULL WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-apb-xbar-gate-serial
test-apb-xbar-gate-serial:
	@echo "=== apb-xbar GATE (serial) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=GATE $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-apb-xbar-func-serial
test-apb-xbar-func-serial:
	@echo "=== apb-xbar FUNC (serial) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=FUNC $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-apb-xbar-full-serial
test-apb-xbar-full-serial:
	@echo "=== apb-xbar FULL (serial) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=FULL $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: coverage-apb-xbar
coverage-apb-xbar:
	@echo "=== apb-xbar FUNC (parallel + coverage) ==="
	@cd projects/components/apbx-xbar/dv/tests && REG_LEVEL=FUNC COVERAGE=1 $(PYTEST) -v --tb=short -n 24 --reruns 5 --reruns-delay 2 test_*.py
...
test-retro-legacy:
	...
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=FUNC $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-retro-legacy-gate
test-retro-legacy-gate:
	@echo "=== retro-legacy GATE (parallel) ==="
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=GATE $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py
...
test-retro-legacy-full:
	...
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=FULL $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-retro-legacy-gate-waves
test-retro-legacy-gate-waves:
	@echo "=== retro-legacy GATE (parallel + waves) ==="
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=GATE WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-retro-legacy-func-waves
test-retro-legacy-func-waves:
	@echo "=== retro-legacy FUNC (parallel + waves) ==="
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=FUNC WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-retro-legacy-full-waves
test-retro-legacy-full-waves:
	@echo "=== retro-legacy FULL (parallel + waves) ==="
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=FULL WAVES=1 $(PYTEST) -v --tb=short -n 48 --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-retro-legacy-gate-serial
test-retro-legacy-gate-serial:
	@echo "=== retro-legacy GATE (serial) ==="
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=GATE $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-retro-legacy-func-serial
test-retro-legacy-func-serial:
	@echo "=== retro-legacy FUNC (serial) ==="
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=FUNC $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py

.PHONY: test-retro-legacy-full-serial
test-retro-legacy-full-serial:
	@echo "=== retro-legacy FULL (serial) ==="
	@cd projects/components/retro_legacy_blocks/dv/tests && REG_LEVEL=FULL $(PYTEST) -v --tb=short --reruns 3 --reruns-delay 1 test_*.py
