# Filelist for apb4_peripheral_subsystem
# Location: rtl/integ_amba/filelists/apb4_peripheral_subsystem.f
#
...
$REPO_ROOT/rtl/integ_amba/examples/apb4_peripheral_subsystem.sv
