# Filelist for apbx_xbar_monitored
# Location: rtl/integ_amba/filelists/apbx_xbar_monitored.f
#
...
# apbx_xbar_thin instantiates arbiter_round_robin_weighted but its own filelist
