`timescale 1ns / 1ps
/**
 * AXI Error Monitor and Interrupt Bus Type Definitions
 *
 * This package defines common type definitions used across components
 * that interface with the AXI error monitoring system and interrupt bus,
 * providing consistent data structures and enumerations.
 */
package axi_errmon_types;
    ...
    typedef struct packed {
        ...
        axi_event_code_t error_code;    // Error code if any
    ...
    typedef logic [63:0] intrbus_packet_t;
