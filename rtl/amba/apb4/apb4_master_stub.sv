...
module apb4_master_stub #(
    ...
    // Response signals from apb4_master
    ...
    //
    // apb4_master takes cmd_pwrite/paddr/pwdata/pstrb/pprot only — it
    ...
    // FIFO mirrors the depth of the apb4_master cmd FIFO so it never
    ...
    // Instantiate fully-tested apb4_master
    apb4_master #(
