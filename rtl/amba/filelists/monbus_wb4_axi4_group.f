# Filelist for monbus_wb4_axi4_group
# Location: rtl/amba/filelists/monbus_wb4_axi4_group.f
# Purpose: monbus_axil4_axi4_group with a Wishbone B4 read port in place of the AXI4-Lite one
