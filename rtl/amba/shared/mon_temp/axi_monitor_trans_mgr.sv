...
//
// Module: axi_monitor_trans_mgr  (staging version under mon_temp/)
// Purpose: CAM-backed rewrite of the AXI transaction manager.
//
...
//
// ============================================================================
// STAGING VERSION -- not on the synth path
// ----------------------------------------------------------------------------
// This is a drop-in candidate for rtl/amba/shared/axi_monitor_trans_mgr.sv
// that moves the per-transaction keying + payload storage into the shared
// monitor_trans_cam module. Port signature is byte-identical to the
// production module so a future swap is just a filelist edit.
//
// The production module (2026-04-23 revision) computed match/free/alloc
// one-hots inline and stored bus_transaction_t per slot in a per-entry
// generate-loop always_ff. This version delegates:
//
