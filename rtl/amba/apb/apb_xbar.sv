    ...
    generate
        for (genvar m_port = 0; m_port < M; m_port++) begin : gen_apb_slave_stubs
            ...
            apb_slave_stub #(
                ...
                .cmd_ready      (r_slv_cmd_ready[m_port]), // used
                .cmd_data       (r_slv_cmd_data[m_port]),  // used
                .rsp_valid      (r_slv_rsp_valid[m_port]), // used
                .rsp_ready      (r_slv_rsp_ready[m_port]), // used
                .rsp_data       (r_slv_rsp_data[m_port])   // used
            );
    ...
    generate
        for (genvar s_port = 0; s_port < S; s_port++) begin : gen_apb_master_stubs
            ...
            apb_master_stub #(
                ...
                .cmd_valid    (r_mst_cmd_valid[s_port]), // used
                .cmd_ready    (r_mst_cmd_ready[s_port]), // used
                .cmd_data     (r_mst_cmd_data[s_port]),  // used
                .rsp_valid    (r_mst_rsp_valid[s_port]), // used
                .rsp_ready    (r_mst_rsp_ready[s_port]), // used
            ...
            gaxi_skid_buffer #(
                ...
                .axi_aclk   (pclk),
                .axi_aresetn(presetn),
                .wr_valid   (r_mst_side_wr_valid[s_port]), // used
                .wr_ready   (r_mst_side_wr_ready[s_port]), // used
                .wr_data    (r_mst_side_wr_data[s_port]),  // used
                .rd_valid   (r_mst_side_rd_valid[s_port]), // used
                .rd_ready   (r_mst_side_rd_ready[s_port]), // used
