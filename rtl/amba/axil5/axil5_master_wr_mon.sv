 ...
 *
 * This module combines the standard axil5_master_wr module with an axi_monitor_filtered
 * to provide comprehensive transaction monitoring for AXI4-Lite write transactions.
 *
 * Features:
 * - Instantiates axil5_master_wr for core AXIL4 functionality
...
module axil5_master_wr_mon
    import monitor_pkg::*;
#(
    // AXIL4 Master parameters (passed through to axil5_master_wr)
...
(
    ...
    assign w_gated_awvalid = fub_axil_awvalid & (w_block_ready | ~cfg_monitor_enable);
    ...
    assign fub_axil_awready = w_core_fub_axil_awready &
