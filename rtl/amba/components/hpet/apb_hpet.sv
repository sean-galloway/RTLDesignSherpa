...
module apb_hpet #(
    ...
    // ========================================================================
    input  logic                    pclk,          // APB clock domain (low freq)
    input  logic                    presetn,       // APB reset (active low)
    input  logic                    hpet_clk,      // HPET clock domain (high freq)
...
// ============================================================================
// APB Slave with Clock Domain Crossing
// ============================================================================
apb_slave_cdc #(
    ...
    // APB Clock Domain (Low Frequency)
    .pclk                 (pclk),
    .presetn              (presetn),

    // HPET Clock Domain  (High Frequency)
    .aclk                 (hpet_clk),
    .aresetn              (hpet_resetn),

    // APB Interface      (Low Frequency)
    ...
    // Command Interface  (High Frequency)
    ...
    // Response Interface (High Frequency)
...
// ============================================================================
// HPET Configuration Registers (High Speed Domain)
// ============================================================================
hpet_config_regs #(
    .VENDOR_ID        (VENDOR_ID),
