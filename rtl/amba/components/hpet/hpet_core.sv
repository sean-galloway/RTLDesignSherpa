...
module hpet_core #(
    ...
    input  logic [63:0]             timer_comp_wdata,
                ...
                if (!rst_n) begin
                    ...
                    if (timer_comp_write[i]) begin
                        ...
                        if (timer_comp_write_high) begin
                            ...
                            r_timer_comparator[i][63:32] <= timer_comp_wdata[63:32];
                            r_timer_period[i][63:32] <= timer_comp_wdata[63:32];
                        end else begin
                            // Writing to low 32 bits
                            r_timer_comparator[i][31:0] <= timer_comp_wdata[31:0];
                            r_timer_period[i][31:0] <= timer_comp_wdata[31:0];
                        end
