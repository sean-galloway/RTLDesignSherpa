...
(
    ...
    always_comb begin
        ...
        if (fub_awvalid && fub_awready) begin
            w_addr_fifo_wr_valid[fub_awid] = 1'b1;
            w_addr_fifo_wr_data[fub_awid] = fub_awaddr;
        end
    end
    ...
    always_comb begin
        ...
        if (fub_bvalid && fub_bready) begin
            w_addr_fifo_rd_ready[fub_bid] = 1'b1;
        end
    end
    ...
    assign w_error_addr = w_addr_fifo_rd_valid[fub_bid] ? w_addr_fifo_rd_data[fub_bid] : '0;
    ...
    always_ff @(posedge aclk or negedge aresetn) begin
        if (!aresetn) begin
            ...
            if (w_resp_error) begin
                ...
                r_error_fifo_wr_data <= {ErrorBResp, fub_bid, w_error_addr};
            end
            ...
            if (w_wto_error) begin
                ...
                r_error_fifo_wr_data <= {ErrorWTimeout, fub_bid,
                    w_addr_fifo_rd_valid[fub_bid] ? w_addr_fifo_rd_data[fub_bid] : '0};
                r_error_flag_wto <= 'b0;
                r_error_flag_wto_data <= 'b0;
            end else if (r_w_timeout) begin
                r_error_flag_wto <= 'b1;
                r_error_flag_wto_data <= {ErrorWTimeout, fub_bid,
                    w_addr_fifo_rd_valid[fub_bid] ? w_addr_fifo_rd_data[fub_bid] : '0};
            end
            ...
            if (w_bto_error) begin
                ...
                r_error_fifo_wr_data <= {ErrorBTimeout, fub_bid,
                    w_addr_fifo_rd_valid[fub_bid] ? w_addr_fifo_rd_data[fub_bid] : '0};
                r_error_flag_bto <= 'b0;
                r_error_flag_bto_data <= 'b0;
            end else if (r_b_timeout) begin
                r_error_flag_bto <= 'b1;
                r_error_flag_bto_data <= {ErrorBTimeout, fub_bid,
                    w_addr_fifo_rd_valid[fub_bid] ? w_addr_fifo_rd_data[fub_bid] : '0};
            end
        end
    end
