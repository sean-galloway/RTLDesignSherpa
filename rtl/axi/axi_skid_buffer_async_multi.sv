...
module axi_skid_buffer_async_multi #(
    ...
    axi_skid_buffer #(
        ...
        .i_wr_data    ({i_wr_addr, i_wr_ctrl, i_wr_data}),
    ...
    axi_fifo_async #(
        ...
        .ow_rd_data      ({ow_rd_addr, ow_rd_ctrl, ow_rd_data}),
        .o_rd_data       ({o_rd_addr, o_rd_ctrl, o_rd_data})
    );

endmodule : axi_skid_buffer_async_multi
