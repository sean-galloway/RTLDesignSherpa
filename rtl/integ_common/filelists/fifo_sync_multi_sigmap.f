# Filelist for fifo_sync_multi_sigmap
# Location: rtl/integ_common/filelists/fifo_sync_multi_sigmap.f
#
# fifo_sync_multi with generic positional signal-map ports.
...
$REPO_ROOT/rtl/integ_common/fifo_sync_multi_sigmap.sv
