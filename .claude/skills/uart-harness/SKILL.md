...
READ FIRST: vault/handbook/fpga/cmn-infra/uart-harness.md (the handbook is the repo's memory; this skill is the
signpost). One host program, sim + silicon; registers by name only. Board mechanics: vault/handbook/fpga/cmn-infra/boards.md.
