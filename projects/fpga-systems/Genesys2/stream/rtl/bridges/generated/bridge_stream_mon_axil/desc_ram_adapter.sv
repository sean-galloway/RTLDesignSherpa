...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_desc_ram_axi_awvalid && xbar_desc_ram_axi_awready)
                wr_id_fifo[wr_ptr[$clog2(WR_FIFO_DEPTH)-1:0]] <= xbar_desc_ram_axi_awid;
            if (xbar_desc_ram_axi_bvalid && xbar_desc_ram_axi_bready) begin
                if (xbar_desc_ram_axi_bid !== wr_id_fifo[rd_ptr[$clog2(WR_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned B out of AW order -- ",
                           ...
                           "wrong master.", xbar_desc_ram_axi_bid,
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_desc_ram_axi_arvalid && xbar_desc_ram_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_desc_ram_axi_arid;
            if (xbar_desc_ram_axi_rvalid && xbar_desc_ram_axi_rready && xbar_desc_ram_axi_rlast) begin
                if (xbar_desc_ram_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned R out of AR order -- ",
                           ...
                           "wrong master.", xbar_desc_ram_axi_rid,
