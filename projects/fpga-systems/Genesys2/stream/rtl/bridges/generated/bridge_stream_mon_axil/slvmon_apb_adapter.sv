...
`endif
    ...
    axi4_to_apb4_shim #(
        ...
        .s_axi_awid(xbar_slvmon_apb_axi_awid),
        .s_axi_awaddr(xbar_slvmon_apb_axi_awaddr),
        .s_axi_awlen(xbar_slvmon_apb_axi_awlen),
        .s_axi_awsize(xbar_slvmon_apb_axi_awsize),
        .s_axi_awburst(xbar_slvmon_apb_axi_awburst),
        .s_axi_awlock(xbar_slvmon_apb_axi_awlock),
        .s_axi_awcache(xbar_slvmon_apb_axi_awcache),
        .s_axi_awprot(xbar_slvmon_apb_axi_awprot),
        .s_axi_awqos(xbar_slvmon_apb_axi_awqos),
        .s_axi_awregion(xbar_slvmon_apb_axi_awregion),
        .s_axi_awuser(xbar_slvmon_apb_axi_awuser),
        .s_axi_awvalid(xbar_slvmon_apb_axi_awvalid && !wr_trk_full),
        .s_axi_awready(w_sub_awready),
        .s_axi_wdata(xbar_slvmon_apb_axi_wdata),
        .s_axi_wstrb(xbar_slvmon_apb_axi_wstrb),
        .s_axi_wlast(xbar_slvmon_apb_axi_wlast),
        .s_axi_wuser(xbar_slvmon_apb_axi_wuser),
        .s_axi_wvalid(xbar_slvmon_apb_axi_wvalid),
        .s_axi_wready(xbar_slvmon_apb_axi_wready),
        .s_axi_bid(xbar_slvmon_apb_axi_bid),
        .s_axi_bresp(xbar_slvmon_apb_axi_bresp),
        .s_axi_buser(xbar_slvmon_apb_axi_buser),
        .s_axi_bvalid(converter_bvalid),
        .s_axi_bready(converter_bready),

        // AXI4 read channels (from crossbar)
        .s_axi_arid(xbar_slvmon_apb_axi_arid),
        .s_axi_araddr(xbar_slvmon_apb_axi_araddr),
        .s_axi_arlen(xbar_slvmon_apb_axi_arlen),
        .s_axi_arsize(xbar_slvmon_apb_axi_arsize),
        .s_axi_arburst(xbar_slvmon_apb_axi_arburst),
        .s_axi_arlock(xbar_slvmon_apb_axi_arlock),
        .s_axi_arcache(xbar_slvmon_apb_axi_arcache),
        .s_axi_arprot(xbar_slvmon_apb_axi_arprot),
        .s_axi_arqos(xbar_slvmon_apb_axi_arqos),
        .s_axi_arregion(xbar_slvmon_apb_axi_arregion),
        .s_axi_aruser(xbar_slvmon_apb_axi_aruser),
        .s_axi_arvalid(xbar_slvmon_apb_axi_arvalid && !rd_trk_full),
        .s_axi_arready(w_sub_arready),
        .s_axi_rid(xbar_slvmon_apb_axi_rid),
        .s_axi_rdata(xbar_slvmon_apb_axi_rdata),
        .s_axi_rresp(xbar_slvmon_apb_axi_rresp),
        .s_axi_rlast(converter_rlast),
        .s_axi_ruser(xbar_slvmon_apb_axi_ruser),
    ...
    assign xbar_slvmon_apb_axi_bvalid = converter_bvalid;
    assign converter_bready = xbar_slvmon_apb_axi_bready;
    assign xbar_slvmon_apb_axi_rvalid = converter_rvalid;
    assign converter_rready = xbar_slvmon_apb_axi_rready;
    assign xbar_slvmon_apb_axi_rlast = converter_rlast;
