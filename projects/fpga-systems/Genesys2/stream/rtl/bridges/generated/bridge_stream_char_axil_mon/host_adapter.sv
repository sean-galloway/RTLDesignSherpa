   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr <= 32'h00001FFF) begin
            ...
            comb_slave_select_aw[6] = 1'b1;  // subtractive
        end
    end
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[0] | comb_slave_select_aw[1] | comb_slave_select_aw[3] | comb_slave_select_aw[5]) && aw_gate_ok;
    ...
    assign ar_path_active_32b = (comb_slave_select_ar[0] | comb_slave_select_ar[1] | comb_slave_select_ar[3] | comb_slave_select_ar[5]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[0] | b_slave_select[1] | b_slave_select[3] | b_slave_select[5];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[0] | r_slave_select[1] | r_slave_select[3] | r_slave_select[5];
    ...
    assign ar_path_active_64b = (comb_slave_select_ar[4]) && ar_gate_ok;
    logic b_path_active_64b;
    assign b_path_active_64b = b_slave_select[4];
    logic r_path_active_64b;
    assign r_path_active_64b = r_slave_select[4];
    logic aw_path_active_256b;
    assign aw_path_active_256b = (comb_slave_select_aw[2] | comb_slave_select_aw[6]) && aw_gate_ok;
    logic w_path_active_256b;
    assign w_path_active_256b = w_slave_select[2] | w_slave_select[6];
    ...
    assign b_path_active_256b = b_slave_select[2] | b_slave_select[6];
