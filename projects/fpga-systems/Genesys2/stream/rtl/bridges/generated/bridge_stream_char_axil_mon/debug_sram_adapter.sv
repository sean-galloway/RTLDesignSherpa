...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    input  logic [9:0]  xbar_debug_sram_axi_awid,
    ...
    input  logic [63:0]  xbar_debug_sram_axi_wdata,
    input  logic [7:0]  xbar_debug_sram_axi_wstrb,
    ...
    output  logic [9:0]  xbar_debug_sram_axi_bid,
    ...
    input  logic [9:0]  xbar_debug_sram_axi_arid,
    ...
    output  logic [9:0]  xbar_debug_sram_axi_rid,
    ...
    assign xbar_debug_sram_axi_awready = w_sub_awready && !wr_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_debug_sram_axi_awvalid && xbar_debug_sram_axi_awready)
                wr_id_fifo[wr_ptr[$clog2(WR_FIFO_DEPTH)-1:0]] <= xbar_debug_sram_axi_awid;
            if (xbar_debug_sram_axi_bvalid && xbar_debug_sram_axi_bready) begin
                if (xbar_debug_sram_axi_bid !== wr_id_fifo[rd_ptr[$clog2(WR_FIFO_DEPTH)-1:0]]) begin
                    $error({"BRIDGE-010: slave returned B out of AW order -- ",
                            ...
                            "wrong master."}, xbar_debug_sram_axi_bid,
...
`endif
    ...
    assign xbar_debug_sram_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_debug_sram_axi_arvalid && xbar_debug_sram_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_debug_sram_axi_arid;
            if (xbar_debug_sram_axi_rvalid && xbar_debug_sram_axi_rready && xbar_debug_sram_axi_rlast) begin
                if (xbar_debug_sram_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
                    $error({"BRIDGE-010: slave returned R out of AR order -- ",
                            ...
                            "wrong master."}, xbar_debug_sram_axi_rid,
...
`endif
    ...
    // ============================================================
    logic [9:0] debug_sram_mon_axi_awid;
    logic [31:0] debug_sram_mon_axi_awaddr;
    logic [7:0]  debug_sram_mon_axi_awlen;
    logic [2:0]  debug_sram_mon_axi_awsize;
    logic [1:0]  debug_sram_mon_axi_awburst;
    logic        debug_sram_mon_axi_awlock;
    logic [3:0]  debug_sram_mon_axi_awcache;
    logic [2:0]  debug_sram_mon_axi_awprot;
    logic [3:0]  debug_sram_mon_axi_awqos;
    logic [3:0]  debug_sram_mon_axi_awregion;
    logic        debug_sram_mon_axi_awuser;
    logic        debug_sram_mon_axi_awvalid;
    logic        debug_sram_mon_axi_awready;
    logic [63:0] debug_sram_mon_axi_wdata;
    logic [7:0] debug_sram_mon_axi_wstrb;
    logic        debug_sram_mon_axi_wlast;
    logic        debug_sram_mon_axi_wuser;
    logic        debug_sram_mon_axi_wvalid;
    logic        debug_sram_mon_axi_wready;
    logic [9:0] debug_sram_mon_axi_bid;
    logic [1:0]  debug_sram_mon_axi_bresp;
    logic        debug_sram_mon_axi_buser;
    logic        debug_sram_mon_axi_bvalid;
    logic        debug_sram_mon_axi_bready;
    logic [9:0] debug_sram_mon_axi_arid;
    logic [31:0] debug_sram_mon_axi_araddr;
    logic [7:0]  debug_sram_mon_axi_arlen;
    logic [2:0]  debug_sram_mon_axi_arsize;
    logic [1:0]  debug_sram_mon_axi_arburst;
    logic        debug_sram_mon_axi_arlock;
    logic [3:0]  debug_sram_mon_axi_arcache;
    logic [2:0]  debug_sram_mon_axi_arprot;
    logic [3:0]  debug_sram_mon_axi_arqos;
    logic [3:0]  debug_sram_mon_axi_arregion;
    logic        debug_sram_mon_axi_aruser;
    logic        debug_sram_mon_axi_arvalid;
    logic        debug_sram_mon_axi_arready;
    logic [9:0] debug_sram_mon_axi_rid;
    logic [63:0] debug_sram_mon_axi_rdata;
    logic [1:0]  debug_sram_mon_axi_rresp;
    logic        debug_sram_mon_axi_rlast;
    logic        debug_sram_mon_axi_ruser;
    logic        debug_sram_mon_axi_rvalid;
    logic        debug_sram_mon_axi_rready;
    ...
    axi4_master_wr_mon #(
        ...
        .fub_axi_awvalid(xbar_debug_sram_axi_awvalid && !wr_trk_full),
        ...
        // External side (m_axi)
        .m_axi_awid(debug_sram_mon_axi_awid),
        .m_axi_awaddr(debug_sram_mon_axi_awaddr),
        .m_axi_awlen(debug_sram_mon_axi_awlen),
        .m_axi_awsize(debug_sram_mon_axi_awsize),
        .m_axi_awburst(debug_sram_mon_axi_awburst),
        .m_axi_awlock(debug_sram_mon_axi_awlock),
        .m_axi_awcache(debug_sram_mon_axi_awcache),
        .m_axi_awprot(debug_sram_mon_axi_awprot),
        .m_axi_awqos(debug_sram_mon_axi_awqos),
        .m_axi_awregion(debug_sram_mon_axi_awregion),
        .m_axi_awuser(debug_sram_mon_axi_awuser),
        .m_axi_awvalid(debug_sram_mon_axi_awvalid),
        .m_axi_awready(debug_sram_mon_axi_awready),
        .m_axi_wdata(debug_sram_mon_axi_wdata),
        .m_axi_wstrb(debug_sram_mon_axi_wstrb),
        .m_axi_wlast(debug_sram_mon_axi_wlast),
        .m_axi_wuser(debug_sram_mon_axi_wuser),
        .m_axi_wvalid(debug_sram_mon_axi_wvalid),
        .m_axi_wready(debug_sram_mon_axi_wready),
        .m_axi_bid(debug_sram_mon_axi_bid),
        .m_axi_bresp(debug_sram_mon_axi_bresp),
        .m_axi_buser(debug_sram_mon_axi_buser),
        .m_axi_bvalid(debug_sram_mon_axi_bvalid),
        .m_axi_bready(debug_sram_mon_axi_bready),
    ...
    axi4_master_rd_mon #(
        ...
        .fub_axi_arvalid(xbar_debug_sram_axi_arvalid && !rd_trk_full),
        ...
        // External side (m_axi)
        .m_axi_arid(debug_sram_mon_axi_arid),
        .m_axi_araddr(debug_sram_mon_axi_araddr),
        .m_axi_arlen(debug_sram_mon_axi_arlen),
        .m_axi_arsize(debug_sram_mon_axi_arsize),
        .m_axi_arburst(debug_sram_mon_axi_arburst),
        .m_axi_arlock(debug_sram_mon_axi_arlock),
        .m_axi_arcache(debug_sram_mon_axi_arcache),
        .m_axi_arprot(debug_sram_mon_axi_arprot),
        .m_axi_arqos(debug_sram_mon_axi_arqos),
        .m_axi_arregion(debug_sram_mon_axi_arregion),
        .m_axi_aruser(debug_sram_mon_axi_aruser),
        .m_axi_arvalid(debug_sram_mon_axi_arvalid),
        .m_axi_arready(debug_sram_mon_axi_arready),
        .m_axi_rid(debug_sram_mon_axi_rid),
        .m_axi_rdata(debug_sram_mon_axi_rdata),
        .m_axi_rresp(debug_sram_mon_axi_rresp),
        .m_axi_rlast(debug_sram_mon_axi_rlast),
        .m_axi_ruser(debug_sram_mon_axi_ruser),
        .m_axi_rvalid(debug_sram_mon_axi_rvalid),
        .m_axi_rready(debug_sram_mon_axi_rready),
    ...
    axi4_to_axil4_wr #(
        ...
        .s_axi_awid(debug_sram_mon_axi_awid),
        .s_axi_awaddr(debug_sram_mon_axi_awaddr),
        .s_axi_awlen(debug_sram_mon_axi_awlen),
        .s_axi_awsize(debug_sram_mon_axi_awsize),
        .s_axi_awburst(debug_sram_mon_axi_awburst),
        .s_axi_awlock(debug_sram_mon_axi_awlock),
        .s_axi_awcache(debug_sram_mon_axi_awcache),
        .s_axi_awprot(debug_sram_mon_axi_awprot),
        .s_axi_awqos(debug_sram_mon_axi_awqos),
        .s_axi_awregion(debug_sram_mon_axi_awregion),
        .s_axi_awuser(debug_sram_mon_axi_awuser),
        .s_axi_awvalid(debug_sram_mon_axi_awvalid),
        .s_axi_awready(debug_sram_mon_axi_awready),
        .s_axi_wdata(debug_sram_mon_axi_wdata),
        .s_axi_wstrb(debug_sram_mon_axi_wstrb),
        .s_axi_wlast(debug_sram_mon_axi_wlast),
        .s_axi_wuser(debug_sram_mon_axi_wuser),
        .s_axi_wvalid(debug_sram_mon_axi_wvalid),
        .s_axi_wready(debug_sram_mon_axi_wready),
        .s_axi_bid(debug_sram_mon_axi_bid),
        .s_axi_bresp(debug_sram_mon_axi_bresp),
        .s_axi_buser(debug_sram_mon_axi_buser),
    ...
    axi4_to_axil4_rd #(
        ...
        .s_axi_arid(debug_sram_mon_axi_arid),
        .s_axi_araddr(debug_sram_mon_axi_araddr),
        .s_axi_arlen(debug_sram_mon_axi_arlen),
        .s_axi_arsize(debug_sram_mon_axi_arsize),
        .s_axi_arburst(debug_sram_mon_axi_arburst),
        .s_axi_arlock(debug_sram_mon_axi_arlock),
        .s_axi_arcache(debug_sram_mon_axi_arcache),
        .s_axi_arprot(debug_sram_mon_axi_arprot),
        .s_axi_arqos(debug_sram_mon_axi_arqos),
        .s_axi_arregion(debug_sram_mon_axi_arregion),
        .s_axi_aruser(debug_sram_mon_axi_aruser),
        .s_axi_arvalid(debug_sram_mon_axi_arvalid),
        .s_axi_arready(debug_sram_mon_axi_arready),
        .s_axi_rid(debug_sram_mon_axi_rid),
        .s_axi_rdata(debug_sram_mon_axi_rdata),
        .s_axi_rresp(debug_sram_mon_axi_rresp),
        .s_axi_rlast(converter_rlast),
        .s_axi_ruser(debug_sram_mon_axi_ruser),
    ...
    assign debug_sram_mon_axi_bvalid = converter_bvalid;
    assign converter_bready = debug_sram_mon_axi_bready;
    assign debug_sram_mon_axi_rvalid = converter_rvalid;
    assign converter_rready = debug_sram_mon_axi_rready;
    assign debug_sram_mon_axi_rlast = converter_rlast;
