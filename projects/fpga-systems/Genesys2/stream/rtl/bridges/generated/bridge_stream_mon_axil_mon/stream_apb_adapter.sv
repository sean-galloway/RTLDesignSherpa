...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    assign xbar_stream_apb_axi_awready = w_sub_awready && !wr_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_stream_apb_axi_awvalid && xbar_stream_apb_axi_awready)
...
`endif
    ...
    assign xbar_stream_apb_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_stream_apb_axi_arvalid && xbar_stream_apb_axi_arready)
...
`endif
    ...
    // ============================================================
    logic [9:0] stream_apb_mon_axi_awid;
    ...
    logic [9:0] stream_apb_mon_axi_bid;
    ...
    logic [9:0] stream_apb_mon_axi_arid;
    ...
    logic [9:0] stream_apb_mon_axi_rid;
    ...
    axi4_master_wr_mon #(
        ...
        .fub_axi_awvalid(xbar_stream_apb_axi_awvalid && !wr_trk_full),
    ...
    axi4_master_rd_mon #(
        ...
        .fub_axi_arvalid(xbar_stream_apb_axi_arvalid && !rd_trk_full),
