...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr >= 32'h00190000 && fub_axi_awaddr <= 32'h00190FFF) begin
            comb_slave_select_aw[0] = 1'b1;  // obs_apb
        end
        else if (fub_axi_awaddr >= 32'h00180000 && fub_axi_awaddr <= 32'h00180FFF) begin
            comb_slave_select_aw[1] = 1'b1;  // slvmon_apb
        end
        else if (fub_axi_awaddr <= 32'h00001FFF) begin
            comb_slave_select_aw[2] = 1'b1;  // stream_apb
        end
        else if (fub_axi_awaddr >= 32'h00010000 && fub_axi_awaddr <= 32'h00010FFF) begin
            comb_slave_select_aw[3] = 1'b1;  // harness_csr
        end
        else if (fub_axi_awaddr >= 32'h00020000 && fub_axi_awaddr <= 32'h0002FFFF) begin
            comb_slave_select_aw[4] = 1'b1;  // desc_ram
        end
        else if (fub_axi_awaddr >= 32'h00030000 && fub_axi_awaddr <= 32'h00030FFF) begin
            comb_slave_select_aw[5] = 1'b1;  // stream_err
        end
            ...
            comb_slave_select_aw[7] = 1'b1;  // dma_axil
        end
        else if (fub_axi_awaddr >= 32'h00090000 && fub_axi_awaddr <= 32'h00090FFF) begin
            comb_slave_select_aw[8] = 1'b1;  // slave_err
        end
        else if (fub_axi_awaddr >= 32'h000C0000 && fub_axi_awaddr <= 32'h000FFFFF) begin
            comb_slave_select_aw[9] = 1'b1;  // slave_tally
        end
            ...
            comb_slave_select_aw[11] = 1'b1;  // stream_tally_cfg
        end
    ...
    always_comb begin
        ...
        if (fub_axi_araddr >= 32'h00190000 && fub_axi_araddr <= 32'h00190FFF) begin
            comb_slave_select_ar[0] = 1'b1;  // obs_apb
        end
        else if (fub_axi_araddr >= 32'h00180000 && fub_axi_araddr <= 32'h00180FFF) begin
            comb_slave_select_ar[1] = 1'b1;  // slvmon_apb
        end
        else if (fub_axi_araddr <= 32'h00001FFF) begin
            comb_slave_select_ar[2] = 1'b1;  // stream_apb
        end
        else if (fub_axi_araddr >= 32'h00010000 && fub_axi_araddr <= 32'h00010FFF) begin
            comb_slave_select_ar[3] = 1'b1;  // harness_csr
        end
            ...
            comb_slave_select_ar[5] = 1'b1;  // stream_err
        end
            ...
            comb_slave_select_ar[7] = 1'b1;  // dma_axil
        end
        else if (fub_axi_araddr >= 32'h00090000 && fub_axi_araddr <= 32'h00090FFF) begin
            comb_slave_select_ar[8] = 1'b1;  // slave_err
        end
        else if (fub_axi_araddr >= 32'h000C0000 && fub_axi_araddr <= 32'h000FFFFF) begin
            comb_slave_select_ar[9] = 1'b1;  // slave_tally
        end
        else if (fub_axi_araddr >= 32'h001A0000 && fub_axi_araddr <= 32'h001AFFFF) begin
            comb_slave_select_ar[10] = 1'b1;  // comp_sram
        end
        else if (fub_axi_araddr >= 32'h00100000 && fub_axi_araddr <= 32'h0013FFFF) begin
            comb_slave_select_ar[11] = 1'b1;  // stream_tally_cfg
        end
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[0] | comb_slave_select_aw[1] | comb_slave_select_aw[2] | comb_slave_select_aw[3] | comb_slave_select_aw[5] | comb_slave_select_aw[7] | comb_slave_select_aw[8]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[0] | w_slave_select[1] | w_slave_select[2] | w_slave_select[3] | w_slave_select[5] | w_slave_select[7] | w_slave_select[8];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[0] | comb_slave_select_ar[1] | comb_slave_select_ar[2] | comb_slave_select_ar[3] | comb_slave_select_ar[5] | comb_slave_select_ar[7] | comb_slave_select_ar[8]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[0] | b_slave_select[1] | b_slave_select[2] | b_slave_select[3] | b_slave_select[5] | b_slave_select[7] | b_slave_select[8];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[0] | r_slave_select[1] | r_slave_select[2] | r_slave_select[3] | r_slave_select[5] | r_slave_select[7] | r_slave_select[8];
    logic aw_path_active_64b;
    assign aw_path_active_64b = (comb_slave_select_aw[6] | comb_slave_select_aw[9] | comb_slave_select_aw[10] | comb_slave_select_aw[11] | comb_slave_select_aw[12]) && aw_gate_ok;
    logic w_path_active_64b;
    assign w_path_active_64b = w_slave_select[6] | w_slave_select[9] | w_slave_select[10] | w_slave_select[11] | w_slave_select[12];
    logic ar_path_active_64b;
    assign ar_path_active_64b = (comb_slave_select_ar[6] | comb_slave_select_ar[9] | comb_slave_select_ar[10] | comb_slave_select_ar[11] | comb_slave_select_ar[12]) && ar_gate_ok;
    logic b_path_active_64b;
    assign b_path_active_64b = b_slave_select[6] | b_slave_select[9] | b_slave_select[10] | b_slave_select[11] | b_slave_select[12];
    ...
    assign host_32b_aw.id     = xbar_axi_awid;
    ...
    assign host_32b_bready = fub_axi_bready && b_path_active_32b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign host_32b_ar.id     = xbar_axi_arid;
    ...
    assign host_32b_rready = fub_axi_rready && r_path_active_32b;
