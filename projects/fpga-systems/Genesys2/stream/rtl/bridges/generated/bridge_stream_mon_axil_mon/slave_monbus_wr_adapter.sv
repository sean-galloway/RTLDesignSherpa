// SLAVE_MONBUS_WR Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for slave_monbus_wr master
...
module slave_monbus_wr_adapter #(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    // External AXI interface (from slave_monbus_wr master)
    input  logic [7:0]  slave_monbus_wr_awid,
    input  logic [31:0]  slave_monbus_wr_awaddr,
    input  logic [7:0]  slave_monbus_wr_awlen,
    input  logic [2:0]  slave_monbus_wr_awsize,
    input  logic [1:0]  slave_monbus_wr_awburst,
    input  logic         slave_monbus_wr_awlock,
    input  logic [3:0]  slave_monbus_wr_awcache,
    input  logic [2:0]  slave_monbus_wr_awprot,
    input  logic [3:0]  slave_monbus_wr_awqos,
    input  logic [3:0]  slave_monbus_wr_awregion,
    input  logic         slave_monbus_wr_awuser,
    ...
    input  logic         slave_monbus_wr_wlast,
    input  logic         slave_monbus_wr_wuser,
    input  logic         slave_monbus_wr_wvalid,
    output  logic         slave_monbus_wr_wready,

    output  logic [7:0]  slave_monbus_wr_bid,
    output  logic [1:0]  slave_monbus_wr_bresp,
    output  logic         slave_monbus_wr_buser,
    ...
    output logic         slave_monbus_wr_64b_awvalid,
    input  logic         slave_monbus_wr_64b_awready,

    output axi4_w_64b_t  slave_monbus_wr_64b_w,
    output logic         slave_monbus_wr_64b_wvalid,
    input  logic         slave_monbus_wr_64b_wready,
    ...
    axi4_slave_wr_mon #(
        ...
        // External side (s_axi)
        .s_axi_awid(slave_monbus_wr_awid),
        .s_axi_awaddr(slave_monbus_wr_awaddr),
        .s_axi_awlen(slave_monbus_wr_awlen),
        .s_axi_awsize(slave_monbus_wr_awsize),
        .s_axi_awburst(slave_monbus_wr_awburst),
        .s_axi_awlock(slave_monbus_wr_awlock),
        .s_axi_awcache(slave_monbus_wr_awcache),
        .s_axi_awprot(slave_monbus_wr_awprot),
        .s_axi_awqos(slave_monbus_wr_awqos),
        .s_axi_awregion(slave_monbus_wr_awregion),
        .s_axi_awuser(slave_monbus_wr_awuser),
        .s_axi_awvalid(slave_monbus_wr_awvalid),
        .s_axi_awready(slave_monbus_wr_awready),
        .s_axi_wdata(slave_monbus_wr_wdata),
        .s_axi_wstrb(slave_monbus_wr_wstrb),
        .s_axi_wlast(slave_monbus_wr_wlast),
        .s_axi_wuser(slave_monbus_wr_wuser),
        .s_axi_wvalid(slave_monbus_wr_wvalid),
        .s_axi_wready(slave_monbus_wr_wready),
        .s_axi_bid(slave_monbus_wr_bid),
        .s_axi_bresp(slave_monbus_wr_bresp),
        .s_axi_buser(slave_monbus_wr_buser),
        .s_axi_bvalid(slave_monbus_wr_bvalid),
        .s_axi_bready(slave_monbus_wr_bready),
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr >= 32'h000C0000 && fub_axi_awaddr <= 32'h000FFFFF) begin
    ...
    assign aw_path_active_64b = comb_slave_select_aw[9];
    logic w_path_active_64b;
    assign w_path_active_64b = w_slave_select[9];
    logic ar_path_active_64b;
    assign ar_path_active_64b = comb_slave_select_ar[9];

    // ================================================================
    // Direct passthrough: 64b → 64b (no converter)
    // Requests: fub_axi_* → slave_monbus_wr_64b_*
    // Responses: slave_monbus_wr_64b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign slave_monbus_wr_64b_aw.id     = fub_axi_awid;
    assign slave_monbus_wr_64b_aw.addr   = fub_axi_awaddr;
    assign slave_monbus_wr_64b_aw.len    = fub_axi_awlen;
    assign slave_monbus_wr_64b_aw.size   = fub_axi_awsize;
    assign slave_monbus_wr_64b_aw.burst  = fub_axi_awburst;
...
endmodule : slave_monbus_wr_adapter
