...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    axi4_master_wr_mon #(
        ...
        .fub_axi_awvalid(xbar_slvmon_apb_axi_awvalid),
        .fub_axi_awready(xbar_slvmon_apb_axi_awready),
    ...
    axi4_master_rd_mon #(
        ...
        .fub_axi_arvalid(xbar_slvmon_apb_axi_arvalid),
        .fub_axi_arready(xbar_slvmon_apb_axi_arready),
