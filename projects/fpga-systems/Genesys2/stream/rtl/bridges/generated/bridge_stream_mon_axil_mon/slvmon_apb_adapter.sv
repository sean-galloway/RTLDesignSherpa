// Slave Adapter: slvmon_apb_adapter
// Generated by: SlaveAdapterGenerator
//
// Provides timing isolation and protocol conversion for slave: slvmon_apb
// Protocol: APB
...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    input  logic [1:0]  xbar_slvmon_apb_axi_awburst,
    input  logic         xbar_slvmon_apb_axi_awlock,
    input  logic [3:0]  xbar_slvmon_apb_axi_awcache,
    input  logic [2:0]  xbar_slvmon_apb_axi_awprot,
    input  logic [3:0]  xbar_slvmon_apb_axi_awqos,
    input  logic [3:0]  xbar_slvmon_apb_axi_awregion,
    input  logic         xbar_slvmon_apb_axi_awuser,
    input  logic         xbar_slvmon_apb_axi_awvalid,
    output  logic         xbar_slvmon_apb_axi_awready,
    input  logic [31:0]  xbar_slvmon_apb_axi_wdata,
    input  logic [3:0]  xbar_slvmon_apb_axi_wstrb,
    input  logic         xbar_slvmon_apb_axi_wlast,
    ...
    input  logic [1:0]  xbar_slvmon_apb_axi_arburst,
    input  logic         xbar_slvmon_apb_axi_arlock,
    input  logic [3:0]  xbar_slvmon_apb_axi_arcache,
    input  logic [2:0]  xbar_slvmon_apb_axi_arprot,
    input  logic [3:0]  xbar_slvmon_apb_axi_arqos,
    input  logic [3:0]  xbar_slvmon_apb_axi_arregion,
    ...
    output  logic         xbar_slvmon_apb_axi_ruser,
    output  logic         xbar_slvmon_apb_axi_rvalid,
    input  logic         xbar_slvmon_apb_axi_rready,
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            wr_ptr <= '0;
        end else if (xbar_slvmon_apb_axi_awvalid && xbar_slvmon_apb_axi_awready) begin
    ...
    assign xbar_slvmon_apb_axi_awready = w_sub_awready && !wr_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_slvmon_apb_axi_awvalid && xbar_slvmon_apb_axi_awready)
...
`endif
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ar_ptr <= '0;
        end else if (xbar_slvmon_apb_axi_arvalid && xbar_slvmon_apb_axi_arready) begin
    ...
    assign xbar_slvmon_apb_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_slvmon_apb_axi_arvalid && xbar_slvmon_apb_axi_arready)
...
`endif
    ...
    logic [1:0]  slvmon_apb_mon_axi_awburst;
    logic        slvmon_apb_mon_axi_awlock;
    logic [3:0]  slvmon_apb_mon_axi_awcache;
    logic [2:0]  slvmon_apb_mon_axi_awprot;
    logic [3:0]  slvmon_apb_mon_axi_awqos;
    logic [3:0]  slvmon_apb_mon_axi_awregion;
    logic        slvmon_apb_mon_axi_awuser;
    logic        slvmon_apb_mon_axi_awvalid;
    logic        slvmon_apb_mon_axi_awready;
    logic [31:0] slvmon_apb_mon_axi_wdata;
    logic [3:0] slvmon_apb_mon_axi_wstrb;
    logic        slvmon_apb_mon_axi_wlast;
    ...
    logic [1:0]  slvmon_apb_mon_axi_arburst;
    logic        slvmon_apb_mon_axi_arlock;
    logic [3:0]  slvmon_apb_mon_axi_arcache;
    logic [2:0]  slvmon_apb_mon_axi_arprot;
    logic [3:0]  slvmon_apb_mon_axi_arqos;
    logic [3:0]  slvmon_apb_mon_axi_arregion;
    ...
    logic        slvmon_apb_mon_axi_ruser;
    logic        slvmon_apb_mon_axi_rvalid;
    logic        slvmon_apb_mon_axi_rready;
    ...
    axi4_master_wr_mon #(
        ...
        .fub_axi_awid(xbar_slvmon_apb_axi_awid),
        .fub_axi_awaddr(xbar_slvmon_apb_axi_awaddr),
        .fub_axi_awlen(xbar_slvmon_apb_axi_awlen),
        .fub_axi_awsize(xbar_slvmon_apb_axi_awsize),
        .fub_axi_awburst(xbar_slvmon_apb_axi_awburst),
        .fub_axi_awlock(xbar_slvmon_apb_axi_awlock),
        .fub_axi_awcache(xbar_slvmon_apb_axi_awcache),
        .fub_axi_awprot(xbar_slvmon_apb_axi_awprot),
        .fub_axi_awqos(xbar_slvmon_apb_axi_awqos),
        .fub_axi_awregion(xbar_slvmon_apb_axi_awregion),
        .fub_axi_awuser(xbar_slvmon_apb_axi_awuser),
        .fub_axi_awvalid(xbar_slvmon_apb_axi_awvalid && !wr_trk_full),
        .fub_axi_awready(w_sub_awready),
        .fub_axi_wdata(xbar_slvmon_apb_axi_wdata),
        .fub_axi_wstrb(xbar_slvmon_apb_axi_wstrb),
        .fub_axi_wlast(xbar_slvmon_apb_axi_wlast),
        .fub_axi_wuser(xbar_slvmon_apb_axi_wuser),
        .fub_axi_wvalid(xbar_slvmon_apb_axi_wvalid),
        .fub_axi_wready(xbar_slvmon_apb_axi_wready),
        .fub_axi_bid(xbar_slvmon_apb_axi_bid),
        .fub_axi_bresp(xbar_slvmon_apb_axi_bresp),
        .fub_axi_buser(xbar_slvmon_apb_axi_buser),
        .fub_axi_bvalid(xbar_slvmon_apb_axi_bvalid),
        .fub_axi_bready(xbar_slvmon_apb_axi_bready),

        // External side (m_axi)
        .m_axi_awid(slvmon_apb_mon_axi_awid),
        .m_axi_awaddr(slvmon_apb_mon_axi_awaddr),
        .m_axi_awlen(slvmon_apb_mon_axi_awlen),
        .m_axi_awsize(slvmon_apb_mon_axi_awsize),
        .m_axi_awburst(slvmon_apb_mon_axi_awburst),
        .m_axi_awlock(slvmon_apb_mon_axi_awlock),
        .m_axi_awcache(slvmon_apb_mon_axi_awcache),
        .m_axi_awprot(slvmon_apb_mon_axi_awprot),
        .m_axi_awqos(slvmon_apb_mon_axi_awqos),
        .m_axi_awregion(slvmon_apb_mon_axi_awregion),
        .m_axi_awuser(slvmon_apb_mon_axi_awuser),
        .m_axi_awvalid(slvmon_apb_mon_axi_awvalid),
        .m_axi_awready(slvmon_apb_mon_axi_awready),
        .m_axi_wdata(slvmon_apb_mon_axi_wdata),
        .m_axi_wstrb(slvmon_apb_mon_axi_wstrb),
        .m_axi_wlast(slvmon_apb_mon_axi_wlast),
        .m_axi_wuser(slvmon_apb_mon_axi_wuser),
        .m_axi_wvalid(slvmon_apb_mon_axi_wvalid),
        .m_axi_wready(slvmon_apb_mon_axi_wready),
        .m_axi_bid(slvmon_apb_mon_axi_bid),
        .m_axi_bresp(slvmon_apb_mon_axi_bresp),
        .m_axi_buser(slvmon_apb_mon_axi_buser),
        .m_axi_bvalid(slvmon_apb_mon_axi_bvalid),
        .m_axi_bready(slvmon_apb_mon_axi_bready),
    ...
    axi4_master_rd_mon #(
        ...
        // Bridge-internal side (fub_axi)
        .fub_axi_arid(xbar_slvmon_apb_axi_arid),
        .fub_axi_araddr(xbar_slvmon_apb_axi_araddr),
        .fub_axi_arlen(xbar_slvmon_apb_axi_arlen),
        .fub_axi_arsize(xbar_slvmon_apb_axi_arsize),
        .fub_axi_arburst(xbar_slvmon_apb_axi_arburst),
        .fub_axi_arlock(xbar_slvmon_apb_axi_arlock),
        .fub_axi_arcache(xbar_slvmon_apb_axi_arcache),
        .fub_axi_arprot(xbar_slvmon_apb_axi_arprot),
        .fub_axi_arqos(xbar_slvmon_apb_axi_arqos),
        .fub_axi_arregion(xbar_slvmon_apb_axi_arregion),
        .fub_axi_aruser(xbar_slvmon_apb_axi_aruser),
        .fub_axi_arvalid(xbar_slvmon_apb_axi_arvalid && !rd_trk_full),
        .fub_axi_arready(w_sub_arready),
        .fub_axi_rid(xbar_slvmon_apb_axi_rid),
        .fub_axi_rdata(xbar_slvmon_apb_axi_rdata),
        .fub_axi_rresp(xbar_slvmon_apb_axi_rresp),
        .fub_axi_rlast(xbar_slvmon_apb_axi_rlast),
        .fub_axi_ruser(xbar_slvmon_apb_axi_ruser),
        .fub_axi_rvalid(xbar_slvmon_apb_axi_rvalid),
        .fub_axi_rready(xbar_slvmon_apb_axi_rready),

        // External side (m_axi)
        .m_axi_arid(slvmon_apb_mon_axi_arid),
        .m_axi_araddr(slvmon_apb_mon_axi_araddr),
        .m_axi_arlen(slvmon_apb_mon_axi_arlen),
        .m_axi_arsize(slvmon_apb_mon_axi_arsize),
        .m_axi_arburst(slvmon_apb_mon_axi_arburst),
        .m_axi_arlock(slvmon_apb_mon_axi_arlock),
        .m_axi_arcache(slvmon_apb_mon_axi_arcache),
        .m_axi_arprot(slvmon_apb_mon_axi_arprot),
        .m_axi_arqos(slvmon_apb_mon_axi_arqos),
        .m_axi_arregion(slvmon_apb_mon_axi_arregion),
        .m_axi_aruser(slvmon_apb_mon_axi_aruser),
        .m_axi_arvalid(slvmon_apb_mon_axi_arvalid),
        .m_axi_arready(slvmon_apb_mon_axi_arready),
        .m_axi_rid(slvmon_apb_mon_axi_rid),
        .m_axi_rdata(slvmon_apb_mon_axi_rdata),
        .m_axi_rresp(slvmon_apb_mon_axi_rresp),
        .m_axi_rlast(slvmon_apb_mon_axi_rlast),
        .m_axi_ruser(slvmon_apb_mon_axi_ruser),
        .m_axi_rvalid(slvmon_apb_mon_axi_rvalid),
        .m_axi_rready(slvmon_apb_mon_axi_rready),
    ...
    axi4_to_apb4_shim #(
        ...
        .s_axi_awid(slvmon_apb_mon_axi_awid),
        .s_axi_awaddr(slvmon_apb_mon_axi_awaddr),
        .s_axi_awlen(slvmon_apb_mon_axi_awlen),
        .s_axi_awsize(slvmon_apb_mon_axi_awsize),
        .s_axi_awburst(slvmon_apb_mon_axi_awburst),
        .s_axi_awlock(slvmon_apb_mon_axi_awlock),
        .s_axi_awcache(slvmon_apb_mon_axi_awcache),
        .s_axi_awprot(slvmon_apb_mon_axi_awprot),
        .s_axi_awqos(slvmon_apb_mon_axi_awqos),
        .s_axi_awregion(slvmon_apb_mon_axi_awregion),
        .s_axi_awuser(slvmon_apb_mon_axi_awuser),
        .s_axi_awvalid(slvmon_apb_mon_axi_awvalid),
        .s_axi_awready(slvmon_apb_mon_axi_awready),
        .s_axi_wdata(slvmon_apb_mon_axi_wdata),
        .s_axi_wstrb(slvmon_apb_mon_axi_wstrb),
        .s_axi_wlast(slvmon_apb_mon_axi_wlast),
        .s_axi_wuser(slvmon_apb_mon_axi_wuser),
        .s_axi_wvalid(slvmon_apb_mon_axi_wvalid),
        .s_axi_wready(slvmon_apb_mon_axi_wready),
        .s_axi_bid(slvmon_apb_mon_axi_bid),
        .s_axi_bresp(slvmon_apb_mon_axi_bresp),
        .s_axi_buser(slvmon_apb_mon_axi_buser),
        .s_axi_bvalid(converter_bvalid),
        .s_axi_bready(converter_bready),

        // AXI4 read channels (from crossbar)
        .s_axi_arid(slvmon_apb_mon_axi_arid),
        .s_axi_araddr(slvmon_apb_mon_axi_araddr),
        .s_axi_arlen(slvmon_apb_mon_axi_arlen),
        .s_axi_arsize(slvmon_apb_mon_axi_arsize),
        .s_axi_arburst(slvmon_apb_mon_axi_arburst),
        .s_axi_arlock(slvmon_apb_mon_axi_arlock),
        .s_axi_arcache(slvmon_apb_mon_axi_arcache),
        .s_axi_arprot(slvmon_apb_mon_axi_arprot),
        .s_axi_arqos(slvmon_apb_mon_axi_arqos),
        .s_axi_arregion(slvmon_apb_mon_axi_arregion),
        .s_axi_aruser(slvmon_apb_mon_axi_aruser),
        .s_axi_arvalid(slvmon_apb_mon_axi_arvalid),
        .s_axi_arready(slvmon_apb_mon_axi_arready),
        .s_axi_rid(slvmon_apb_mon_axi_rid),
        .s_axi_rdata(slvmon_apb_mon_axi_rdata),
        .s_axi_rresp(slvmon_apb_mon_axi_rresp),
        .s_axi_rlast(converter_rlast),
        .s_axi_ruser(slvmon_apb_mon_axi_ruser),
        .s_axi_rvalid(converter_rvalid),
        .s_axi_rready(converter_rready),

        // APB master interface (to external slave)
        .m_apb_PSEL(slvmon_apb_PSEL),
        .m_apb_PADDR(slvmon_apb_PADDR),
        .m_apb_PENABLE(slvmon_apb_PENABLE),
        .m_apb_PWRITE(slvmon_apb_PWRITE),
        .m_apb_PWDATA(slvmon_apb_PWDATA),
        .m_apb_PSTRB(slvmon_apb_PSTRB),
        .m_apb_PPROT(slvmon_apb_PPROT),
        .m_apb_PRDATA(slvmon_apb_PRDATA),
        .m_apb_PSLVERR(slvmon_apb_PSLVERR),
        .m_apb_PREADY(slvmon_apb_PREADY)
    );

    // Wire converter outputs back to shim's crossbar-facing interface
    assign slvmon_apb_mon_axi_bvalid = converter_bvalid;
    assign converter_bready = slvmon_apb_mon_axi_bready;
    assign slvmon_apb_mon_axi_rvalid = converter_rvalid;
    assign converter_rready = slvmon_apb_mon_axi_rready;
    assign slvmon_apb_mon_axi_rlast = converter_rlast;

endmodule : slvmon_apb_adapter
