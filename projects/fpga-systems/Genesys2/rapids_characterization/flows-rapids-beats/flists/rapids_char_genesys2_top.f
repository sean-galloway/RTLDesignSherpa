...
# Location: projects/fpga-systems/Genesys2/rapids_characterization/flows-rapids-beats/flists/rapids_char_genesys2_top.f
#
...
-f $REPO_ROOT/projects/fpga-systems/Genesys2/rapids_characterization/flows-rapids-beats/flists/rapids_char_top.f

# ---- Genesys 2 board wrapper (MMCM + pin mapping) ----
$REPO_ROOT/projects/fpga-systems/Genesys2/rapids_characterization/flows-rapids-beats/rtl/rapids_char_genesys2_top.sv
