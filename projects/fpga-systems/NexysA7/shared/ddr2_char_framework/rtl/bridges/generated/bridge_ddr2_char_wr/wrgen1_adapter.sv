// WRGEN1 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for wrgen1 master
...
#(
    ...
    // External AXI interface (from wrgen1 master)
    ...
    output axi4_aw_t     wrgen1_64b_aw,
    output logic         wrgen1_64b_awvalid,
    input  logic         wrgen1_64b_awready,

    output axi4_w_64b_t  wrgen1_64b_w,
    output logic         wrgen1_64b_wvalid,
    input  logic         wrgen1_64b_wready,

    input  axi4_b_t      wrgen1_64b_b,
    input  logic         wrgen1_64b_bvalid,
    output logic         wrgen1_64b_bready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(wrgen1_axi_awid),
        .s_axi_awaddr(wrgen1_axi_awaddr),
        .s_axi_awlen(wrgen1_axi_awlen),
        .s_axi_awsize(wrgen1_axi_awsize),
        .s_axi_awburst(wrgen1_axi_awburst),
        .s_axi_awlock(wrgen1_axi_awlock),
        .s_axi_awcache(wrgen1_axi_awcache),
        .s_axi_awprot(wrgen1_axi_awprot),
        .s_axi_awqos(wrgen1_axi_awqos),
        .s_axi_awregion(wrgen1_axi_awregion),
        .s_axi_awuser(wrgen1_axi_awuser),
        .s_axi_awvalid(wrgen1_axi_awvalid),
        .s_axi_awready(wrgen1_axi_awready),
        .s_axi_wdata(wrgen1_axi_wdata),
        .s_axi_wstrb(wrgen1_axi_wstrb),
        .s_axi_wlast(wrgen1_axi_wlast),
        .s_axi_wuser(wrgen1_axi_wuser),
        .s_axi_wvalid(wrgen1_axi_wvalid),
        .s_axi_wready(wrgen1_axi_wready),
        .s_axi_bid(wrgen1_axi_bid),
        .s_axi_bresp(wrgen1_axi_bresp),
        .s_axi_buser(wrgen1_axi_buser),
        .s_axi_bvalid(wrgen1_axi_bvalid),
        .s_axi_bready(wrgen1_axi_bready),
    ...
    // Requests: fub_axi_* → wrgen1_64b_*
    // Responses: wrgen1_64b_* → MUX → fub_axi_*
    // ================================================================
    ...
    assign wrgen1_64b_aw.burst  = fub_axi_awburst;
    assign wrgen1_64b_aw.lock   = fub_axi_awlock;
    assign wrgen1_64b_aw.cache  = fub_axi_awcache;
    assign wrgen1_64b_aw.prot   = fub_axi_awprot;
    assign wrgen1_64b_aw.qos    = fub_axi_awqos;
    assign wrgen1_64b_aw.region = fub_axi_awregion;
    assign wrgen1_64b_aw.user   = fub_axi_awuser;
    assign wrgen1_64b_awvalid   = fub_axi_awvalid && aw_path_active_64b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign wrgen1_64b_w.data  = fub_axi_wdata;
    assign wrgen1_64b_w.strb  = fub_axi_wstrb;
    assign wrgen1_64b_w.last  = fub_axi_wlast;
    assign wrgen1_64b_w.user  = fub_axi_wuser;
    assign wrgen1_64b_wvalid  = fub_axi_wvalid && w_path_active_64b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign wrgen1_64b_bready = fub_axi_bready && b_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_awready = wrgen1_64b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_wready = wrgen1_64b_wready;
            end
            2'b10: begin  // Slave 1 (64b)
                fub_axi_wready = wrgen1_64b_wready;
            end
    ...
    always_comb begin
        ...
        case (b_slave_select)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_bid = wrgen1_64b_b.id[7:0];
                fub_axi_bresp = wrgen1_64b_b.resp;
                fub_axi_bvalid = wrgen1_64b_bvalid;
            end
            2'b10: begin  // Slave 1 (64b)
                fub_axi_bid = wrgen1_64b_b.id[7:0];
                fub_axi_bresp = wrgen1_64b_b.resp;
