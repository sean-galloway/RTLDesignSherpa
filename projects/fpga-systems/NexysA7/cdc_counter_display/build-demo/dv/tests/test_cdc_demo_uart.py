...
_HOST = os.path.join(
    _REPO, "projects/fpga-systems/NexysA7/cdc_counter_display/build-demo/host")
# The shared board+UART layer -- the real home of uart_axi_bridge (the
# converters/bin copy is a legacy re-export shim; never import through it).
...
def _run(testcase: str):
    ...
    filelist_path = ("projects/fpga-systems/NexysA7/cdc_counter_display/"
                     "build-demo/dv/filelists/cdc_demo_uart_tb_top.f")
