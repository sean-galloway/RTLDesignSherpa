#==============================================================================
# build_all.tcl -- synth + impl + bitstream for cdc_demo
#==============================================================================
...
puts "========================================================================"
puts "CDC demo (UART harness) -- Full Build"
puts "========================================================================"
...
set bit_src "$project_root/build/vivado_project/cdc_demo.runs/impl_1/cdc_demo_top.bit"
set bit_dst [expr {[info exists ::env(FPGA_BITSTREAM)] \
                   ? $::env(FPGA_BITSTREAM) \
                   : "$project_root/bitstream/cdc_demo.bit"}]
