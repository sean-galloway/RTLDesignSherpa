...
project (`projects/fpga-systems/NexysA7/cdc_counter_display`). It explains what the project
...
| Source | Title |
|--------|-------|
| RTL Design Sherpa | `projects/fpga-systems/NexysA7/cdc_counter_display/README.md` |
