...
def test_cdc_counter_display():
    ...
    repo_root = os.environ["REPO_ROOT"]  # source env_python first

    # Sources come from the BUILD's filelist -- the same closure `make lint`
    # flattens and the Vivado tcl expands, so sim/lint/synth cannot drift.
    from TBClasses.shared.filelist_utils import get_sources_from_filelist
    filelist_path = ("projects/fpga-systems/NexysA7/cdc_counter_display/"
                     "build-phase1/rtl/filelists/cdc_counter_display_top.f")
