#==============================================================================
# create_project.tcl -- Vivado project for the button-only CDC demo (phase-1)
#==============================================================================
# Board:  Digilent Nexys A7-100T (xc7a100tcsg324-1)
# Top:    cdc_counter_display_top
# Usage:  run via `make project` / `make bitstream`, which export the layout
#         (FPGA_PROJECT_ROOT / FPGA_BUILD_ROOT / FPGA_FILELIST) and REPO_ROOT,
#         which this build's filelist resolves against.
#==============================================================================
...
puts "========================================================================"
puts "RTL Design Sherpa -- CDC counter display, phase-1 (Nexys A7-100T)"
puts "========================================================================"
...
set top_filelist [expr {[info exists ::env(FPGA_FILELIST)] \
                        ...
                        : "$build_root/rtl/filelists/cdc_counter_display_top.f"}]
...
set_property top cdc_counter_display_top $src_fs
...
add_files -norecurse -fileset $cf "$project_root/constraints/nexys_a7_100t.xdc"
