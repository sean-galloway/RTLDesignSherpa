// Slave Adapter: chargen_apb_adapter
// Generated by: SlaveAdapterGenerator
//
// Provides timing isolation and protocol conversion for slave: chargen_apb
// Protocol: APB
...
#(
    ...
    input  logic [1:0]  xbar_chargen_apb_axi_awburst,
    input  logic         xbar_chargen_apb_axi_awlock,
    input  logic [3:0]  xbar_chargen_apb_axi_awcache,
    input  logic [2:0]  xbar_chargen_apb_axi_awprot,
    input  logic [3:0]  xbar_chargen_apb_axi_awqos,
    input  logic [3:0]  xbar_chargen_apb_axi_awregion,
    input  logic         xbar_chargen_apb_axi_awuser,
    input  logic         xbar_chargen_apb_axi_awvalid,
    output  logic         xbar_chargen_apb_axi_awready,
    input  logic [31:0]  xbar_chargen_apb_axi_wdata,
    input  logic [3:0]  xbar_chargen_apb_axi_wstrb,
    input  logic         xbar_chargen_apb_axi_wlast,
    ...
    input  logic [1:0]  xbar_chargen_apb_axi_arburst,
    input  logic         xbar_chargen_apb_axi_arlock,
    input  logic [3:0]  xbar_chargen_apb_axi_arcache,
    input  logic [2:0]  xbar_chargen_apb_axi_arprot,
    input  logic [3:0]  xbar_chargen_apb_axi_arqos,
    input  logic [3:0]  xbar_chargen_apb_axi_arregion,
    ...
    output  logic         xbar_chargen_apb_axi_ruser,
    output  logic         xbar_chargen_apb_axi_rvalid,
    input  logic         xbar_chargen_apb_axi_rready,
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            wr_ptr <= '0;
        end else if (xbar_chargen_apb_axi_awvalid && xbar_chargen_apb_axi_awready) begin
    ...
    assign xbar_chargen_apb_axi_awready = w_sub_awready && !wr_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_chargen_apb_axi_awvalid && xbar_chargen_apb_axi_awready)
                wr_id_fifo[wr_ptr[$clog2(WR_FIFO_DEPTH)-1:0]] <= xbar_chargen_apb_axi_awid;
            if (xbar_chargen_apb_axi_bvalid && xbar_chargen_apb_axi_bready) begin
                if (xbar_chargen_apb_axi_bid !== wr_id_fifo[rd_ptr[$clog2(WR_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned B out of AW order -- ",
                           ...
                           "wrong master.", xbar_chargen_apb_axi_bid,
...
`endif
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ar_ptr <= '0;
        end else if (xbar_chargen_apb_axi_arvalid && xbar_chargen_apb_axi_arready) begin
    ...
    assign xbar_chargen_apb_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_chargen_apb_axi_arvalid && xbar_chargen_apb_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_chargen_apb_axi_arid;
            if (xbar_chargen_apb_axi_rvalid && xbar_chargen_apb_axi_rready && xbar_chargen_apb_axi_rlast) begin
                if (xbar_chargen_apb_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned R out of AR order -- ",
                           ...
                           "wrong master.", xbar_chargen_apb_axi_rid,
...
`endif
    ...
    axi4_to_apb4_shim #(
        ...
        .s_axi_awid(xbar_chargen_apb_axi_awid),
        .s_axi_awaddr(xbar_chargen_apb_axi_awaddr),
        .s_axi_awlen(xbar_chargen_apb_axi_awlen),
        .s_axi_awsize(xbar_chargen_apb_axi_awsize),
        .s_axi_awburst(xbar_chargen_apb_axi_awburst),
        .s_axi_awlock(xbar_chargen_apb_axi_awlock),
        .s_axi_awcache(xbar_chargen_apb_axi_awcache),
        .s_axi_awprot(xbar_chargen_apb_axi_awprot),
        .s_axi_awqos(xbar_chargen_apb_axi_awqos),
        .s_axi_awregion(xbar_chargen_apb_axi_awregion),
        .s_axi_awuser(xbar_chargen_apb_axi_awuser),
        .s_axi_awvalid(xbar_chargen_apb_axi_awvalid && !wr_trk_full),
        .s_axi_awready(w_sub_awready),
        .s_axi_wdata(xbar_chargen_apb_axi_wdata),
        .s_axi_wstrb(xbar_chargen_apb_axi_wstrb),
        .s_axi_wlast(xbar_chargen_apb_axi_wlast),
        .s_axi_wuser(xbar_chargen_apb_axi_wuser),
        .s_axi_wvalid(xbar_chargen_apb_axi_wvalid),
        .s_axi_wready(xbar_chargen_apb_axi_wready),
        .s_axi_bid(xbar_chargen_apb_axi_bid),
        .s_axi_bresp(xbar_chargen_apb_axi_bresp),
        .s_axi_buser(xbar_chargen_apb_axi_buser),
        .s_axi_bvalid(converter_bvalid),
        .s_axi_bready(converter_bready),

        // AXI4 read channels (from crossbar)
        .s_axi_arid(xbar_chargen_apb_axi_arid),
        .s_axi_araddr(xbar_chargen_apb_axi_araddr),
        .s_axi_arlen(xbar_chargen_apb_axi_arlen),
        .s_axi_arsize(xbar_chargen_apb_axi_arsize),
        .s_axi_arburst(xbar_chargen_apb_axi_arburst),
        .s_axi_arlock(xbar_chargen_apb_axi_arlock),
        .s_axi_arcache(xbar_chargen_apb_axi_arcache),
        .s_axi_arprot(xbar_chargen_apb_axi_arprot),
        .s_axi_arqos(xbar_chargen_apb_axi_arqos),
        .s_axi_arregion(xbar_chargen_apb_axi_arregion),
        .s_axi_aruser(xbar_chargen_apb_axi_aruser),
        .s_axi_arvalid(xbar_chargen_apb_axi_arvalid && !rd_trk_full),
        .s_axi_arready(w_sub_arready),
        .s_axi_rid(xbar_chargen_apb_axi_rid),
        .s_axi_rdata(xbar_chargen_apb_axi_rdata),
        .s_axi_rresp(xbar_chargen_apb_axi_rresp),
        .s_axi_rlast(converter_rlast),
        .s_axi_ruser(xbar_chargen_apb_axi_ruser),
        .s_axi_rvalid(converter_rvalid),
        .s_axi_rready(converter_rready),

        // APB master interface (to external slave)
        .m_apb_PSEL(chargen_apb_PSEL),
        .m_apb_PADDR(chargen_apb_PADDR),
        .m_apb_PENABLE(chargen_apb_PENABLE),
        .m_apb_PWRITE(chargen_apb_PWRITE),
        .m_apb_PWDATA(chargen_apb_PWDATA),
        .m_apb_PSTRB(chargen_apb_PSTRB),
        .m_apb_PPROT(chargen_apb_PPROT),
        .m_apb_PRDATA(chargen_apb_PRDATA),
        .m_apb_PSLVERR(chargen_apb_PSLVERR),
        .m_apb_PREADY(chargen_apb_PREADY)
    );

    // Wire converter outputs back to shim's crossbar-facing interface
    assign xbar_chargen_apb_axi_bvalid = converter_bvalid;
    assign converter_bready = xbar_chargen_apb_axi_bready;
    assign xbar_chargen_apb_axi_rvalid = converter_rvalid;
    assign converter_rready = xbar_chargen_apb_axi_rready;
    assign xbar_chargen_apb_axi_rlast = converter_rlast;

endmodule : chargen_apb_adapter
