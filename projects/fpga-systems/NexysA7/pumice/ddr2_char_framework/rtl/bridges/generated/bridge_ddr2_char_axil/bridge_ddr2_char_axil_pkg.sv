...
package bridge_ddr2_char_axil_pkg;
    ...
    localparam int XBAR_ID_WIDTH   = 1;  // MASTER_ID_WIDTH + ID_PREFIX_WIDTH

    // AXI4 Write Address Channel (width-independent)
    // Note: ID width is 1-bit for this bridge
    typedef struct packed {
        logic [0:0]   id;      // Transaction ID
...
endpackage : bridge_ddr2_char_axil_pkg
