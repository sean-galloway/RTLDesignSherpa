...
#(
    ...
    input  logic [8:0]  xbar_subtractive_axi_arid,
    ...
    output  logic [8:0]  xbar_subtractive_axi_rid,
    ...
    output  logic [8:0]  subtractive_arid,
    ...
    input  logic [8:0]  subtractive_rid,
...
`ifndef SYNTHESIS
    ...
    logic [9-1:0] rd_id_fifo [RD_FIFO_DEPTH];
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
        end else begin
