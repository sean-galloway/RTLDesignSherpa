...
#(
    ...
    logic host_64b_w_to_subtractive;
    logic host_64b_w_sel_subtractive;
    ...
    // ================================================================
    // Slave 6: subtractive (64b)
    // ================================================================
    // Single master: host → subtractive
    // Master width: 32b, Slave width: 64b
    // Using 64b path from adapter

    // AW channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_aw_to_subtractive = !(((host_64b_aw.addr <= 32'h00000fff)) || (((host_64b_aw.addr >= 32'h00010000) && (host_64b_aw.addr <= 32'h00010fff))) || (((host_64b_aw.addr >= 32'h00040000) && (host_64b_aw.addr <= 32'h0007ffff))) || (((host_64b_aw.addr >= 32'h00080000) && (host_64b_aw.addr <= 32'h00080fff))) || (((host_64b_aw.addr >= 32'h00090000) && (host_64b_aw.addr <= 32'h00090fff))) || (((host_64b_aw.addr >= 32'h000a0000) && (host_64b_aw.addr <= 32'h000a0fff))));
    wire host_64b_aw_gnt_subtractive = host_64b_aw_to_subtractive;
    assign subtractive_axi_awid     = host_64b_aw_to_subtractive ? host_64b_aw.id : '0;
    assign subtractive_axi_awaddr   = host_64b_aw_to_subtractive ? host_64b_aw.addr : '0;
    assign subtractive_axi_awlen    = host_64b_aw_to_subtractive ? host_64b_aw.len : '0;
    assign subtractive_axi_awsize   = host_64b_aw_to_subtractive ? host_64b_aw.size : '0;
    assign subtractive_axi_awburst  = host_64b_aw_to_subtractive ? host_64b_aw.burst : '0;
    assign subtractive_axi_awlock   = host_64b_aw_to_subtractive ? host_64b_aw.lock : '0;
    assign subtractive_axi_awcache  = host_64b_aw_to_subtractive ? host_64b_aw.cache : '0;
    assign subtractive_axi_awprot   = host_64b_aw_to_subtractive ? host_64b_aw.prot : '0;
    assign subtractive_axi_awqos    = host_64b_aw_to_subtractive ? host_64b_aw.qos : '0;
    assign subtractive_axi_awregion = host_64b_aw_to_subtractive ? host_64b_aw.region : '0;
    assign subtractive_axi_awuser   = host_64b_aw_to_subtractive ? host_64b_aw.user : '0;
    assign subtractive_axi_awvalid  = host_64b_aw_to_subtractive && host_64b_awvalid;

    assign host_64b_w_sel_subtractive = host_64b_w_to_subtractive;

    // W channel (gated by the W destination FIFO head)
    assign subtractive_axi_wdata  = host_64b_w_to_subtractive ? host_64b_w.data : '0;
    assign subtractive_axi_wstrb  = host_64b_w_to_subtractive ? host_64b_w.strb : '0;
    assign subtractive_axi_wlast  = host_64b_w_to_subtractive ? host_64b_w.last : '0;
    assign subtractive_axi_wuser  = host_64b_w_to_subtractive ? host_64b_w.user : '0;
    assign subtractive_axi_wvalid = host_64b_w_to_subtractive && host_64b_wvalid;

    // Bready (master → slave) — gated on bid_valid so the path stays
    // open through the entire B handshake, not just the AW phase.
    assign subtractive_axi_bready = ((subtractive_axi_bid_bridge_id == 0) && subtractive_axi_bid_valid) ? host_64b_bready : '0;

    // Bridge ID (master → slave)
    assign subtractive_axi_bridge_id_aw = host_64b_aw_to_subtractive ? host_bridge_id_aw : '0;

    // AR channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_ar_to_subtractive = !(((host_64b_ar.addr <= 32'h00000fff)) || (((host_64b_ar.addr >= 32'h00010000) && (host_64b_ar.addr <= 32'h00010fff))) || (((host_64b_ar.addr >= 32'h00040000) && (host_64b_ar.addr <= 32'h0007ffff))) || (((host_64b_ar.addr >= 32'h00080000) && (host_64b_ar.addr <= 32'h00080fff))) || (((host_64b_ar.addr >= 32'h00090000) && (host_64b_ar.addr <= 32'h00090fff))) || (((host_64b_ar.addr >= 32'h000a0000) && (host_64b_ar.addr <= 32'h000a0fff))));
    wire host_64b_ar_gnt_subtractive = host_64b_ar_to_subtractive;
    assign subtractive_axi_arid     = host_64b_ar_to_subtractive ? host_64b_ar.id : '0;
    assign subtractive_axi_araddr   = host_64b_ar_to_subtractive ? host_64b_ar.addr : '0;
    assign subtractive_axi_arlen    = host_64b_ar_to_subtractive ? host_64b_ar.len : '0;
    assign subtractive_axi_arsize   = host_64b_ar_to_subtractive ? host_64b_ar.size : '0;
    assign subtractive_axi_arburst  = host_64b_ar_to_subtractive ? host_64b_ar.burst : '0;
    assign subtractive_axi_arlock   = host_64b_ar_to_subtractive ? host_64b_ar.lock : '0;
    assign subtractive_axi_arcache  = host_64b_ar_to_subtractive ? host_64b_ar.cache : '0;
    assign subtractive_axi_arprot   = host_64b_ar_to_subtractive ? host_64b_ar.prot : '0;
    assign subtractive_axi_arqos    = host_64b_ar_to_subtractive ? host_64b_ar.qos : '0;
    assign subtractive_axi_arregion = host_64b_ar_to_subtractive ? host_64b_ar.region : '0;
    assign subtractive_axi_aruser   = host_64b_ar_to_subtractive ? host_64b_ar.user : '0;
    assign subtractive_axi_arvalid  = host_64b_ar_to_subtractive && host_64b_arvalid;

    // Rready (master → slave) — gated on rid_valid so the path stays
    // open through the entire R handshake, not just the AR phase.
    assign subtractive_axi_rready = ((subtractive_axi_rid_bridge_id == 0) && subtractive_axi_rid_valid) ? host_64b_rready : '0;

    // Bridge ID (master → slave)
    assign subtractive_axi_bridge_id_ar = host_64b_ar_to_subtractive ? host_bridge_id_ar : '0;
    ...
    // host 64b path -> debug_sram, subtractive
    logic [0:0] host_64b_wdest_mem [16];
    logic [4:0] host_64b_wdest_wptr, host_64b_wdest_rptr;
    wire [0:0] host_64b_wdest_enc = host_64b_aw_to_subtractive ? 1'd1 : 1'd0;
    ...
    assign host_64b_w_to_subtractive = host_64b_wdest_valid && (host_64b_wdest_head == 1'd1);
...
`endif
    ...
    assign host_64b_awready = 
        ...
        (host_64b_aw_gnt_subtractive ? subtractive_axi_awready : '0);

    assign host_64b_wready = 
        (host_64b_w_sel_debug_sram ? debug_sram_axi_wready : '0) |
        (host_64b_w_sel_subtractive ? subtractive_axi_wready : '0);
    ...
    assign host_64b_arready = 
        ...
        (host_64b_ar_gnt_subtractive ? subtractive_axi_arready : '0);
