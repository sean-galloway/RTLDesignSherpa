// RDGEN0 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for rdgen0 master
...
#(
    ...
    // External AXI interface (from rdgen0 master)
    ...
    output axi4_ar_t     rdgen0_64b_ar,
    output logic         rdgen0_64b_arvalid,
    input  logic         rdgen0_64b_arready,

    input  axi4_r_64b_t  rdgen0_64b_r,
    input  logic         rdgen0_64b_rvalid,
    output logic         rdgen0_64b_rready
);
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(rdgen0_axi_arid),
        .s_axi_araddr(rdgen0_axi_araddr),
        .s_axi_arlen(rdgen0_axi_arlen),
        .s_axi_arsize(rdgen0_axi_arsize),
        .s_axi_arburst(rdgen0_axi_arburst),
        .s_axi_arlock(rdgen0_axi_arlock),
        .s_axi_arcache(rdgen0_axi_arcache),
        .s_axi_arprot(rdgen0_axi_arprot),
        .s_axi_arqos(rdgen0_axi_arqos),
        .s_axi_arregion(rdgen0_axi_arregion),
        .s_axi_aruser(rdgen0_axi_aruser),
        .s_axi_arvalid(rdgen0_axi_arvalid),
        .s_axi_arready(rdgen0_axi_arready),
        .s_axi_rid(rdgen0_axi_rid),
        .s_axi_rdata(rdgen0_axi_rdata),
        .s_axi_rresp(rdgen0_axi_rresp),
        .s_axi_rlast(rdgen0_axi_rlast),
        .s_axi_ruser(rdgen0_axi_ruser),
        .s_axi_rvalid(rdgen0_axi_rvalid),
        .s_axi_rready(rdgen0_axi_rready),
    ...
    // Requests: fub_axi_* → rdgen0_64b_*
    // Responses: rdgen0_64b_* → MUX → fub_axi_*
    // ================================================================

    // AR channel (request: fub → output)
    assign rdgen0_64b_ar.id     = xbar_axi_arid;
    assign rdgen0_64b_ar.addr   = fub_axi_araddr;
    assign rdgen0_64b_ar.len    = fub_axi_arlen;
    assign rdgen0_64b_ar.size   = fub_axi_arsize;
    assign rdgen0_64b_ar.burst  = fub_axi_arburst;
    assign rdgen0_64b_ar.lock   = fub_axi_arlock;
    assign rdgen0_64b_ar.cache  = fub_axi_arcache;
    assign rdgen0_64b_ar.prot   = fub_axi_arprot;
    assign rdgen0_64b_ar.qos    = fub_axi_arqos;
    assign rdgen0_64b_ar.region = fub_axi_arregion;
    assign rdgen0_64b_ar.user   = fub_axi_aruser;
    assign rdgen0_64b_arvalid   = fub_axi_arvalid && ar_path_active_64b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign rdgen0_64b_rready = fub_axi_rready && r_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_arready = rdgen0_64b_arready;
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_rid = rdgen0_64b_r.id[7:0];
                fub_axi_rdata = rdgen0_64b_r.data;
                fub_axi_rresp = rdgen0_64b_r.resp;
                fub_axi_rlast = rdgen0_64b_r.last;
                fub_axi_rvalid = rdgen0_64b_rvalid;
            end
            2'b10: begin  // Slave 1 (64b)
                fub_axi_rid = rdgen0_64b_r.id[7:0];
                fub_axi_rdata = rdgen0_64b_r.data;
