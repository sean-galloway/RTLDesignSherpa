...
package bridge_ddr2_char_wr_pkg;
    ...
    localparam int XBAR_ID_WIDTH   = 9;  // MASTER_ID_WIDTH + ID_PREFIX_WIDTH

    // AXI4 Write Address Channel (width-independent)
    // Note: ID width is 9-bit for this bridge
    typedef struct packed {
        logic [8:0]   id;      // Transaction ID
...
endpackage : bridge_ddr2_char_wr_pkg
