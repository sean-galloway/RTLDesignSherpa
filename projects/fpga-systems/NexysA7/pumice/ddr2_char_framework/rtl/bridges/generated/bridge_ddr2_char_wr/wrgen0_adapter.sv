// WRGEN0 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for wrgen0 master
...
#(
    ...
    // External AXI interface (from wrgen0 master)
    ...
    output axi4_aw_t     wrgen0_64b_aw,
    output logic         wrgen0_64b_awvalid,
    input  logic         wrgen0_64b_awready,

    output axi4_w_64b_t  wrgen0_64b_w,
    output logic         wrgen0_64b_wvalid,
    input  logic         wrgen0_64b_wready,

    input  axi4_b_t      wrgen0_64b_b,
    input  logic         wrgen0_64b_bvalid,
    output logic         wrgen0_64b_bready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(wrgen0_axi_awid),
        .s_axi_awaddr(wrgen0_axi_awaddr),
        .s_axi_awlen(wrgen0_axi_awlen),
        .s_axi_awsize(wrgen0_axi_awsize),
        .s_axi_awburst(wrgen0_axi_awburst),
        .s_axi_awlock(wrgen0_axi_awlock),
        .s_axi_awcache(wrgen0_axi_awcache),
        .s_axi_awprot(wrgen0_axi_awprot),
        .s_axi_awqos(wrgen0_axi_awqos),
        .s_axi_awregion(wrgen0_axi_awregion),
        .s_axi_awuser(wrgen0_axi_awuser),
        .s_axi_awvalid(wrgen0_axi_awvalid),
        .s_axi_awready(wrgen0_axi_awready),
        .s_axi_wdata(wrgen0_axi_wdata),
        .s_axi_wstrb(wrgen0_axi_wstrb),
        .s_axi_wlast(wrgen0_axi_wlast),
        .s_axi_wuser(wrgen0_axi_wuser),
        .s_axi_wvalid(wrgen0_axi_wvalid),
        .s_axi_wready(wrgen0_axi_wready),
        .s_axi_bid(wrgen0_axi_bid),
        .s_axi_bresp(wrgen0_axi_bresp),
        .s_axi_buser(wrgen0_axi_buser),
        .s_axi_bvalid(wrgen0_axi_bvalid),
        .s_axi_bready(wrgen0_axi_bready),
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr <= 32'h07FFFFFF) begin
            ...
            comb_slave_select_aw[1] = 1'b1;  // subtractive
        end
    end
    ...
    assign aw_path_active_64b = (comb_slave_select_aw[0] | comb_slave_select_aw[1]) && aw_gate_ok;
    logic w_path_active_64b;
    assign w_path_active_64b = w_slave_select[0] | w_slave_select[1];
    logic b_path_active_64b;
    assign b_path_active_64b = b_slave_select[0] | b_slave_select[1];

    // ================================================================
    // Direct passthrough: 64b → 64b (no converter)
    // Requests: fub_axi_* → wrgen0_64b_*
    // Responses: wrgen0_64b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign wrgen0_64b_aw.id     = xbar_axi_awid;
    assign wrgen0_64b_aw.addr   = fub_axi_awaddr;
    assign wrgen0_64b_aw.len    = fub_axi_awlen;
    assign wrgen0_64b_aw.size   = fub_axi_awsize;
    assign wrgen0_64b_aw.burst  = fub_axi_awburst;
    assign wrgen0_64b_aw.lock   = fub_axi_awlock;
    assign wrgen0_64b_aw.cache  = fub_axi_awcache;
    assign wrgen0_64b_aw.prot   = fub_axi_awprot;
    assign wrgen0_64b_aw.qos    = fub_axi_awqos;
    assign wrgen0_64b_aw.region = fub_axi_awregion;
    assign wrgen0_64b_aw.user   = fub_axi_awuser;
    assign wrgen0_64b_awvalid   = fub_axi_awvalid && aw_path_active_64b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign wrgen0_64b_w.data  = fub_axi_wdata;
    assign wrgen0_64b_w.strb  = fub_axi_wstrb;
    assign wrgen0_64b_w.last  = fub_axi_wlast;
    assign wrgen0_64b_w.user  = fub_axi_wuser;
    assign wrgen0_64b_wvalid  = fub_axi_wvalid && w_path_active_64b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign wrgen0_64b_bready = fub_axi_bready && b_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_awready = wrgen0_64b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_wready = wrgen0_64b_wready;
            end
            2'b10: begin  // Slave 1 (64b)
                fub_axi_wready = wrgen0_64b_wready;
            end
    ...
    always_comb begin
        ...
        case (b_slave_select)
            2'b01: begin  // Slave 0 (64b)
                fub_axi_bid = wrgen0_64b_b.id[7:0];
                fub_axi_bresp = wrgen0_64b_b.resp;
                fub_axi_bvalid = wrgen0_64b_bvalid;
            end
            2'b10: begin  // Slave 1 (64b)
                fub_axi_bid = wrgen0_64b_b.id[7:0];
                fub_axi_bresp = wrgen0_64b_b.resp;
