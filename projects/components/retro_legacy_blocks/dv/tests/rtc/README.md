...
- `test_apb_rtc.py` - Main test runner
...
- `rtc_tb.py` - Main testbench
- `rtc_tests_basic.py` - Basic test suite
- `rtc_tests_medium.py` - Medium test suite
- `rtc_tests_full.py` - Full test suite

## Running Tests

```bash
# Run all tests
pytest dv/tests/rtc/ -v

# Run basic tests only
pytest dv/tests/rtc/ -v -k "basic"

# With waveforms
WAVES=1 pytest dv/tests/rtc/ -v
```
