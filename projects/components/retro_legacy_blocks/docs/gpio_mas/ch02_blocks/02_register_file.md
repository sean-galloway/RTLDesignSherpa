...
The register file is generated by PeakRDL from `../../rdl/gpio/gpio_regs.rdl` and is the hardware/software contract for the whole block. If a bit isn't in the RDL, it doesn't exist.
