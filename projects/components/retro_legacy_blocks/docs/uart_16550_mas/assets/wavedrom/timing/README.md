...
This directory contains WaveDrom timing diagrams for UART 16550 operational scenarios. Each JSON file renders one scenario end to end, from the APB or serial pins down to the internal shift registers and status flags.
