...
The source material behind this specification — the RTL itself, the original 16550 datasheets that defined the programming model, and the bus and signaling standards the block is built against.
