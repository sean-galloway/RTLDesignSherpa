...
- **Source**: `rdl/pit_8254/pit_regs.rdl`
- **Generated by**: PeakRDL regblock tool

**RTL README**
- **File**: `rtl/pit_8254/README.md`
- **Description**: Status, stated deviations, test results and the known test-vs-design gap
...
- Check the RTL `README.md` for latest implementation details
