...
module hpet_regs (
    ...
    for(genvar i0=0; i0<8; i0++) begin
        ...
        assign hwif_out.TIMER[i0].TIMER_COMPARATOR_LO.timer_comp_lo.swmod = decoded_reg_strb.TIMER[i0].TIMER_COMPARATOR_LO && decoded_req_is_wr && |(decoded_wr_biten[31:0]);
        ...
        assign hwif_out.TIMER[i0].TIMER_COMPARATOR_HI.timer_comp_hi.swmod = decoded_reg_strb.TIMER[i0].TIMER_COMPARATOR_HI && decoded_req_is_wr && |(decoded_wr_biten[31:0]);
    end
