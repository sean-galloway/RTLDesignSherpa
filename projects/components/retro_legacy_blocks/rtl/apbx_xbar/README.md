...
```
┌─────────────────────────────────────────────────────┐
│ apbx_xbar_legacy_1to8 (Named Port Wrapper)           │
│                                                      │
│  Master APB ─────► apbx_xbar_1to8 ───────► Named     │
...
Then wrapped with named ports in `apbx_xbar_legacy_1to8.sv`.
...
```
retro_legacy_blocks/rtl/apbx_xbar/
├── apbx_xbar_1to8.sv           # Generated crossbar (from apbx_xbar component)
├── apbx_xbar_legacy_1to8.sv    # Named-port wrapper
├── apbx_xbar_legacy_1to8.f     # Filelist with all dependencies
└── README.md                   # This file
```
...
All dependencies are listed in `apbx_xbar_legacy_1to8.f`.
