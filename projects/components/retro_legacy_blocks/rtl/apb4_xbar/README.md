...
```
┌─────────────────────────────────────────────────────┐
│ apb4_xbar_legacy_1to8 (Named Port Wrapper)           │
│                                                      │
│  Master APB ─────► apb4_xbar_1to8 ───────► Named     │
...
- **apb4_xbar_1to8.sv** - Generated using `generate_xbars.py` from `projects/components/apb4_xbar/bin/`
- **apb4_xbar_legacy_1to8.sv** - Named-port wrapper mapping numbered ports to descriptive legacy block names

## Module: apb4_xbar_legacy_1to8
...
```bash
cd /mnt/data/github/rtldesignsherpa/projects/components/apb4_xbar/bin
python3 apb4_xbar_generator.py --masters 1 --slaves 8 --base-addr 0xFEC00000 --slave-size 0x1000
# Output: apb4_xbar_1to8.sv with 4KB regions (moved to retro_legacy_blocks/rtl/apb4_xbar/)
```

Then wrapped with named ports in `apb4_xbar_legacy_1to8.sv`.
...
```
retro_legacy_blocks/rtl/apb4_xbar/
├── apb4_xbar_1to8.sv           # Generated crossbar (from apb4_xbar component)
├── apb4_xbar_legacy_1to8.sv    # Named-port wrapper
├── apb4_xbar_legacy_1to8.f     # Filelist with all dependencies
└── README.md                   # This file
```
...
All dependencies are listed in `apb4_xbar_legacy_1to8.f`.

### Related Documentation

- Main APB Crossbar Component: `/projects/components/apb4_xbar/`
- APB Crossbar PRD: `/projects/components/apb4_xbar/PRD.md`
