...
module rlb_top #(
    ...
    // APB Crossbar
    // ========================================================================
    // Generated by projects/components/apbx-xbar/bin/apbx_xbar_generator.py:
    //   generate_apbx_xbar(num_masters=1, num_slaves=10, base_addr=0xFEC00000,
    //                      addr_width=32, data_width=32, slave_size=0x1000)
    // Regenerate rather than hand-edit apbx_xbar_1to10.sv. The generator owns the
    // decode-miss path (an unmapped address completes with PSLVERR instead of
    // hanging); a hand-rolled copy is how that fix gets lost.
    //
    // Slave index -> RLB window, 4KB apart from BASE_ADDR:
    //   s0 HPET   s1 PIC    s2 PIT   s3 RTC   s4 SMBus
    //   s5 PM     s6 IOAPIC s7 GPIO  s8 UART  s9 Reserved
    //
    // The crossbar routes the FULL address; each peripheral takes the low 12 bits
    // of its own 4KB window, sliced at that peripheral's instantiation below.
    apbx_xbar_1to10 #(
        ...
        .m0_apb_PSEL     (s_apb_PSEL),
        .m0_apb_PENABLE  (s_apb_PENABLE),
        .m0_apb_PADDR    (s_apb_PADDR),
        .m0_apb_PWRITE   (s_apb_PWRITE),
        .m0_apb_PWDATA   (s_apb_PWDATA),
        .m0_apb_PSTRB    (s_apb_PSTRB),
        .m0_apb_PPROT    (s_apb_PPROT),
        .m0_apb_PRDATA   (s_apb_PRDATA),
        .m0_apb_PSLVERR  (s_apb_PSLVERR),
        .m0_apb_PREADY   (s_apb_PREADY),

        // Slave 0: HPET
        .s0_apb_PSEL     (hpet_apb_PSEL),
        .s0_apb_PENABLE  (hpet_apb_PENABLE),
        .s0_apb_PADDR    (hpet_apb_PADDR),
        .s0_apb_PWRITE   (hpet_apb_PWRITE),
        .s0_apb_PWDATA   (hpet_apb_PWDATA),
        .s0_apb_PSTRB    (hpet_apb_PSTRB),
        .s0_apb_PPROT    (hpet_apb_PPROT),
        .s0_apb_PRDATA   (hpet_apb_PRDATA),
        .s0_apb_PSLVERR  (hpet_apb_PSLVERR),
        .s0_apb_PREADY   (hpet_apb_PREADY),

        // Slave 1: 8259 PIC
        .s1_apb_PSEL     (pic_apb_PSEL),
        .s1_apb_PENABLE  (pic_apb_PENABLE),
        .s1_apb_PADDR    (pic_apb_PADDR),
        .s1_apb_PWRITE   (pic_apb_PWRITE),
        .s1_apb_PWDATA   (pic_apb_PWDATA),
        .s1_apb_PSTRB    (pic_apb_PSTRB),
        .s1_apb_PPROT    (pic_apb_PPROT),
        .s1_apb_PRDATA   (pic_apb_PRDATA),
        .s1_apb_PSLVERR  (pic_apb_PSLVERR),
        .s1_apb_PREADY   (pic_apb_PREADY),

        // Slave 2: 8254 PIT
        .s2_apb_PSEL     (pit_apb_PSEL),
        .s2_apb_PENABLE  (pit_apb_PENABLE),
        .s2_apb_PADDR    (pit_apb_PADDR),
        .s2_apb_PWRITE   (pit_apb_PWRITE),
        .s2_apb_PWDATA   (pit_apb_PWDATA),
        .s2_apb_PSTRB    (pit_apb_PSTRB),
        .s2_apb_PPROT    (pit_apb_PPROT),
        .s2_apb_PRDATA   (pit_apb_PRDATA),
        .s2_apb_PSLVERR  (pit_apb_PSLVERR),
        .s2_apb_PREADY   (pit_apb_PREADY),
        ...
        // Slave 4: SMBus
        .s4_apb_PSEL     (smbus_apb_PSEL),
        .s4_apb_PENABLE  (smbus_apb_PENABLE),
        .s4_apb_PADDR    (smbus_apb_PADDR),
        .s4_apb_PWRITE   (smbus_apb_PWRITE),
        .s4_apb_PWDATA   (smbus_apb_PWDATA),
        .s4_apb_PSTRB    (smbus_apb_PSTRB),
        .s4_apb_PPROT    (smbus_apb_PPROT),
        .s4_apb_PRDATA   (smbus_apb_PRDATA),
        .s4_apb_PSLVERR  (smbus_apb_PSLVERR),
        .s4_apb_PREADY   (smbus_apb_PREADY),

        // Slave 5: PM/ACPI
        .s5_apb_PSEL     (pm_apb_PSEL),
        .s5_apb_PENABLE  (pm_apb_PENABLE),
        .s5_apb_PADDR    (pm_apb_PADDR),
        .s5_apb_PWRITE   (pm_apb_PWRITE),
        .s5_apb_PWDATA   (pm_apb_PWDATA),
        .s5_apb_PSTRB    (pm_apb_PSTRB),
        .s5_apb_PPROT    (pm_apb_PPROT),
        .s5_apb_PRDATA   (pm_apb_PRDATA),
        .s5_apb_PSLVERR  (pm_apb_PSLVERR),
        .s5_apb_PREADY   (pm_apb_PREADY),

        // Slave 6: IOAPIC
        .s6_apb_PSEL     (ioapic_apb_PSEL),
        .s6_apb_PENABLE  (ioapic_apb_PENABLE),
        .s6_apb_PADDR    (ioapic_apb_PADDR),
        .s6_apb_PWRITE   (ioapic_apb_PWRITE),
        .s6_apb_PWDATA   (ioapic_apb_PWDATA),
        .s6_apb_PSTRB    (ioapic_apb_PSTRB),
        .s6_apb_PPROT    (ioapic_apb_PPROT),
        .s6_apb_PRDATA   (ioapic_apb_PRDATA),
        .s6_apb_PSLVERR  (ioapic_apb_PSLVERR),
        .s6_apb_PREADY   (ioapic_apb_PREADY),

        // Slave 7: GPIO
        .s7_apb_PSEL     (gpio_apb_PSEL),
        .s7_apb_PENABLE  (gpio_apb_PENABLE),
        .s7_apb_PADDR    (gpio_apb_PADDR),
        .s7_apb_PWRITE   (gpio_apb_PWRITE),
        .s7_apb_PWDATA   (gpio_apb_PWDATA),
        .s7_apb_PSTRB    (gpio_apb_PSTRB),
        .s7_apb_PPROT    (gpio_apb_PPROT),
        .s7_apb_PRDATA   (gpio_apb_PRDATA),
        .s7_apb_PSLVERR  (gpio_apb_PSLVERR),
        .s7_apb_PREADY   (gpio_apb_PREADY),

        // Slave 8: UART 16550
        .s8_apb_PSEL     (uart_apb_PSEL),
        .s8_apb_PENABLE  (uart_apb_PENABLE),
        .s8_apb_PADDR    (uart_apb_PADDR),
        .s8_apb_PWRITE   (uart_apb_PWRITE),
        .s8_apb_PWDATA   (uart_apb_PWDATA),
        .s8_apb_PSTRB    (uart_apb_PSTRB),
        .s8_apb_PPROT    (uart_apb_PPROT),
        .s8_apb_PRDATA   (uart_apb_PRDATA),
        .s8_apb_PSLVERR  (uart_apb_PSLVERR),
    ...
    apb4_hpet #(
        ...
        .s_apb_PADDR   (hpet_apb_PADDR[11:0]),
    ...
    apb4_pic_8259 u_pic (
        ...
        .s_apb_PADDR   (pic_apb_PADDR[11:0]),
    ...
    apb4_pit_8254 #(
        ...
        .s_apb_PADDR   (pit_apb_PADDR[11:0]),
    ...
    apb4_rtc u_rtc (
        ...
        .s_apb_PADDR   (rtc_apb_PADDR[11:0]),
    ...
    apb4_smbus #(
        ...
        .s_apb_PADDR   (smbus_apb_PADDR[11:0]),
    ...
    apb4_ioapic #(
        ...
        .s_apb_PADDR      (ioapic_apb_PADDR[11:0]),
    ...
    apb4_gpio #(
        ...
        .s_apb_PADDR   (gpio_apb_PADDR[11:0]),
    ...
    apb4_uart_16550 #(
        ...
        .s_apb_PADDR   (uart_apb_PADDR[11:0]),
