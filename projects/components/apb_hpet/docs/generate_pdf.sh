...
# ------------------------------------------------------------
# HPET Spec PDF Generator
# ------------------------------------------------------------
# Usage:
#   ./generate_pdf.sh [--rev <version>] [--help]
#
# Example:
#   ./generate_pdf.sh --rev 0.27
#
# This script builds the HPET specification document
...
Description:
  This script generates a DOCX and PDF version of the HPET specification
...
# ------------------------------------------------------------
OUTPUT_BASENAME="APB_HPET_Specification_v${REV}"
...
# ------------------------------------------------------------
echo "------------------------------------------------------------"
echo " Generating HPET Specification"
echo "------------------------------------------------------------"
echo "  Version: ${REV}"
