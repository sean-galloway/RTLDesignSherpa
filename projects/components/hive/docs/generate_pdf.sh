...
# ------------------------------------------------------------
# HIVE Specification PDF Generator
# ------------------------------------------------------------
# Usage:
...
#
# This script builds the HIVE specification document
# (DOCX and PDF) from Markdown sources using md_to_docx.py.
# ------------------------------------------------------------

# Default values
REV="0.25"
ASSETS="hive_spec/assets"
SPEC_INDEX="hive_spec/hive_index.md"
...
Description:
  This script generates a DOCX and PDF version of the HIVE specification
...
# ------------------------------------------------------------
OUTPUT_BASENAME="HIVE_Specification_v${REV}"
...
# ------------------------------------------------------------
echo "------------------------------------------------------------"
echo " Generating HIVE Specification"
echo "------------------------------------------------------------"
echo "  Version:     ${REV}"
