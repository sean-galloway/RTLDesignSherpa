...
from projects.components.misc.dv.tbclasses.axi4_slave_rd_pattern_gen_tb import (
...
async def cocotb_test_axi4_slave_rd_pattern_gen(dut):
    ...
    if test_type == 'single':
        ...
        burst_len = int(os.environ.get('BURST_LEN', '4'))
...
def test_axi4_slave_rd_pattern_gen(request, test_type, data_width, id_width,
    ...
    verilog_sources = [
        ...
        os.path.join(rtl_dict['rtl_common'], 'shifter_lfsr_fibonacci.sv'),
        # AMBA infrastructure
