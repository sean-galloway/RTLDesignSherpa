# Filelist for axi4_to_apb4_shim module
# Location: projects/components/converters/rtl/filelists/axi4_to_apb4_shim.f
...
# axi4_to_apb4_shim started instantiating when its APB cmd/rsp CDC moved from a
...
$CONVERTERS_ROOT/rtl/axi4_to_apb4_convert.sv

# Top-level AXI4 to APB shim
$CONVERTERS_ROOT/rtl/axi4_to_apb4_shim.sv
