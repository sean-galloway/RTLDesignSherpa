# Filelist for axi4_dwidth_to_apb4_chain FUB-level chain
# Location: projects/components/converters/rtl/filelists/axi4_dwidth_to_apb4_chain.f
# Purpose: Chain wrapper: axi4_dwidth_converter_rd → axi4_to_apb4_shim.
...
-f $CONVERTERS_ROOT/rtl/filelists/axi4_to_apb4_shim.f

# Top: the chain wrapper
$CONVERTERS_ROOT/rtl/axi4_dwidth_to_apb4_chain.sv
