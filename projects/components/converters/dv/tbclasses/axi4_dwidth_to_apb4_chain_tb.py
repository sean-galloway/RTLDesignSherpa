...
#
# Module: axi4_dwidth_to_apb4_chain_tb
# Purpose: Testbench for the axi4_dwidth_converter_rd → axi4_to_apb4_shim chain.
#
# Author: RTL Design Sherpa
# Created: 2026-05-22

"""
Testbench for axi4_dwidth_to_apb4_chain.

Wide AXI4 master → axi4_dwidth_converter_rd → axi4_to_apb4_shim → narrow APB.
...
from CocoTBFramework.components.apb.apb_factories import create_apb4_slave
