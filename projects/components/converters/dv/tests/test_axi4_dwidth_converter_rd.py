...
Imports testbench class from bin/TBClasses/axi4/axi4_dwidth_converter_rd_tb.py

Test Levels:
- gate: Quick smoke test (single read transaction)
- func: Multiple read transactions with different patterns
...
def test_axi4_dwidth_converter_rd(request, params):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/converters/rtl/filelists/axi4_dwidth_converter_rd.f'
    )
    # RTL parameters
