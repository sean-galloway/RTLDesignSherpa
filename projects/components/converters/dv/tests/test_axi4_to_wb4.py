...
#
# Module: test_axi4_to_wb4
# Purpose: axi4_to_wb4 converter test runner (BRIDGE-019)
#
# Author: sean galloway
# Created: 2026-09-11

"""axi4_to_wb4: see dv/tbclasses/axi4_to_wb4_tb.py for what is checked.
...
from projects.components.converters.dv.tbclasses.axi4_to_wb4_tb import AXI4ToWB4TB
from TBClasses.shared.filelist_utils import get_sources_from_filelist


@cocotb.test(timeout_time=300, timeout_unit="ms")
async def axi4_to_wb4_test(dut):
    tb = AXI4ToWB4TB(dut)
...
def test_axi4_to_wb4(request, params):
    ...
    rtl_parameters = {'AXI_ID_WIDTH': str(id_width), 'AXI_ADDR_WIDTH': str(addr_width), 'AXI_DATA_WIDTH': str(data_width), 'AXI_USER_WIDTH': '1', 'CLASSIC': str(classic)}
    ...
    extra_env = {
        ...
        'TEST_LEVEL': test_level, 'AXI_ADDR_WIDTH': str(addr_width), 'AXI_DATA_WIDTH': str(data_width), 'AXI_ID_WIDTH': str(id_width), 'CLASSIC': str(classic), 'RTY_RESP': '2',
    }
