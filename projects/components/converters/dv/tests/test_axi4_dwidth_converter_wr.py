...
#
# Module: test_axi4_dwidth_converter_wr
# Purpose: AXI4 Write Data Width Converter Test Runner (WRITE-ONLY)
#
...
async def axi4_dwidth_converter_wr_test(dut):
    """
    AXI4 Write Data Width Converter test - WRITE-ONLY.

    Tests ONLY write path (AW, W, B channels).
...
def test_axi4_dwidth_converter_wr(request, params):
    """
    AXI4 Write Data Width Converter test with comprehensive validation.
    ...
    dut_name = "axi4_dwidth_converter_wr"  # Write-only converter
    toplevel = dut_name
