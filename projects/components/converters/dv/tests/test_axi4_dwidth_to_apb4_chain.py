...
#
# Module: test_axi4_dwidth_to_apb4_chain
# Purpose: FUB-level test for the axi4_dwidth_converter_rd → axi4_to_apb4_shim chain.
#
...
from projects.components.converters.dv.tbclasses.axi4_dwidth_to_apb4_chain_tb import (
...
async def cocotb_test_axi4_dwidth_to_apb4_chain(dut):
    """Chain test: wide AXI4 master → dwidth(rd) → axi4_to_apb4_shim → narrow APB."""
...
def test_axi4_dwidth_to_apb4_chain(request, params):
    ...
    dut_name = "axi4_dwidth_to_apb4_chain"
    toplevel = dut_name
    ...
    test_name_plus_params = (
        f"test_axi4_dwidth_to_apb4_chain_"
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/converters/rtl/filelists/axi4_dwidth_to_apb4_chain.f',
    )
