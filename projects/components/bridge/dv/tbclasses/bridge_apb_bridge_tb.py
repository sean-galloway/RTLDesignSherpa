...
#
# BridgeApbBridgeTB - Testbench for apb_bridge
...
class BridgeApbBridgeTB(TBBase):
    """
    Testbench for apb_bridge bridge
    ...
    def _setup_slave_0_apb_periph(self):
        """Setup components for slave 0: apb_periph (protocol: apb)"""        # APB protocol slave - use APB BFMs
