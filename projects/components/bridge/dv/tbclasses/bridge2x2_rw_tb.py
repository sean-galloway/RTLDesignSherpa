...
class Bridge2x2RwTB(TBBase):
    ...
    def _setup_master_0_cpu(self):
        """Setup GAXI components for master 0: cpu"""
    ...
    def _setup_master_1_dma(self):
        """Setup GAXI components for master 1: dma"""
        ...
        # AR channel (master 1 read address)
        self.ar_m1 = GAXIMaster(
            dut=self.dut,
            title="AR_M1",
            prefix="dma_m_axi",
            clock=self.clock,
    ...
    def _setup_slave_0_ddr(self):
        """Setup components for slave 0: ddr (protocol: axi4)"""        # AXI4 protocol slave - use GAXI BFMs        # AW channel (slave 0 write address)
    ...
    def _setup_slave_1_sram(self):
        """Setup components for slave 1: sram (protocol: axi4)"""        # AXI4 protocol slave - use GAXI BFMs        # AW channel (slave 1 write address)
