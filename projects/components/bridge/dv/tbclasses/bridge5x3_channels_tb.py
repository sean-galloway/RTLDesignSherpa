...
class Bridge5x3ChannelsTB(TBBase):
    ...
    def __init__(self, dut):
        ...
        self.slave_info = {
            0: ('axi4', 0x00000000, 0x40000000, 256),  # sram_buffer
            1: ('axi4', 0x40000000, 0x80000000, 256),  # ddr_controller
            2: ('apb', 0xc0000000, 0x10000000, 32),  # apb_periph
        }
        ...
        self.master_data_width = {
            0: 256,  # descr_wr_master
            1: 256,  # sink_wr_master
            2: 256,  # src_rd_master
            3: 256,  # stream_master
            4: 64,  # cpu_master
        }
        ...
        self.observed_ar = {i: [] for i in range(3)}
        self.observed_aw = {i: [] for i in range(3)}
    ...
    def _setup_master_0_descr_wr_master(self):
        """Set up protocol BFMs for master 0: descr_wr_master (protocol: axi4)"""
    ...
    def _setup_master_4_cpu_master(self):
        ...
        self.master_wr[4] = AXI4MasterWrite(
            self.dut, self.clock,
            prefix="cpu_axi_",
            log=self.log,
            data_width=64,
    ...
    def _setup_slave_0_sram_buffer(self):
        """Set up protocol BFM and pre-seeded MemoryModel for slave 0: sram_buffer (protocol: axi4)"""
        ...
        preset = self._build_preset(0, addr_range, 256)
    ...
    def _setup_slave_1_ddr_controller(self):
        """Set up protocol BFM and pre-seeded MemoryModel for slave 1: ddr_controller (protocol: axi4)"""
        # AXI4 slave — full memory-backed BFM.
        bytes_per_line = 256 // 8
        addr_range = 0x80000000
        # Cap MemoryModel size — see SLAVE_MEM_CAP_BYTES comment.
        mem_bytes = min(addr_range, self.SLAVE_MEM_CAP_BYTES)
        preset = self._build_preset(1, addr_range, 256)
    ...
    def _setup_slave_2_apb_periph(self):
        ...
        preset = self._build_preset(2, 0x10000000, 32)
