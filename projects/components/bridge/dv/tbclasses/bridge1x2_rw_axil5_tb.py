...
#
# Bridge1x2RwAxil5TB - Testbench for bridge_1x2_rw_axil5
...
class Bridge1x2RwAxil5TB(TBBase):
    """
    Testbench for bridge_1x2_rw_axil5 bridge.
    ...
    def __init__(self, dut):
        ...
        self.slave_info = {
            ...
            1: ('axil5', 0x80000000, 0x80000000, 32),  # cfg
        }
    ...
    def _setup_slave_1_cfg(self):
        """Set up protocol BFM and pre-seeded MemoryModel for slave 1: cfg (protocol: axil5)"""
