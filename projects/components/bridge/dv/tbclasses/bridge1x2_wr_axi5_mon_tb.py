...
#
# Bridge1x2WrAxi5MonTB - Testbench for bridge_1x2_wr_axi5_mon
...
class Bridge1x2WrAxi5MonTB(TBBase):
    """
    Testbench for bridge_1x2_wr_axi5_mon bridge.
    ...
    def _setup_master_0_cpu_wr(self):
        """Set up protocol BFMs for master 0: cpu_wr (protocol: axi5)"""
