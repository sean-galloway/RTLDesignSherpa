...
#
# Bridge2x2LiteReqMonTB - Testbench for bridge_2x2_lite_req_mon
...
# AXI5-Lite requester ports are driven by the AXIL5 BFMs: AXIL4 transaction
# logic plus the optional sideband groups, so they bind to the awuser/
# awlock/awtrace/... ports the bridge exposes on an axil5 master.
from CocoTBFramework.components.axil5.axil5_interfaces import (
    AXIL5MasterRead, AXIL5MasterWrite,
)
...
class Bridge2x2LiteReqMonTB(TBBase):
    """
    Testbench for bridge_2x2_lite_req_mon bridge.

    Configuration:
        Masters: 2 (lite4, lite5)
        Slaves:  2 (mem, regs)
        Channels: RW
        Data Width: 64
        Addr Width: 64
    ...
    def __init__(self, dut):
        ...
        self.slave_info = {
            ...
            1: ('axil5', 0x40000000, 0x00010000, 32),  # regs
        }
        ...
        self._setup_slave_1_regs()
        self._setup_master_0_lite4()
        self._setup_master_1_lite5()
    ...
    def _setup_master_0_lite4(self):
        """Set up protocol BFMs for master 0: lite4 (protocol: axil)"""
    ...
    def _setup_master_1_lite5(self):
        """Set up protocol BFMs for master 1: lite5 (protocol: axil5)"""
        self.master_rd[1] = AXIL5MasterRead(
            self.dut, self.clock,
            prefix="lite5_axil_",
            log=self.log,
            data_width=32,
        ...
        self.master_wr[1] = AXIL5MasterWrite(
            self.dut, self.clock,
            prefix="lite5_axil_",
            log=self.log,
            data_width=32,
    ...
    def _setup_slave_1_regs(self):
        """Set up protocol BFM and pre-seeded MemoryModel for slave 1: regs (protocol: axil5)"""
