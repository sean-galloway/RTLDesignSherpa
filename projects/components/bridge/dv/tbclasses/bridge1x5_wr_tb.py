...
#
# Bridge1x5WrTB - Testbench for bridge_1x5_wr
...
class Bridge1x5WrTB(TBBase):
    """
    Testbench for bridge_1x5_wr bridge.
    ...
    def __init__(self, dut):
        ...
        self.slave_info = {
            0: ('axi4', 0x00000000, 0x10000000, 32),  # periph_wr
            1: ('axi4', 0x10000000, 0x40000000, 64),  # ddr_wr
            2: ('axi4', 0x50000000, 0x30000000, 128),  # hbm_wr
        ...
        self._setup_slave_0_periph_wr()
        self._setup_slave_1_ddr_wr()
        self._setup_slave_2_hbm_wr()
    ...
    def _setup_slave_0_periph_wr(self):
        """Set up protocol BFM and pre-seeded MemoryModel for slave 0: periph_wr (protocol: axi4)"""
    ...
    def _setup_slave_4_axil_periph(self):
        ...
        self.slave_wr[4].aw_channel.add_callback(
            lambda pkt, _i=4: self.observed_aw[_i].append(pkt))
