...
class Bridge1x5WrTB(TBBase):
    ...
    def _setup_slave_0_periph_wr(self):
        """Setup components for slave 0: periph_wr (protocol: axi4)"""        # AXI4 protocol slave - use GAXI BFMs        # AW channel (slave 0 write address)
    ...
    def _setup_slave_1_ddr_wr(self):
        """Setup components for slave 1: ddr_wr (protocol: axi4)"""        # AXI4 protocol slave - use GAXI BFMs        # AW channel (slave 1 write address)
    ...
    def _setup_slave_2_hbm_wr(self):
        """Setup components for slave 2: hbm_wr (protocol: axi4)"""        # AXI4 protocol slave - use GAXI BFMs        # AW channel (slave 2 write address)
    ...
    def _setup_slave_4_axil_periph(self):
        """Setup components for slave 4: axil_periph (protocol: axil)"""        # AXI4 protocol slave - use GAXI BFMs        # AW channel (slave 4 write address)
