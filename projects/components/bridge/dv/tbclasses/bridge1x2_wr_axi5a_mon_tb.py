...
#
# Bridge1x2WrAxi5aMonTB - Testbench for bridge_1x2_wr_axi5a_mon
...
class Bridge1x2WrAxi5aMonTB(TBBase):
    """
    Testbench for bridge_1x2_wr_axi5a_mon bridge.
    ...
    def __init__(self, dut):
        ...
        self.slave_info = {
            0: ('axi5', 0x00000000, 0x80000000, 32),  # ddr_wr
            1: ('axi5', 0x80000000, 0x80000000, 32),  # sram_wr
        }
    ...
    def _setup_slave_0_ddr_wr(self):
        """Set up protocol BFM and pre-seeded MemoryModel for slave 0: ddr_wr (protocol: axi5)"""
