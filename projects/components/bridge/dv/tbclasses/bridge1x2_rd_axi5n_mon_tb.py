...
#
# Bridge1x2RdAxi5nMonTB - Testbench for bridge_1x2_rd_axi5n_mon
...
class Bridge1x2RdAxi5nMonTB(TBBase):
    """
    Testbench for bridge_1x2_rd_axi5n_mon bridge.
    ...
    def __init__(self, dut):
        ...
        self.slave_info = {
            ...
            1: ('axi5', 0x80000000, 0x80000000, 32),  # sram_rd
        }
    ...
    def _setup_master_0_cpu_rd(self):
        """Set up protocol BFMs for master 0: cpu_rd (protocol: axi5)"""
    ...
    def _setup_slave_1_sram_rd(self):
        """Set up protocol BFM and pre-seeded MemoryModel for slave 1: sram_rd (protocol: axi5)"""
        # AXI4 slave — full memory-backed BFM.
        bytes_per_line = 32 // 8
        addr_range = 0x80000000
        # Cap MemoryModel size — see SLAVE_MEM_CAP_BYTES comment.
