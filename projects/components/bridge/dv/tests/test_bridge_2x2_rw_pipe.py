...
#
# Test file for bridge_2x2_rw_pipe
...
from projects.components.bridge.dv.tbclasses.bridge2x2_rw_pipe_tb import Bridge2x2RwPipeTB, AxiResponseError
...
async def cocotb_test_bridge_2x2_rw_pipe_basic_connectivity(dut):
    """
...
async def cocotb_test_bridge_2x2_rw_pipe_boundary_probe(dut):
    """
    ...
    tb.log.info("=" * 80)
@cocotb.test(timeout_time=8000, timeout_unit="ms")
async def cocotb_test_bridge_2x2_rw_pipe_arbitration(dut):
    """
...
def test_bridge_2x2_rw_pipe_basic_connectivity(request, test_level):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/bridge/rtl/filelists/bridge_2x2_rw_pipe.f'
    )
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_2x2_rw_pipe_basic_connectivity",
        sim_build=sim_build,
...
@pytest.mark.parametrize("test_level", reg_level_grid())
def test_bridge_2x2_rw_pipe_boundary_probe(request, test_level):
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_2x2_rw_pipe_boundary_probe",
        sim_build=sim_build,
        waves=False,
        extra_args=extra_args,
        plus_args=waves['sim_args'],
...
@pytest.mark.parametrize("test_level", reg_level_grid())
def test_bridge_2x2_rw_pipe_arbitration(request, test_level):
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_2x2_rw_pipe_arbitration",
        sim_build=sim_build,
        waves=False,
        extra_args=extra_args,
        plus_args=waves['sim_args'],
