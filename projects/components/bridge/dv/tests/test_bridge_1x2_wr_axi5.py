...
#
# Test file for bridge_1x2_wr_axi5
...
from projects.components.bridge.dv.tbclasses.bridge1x2_wr_axi5_tb import Bridge1x2WrAxi5TB, AxiResponseError
...
def test_bridge_1x2_wr_axi5_basic_connectivity(request, test_level):
    ...
    dut_name = "bridge_1x2_wr_axi5"

    # Get sources from filelist
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/bridge/rtl/filelists/bridge_1x2_wr_axi5.f'
    )
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x2_wr_axi5_basic_connectivity",
        sim_build=sim_build,
...
def test_bridge_1x2_wr_axi5_boundary_probe(request, test_level):
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x2_wr_axi5_boundary_probe",
        sim_build=sim_build,
        waves=False,
        extra_args=extra_args,
        plus_args=waves['sim_args'],
