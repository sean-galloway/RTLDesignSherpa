...
#
# Test file for bridge_1x2_rd_axi5n
...
from projects.components.bridge.dv.tbclasses.bridge1x2_rd_axi5n_tb import Bridge1x2RdAxi5nTB, AxiResponseError
...
async def cocotb_test_bridge_1x2_rd_axi5n_basic_connectivity(dut):
    """
...
async def cocotb_test_bridge_1x2_rd_axi5n_boundary_probe(dut):
    """
...
def test_bridge_1x2_rd_axi5n_basic_connectivity(request, test_level):
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x2_rd_axi5n_basic_connectivity",
        sim_build=sim_build,
...
@pytest.mark.parametrize("test_level", reg_level_grid())
def test_bridge_1x2_rd_axi5n_boundary_probe(request, test_level):
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x2_rd_axi5n_boundary_probe",
        sim_build=sim_build,
        waves=False,
        extra_args=extra_args,
        plus_args=waves['sim_args'],
