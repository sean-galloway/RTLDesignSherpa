...
from projects.components.bridge.dv.tbclasses.bridge1x3_rd_tb import Bridge1x3RdTB, AxiResponseError
...
async def cocotb_test_bridge_1x3_rd_basic_connectivity(dut):
    """
...
async def cocotb_test_bridge_1x3_rd_boundary_probe(dut):
    """
...
def test_bridge_1x3_rd_basic_connectivity(request, test_level):
    ...
    dut_name = "bridge_1x3_rd"

    # Get sources from filelist
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/bridge/rtl/filelists/bridge_1x3_rd.f'
    )
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x3_rd_basic_connectivity",
        sim_build=sim_build,
...
@pytest.mark.parametrize("test_level", reg_level_grid())
def test_bridge_1x3_rd_boundary_probe(request, test_level):
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x3_rd_boundary_probe",
        sim_build=sim_build,
        waves=False,
        extra_args=extra_args,
        plus_args=waves['sim_args'],
