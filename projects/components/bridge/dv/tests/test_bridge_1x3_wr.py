...
from projects.components.bridge.dv.tbclasses.bridge1x3_wr_tb import Bridge1x3WrTB, AxiResponseError
...
async def cocotb_test_bridge_1x3_wr_basic_connectivity(dut):
    """
    ...
    tb.log.info(f"Configuration: 1M x 3S, WR channels")
    tb.log.info("=" * 80)
...
def test_bridge_1x3_wr_basic_connectivity(request, test_level):
    ...
    dut_name = "bridge_1x3_wr"

    # Get sources from filelist
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/bridge/rtl/filelists/bridge_1x3_wr.f'
    )
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x3_wr_basic_connectivity",
        sim_build=sim_build,
...
@pytest.mark.parametrize("test_level", reg_level_grid())
def test_bridge_1x3_wr_boundary_probe(request, test_level):
