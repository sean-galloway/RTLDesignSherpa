...
from projects.components.bridge.dv.tbclasses.bridge1x4_rd_tb import Bridge1x4RdTB, AxiResponseError
...
async def cocotb_test_bridge_1x4_rd_boundary_probe(dut):
    """
...
def test_bridge_1x4_rd_basic_connectivity(request, test_level):
...
@pytest.mark.parametrize("test_level", reg_level_grid())
def test_bridge_1x4_rd_boundary_probe(request, test_level):
    ...
    run(
        ...
        toplevel=dut_name,
        module=module,
        testcase="cocotb_test_bridge_1x4_rd_boundary_probe",
        sim_build=sim_build,
        waves=False,
        extra_args=extra_args,
        plus_args=waves['sim_args'],
