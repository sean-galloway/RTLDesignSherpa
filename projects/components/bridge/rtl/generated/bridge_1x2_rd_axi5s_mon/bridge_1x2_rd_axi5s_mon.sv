// Bridge: bridge_1x2_rd_axi5s_mon
...
module bridge_1x2_rd_axi5s_mon
    import bridge_1x2_rd_axi5s_mon_pkg::*;
#(
   ...
   ,parameter bit USE_NO_MONITORS  = 1'b0
    ...
    // ================================================================
    bridge_1x2_rd_axi5s_mon_xbar u_xbar (
        .aclk(aclk),
        .aresetn(aresetn),
...
endmodule : bridge_1x2_rd_axi5s_mon
