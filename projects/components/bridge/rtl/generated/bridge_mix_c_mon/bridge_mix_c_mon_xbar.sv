...
#(
    ...
    output  logic [4:0]  cfg_regs_axi_awid,
    ...
    input  logic [4:0]  cfg_regs_axi_bid,
    ...
    output  logic [4:0]  cfg_regs_axi_arid,
    ...
    input  logic [4:0]  cfg_regs_axi_rid,
...
`ifndef SYNTHESIS
    ...
    always_ff @(posedge aclk) begin
        if (aresetn && $countones({((cfg_regs_axi_rid_bridge_id == 0) && cfg_regs_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 0) && apb_periph_axi_rid_valid)}) > 1) begin
            $error("%m: response mux for master cpu_axi4 (32b) has %0d slaves selected at once; ",
                   ...
                   $countones({((cfg_regs_axi_rid_bridge_id == 0) && cfg_regs_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 0) && apb_periph_axi_rid_valid)}));
        end
    end
...
`ifndef SYNTHESIS
    // synthesis translate_off
    always_ff @(posedge aclk) begin
        if (aresetn && $countones({((cfg_regs_axi_rid_bridge_id == 1) && cfg_regs_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 1) && apb_periph_axi_rid_valid)}) > 1) begin
            $error("%m: response mux for master host_axil (32b) has %0d slaves selected at once; ",
                   "the single-outstanding-target invariant is broken and the R payload is OR-merged",
                   $countones({((cfg_regs_axi_rid_bridge_id == 1) && cfg_regs_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 1) && apb_periph_axi_rid_valid)}));
        end
    end
    // synthesis translate_on
`endif
