...
module bridge_1x2_rd_lite_mon
    import bridge_1x2_rd_lite_mon_pkg::*;
#(
   ...
   ,parameter bit USE_NO_MONITORS  = 1'b0
    ...
    // ================================================================
    bridge_1x2_rd_lite_mon_xbar u_xbar (
        .aclk(aclk),
        .aresetn(aresetn),
...
endmodule : bridge_1x2_rd_lite_mon
