...
module dma0_master_adapter #(
    ...
    assign dma0_master_32b_wvalid  = fub_axi_wvalid && aw_path_active_32b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    assign dma0_master_32b_bready = fub_axi_bready;
    ...
    assign dma0_master_32b_rready = fub_axi_rready;
