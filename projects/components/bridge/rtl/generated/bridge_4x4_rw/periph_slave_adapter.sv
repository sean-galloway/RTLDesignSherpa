// Slave Adapter: periph_slave_adapter
// Generated by: SlaveAdapterGenerator
//
// Provides timing isolation and protocol conversion for slave: periph_slave
// Protocol: AXI4
...
#(
    ...
    input  logic [3:0]  xbar_periph_slave_axi_awid,
    input  logic [31:0]  xbar_periph_slave_axi_awaddr,
    input  logic [7:0]  xbar_periph_slave_axi_awlen,
    input  logic [2:0]  xbar_periph_slave_axi_awsize,
    input  logic [1:0]  xbar_periph_slave_axi_awburst,
    input  logic         xbar_periph_slave_axi_awlock,
    input  logic [3:0]  xbar_periph_slave_axi_awcache,
    input  logic [2:0]  xbar_periph_slave_axi_awprot,
    input  logic [3:0]  xbar_periph_slave_axi_awqos,
    input  logic [3:0]  xbar_periph_slave_axi_awregion,
    input  logic         xbar_periph_slave_axi_awuser,
    input  logic         xbar_periph_slave_axi_awvalid,
    output  logic         xbar_periph_slave_axi_awready,
    input  logic [31:0]  xbar_periph_slave_axi_wdata,
    input  logic [3:0]  xbar_periph_slave_axi_wstrb,
    input  logic         xbar_periph_slave_axi_wlast,
    input  logic         xbar_periph_slave_axi_wuser,
    input  logic         xbar_periph_slave_axi_wvalid,
    output  logic         xbar_periph_slave_axi_wready,
    output  logic [3:0]  xbar_periph_slave_axi_bid,
    output  logic [1:0]  xbar_periph_slave_axi_bresp,
    output  logic         xbar_periph_slave_axi_buser,
    output  logic         xbar_periph_slave_axi_bvalid,
    input  logic         xbar_periph_slave_axi_bready,
    input  logic [3:0]  xbar_periph_slave_axi_arid,
    input  logic [31:0]  xbar_periph_slave_axi_araddr,
    input  logic [7:0]  xbar_periph_slave_axi_arlen,
    input  logic [2:0]  xbar_periph_slave_axi_arsize,
    input  logic [1:0]  xbar_periph_slave_axi_arburst,
    input  logic         xbar_periph_slave_axi_arlock,
    input  logic [3:0]  xbar_periph_slave_axi_arcache,
    input  logic [2:0]  xbar_periph_slave_axi_arprot,
    input  logic [3:0]  xbar_periph_slave_axi_arqos,
    input  logic [3:0]  xbar_periph_slave_axi_arregion,
    input  logic         xbar_periph_slave_axi_aruser,
    input  logic         xbar_periph_slave_axi_arvalid,
    output  logic         xbar_periph_slave_axi_arready,
    output  logic [3:0]  xbar_periph_slave_axi_rid,
    output  logic [31:0]  xbar_periph_slave_axi_rdata,
    output  logic [1:0]  xbar_periph_slave_axi_rresp,
    output  logic         xbar_periph_slave_axi_rlast,
    output  logic         xbar_periph_slave_axi_ruser,
    output  logic         xbar_periph_slave_axi_rvalid,
    input  logic         xbar_periph_slave_axi_rready,
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            wr_ptr <= '0;
        end else if (xbar_periph_slave_axi_awvalid && xbar_periph_slave_axi_awready) begin
            wr_fifo[wr_ptr[$clog2(WR_FIFO_DEPTH)-1:0]] <= xbar_bridge_id_aw;
            wr_ptr <= wr_ptr + 1'b1;
        end
    )

    // Pop on B response (xbar_periph_slave_axi_bvalid && xbar_periph_slave_axi_bready)
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            rd_ptr <= '0;
        end else if (xbar_periph_slave_axi_bvalid && xbar_periph_slave_axi_bready) begin
            rd_ptr <= rd_ptr + 1'b1;
        end
    )
    ...
    assign xbar_periph_slave_axi_awready = w_sub_awready && !wr_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_periph_slave_axi_awvalid && xbar_periph_slave_axi_awready)
                wr_id_fifo[wr_ptr[$clog2(WR_FIFO_DEPTH)-1:0]] <= xbar_periph_slave_axi_awid;
            if (xbar_periph_slave_axi_bvalid && xbar_periph_slave_axi_bready) begin
                if (xbar_periph_slave_axi_bid !== wr_id_fifo[rd_ptr[$clog2(WR_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned B out of AW order -- ",
                           ...
                           "wrong master.", xbar_periph_slave_axi_bid,
...
`endif
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ar_ptr <= '0;
        end else if (xbar_periph_slave_axi_arvalid && xbar_periph_slave_axi_arready) begin
            rd_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_bridge_id_ar;
            ar_ptr <= ar_ptr + 1'b1;
        end
    )

    // Pop on R response (xbar_periph_slave_axi_rvalid && xbar_periph_slave_axi_rready && xbar_periph_slave_axi_rlast)
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            r_ptr <= '0;
        end else if (xbar_periph_slave_axi_rvalid && xbar_periph_slave_axi_rready && xbar_periph_slave_axi_rlast) begin
            r_ptr <= r_ptr + 1'b1;
        end
    )
    ...
    assign xbar_periph_slave_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_periph_slave_axi_arvalid && xbar_periph_slave_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_periph_slave_axi_arid;
            if (xbar_periph_slave_axi_rvalid && xbar_periph_slave_axi_rready && xbar_periph_slave_axi_rlast) begin
                if (xbar_periph_slave_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned R out of AR order -- ",
                           ...
                           "wrong master.", xbar_periph_slave_axi_rid,
...
`endif
    ...
    axi4_master_wr #(
        ...
        .fub_axi_awsize(xbar_periph_slave_axi_awsize),
        .fub_axi_awburst(xbar_periph_slave_axi_awburst),
        .fub_axi_awlock(xbar_periph_slave_axi_awlock),
        .fub_axi_awcache(xbar_periph_slave_axi_awcache),
        .fub_axi_awprot(xbar_periph_slave_axi_awprot),
        .fub_axi_awqos(xbar_periph_slave_axi_awqos),
        .fub_axi_awregion(xbar_periph_slave_axi_awregion),
        .fub_axi_awuser(xbar_periph_slave_axi_awuser),
        .fub_axi_awvalid(xbar_periph_slave_axi_awvalid && !wr_trk_full),
        ...
        .m_axi_awsize(periph_slave_axi_awsize),
        .m_axi_awburst(periph_slave_axi_awburst),
        .m_axi_awlock(periph_slave_axi_awlock),
        .m_axi_awcache(periph_slave_axi_awcache),
        .m_axi_awprot(periph_slave_axi_awprot),
        .m_axi_awqos(periph_slave_axi_awqos),
        .m_axi_awregion(periph_slave_axi_awregion),
    ...
    axi4_master_rd #(
        ...
        .fub_axi_arsize(xbar_periph_slave_axi_arsize),
        .fub_axi_arburst(xbar_periph_slave_axi_arburst),
        .fub_axi_arlock(xbar_periph_slave_axi_arlock),
        .fub_axi_arcache(xbar_periph_slave_axi_arcache),
        .fub_axi_arprot(xbar_periph_slave_axi_arprot),
        .fub_axi_arqos(xbar_periph_slave_axi_arqos),
        .fub_axi_arregion(xbar_periph_slave_axi_arregion),
        .fub_axi_aruser(xbar_periph_slave_axi_aruser),
        .fub_axi_arvalid(xbar_periph_slave_axi_arvalid && !rd_trk_full),
        ...
        .fub_axi_rlast(xbar_periph_slave_axi_rlast),
        .fub_axi_ruser(xbar_periph_slave_axi_ruser),
        ...
        .m_axi_arsize(periph_slave_axi_arsize),
        .m_axi_arburst(periph_slave_axi_arburst),
        .m_axi_arlock(periph_slave_axi_arlock),
        .m_axi_arcache(periph_slave_axi_arcache),
        .m_axi_arprot(periph_slave_axi_arprot),
        .m_axi_arqos(periph_slave_axi_arqos),
        .m_axi_arregion(periph_slave_axi_arregion),
        ...
        .m_axi_rlast(periph_slave_axi_rlast),
        .m_axi_ruser(periph_slave_axi_ruser),
...
endmodule : periph_slave_adapter
