...
module cpu_master_adapter #(
    ...
    assign cpu_master_64b_wvalid  = fub_axi_wvalid && aw_path_active_64b;
    ...
    axi4_dwidth_converter_wr #(
        ...
        .m_axi_awqos(cpu_master_128b_aw.qos),      // Tie to 0 in packet
        .m_axi_awregion(cpu_master_128b_aw.region), // Tie to 0 in packet
        .m_axi_awuser(cpu_master_128b_aw.user),     // Tie to 0 in packet
        ...
        .m_axi_wuser(cpu_master_128b_w.user),       // Tie to 0 in packet
        ...
        .m_axi_buser(cpu_master_128b_b.user),       // From packet (ignored)
    ...
    axi4_dwidth_converter_rd #(
        ...
        .m_axi_arqos(cpu_master_128b_ar.qos),      // Tie to 0 in packet
        .m_axi_arregion(cpu_master_128b_ar.region), // Tie to 0 in packet
        .m_axi_aruser(cpu_master_128b_ar.user),     // Tie to 0 in packet
        ...
        .m_axi_ruser(cpu_master_128b_r.user),       // From packet (ignored)
