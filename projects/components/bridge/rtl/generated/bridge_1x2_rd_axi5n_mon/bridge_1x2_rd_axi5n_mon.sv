// Bridge: bridge_1x2_rd_axi5n_mon
...
module bridge_1x2_rd_axi5n_mon
...
#(
   ...
   ,parameter bit USE_NO_MONITORS  = 1'b0
    ...
    output  logic [3:0]  sram_rd_axi_arnsaid,
    ...
    input  logic [3:0] cfg_cpu_rd_0_rd_freq_sel,
    ...
    input  logic [3:0] cfg_ddr_rd_0_rd_freq_sel,
    ...
    input  logic [3:0] cfg_sram_rd_1_rd_freq_sel,
    ...
    // sram_rd (AXI5, 32b AXI4 interface)
    ...
    logic [3:0]               xbar_sram_rd_axi_arnsaid;  // AXI5 sideband (nsaid)
    ...
    cpu_rd_adapter #(
        ...
        .cpu_rd_axi_arnsaid(cpu_rd_axi_arnsaid),
    ...
    // ================================================================
    bridge_1x2_rd_axi5n_mon_xbar u_xbar (
        .aclk(aclk),
        .aresetn(aresetn),
        ...
        .sram_rd_axi_arnsaid(xbar_sram_rd_axi_arnsaid),
    ...
    // sram_rd adapter (AXI5, crossbar → external slave)
    sram_rd_adapter #(
        ...
        .xbar_sram_rd_axi_arnsaid(xbar_sram_rd_axi_arnsaid),
        ...
        .sram_rd_axi_arnsaid(sram_rd_axi_arnsaid),
        .sram_rd_axi_artrace(sram_rd_axi_artrace),
        .sram_rd_axi_arunique(sram_rd_axi_arunique),
        ...
        .sram_rd_axi_rtrace(sram_rd_axi_rtrace),
...
endmodule : bridge_1x2_rd_axi5n_mon
