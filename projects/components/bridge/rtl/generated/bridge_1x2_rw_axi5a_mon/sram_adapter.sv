...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    input  logic [5:0]  xbar_sram_axi_awatop,
    ...
    assign aw_rr_blocked = xbar_sram_axi_awatop[5] && atom_full;
    assign xbar_sram_axi_awready = w_sub_awready && !wr_trk_full && !aw_rr_blocked;
...
`endif
    ...
    // Pop on R response (xbar_sram_axi_rvalid && xbar_sram_axi_rready && xbar_sram_axi_rlast && !atom_hit)
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            r_ptr <= '0;
        end else if (xbar_sram_axi_rvalid && xbar_sram_axi_rready && xbar_sram_axi_rlast && !atom_hit) begin
            r_ptr <= r_ptr + 1'b1;
        end
    )
    ...
    axi5_atomic_rr_tracker #(
        ...
        .aclk(aclk),
        .aresetn(aresetn),
        .alloc(xbar_sram_axi_awvalid && xbar_sram_axi_awready && xbar_sram_axi_awatop[5]),
        .alloc_id(xbar_sram_axi_awid),
        .alloc_data(xbar_bridge_id_aw),
        .full(atom_full),
        .lookup_id(xbar_sram_axi_rid),
        .hit(atom_hit),
        .hit_data(atom_bridge_id),
        .release_beat(xbar_sram_axi_rvalid && xbar_sram_axi_rready && xbar_sram_axi_rlast)
    );
...
`endif
    ...
    axi5_master_wr_mon #(
        ...
        .fub_axi_awvalid(xbar_sram_axi_awvalid && !wr_trk_full && !aw_rr_blocked),
        .fub_axi_awready(w_sub_awready),
        .fub_axi_awatop(xbar_sram_axi_awatop),
        .fub_axi_awnsaid('0),
        .fub_axi_awtrace('0),
        .fub_axi_awmpam('0),
        .fub_axi_awmecid('0),
