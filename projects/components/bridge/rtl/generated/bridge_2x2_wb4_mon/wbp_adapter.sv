// Slave Adapter: wbp_adapter
// Generated by: SlaveAdapterGenerator
//
// Provides timing isolation and protocol conversion for slave: wbp
// Protocol: WB4
...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    input  logic [4:0]  xbar_wbp_axi_awid,
    input  logic [31:0]  xbar_wbp_axi_awaddr,
    input  logic [7:0]  xbar_wbp_axi_awlen,
    input  logic [2:0]  xbar_wbp_axi_awsize,
    input  logic [1:0]  xbar_wbp_axi_awburst,
    input  logic         xbar_wbp_axi_awlock,
    input  logic [3:0]  xbar_wbp_axi_awcache,
    input  logic [2:0]  xbar_wbp_axi_awprot,
    input  logic [3:0]  xbar_wbp_axi_awqos,
    input  logic [3:0]  xbar_wbp_axi_awregion,
    input  logic         xbar_wbp_axi_awuser,
    input  logic         xbar_wbp_axi_awvalid,
    output  logic         xbar_wbp_axi_awready,
    input  logic [31:0]  xbar_wbp_axi_wdata,
    input  logic [3:0]  xbar_wbp_axi_wstrb,
    input  logic         xbar_wbp_axi_wlast,
    input  logic         xbar_wbp_axi_wuser,
    input  logic         xbar_wbp_axi_wvalid,
    output  logic         xbar_wbp_axi_wready,
    output  logic [4:0]  xbar_wbp_axi_bid,
    output  logic [1:0]  xbar_wbp_axi_bresp,
    output  logic         xbar_wbp_axi_buser,
    output  logic         xbar_wbp_axi_bvalid,
    input  logic         xbar_wbp_axi_bready,
    input  logic [4:0]  xbar_wbp_axi_arid,
    input  logic [31:0]  xbar_wbp_axi_araddr,
    input  logic [7:0]  xbar_wbp_axi_arlen,
    input  logic [2:0]  xbar_wbp_axi_arsize,
    input  logic [1:0]  xbar_wbp_axi_arburst,
    input  logic         xbar_wbp_axi_arlock,
    input  logic [3:0]  xbar_wbp_axi_arcache,
    input  logic [2:0]  xbar_wbp_axi_arprot,
    input  logic [3:0]  xbar_wbp_axi_arqos,
    input  logic [3:0]  xbar_wbp_axi_arregion,
    input  logic         xbar_wbp_axi_aruser,
    input  logic         xbar_wbp_axi_arvalid,
    output  logic         xbar_wbp_axi_arready,
    output  logic [4:0]  xbar_wbp_axi_rid,
    output  logic [31:0]  xbar_wbp_axi_rdata,
    output  logic [1:0]  xbar_wbp_axi_rresp,
    output  logic         xbar_wbp_axi_rlast,
    output  logic         xbar_wbp_axi_ruser,
    output  logic         xbar_wbp_axi_rvalid,
    input  logic         xbar_wbp_axi_rready,
    ...
    // Write Channel FIFO (In-Order) - WB4 Protocol
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            wr_ptr <= '0;
        end else if (xbar_wbp_axi_awvalid && xbar_wbp_axi_awready) begin
    ...
    assign xbar_wbp_axi_awready = w_sub_awready && !wr_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_wbp_axi_awvalid && xbar_wbp_axi_awready)
                wr_id_fifo[wr_ptr[$clog2(WR_FIFO_DEPTH)-1:0]] <= xbar_wbp_axi_awid;
            if (xbar_wbp_axi_bvalid && xbar_wbp_axi_bready) begin
                if (xbar_wbp_axi_bid !== wr_id_fifo[rd_ptr[$clog2(WR_FIFO_DEPTH)-1:0]]) begin
...
`endif
    ...
    // Read Channel FIFO (In-Order) - WB4 Protocol
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ar_ptr <= '0;
        end else if (xbar_wbp_axi_arvalid && xbar_wbp_axi_arready) begin
    ...
    assign xbar_wbp_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_wbp_axi_arvalid && xbar_wbp_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_wbp_axi_arid;
            if (xbar_wbp_axi_rvalid && xbar_wbp_axi_rready && xbar_wbp_axi_rlast) begin
                if (xbar_wbp_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
...
`endif
    ...
    // ============================================================
    // axi4_master_*_mon wrapper(s) between crossbar and WB4 shim
    // ============================================================
    logic [4:0] wbp_mon_axi_awid;
    logic [31:0] wbp_mon_axi_awaddr;
    logic [7:0]  wbp_mon_axi_awlen;
    logic [2:0]  wbp_mon_axi_awsize;
    logic [1:0]  wbp_mon_axi_awburst;
    logic        wbp_mon_axi_awlock;
    logic [3:0]  wbp_mon_axi_awcache;
    logic [2:0]  wbp_mon_axi_awprot;
    logic [3:0]  wbp_mon_axi_awqos;
    logic [3:0]  wbp_mon_axi_awregion;
    logic        wbp_mon_axi_awuser;
    logic        wbp_mon_axi_awvalid;
    logic        wbp_mon_axi_awready;
    logic [31:0] wbp_mon_axi_wdata;
    logic [3:0] wbp_mon_axi_wstrb;
    logic        wbp_mon_axi_wlast;
    logic        wbp_mon_axi_wuser;
    logic        wbp_mon_axi_wvalid;
    logic        wbp_mon_axi_wready;
    logic [4:0] wbp_mon_axi_bid;
    logic [1:0]  wbp_mon_axi_bresp;
    logic        wbp_mon_axi_buser;
    logic        wbp_mon_axi_bvalid;
    logic        wbp_mon_axi_bready;
    logic [4:0] wbp_mon_axi_arid;
    logic [31:0] wbp_mon_axi_araddr;
    logic [7:0]  wbp_mon_axi_arlen;
    logic [2:0]  wbp_mon_axi_arsize;
    logic [1:0]  wbp_mon_axi_arburst;
    logic        wbp_mon_axi_arlock;
    logic [3:0]  wbp_mon_axi_arcache;
    logic [2:0]  wbp_mon_axi_arprot;
    logic [3:0]  wbp_mon_axi_arqos;
    logic [3:0]  wbp_mon_axi_arregion;
    logic        wbp_mon_axi_aruser;
    logic        wbp_mon_axi_arvalid;
    logic        wbp_mon_axi_arready;
    logic [4:0] wbp_mon_axi_rid;
    logic [31:0] wbp_mon_axi_rdata;
    logic [1:0]  wbp_mon_axi_rresp;
    logic        wbp_mon_axi_rlast;
    logic        wbp_mon_axi_ruser;
    logic        wbp_mon_axi_rvalid;
    logic        wbp_mon_axi_rready;
    ...
    axi4_master_wr_mon #(
        ...
        .fub_axi_awid(xbar_wbp_axi_awid),
        .fub_axi_awaddr(xbar_wbp_axi_awaddr),
        .fub_axi_awlen(xbar_wbp_axi_awlen),
        .fub_axi_awsize(xbar_wbp_axi_awsize),
        .fub_axi_awburst(xbar_wbp_axi_awburst),
        .fub_axi_awlock(xbar_wbp_axi_awlock),
        .fub_axi_awcache(xbar_wbp_axi_awcache),
        .fub_axi_awprot(xbar_wbp_axi_awprot),
        .fub_axi_awqos(xbar_wbp_axi_awqos),
        .fub_axi_awregion(xbar_wbp_axi_awregion),
        .fub_axi_awuser(xbar_wbp_axi_awuser),
        .fub_axi_awvalid(xbar_wbp_axi_awvalid && !wr_trk_full),
        .fub_axi_awready(w_sub_awready),
        .fub_axi_wdata(xbar_wbp_axi_wdata),
        .fub_axi_wstrb(xbar_wbp_axi_wstrb),
        .fub_axi_wlast(xbar_wbp_axi_wlast),
        .fub_axi_wuser(xbar_wbp_axi_wuser),
        .fub_axi_wvalid(xbar_wbp_axi_wvalid),
        .fub_axi_wready(xbar_wbp_axi_wready),
        .fub_axi_bid(xbar_wbp_axi_bid),
        .fub_axi_bresp(xbar_wbp_axi_bresp),
        .fub_axi_buser(xbar_wbp_axi_buser),
        .fub_axi_bvalid(xbar_wbp_axi_bvalid),
        .fub_axi_bready(xbar_wbp_axi_bready),

        // External side (m_axi)
        .m_axi_awid(wbp_mon_axi_awid),
        .m_axi_awaddr(wbp_mon_axi_awaddr),
        .m_axi_awlen(wbp_mon_axi_awlen),
        .m_axi_awsize(wbp_mon_axi_awsize),
        .m_axi_awburst(wbp_mon_axi_awburst),
        .m_axi_awlock(wbp_mon_axi_awlock),
        .m_axi_awcache(wbp_mon_axi_awcache),
        .m_axi_awprot(wbp_mon_axi_awprot),
        .m_axi_awqos(wbp_mon_axi_awqos),
        .m_axi_awregion(wbp_mon_axi_awregion),
        .m_axi_awuser(wbp_mon_axi_awuser),
        .m_axi_awvalid(wbp_mon_axi_awvalid),
        .m_axi_awready(wbp_mon_axi_awready),
        .m_axi_wdata(wbp_mon_axi_wdata),
        .m_axi_wstrb(wbp_mon_axi_wstrb),
        .m_axi_wlast(wbp_mon_axi_wlast),
        .m_axi_wuser(wbp_mon_axi_wuser),
        .m_axi_wvalid(wbp_mon_axi_wvalid),
        .m_axi_wready(wbp_mon_axi_wready),
        .m_axi_bid(wbp_mon_axi_bid),
        .m_axi_bresp(wbp_mon_axi_bresp),
        .m_axi_buser(wbp_mon_axi_buser),
        .m_axi_bvalid(wbp_mon_axi_bvalid),
        .m_axi_bready(wbp_mon_axi_bready),
    ...
    axi4_master_rd_mon #(
        ...
        // Bridge-internal side (fub_axi)
        .fub_axi_arid(xbar_wbp_axi_arid),
        .fub_axi_araddr(xbar_wbp_axi_araddr),
        .fub_axi_arlen(xbar_wbp_axi_arlen),
        .fub_axi_arsize(xbar_wbp_axi_arsize),
        .fub_axi_arburst(xbar_wbp_axi_arburst),
        .fub_axi_arlock(xbar_wbp_axi_arlock),
        .fub_axi_arcache(xbar_wbp_axi_arcache),
        .fub_axi_arprot(xbar_wbp_axi_arprot),
        .fub_axi_arqos(xbar_wbp_axi_arqos),
        .fub_axi_arregion(xbar_wbp_axi_arregion),
        .fub_axi_aruser(xbar_wbp_axi_aruser),
        .fub_axi_arvalid(xbar_wbp_axi_arvalid && !rd_trk_full),
        .fub_axi_arready(w_sub_arready),
        .fub_axi_rid(xbar_wbp_axi_rid),
        .fub_axi_rdata(xbar_wbp_axi_rdata),
        .fub_axi_rresp(xbar_wbp_axi_rresp),
        .fub_axi_rlast(xbar_wbp_axi_rlast),
        .fub_axi_ruser(xbar_wbp_axi_ruser),
        .fub_axi_rvalid(xbar_wbp_axi_rvalid),
        .fub_axi_rready(xbar_wbp_axi_rready),

        // External side (m_axi)
        .m_axi_arid(wbp_mon_axi_arid),
        .m_axi_araddr(wbp_mon_axi_araddr),
        .m_axi_arlen(wbp_mon_axi_arlen),
        .m_axi_arsize(wbp_mon_axi_arsize),
        .m_axi_arburst(wbp_mon_axi_arburst),
        .m_axi_arlock(wbp_mon_axi_arlock),
        .m_axi_arcache(wbp_mon_axi_arcache),
        .m_axi_arprot(wbp_mon_axi_arprot),
        .m_axi_arqos(wbp_mon_axi_arqos),
        .m_axi_arregion(wbp_mon_axi_arregion),
        .m_axi_aruser(wbp_mon_axi_aruser),
        .m_axi_arvalid(wbp_mon_axi_arvalid),
        .m_axi_arready(wbp_mon_axi_arready),
        .m_axi_rid(wbp_mon_axi_rid),
        .m_axi_rdata(wbp_mon_axi_rdata),
        .m_axi_rresp(wbp_mon_axi_rresp),
        .m_axi_rlast(wbp_mon_axi_rlast),
        .m_axi_ruser(wbp_mon_axi_ruser),
        .m_axi_rvalid(wbp_mon_axi_rvalid),
        .m_axi_rready(wbp_mon_axi_rready),
    ...
    // AXI4-to-Wishbone B4 converter shim
    axi4_to_wb4 #(
        .AXI_ID_WIDTH(5),
        .AXI_ADDR_WIDTH(32),
        .AXI_DATA_WIDTH(32),
        ...
        .s_axi_awid(wbp_mon_axi_awid),
        .s_axi_awaddr(wbp_mon_axi_awaddr),
        .s_axi_awlen(wbp_mon_axi_awlen),
        .s_axi_awsize(wbp_mon_axi_awsize),
        .s_axi_awburst(wbp_mon_axi_awburst),
        .s_axi_awlock(wbp_mon_axi_awlock),
        .s_axi_awcache(wbp_mon_axi_awcache),
        .s_axi_awprot(wbp_mon_axi_awprot),
        .s_axi_awqos(wbp_mon_axi_awqos),
        .s_axi_awregion(wbp_mon_axi_awregion),
        .s_axi_awuser(wbp_mon_axi_awuser),
        .s_axi_awvalid(wbp_mon_axi_awvalid),
        .s_axi_awready(wbp_mon_axi_awready),
        .s_axi_wdata(wbp_mon_axi_wdata),
        .s_axi_wstrb(wbp_mon_axi_wstrb),
        .s_axi_wlast(wbp_mon_axi_wlast),
        .s_axi_wuser(wbp_mon_axi_wuser),
        .s_axi_wvalid(wbp_mon_axi_wvalid),
        .s_axi_wready(wbp_mon_axi_wready),
        .s_axi_bid(wbp_mon_axi_bid),
        .s_axi_bresp(wbp_mon_axi_bresp),
        .s_axi_buser(wbp_mon_axi_buser),
        .s_axi_bvalid(converter_bvalid),
        .s_axi_bready(converter_bready),

        // AXI4 read channels (from crossbar)
        .s_axi_arid(wbp_mon_axi_arid),
        .s_axi_araddr(wbp_mon_axi_araddr),
        .s_axi_arlen(wbp_mon_axi_arlen),
        .s_axi_arsize(wbp_mon_axi_arsize),
        .s_axi_arburst(wbp_mon_axi_arburst),
        .s_axi_arlock(wbp_mon_axi_arlock),
        .s_axi_arcache(wbp_mon_axi_arcache),
        .s_axi_arprot(wbp_mon_axi_arprot),
        .s_axi_arqos(wbp_mon_axi_arqos),
        .s_axi_arregion(wbp_mon_axi_arregion),
        .s_axi_aruser(wbp_mon_axi_aruser),
        .s_axi_arvalid(wbp_mon_axi_arvalid),
        .s_axi_arready(wbp_mon_axi_arready),
        .s_axi_rid(wbp_mon_axi_rid),
        .s_axi_rdata(wbp_mon_axi_rdata),
        .s_axi_rresp(wbp_mon_axi_rresp),
        .s_axi_rlast(converter_rlast),
        .s_axi_ruser(wbp_mon_axi_ruser),
        .s_axi_rvalid(converter_rvalid),
        .s_axi_rready(converter_rready),

        // Wishbone B4 requester interface (to external completer)
        .m_wb_CYC(wbp_wb_CYC),
        .m_wb_STB(wbp_wb_STB),
        .m_wb_WE(wbp_wb_WE),
        .m_wb_ADR(wbp_wb_ADR),
        .m_wb_DAT_W(wbp_wb_DAT_W),
        .m_wb_SEL(wbp_wb_SEL),
        .m_wb_CTI(wbp_wb_CTI),
        .m_wb_BTE(wbp_wb_BTE),
        .m_wb_STALL(wbp_wb_STALL),
        .m_wb_ACK(wbp_wb_ACK),
        .m_wb_ERR(wbp_wb_ERR),
        .m_wb_RTY(wbp_wb_RTY),
        .m_wb_DAT_R(wbp_wb_DAT_R)
    );

    // Wire converter outputs back to shim's crossbar-facing interface
    assign wbp_mon_axi_bvalid = converter_bvalid;
    assign converter_bready = wbp_mon_axi_bready;
    assign wbp_mon_axi_rvalid = converter_rvalid;
    assign converter_rready = wbp_mon_axi_rready;
    assign wbp_mon_axi_rlast = converter_rlast;

endmodule : wbp_adapter
