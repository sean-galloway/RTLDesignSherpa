...
(
    ...
    // cfg (AXIL5, 32b AXI4 interface)
    logic [3:0]            xbar_cfg_axi_awid;
    logic [31:0]               xbar_cfg_axi_awaddr;
    logic [7:0]                xbar_cfg_axi_awlen;
    logic [2:0]                xbar_cfg_axi_awsize;
    logic [1:0]                xbar_cfg_axi_awburst;
    logic                      xbar_cfg_axi_awlock;
    logic [3:0]                xbar_cfg_axi_awcache;
    logic [2:0]                xbar_cfg_axi_awprot;
    logic [3:0]                xbar_cfg_axi_awqos;
    logic [3:0]                xbar_cfg_axi_awregion;
    logic                      xbar_cfg_axi_awuser;
    logic                      xbar_cfg_axi_awvalid;
    logic                      xbar_cfg_axi_awready;
    logic [31:0] xbar_cfg_axi_wdata;
    logic [3:0] xbar_cfg_axi_wstrb;
    logic                      xbar_cfg_axi_wlast;
    logic                      xbar_cfg_axi_wuser;
    logic                      xbar_cfg_axi_wvalid;
    logic                      xbar_cfg_axi_wready;
    logic [3:0]            xbar_cfg_axi_bid;
    logic [1:0]                xbar_cfg_axi_bresp;
    logic                      xbar_cfg_axi_buser;
    logic                      xbar_cfg_axi_bvalid;
    logic                      xbar_cfg_axi_bready;
    logic [3:0]            xbar_cfg_axi_arid;
    logic [31:0]               xbar_cfg_axi_araddr;
    logic [7:0]                xbar_cfg_axi_arlen;
    logic [2:0]                xbar_cfg_axi_arsize;
    logic [1:0]                xbar_cfg_axi_arburst;
    logic                      xbar_cfg_axi_arlock;
    logic [3:0]                xbar_cfg_axi_arcache;
    logic [2:0]                xbar_cfg_axi_arprot;
    logic [3:0]                xbar_cfg_axi_arqos;
    logic [3:0]                xbar_cfg_axi_arregion;
    logic                      xbar_cfg_axi_aruser;
    logic                      xbar_cfg_axi_arvalid;
    logic                      xbar_cfg_axi_arready;
    logic [3:0]            xbar_cfg_axi_rid;
    logic [31:0] xbar_cfg_axi_rdata;
    logic [1:0]                xbar_cfg_axi_rresp;
    logic                      xbar_cfg_axi_rlast;
    logic                      xbar_cfg_axi_ruser;
    logic                      xbar_cfg_axi_rvalid;
    logic                      xbar_cfg_axi_rready;
    logic [BRIDGE_ID_WIDTH-1:0] cfg_axi_bridge_id_aw;
    logic [BRIDGE_ID_WIDTH-1:0] cfg_axi_bid_bridge_id;
    logic                       cfg_axi_bid_valid;
    logic [BRIDGE_ID_WIDTH-1:0] cfg_axi_bridge_id_ar;
    logic [BRIDGE_ID_WIDTH-1:0] cfg_axi_rid_bridge_id;
    logic                       cfg_axi_rid_valid;
    ...
    // ================================================================
    bridge_1x2_rw_axil5_xbar u_xbar (
        .aclk(aclk),
        .aresetn(aresetn),
        ...
        // Slave 1: cfg
        .cfg_axi_awid(xbar_cfg_axi_awid),
        .cfg_axi_awaddr(xbar_cfg_axi_awaddr),
        .cfg_axi_awlen(xbar_cfg_axi_awlen),
        .cfg_axi_awsize(xbar_cfg_axi_awsize),
        .cfg_axi_awburst(xbar_cfg_axi_awburst),
        .cfg_axi_awlock(xbar_cfg_axi_awlock),
        .cfg_axi_awcache(xbar_cfg_axi_awcache),
        .cfg_axi_awprot(xbar_cfg_axi_awprot),
        .cfg_axi_awqos(xbar_cfg_axi_awqos),
        .cfg_axi_awregion(xbar_cfg_axi_awregion),
        .cfg_axi_awuser(xbar_cfg_axi_awuser),
        .cfg_axi_awvalid(xbar_cfg_axi_awvalid),
        .cfg_axi_awready(xbar_cfg_axi_awready),
        .cfg_axi_wdata(xbar_cfg_axi_wdata),
        .cfg_axi_wstrb(xbar_cfg_axi_wstrb),
        .cfg_axi_wlast(xbar_cfg_axi_wlast),
        .cfg_axi_wuser(xbar_cfg_axi_wuser),
        .cfg_axi_wvalid(xbar_cfg_axi_wvalid),
        .cfg_axi_wready(xbar_cfg_axi_wready),
        .cfg_axi_bid(xbar_cfg_axi_bid),
        .cfg_axi_bresp(xbar_cfg_axi_bresp),
        .cfg_axi_buser(xbar_cfg_axi_buser),
        .cfg_axi_bvalid(xbar_cfg_axi_bvalid),
        .cfg_axi_bready(xbar_cfg_axi_bready),
        .cfg_axi_arid(xbar_cfg_axi_arid),
        .cfg_axi_araddr(xbar_cfg_axi_araddr),
        .cfg_axi_arlen(xbar_cfg_axi_arlen),
        .cfg_axi_arsize(xbar_cfg_axi_arsize),
        .cfg_axi_arburst(xbar_cfg_axi_arburst),
        .cfg_axi_arlock(xbar_cfg_axi_arlock),
        .cfg_axi_arcache(xbar_cfg_axi_arcache),
        .cfg_axi_arprot(xbar_cfg_axi_arprot),
        .cfg_axi_arqos(xbar_cfg_axi_arqos),
        .cfg_axi_arregion(xbar_cfg_axi_arregion),
        .cfg_axi_aruser(xbar_cfg_axi_aruser),
        .cfg_axi_arvalid(xbar_cfg_axi_arvalid),
        .cfg_axi_arready(xbar_cfg_axi_arready),
        .cfg_axi_rid(xbar_cfg_axi_rid),
        .cfg_axi_rdata(xbar_cfg_axi_rdata),
        .cfg_axi_rresp(xbar_cfg_axi_rresp),
        .cfg_axi_rlast(xbar_cfg_axi_rlast),
        .cfg_axi_ruser(xbar_cfg_axi_ruser),
        .cfg_axi_rvalid(xbar_cfg_axi_rvalid),
        .cfg_axi_rready(xbar_cfg_axi_rready),
        .cfg_axi_bridge_id_aw(cfg_axi_bridge_id_aw),
        .cfg_axi_bid_bridge_id(cfg_axi_bid_bridge_id),
        .cfg_axi_bid_valid(cfg_axi_bid_valid),

        .cfg_axi_bridge_id_ar(cfg_axi_bridge_id_ar),
        .cfg_axi_rid_bridge_id(cfg_axi_rid_bridge_id),
        .cfg_axi_rid_valid(cfg_axi_rid_valid),
    ...
    // cfg adapter (AXIL5, crossbar → external slave)
    cfg_adapter u_cfg_adapter (
        .aclk(aclk),
        .aresetn(aresetn),

        // Crossbar interface (xbar_cfg_axi_*)
        .xbar_cfg_axi_awid(xbar_cfg_axi_awid),
        .xbar_cfg_axi_awaddr(xbar_cfg_axi_awaddr),
        .xbar_cfg_axi_awlen(xbar_cfg_axi_awlen),
        .xbar_cfg_axi_awsize(xbar_cfg_axi_awsize),
        .xbar_cfg_axi_awburst(xbar_cfg_axi_awburst),
        .xbar_cfg_axi_awlock(xbar_cfg_axi_awlock),
        .xbar_cfg_axi_awcache(xbar_cfg_axi_awcache),
        .xbar_cfg_axi_awprot(xbar_cfg_axi_awprot),
        .xbar_cfg_axi_awqos(xbar_cfg_axi_awqos),
        .xbar_cfg_axi_awregion(xbar_cfg_axi_awregion),
        .xbar_cfg_axi_awuser(xbar_cfg_axi_awuser),
        .xbar_cfg_axi_awvalid(xbar_cfg_axi_awvalid),
        .xbar_cfg_axi_awready(xbar_cfg_axi_awready),
        .xbar_cfg_axi_wdata(xbar_cfg_axi_wdata),
        .xbar_cfg_axi_wstrb(xbar_cfg_axi_wstrb),
        .xbar_cfg_axi_wlast(xbar_cfg_axi_wlast),
        .xbar_cfg_axi_wuser(xbar_cfg_axi_wuser),
        .xbar_cfg_axi_wvalid(xbar_cfg_axi_wvalid),
        .xbar_cfg_axi_wready(xbar_cfg_axi_wready),
        .xbar_cfg_axi_bid(xbar_cfg_axi_bid),
        .xbar_cfg_axi_bresp(xbar_cfg_axi_bresp),
        .xbar_cfg_axi_buser(xbar_cfg_axi_buser),
        .xbar_cfg_axi_bvalid(xbar_cfg_axi_bvalid),
        .xbar_cfg_axi_bready(xbar_cfg_axi_bready),
        .xbar_cfg_axi_arid(xbar_cfg_axi_arid),
        .xbar_cfg_axi_araddr(xbar_cfg_axi_araddr),
        .xbar_cfg_axi_arlen(xbar_cfg_axi_arlen),
        .xbar_cfg_axi_arsize(xbar_cfg_axi_arsize),
        .xbar_cfg_axi_arburst(xbar_cfg_axi_arburst),
        .xbar_cfg_axi_arlock(xbar_cfg_axi_arlock),
        .xbar_cfg_axi_arcache(xbar_cfg_axi_arcache),
        .xbar_cfg_axi_arprot(xbar_cfg_axi_arprot),
        .xbar_cfg_axi_arqos(xbar_cfg_axi_arqos),
        .xbar_cfg_axi_arregion(xbar_cfg_axi_arregion),
        .xbar_cfg_axi_aruser(xbar_cfg_axi_aruser),
        .xbar_cfg_axi_arvalid(xbar_cfg_axi_arvalid),
        .xbar_cfg_axi_arready(xbar_cfg_axi_arready),
        .xbar_cfg_axi_rid(xbar_cfg_axi_rid),
        .xbar_cfg_axi_rdata(xbar_cfg_axi_rdata),
        .xbar_cfg_axi_rresp(xbar_cfg_axi_rresp),
        .xbar_cfg_axi_rlast(xbar_cfg_axi_rlast),
        .xbar_cfg_axi_ruser(xbar_cfg_axi_ruser),
        .xbar_cfg_axi_rvalid(xbar_cfg_axi_rvalid),
        .xbar_cfg_axi_rready(xbar_cfg_axi_rready),

        // External AXI5-Lite interface (cfg_axil_*)
        ...
        .cfg_axil_araddr(cfg_axil_araddr),
        .cfg_axil_arprot(cfg_axil_arprot),
        .cfg_axil_arvalid(cfg_axil_arvalid),
        .cfg_axil_arready(cfg_axil_arready),
        .cfg_axil_rdata(cfg_axil_rdata),
        .cfg_axil_rresp(cfg_axil_rresp),
        .cfg_axil_rvalid(cfg_axil_rvalid),
        .cfg_axil_rready(cfg_axil_rready),
        .cfg_axil_awlock(cfg_axil_awlock),
        .cfg_axil_awuser(cfg_axil_awuser),
        .cfg_axil_awloop(cfg_axil_awloop),
        .cfg_axil_awmpam(cfg_axil_awmpam),
        .cfg_axil_awmecid(cfg_axil_awmecid),
        .cfg_axil_awnsaid(cfg_axil_awnsaid),
        .cfg_axil_awtrace(cfg_axil_awtrace),
        .cfg_axil_wuser(cfg_axil_wuser),
        .cfg_axil_wpoison(cfg_axil_wpoison),
        .cfg_axil_buser(cfg_axil_buser),
        .cfg_axil_bloop(cfg_axil_bloop),
        .cfg_axil_btrace(cfg_axil_btrace),
        .cfg_axil_arlock(cfg_axil_arlock),
        .cfg_axil_aruser(cfg_axil_aruser),
        .cfg_axil_arloop(cfg_axil_arloop),
        .cfg_axil_armpam(cfg_axil_armpam),
        .cfg_axil_armecid(cfg_axil_armecid),
        .cfg_axil_arnsaid(cfg_axil_arnsaid),
        .cfg_axil_artrace(cfg_axil_artrace),
        .cfg_axil_ruser(cfg_axil_ruser),
        .cfg_axil_rloop(cfg_axil_rloop),
        .cfg_axil_rtrace(cfg_axil_rtrace),
        .cfg_axil_rpoison(cfg_axil_rpoison),

        // Bridge ID tracking
        .xbar_bridge_id_aw(cfg_axi_bridge_id_aw),
        .bid_bridge_id(cfg_axi_bid_bridge_id),
        .bid_valid(cfg_axi_bid_valid),
        .xbar_bridge_id_ar(cfg_axi_bridge_id_ar),
        .rid_bridge_id(cfg_axi_rid_bridge_id),
        .rid_valid(cfg_axi_rid_valid)
    );
