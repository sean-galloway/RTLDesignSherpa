// APB4M Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for apb4m master
...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    // External AXI interface (from apb4m master)
    ...
    output axi4_aw_t     apb4m_32b_aw,
    output logic         apb4m_32b_awvalid,
    input  logic         apb4m_32b_awready,

    output axi4_w_32b_t  apb4m_32b_w,
    output logic         apb4m_32b_wvalid,
    input  logic         apb4m_32b_wready,

    input  axi4_b_t      apb4m_32b_b,
    input  logic         apb4m_32b_bvalid,
    output logic         apb4m_32b_bready,

    output axi4_ar_t     apb4m_32b_ar,
    output logic         apb4m_32b_arvalid,
    input  logic         apb4m_32b_arready,

    input  axi4_r_32b_t  apb4m_32b_r,
    input  logic         apb4m_32b_rvalid,
    output logic         apb4m_32b_rready,
    ...
    // ================================================================
    // APB requester front end (apb4_to_axi4): APB completer -> AXI4
    ...
    apb4_to_axi4 #(
        ...
        .aclk(aclk),
        .aresetn(aresetn),
        .s_apb_PSEL(apb4m_apb_PSEL),
        .s_apb_PENABLE(apb4m_apb_PENABLE),
        .s_apb_PREADY(apb4m_apb_PREADY),
        .s_apb_PADDR(apb4m_apb_PADDR),
        .s_apb_PWRITE(apb4m_apb_PWRITE),
        .s_apb_PWDATA(apb4m_apb_PWDATA),
        .s_apb_PSTRB(apb4m_apb_PSTRB),
        .s_apb_PPROT(apb4m_apb_PPROT),
        .s_apb_PRDATA(apb4m_apb_PRDATA),
        .s_apb_PSLVERR(apb4m_apb_PSLVERR),
    ...
    // Requests: fub_axi_* → apb4m_32b_*
    // Responses: apb4m_32b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign apb4m_32b_aw.id     = xbar_axi_awid;
    assign apb4m_32b_aw.addr   = fub_axi_awaddr;
    assign apb4m_32b_aw.len    = fub_axi_awlen;
    assign apb4m_32b_aw.size   = fub_axi_awsize;
    assign apb4m_32b_aw.burst  = fub_axi_awburst;
    assign apb4m_32b_aw.lock   = fub_axi_awlock;
    assign apb4m_32b_aw.cache  = fub_axi_awcache;
    assign apb4m_32b_aw.prot   = fub_axi_awprot;
    assign apb4m_32b_aw.qos    = fub_axi_awqos;
    assign apb4m_32b_aw.region = fub_axi_awregion;
    assign apb4m_32b_aw.user   = fub_axi_awuser;
    assign apb4m_32b_awvalid   = fub_axi_awvalid && aw_path_active_32b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign apb4m_32b_w.data  = fub_axi_wdata;
    assign apb4m_32b_w.strb  = fub_axi_wstrb;
    assign apb4m_32b_w.last  = fub_axi_wlast;
    assign apb4m_32b_w.user  = fub_axi_wuser;
    assign apb4m_32b_wvalid  = fub_axi_wvalid && w_path_active_32b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign apb4m_32b_bready = fub_axi_bready && b_path_active_32b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign apb4m_32b_ar.id     = xbar_axi_arid;
    assign apb4m_32b_ar.addr   = fub_axi_araddr;
    assign apb4m_32b_ar.len    = fub_axi_arlen;
    assign apb4m_32b_ar.size   = fub_axi_arsize;
    assign apb4m_32b_ar.burst  = fub_axi_arburst;
    assign apb4m_32b_ar.lock   = fub_axi_arlock;
    assign apb4m_32b_ar.cache  = fub_axi_arcache;
    assign apb4m_32b_ar.prot   = fub_axi_arprot;
    assign apb4m_32b_ar.qos    = fub_axi_arqos;
    assign apb4m_32b_ar.region = fub_axi_arregion;
    assign apb4m_32b_ar.user   = fub_axi_aruser;
    assign apb4m_32b_arvalid   = fub_axi_arvalid && ar_path_active_32b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign apb4m_32b_rready = fub_axi_rready && r_path_active_32b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            4'b0001: begin  // Slave 0 (32b)
                fub_axi_awready = apb4m_32b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            4'b0001: begin  // Slave 0 (32b)
                fub_axi_wready = apb4m_32b_wready;
            end
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_wready = apb4m_32b_wready;
            end
    ...
    always_comb begin
        ...
        case (b_slave_select)
            4'b0001: begin  // Slave 0 (32b)
                fub_axi_bid = apb4m_32b_b.id[0:0];
                fub_axi_bresp = apb4m_32b_b.resp;
                fub_axi_bvalid = apb4m_32b_bvalid;
            end
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_bid = apb4m_32b_b.id[0:0];
                fub_axi_bresp = apb4m_32b_b.resp;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            4'b0001: begin  // Slave 0 (32b)
                fub_axi_arready = apb4m_32b_arready;
            end
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_arready = apb4m_32b_arready;
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            4'b0001: begin  // Slave 0 (32b)
                fub_axi_rid = apb4m_32b_r.id[0:0];
                fub_axi_rdata = apb4m_32b_r.data;
                fub_axi_rresp = apb4m_32b_r.resp;
                fub_axi_rlast = apb4m_32b_r.last;
                fub_axi_rvalid = apb4m_32b_rvalid;
            end
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_rid = apb4m_32b_r.id[0:0];
                fub_axi_rdata = apb4m_32b_r.data;
