// TRACE_AXIL Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for trace_axil master
...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    input  logic [1:0]  trace_axil_awburst,
    input  logic         trace_axil_awlock,
    input  logic [3:0]  trace_axil_awcache,
    input  logic [2:0]  trace_axil_awprot,
    input  logic [3:0]  trace_axil_awqos,
    input  logic [3:0]  trace_axil_awregion,
    input  logic         trace_axil_awuser,
    ...
    input  logic         trace_axil_wlast,
    input  logic         trace_axil_wuser,
    ...
    input  logic [1:0]  trace_axil_arburst,
    input  logic         trace_axil_arlock,
    input  logic [3:0]  trace_axil_arcache,
    input  logic [2:0]  trace_axil_arprot,
    input  logic [3:0]  trace_axil_arqos,
    input  logic [3:0]  trace_axil_arregion,
    input  logic         trace_axil_aruser,
    ...
    output axi4_aw_t     trace_axil_32b_aw,
    output logic         trace_axil_32b_awvalid,
    input  logic         trace_axil_32b_awready,

    output axi4_w_32b_t  trace_axil_32b_w,
    output logic         trace_axil_32b_wvalid,
    input  logic         trace_axil_32b_wready,

    input  axi4_b_t      trace_axil_32b_b,
    input  logic         trace_axil_32b_bvalid,
    output logic         trace_axil_32b_bready,

    output axi4_ar_t     trace_axil_32b_ar,
    output logic         trace_axil_32b_arvalid,
    input  logic         trace_axil_32b_arready,

    input  axi4_r_32b_t  trace_axil_32b_r,
    input  logic         trace_axil_32b_rvalid,
    output logic         trace_axil_32b_rready,

    output axi4_aw_t     trace_axil_64b_aw,
    output logic         trace_axil_64b_awvalid,
    input  logic         trace_axil_64b_awready,

    output axi4_w_64b_t  trace_axil_64b_w,
    output logic         trace_axil_64b_wvalid,
    input  logic         trace_axil_64b_wready,

    input  axi4_b_t      trace_axil_64b_b,
    input  logic         trace_axil_64b_bvalid,
    output logic         trace_axil_64b_bready,

    output axi4_ar_t     trace_axil_64b_ar,
    output logic         trace_axil_64b_arvalid,
    input  logic         trace_axil_64b_arready,

    input  axi4_r_64b_t  trace_axil_64b_r,
    input  logic         trace_axil_64b_rvalid,
    output logic         trace_axil_64b_rready,
    ...
    axi4_slave_wr_mon #(
        ...
        // External side (s_axi)
        .s_axi_awid(trace_axil_awid),
        .s_axi_awaddr(trace_axil_awaddr),
        .s_axi_awlen(trace_axil_awlen),
        .s_axi_awsize(trace_axil_awsize),
        .s_axi_awburst(trace_axil_awburst),
        .s_axi_awlock(trace_axil_awlock),
        .s_axi_awcache(trace_axil_awcache),
        .s_axi_awprot(trace_axil_awprot),
        .s_axi_awqos(trace_axil_awqos),
        .s_axi_awregion(trace_axil_awregion),
        .s_axi_awuser(trace_axil_awuser),
        .s_axi_awvalid(trace_axil_awvalid),
        .s_axi_awready(trace_axil_awready),
        .s_axi_wdata(trace_axil_wdata),
        .s_axi_wstrb(trace_axil_wstrb),
        .s_axi_wlast(trace_axil_wlast),
        .s_axi_wuser(trace_axil_wuser),
        .s_axi_wvalid(trace_axil_wvalid),
        .s_axi_wready(trace_axil_wready),
        .s_axi_bid(trace_axil_bid),
        .s_axi_bresp(trace_axil_bresp),
        .s_axi_buser(trace_axil_buser),
        .s_axi_bvalid(trace_axil_bvalid),
        .s_axi_bready(trace_axil_bready),
    ...
    axi4_slave_rd_mon #(
        ...
        // External side (s_axi)
        .s_axi_arid(trace_axil_arid),
        .s_axi_araddr(trace_axil_araddr),
        .s_axi_arlen(trace_axil_arlen),
        .s_axi_arsize(trace_axil_arsize),
        .s_axi_arburst(trace_axil_arburst),
        .s_axi_arlock(trace_axil_arlock),
        .s_axi_arcache(trace_axil_arcache),
        .s_axi_arprot(trace_axil_arprot),
        .s_axi_arqos(trace_axil_arqos),
        .s_axi_arregion(trace_axil_arregion),
        .s_axi_aruser(trace_axil_aruser),
        .s_axi_arvalid(trace_axil_arvalid),
        .s_axi_arready(trace_axil_arready),
        .s_axi_rid(trace_axil_rid),
        .s_axi_rdata(trace_axil_rdata),
        .s_axi_rresp(trace_axil_rresp),
        .s_axi_rlast(trace_axil_rlast),
        .s_axi_ruser(trace_axil_ruser),
        .s_axi_rvalid(trace_axil_rvalid),
        .s_axi_rready(trace_axil_rready),
    ...
    // Requests: fub_axi_* → trace_axil_32b_*
    // Responses: trace_axil_32b_* → MUX → fub_axi_*
    // ================================================================
    ...
    assign trace_axil_32b_aw.burst  = fub_axi_awburst;
    ...
    assign trace_axil_32b_bready = fub_axi_bready && b_path_active_32b;
    ...
    assign trace_axil_32b_ar.burst  = fub_axi_arburst;
    ...
    assign trace_axil_32b_rready = fub_axi_rready && r_path_active_32b;
    ...
    axil_to_axi4_wide_align_wr #(
        ...
        .m_axi_awid(trace_axil_64b_aw.id),
        .m_axi_awaddr(trace_axil_64b_aw.addr),
        .m_axi_awlen(trace_axil_64b_aw.len),
        .m_axi_awsize(trace_axil_64b_aw.size),
        .m_axi_awburst(trace_axil_64b_aw.burst),
        .m_axi_awlock(trace_axil_64b_aw.lock),
        .m_axi_awcache(trace_axil_64b_aw.cache),
        .m_axi_awprot(trace_axil_64b_aw.prot),
        .m_axi_awqos(trace_axil_64b_aw.qos),
        .m_axi_awregion(trace_axil_64b_aw.region),
        .m_axi_awuser(trace_axil_64b_aw.user),
        .m_axi_awvalid(trace_axil_64b_awvalid),
        .m_axi_awready(trace_axil_64b_awready),
        .m_axi_wdata(trace_axil_64b_w.data),
        .m_axi_wstrb(trace_axil_64b_w.strb),
        .m_axi_wlast(trace_axil_64b_w.last),
        .m_axi_wuser(trace_axil_64b_w.user),
        .m_axi_wvalid(trace_axil_64b_wvalid),
        .m_axi_wready(trace_axil_64b_wready),
        .m_axi_bid(trace_axil_64b_b.id),
        .m_axi_bresp(trace_axil_64b_b.resp),
        .m_axi_buser(trace_axil_64b_b.user),
        .m_axi_bvalid(trace_axil_64b_bvalid),
        .m_axi_bready(trace_axil_64b_bready)
    );
    ...
    axil_to_axi4_wide_align_rd #(
        ...
        .m_axi_arid(trace_axil_64b_ar.id),
        .m_axi_araddr(trace_axil_64b_ar.addr),
        .m_axi_arlen(trace_axil_64b_ar.len),
        .m_axi_arsize(trace_axil_64b_ar.size),
        .m_axi_arburst(trace_axil_64b_ar.burst),
        .m_axi_arlock(trace_axil_64b_ar.lock),
        .m_axi_arcache(trace_axil_64b_ar.cache),
        .m_axi_arprot(trace_axil_64b_ar.prot),
        .m_axi_arqos(trace_axil_64b_ar.qos),
        .m_axi_arregion(trace_axil_64b_ar.region),
        .m_axi_aruser(trace_axil_64b_ar.user),
        .m_axi_arvalid(trace_axil_64b_arvalid),
        .m_axi_arready(trace_axil_64b_arready),
        .m_axi_rid(trace_axil_64b_r.id),
        .m_axi_rdata(trace_axil_64b_r.data),
        .m_axi_rresp(trace_axil_64b_r.resp),
        .m_axi_rlast(trace_axil_64b_r.last),
        .m_axi_ruser(trace_axil_64b_r.user),
        .m_axi_rvalid(trace_axil_64b_rvalid),
        .m_axi_rready(trace_axil_64b_rready)
    );
    ...
    always_comb begin
        ...
        case (b_slave_select)
            3'b010: begin  // Slave 1 (32b)
                fub_axi_bid = trace_axil_32b_b.id;
    ...
    always_comb begin
        ...
        case (r_slave_select)
            3'b010: begin  // Slave 1 (32b)
                fub_axi_rid = trace_axil_32b_r.id;
