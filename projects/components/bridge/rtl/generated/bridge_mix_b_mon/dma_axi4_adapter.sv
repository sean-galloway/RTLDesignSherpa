...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    assign aw_path_active_128b = (comb_slave_select_aw[0] | comb_slave_select_aw[3]) && aw_gate_ok;
    logic w_path_active_128b;
    assign w_path_active_128b = w_slave_select[0] | w_slave_select[3];
    logic ar_path_active_128b;
    assign ar_path_active_128b = (comb_slave_select_ar[0] | comb_slave_select_ar[3]) && ar_gate_ok;
    logic b_path_active_128b;
    assign b_path_active_128b = b_slave_select[0] | b_slave_select[3];
    logic r_path_active_128b;
    assign r_path_active_128b = r_slave_select[0] | r_slave_select[3];
    ...
    assign dma_axi4_128b_aw.id     = xbar_axi_awid;
    ...
    assign dma_axi4_128b_aw.qos    = fub_axi_awqos;
    assign dma_axi4_128b_aw.region = fub_axi_awregion;
    assign dma_axi4_128b_aw.user   = fub_axi_awuser;
    ...
    assign dma_axi4_128b_w.user  = fub_axi_wuser;
    ...
    assign dma_axi4_128b_ar.id     = xbar_axi_arid;
    ...
    assign dma_axi4_128b_ar.qos    = fub_axi_arqos;
    assign dma_axi4_128b_ar.region = fub_axi_arregion;
    assign dma_axi4_128b_ar.user   = fub_axi_aruser;
