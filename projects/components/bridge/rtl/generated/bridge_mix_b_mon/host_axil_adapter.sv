...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    assign aw_path_active_128b = (comb_slave_select_aw[3]) && aw_gate_ok;
    logic w_path_active_128b;
    assign w_path_active_128b = w_slave_select[3];
    logic ar_path_active_128b;
    assign ar_path_active_128b = (comb_slave_select_ar[3]) && ar_gate_ok;
    logic b_path_active_128b;
    assign b_path_active_128b = b_slave_select[3];
    logic r_path_active_128b;
    assign r_path_active_128b = r_slave_select[3];
    ...
    assign host_axil_32b_aw.id     = xbar_axi_awid;
    ...
    assign host_axil_32b_aw.qos    = fub_axi_awqos;
    assign host_axil_32b_aw.region = fub_axi_awregion;
    assign host_axil_32b_aw.user   = fub_axi_awuser;
    ...
    assign host_axil_32b_w.user  = fub_axi_wuser;
    ...
    assign host_axil_32b_ar.id     = xbar_axi_arid;
    ...
    assign host_axil_32b_ar.qos    = fub_axi_arqos;
    assign host_axil_32b_ar.region = fub_axi_arregion;
    assign host_axil_32b_ar.user   = fub_axi_aruser;
