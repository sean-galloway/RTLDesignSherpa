...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    input  logic [5:0]  xbar_apb_periph_axi_awid,
    ...
    output  logic [5:0]  xbar_apb_periph_axi_bid,
    ...
    input  logic [5:0]  xbar_apb_periph_axi_arid,
    ...
    output  logic [5:0]  xbar_apb_periph_axi_rid,
...
`ifndef SYNTHESIS
    ...
    logic [6-1:0] wr_id_fifo [WR_FIFO_DEPTH];
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
        end else begin
            if (xbar_apb_periph_axi_awvalid && xbar_apb_periph_axi_awready)
...
`ifndef SYNTHESIS
    // synthesis translate_off
    logic [6-1:0] rd_id_fifo [RD_FIFO_DEPTH];
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
        end else begin
...
`endif
    ...
    // ============================================================
    logic [5:0] apb_periph_mon_axi_awid;
    ...
    logic [5:0] apb_periph_mon_axi_bid;
    ...
    logic [5:0] apb_periph_mon_axi_arid;
    ...
    logic [5:0] apb_periph_mon_axi_rid;
    ...
    axi4_master_wr_mon #(
        ...
        .fub_axi_awvalid(xbar_apb_periph_axi_awvalid && !wr_trk_full),
    ...
    axi4_master_rd_mon #(
        ...
        .fub_axi_arvalid(xbar_apb_periph_axi_arvalid && !rd_trk_full),
