// Crossbar: bridge_mix_a_mon_xbar
...
#(
    ...
    output  logic [4:0]  axil_periph_axi_awid,
    ...
    input  logic [4:0]  axil_periph_axi_bid,
    ...
    output  logic [4:0]  axil_periph_axi_arid,
    ...
    input  logic [4:0]  axil_periph_axi_rid,
    ...
    output  logic [4:0]  apb_periph_axi_awid,
    ...
    input  logic [4:0]  apb_periph_axi_bid,
    ...
    output  logic [4:0]  apb_periph_axi_arid,
    ...
    input  logic [4:0]  apb_periph_axi_rid,
    ...
    assign axil_periph_axi_awqos = (cpu_axi4_32b_aw_gnt_axil_periph ? cpu_axi4_32b_aw.qos : '0) |
        (host_axil_32b_aw_gnt_axil_periph ? host_axil_32b_aw.qos : '0);
    assign axil_periph_axi_awregion = (cpu_axi4_32b_aw_gnt_axil_periph ? cpu_axi4_32b_aw.region : '0) |
        (host_axil_32b_aw_gnt_axil_periph ? host_axil_32b_aw.region : '0);
    assign axil_periph_axi_awuser = (cpu_axi4_32b_aw_gnt_axil_periph ? cpu_axi4_32b_aw.user : '0) |
        (host_axil_32b_aw_gnt_axil_periph ? host_axil_32b_aw.user : '0);
    ...
    assign axil_periph_axi_wuser = ((cpu_axi4_32b_w_sel_axil_periph && cpu_axi4_32b_wvalid) ? cpu_axi4_32b_w.user : '0) |
        ((host_axil_32b_w_sel_axil_periph && host_axil_32b_wvalid) ? host_axil_32b_w.user : '0);
    ...
    assign axil_periph_axi_arqos = (cpu_axi4_32b_ar_gnt_axil_periph ? cpu_axi4_32b_ar.qos : '0) |
        (host_axil_32b_ar_gnt_axil_periph ? host_axil_32b_ar.qos : '0);
    assign axil_periph_axi_arregion = (cpu_axi4_32b_ar_gnt_axil_periph ? cpu_axi4_32b_ar.region : '0) |
        (host_axil_32b_ar_gnt_axil_periph ? host_axil_32b_ar.region : '0);
    assign axil_periph_axi_aruser = (cpu_axi4_32b_ar_gnt_axil_periph ? cpu_axi4_32b_ar.user : '0) |
        (host_axil_32b_ar_gnt_axil_periph ? host_axil_32b_ar.user : '0);
    ...
    assign cpu_axi4_32b_b.user = 
        ((axil_periph_axi_bid_bridge_id == 0) && axil_periph_axi_bid_valid ? axil_periph_axi_buser : '0) |
    ...
    assign cpu_axi4_32b_r.user = 
        ((axil_periph_axi_rid_bridge_id == 0) && axil_periph_axi_rid_valid ? axil_periph_axi_ruser : '0) |
...
`ifndef SYNTHESIS
    ...
    always_ff @(posedge aclk) begin
        if (aresetn && $countones({((axil_periph_axi_rid_bridge_id == 0) && axil_periph_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 0) && apb_periph_axi_rid_valid)}) > 1) begin
            $error("%m: response mux for master cpu_axi4 (32b) has %0d slaves selected at once; ",
                   ...
                   $countones({((axil_periph_axi_rid_bridge_id == 0) && axil_periph_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 0) && apb_periph_axi_rid_valid)}));
        end
    end
...
`endif
    ...
    assign host_axil_32b_b.user = 
        ((axil_periph_axi_bid_bridge_id == 1) && axil_periph_axi_bid_valid ? axil_periph_axi_buser : '0) |
    ...
    assign host_axil_32b_r.user = 
        ((axil_periph_axi_rid_bridge_id == 1) && axil_periph_axi_rid_valid ? axil_periph_axi_ruser : '0) |
...
`ifndef SYNTHESIS
    // synthesis translate_off
    always_ff @(posedge aclk) begin
        if (aresetn && $countones({((axil_periph_axi_rid_bridge_id == 1) && axil_periph_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 1) && apb_periph_axi_rid_valid)}) > 1) begin
            $error("%m: response mux for master host_axil (32b) has %0d slaves selected at once; ",
                   "the single-outstanding-target invariant is broken and the R payload is OR-merged",
                   $countones({((axil_periph_axi_rid_bridge_id == 1) && axil_periph_axi_rid_valid), ((apb_periph_axi_rid_bridge_id == 1) && apb_periph_axi_rid_valid)}));
        end
    end
    // synthesis translate_on
`endif
...
endmodule : bridge_mix_a_mon_xbar
