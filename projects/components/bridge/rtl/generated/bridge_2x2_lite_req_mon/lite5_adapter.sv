// LITE5 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for lite5 master
...
#(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    // External AXI interface (from lite5 master)
    input  logic         lite5_axil_awid,
    input  logic [31:0]  lite5_axil_awaddr,
    input  logic [7:0]  lite5_axil_awlen,
    input  logic [2:0]  lite5_axil_awsize,
    input  logic [1:0]  lite5_axil_awburst,
    input  logic         lite5_axil_awlock,
    input  logic [3:0]  lite5_axil_awcache,
    input  logic [2:0]  lite5_axil_awprot,
    input  logic [3:0]  lite5_axil_awqos,
    input  logic [3:0]  lite5_axil_awregion,
    ...
    input  logic         lite5_axil_arid,
    input  logic [31:0]  lite5_axil_araddr,
    input  logic [7:0]  lite5_axil_arlen,
    input  logic [2:0]  lite5_axil_arsize,
    input  logic [1:0]  lite5_axil_arburst,
    input  logic         lite5_axil_arlock,
    input  logic [3:0]  lite5_axil_arcache,
    input  logic [2:0]  lite5_axil_arprot,
    input  logic [3:0]  lite5_axil_arqos,
    input  logic [3:0]  lite5_axil_arregion,
    input  logic         lite5_axil_aruser,
    input  logic         lite5_axil_arvalid,
    output  logic         lite5_axil_arready,

    output  logic         lite5_axil_rid,
    output  logic [31:0]  lite5_axil_rdata,
    output  logic [1:0]  lite5_axil_rresp,
    output  logic         lite5_axil_rlast,
    ...
    output axi4_aw_t     lite5_32b_aw,
    output logic         lite5_32b_awvalid,
    input  logic         lite5_32b_awready,

    output axi4_w_32b_t  lite5_32b_w,
    output logic         lite5_32b_wvalid,
    input  logic         lite5_32b_wready,

    input  axi4_b_t      lite5_32b_b,
    input  logic         lite5_32b_bvalid,
    output logic         lite5_32b_bready,

    output axi4_ar_t     lite5_32b_ar,
    output logic         lite5_32b_arvalid,
    input  logic         lite5_32b_arready,

    input  axi4_r_32b_t  lite5_32b_r,
    input  logic         lite5_32b_rvalid,
    output logic         lite5_32b_rready,

    output axi4_aw_t     lite5_64b_aw,
    output logic         lite5_64b_awvalid,
    input  logic         lite5_64b_awready,

    output axi4_w_64b_t  lite5_64b_w,
    output logic         lite5_64b_wvalid,
    input  logic         lite5_64b_wready,

    input  axi4_b_t      lite5_64b_b,
    input  logic         lite5_64b_bvalid,
    output logic         lite5_64b_bready,

    output axi4_ar_t     lite5_64b_ar,
    output logic         lite5_64b_arvalid,
    input  logic         lite5_64b_arready,

    input  axi4_r_64b_t  lite5_64b_r,
    input  logic         lite5_64b_rvalid,
    output logic         lite5_64b_rready,
    ...
    axi4_slave_wr_mon #(
        ...
        // External side (s_axi)
        .s_axi_awid(lite5_axil_awid),
        .s_axi_awaddr(lite5_axil_awaddr),
        .s_axi_awlen(lite5_axil_awlen),
        .s_axi_awsize(lite5_axil_awsize),
        .s_axi_awburst(lite5_axil_awburst),
        .s_axi_awlock(lite5_axil_awlock),
        .s_axi_awcache(lite5_axil_awcache),
        .s_axi_awprot(lite5_axil_awprot),
        .s_axi_awqos(lite5_axil_awqos),
        .s_axi_awregion(lite5_axil_awregion),
        .s_axi_awuser(lite5_axil_awuser),
        .s_axi_awvalid(lite5_axil_awvalid),
        .s_axi_awready(lite5_axil_awready),
        .s_axi_wdata(lite5_axil_wdata),
        .s_axi_wstrb(lite5_axil_wstrb),
        .s_axi_wlast(lite5_axil_wlast),
        .s_axi_wuser(lite5_axil_wuser),
        .s_axi_wvalid(lite5_axil_wvalid),
        .s_axi_wready(lite5_axil_wready),
        .s_axi_bid(lite5_axil_bid),
        .s_axi_bresp(lite5_axil_bresp),
        .s_axi_buser(lite5_axil_buser),
        .s_axi_bvalid(lite5_axil_bvalid),
        .s_axi_bready(lite5_axil_bready),
    ...
    axi4_slave_rd_mon #(
        ...
        // External side (s_axi)
        .s_axi_arid(lite5_axil_arid),
        .s_axi_araddr(lite5_axil_araddr),
        .s_axi_arlen(lite5_axil_arlen),
        .s_axi_arsize(lite5_axil_arsize),
        .s_axi_arburst(lite5_axil_arburst),
        .s_axi_arlock(lite5_axil_arlock),
        .s_axi_arcache(lite5_axil_arcache),
        .s_axi_arprot(lite5_axil_arprot),
        .s_axi_arqos(lite5_axil_arqos),
        .s_axi_arregion(lite5_axil_arregion),
        .s_axi_aruser(lite5_axil_aruser),
        .s_axi_arvalid(lite5_axil_arvalid),
        .s_axi_arready(lite5_axil_arready),
        .s_axi_rid(lite5_axil_rid),
        .s_axi_rdata(lite5_axil_rdata),
        .s_axi_rresp(lite5_axil_rresp),
        .s_axi_rlast(lite5_axil_rlast),
        .s_axi_ruser(lite5_axil_ruser),
        .s_axi_rvalid(lite5_axil_rvalid),
        .s_axi_rready(lite5_axil_rready),
    ...
    // Requests: fub_axi_* → lite5_32b_*
    // Responses: lite5_32b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign lite5_32b_aw.id     = xbar_axi_awid;
    assign lite5_32b_aw.addr   = fub_axi_awaddr;
    assign lite5_32b_aw.len    = fub_axi_awlen;
    assign lite5_32b_aw.size   = fub_axi_awsize;
    assign lite5_32b_aw.burst  = fub_axi_awburst;
    assign lite5_32b_aw.lock   = fub_axi_awlock;
    assign lite5_32b_aw.cache  = fub_axi_awcache;
    assign lite5_32b_aw.prot   = fub_axi_awprot;
    assign lite5_32b_aw.qos    = fub_axi_awqos;
    assign lite5_32b_aw.region = fub_axi_awregion;
    assign lite5_32b_aw.user   = fub_axi_awuser;
    assign lite5_32b_awvalid   = fub_axi_awvalid && aw_path_active_32b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign lite5_32b_w.data  = fub_axi_wdata;
    assign lite5_32b_w.strb  = fub_axi_wstrb;
    assign lite5_32b_w.last  = fub_axi_wlast;
    assign lite5_32b_w.user  = fub_axi_wuser;
    assign lite5_32b_wvalid  = fub_axi_wvalid && w_path_active_32b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign lite5_32b_bready = fub_axi_bready && b_path_active_32b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign lite5_32b_ar.id     = xbar_axi_arid;
    assign lite5_32b_ar.addr   = fub_axi_araddr;
    assign lite5_32b_ar.len    = fub_axi_arlen;
    assign lite5_32b_ar.size   = fub_axi_arsize;
    assign lite5_32b_ar.burst  = fub_axi_arburst;
    assign lite5_32b_ar.lock   = fub_axi_arlock;
    assign lite5_32b_ar.cache  = fub_axi_arcache;
    assign lite5_32b_ar.prot   = fub_axi_arprot;
    assign lite5_32b_ar.qos    = fub_axi_arqos;
    assign lite5_32b_ar.region = fub_axi_arregion;
    assign lite5_32b_ar.user   = fub_axi_aruser;
    assign lite5_32b_arvalid   = fub_axi_arvalid && ar_path_active_32b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign lite5_32b_rready = fub_axi_rready && r_path_active_32b;
    ...
    axil_to_axi4_wide_align_wr #(
        ...
        .m_axi_awid(lite5_64b_aw.id),
        .m_axi_awaddr(lite5_64b_aw.addr),
        .m_axi_awlen(lite5_64b_aw.len),
        .m_axi_awsize(lite5_64b_aw.size),
        .m_axi_awburst(lite5_64b_aw.burst),
        .m_axi_awlock(lite5_64b_aw.lock),
        .m_axi_awcache(lite5_64b_aw.cache),
        .m_axi_awprot(lite5_64b_aw.prot),
        .m_axi_awqos(lite5_64b_aw.qos),
        .m_axi_awregion(lite5_64b_aw.region),
        .m_axi_awuser(lite5_64b_aw.user),
        .m_axi_awvalid(lite5_64b_awvalid),
        .m_axi_awready(lite5_64b_awready),
        .m_axi_wdata(lite5_64b_w.data),
        .m_axi_wstrb(lite5_64b_w.strb),
        .m_axi_wlast(lite5_64b_w.last),
        .m_axi_wuser(lite5_64b_w.user),
        .m_axi_wvalid(lite5_64b_wvalid),
        .m_axi_wready(lite5_64b_wready),
        .m_axi_bid(lite5_64b_b.id),
        .m_axi_bresp(lite5_64b_b.resp),
        .m_axi_buser(lite5_64b_b.user),
        .m_axi_bvalid(lite5_64b_bvalid),
        .m_axi_bready(lite5_64b_bready)
    );
    ...
    axil_to_axi4_wide_align_rd #(
        ...
        .m_axi_arid(lite5_64b_ar.id),
        .m_axi_araddr(lite5_64b_ar.addr),
        .m_axi_arlen(lite5_64b_ar.len),
        .m_axi_arsize(lite5_64b_ar.size),
        .m_axi_arburst(lite5_64b_ar.burst),
        .m_axi_arlock(lite5_64b_ar.lock),
        .m_axi_arcache(lite5_64b_ar.cache),
        .m_axi_arprot(lite5_64b_ar.prot),
        .m_axi_arqos(lite5_64b_ar.qos),
        .m_axi_arregion(lite5_64b_ar.region),
        .m_axi_aruser(lite5_64b_ar.user),
        .m_axi_arvalid(lite5_64b_arvalid),
        .m_axi_arready(lite5_64b_arready),
        .m_axi_rid(lite5_64b_r.id),
        .m_axi_rdata(lite5_64b_r.data),
        .m_axi_rresp(lite5_64b_r.resp),
        .m_axi_rlast(lite5_64b_r.last),
        .m_axi_ruser(lite5_64b_r.user),
        .m_axi_rvalid(lite5_64b_rvalid),
        .m_axi_rready(lite5_64b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            3'b010: begin  // Slave 1 (32b)
                fub_axi_awready = lite5_32b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            3'b010: begin  // Slave 1 (32b)
                fub_axi_wready = lite5_32b_wready;
            end
            3'b001: begin  // Slave 0 (64b)
    ...
    always_comb begin
        ...
        case (b_slave_select)
            3'b010: begin  // Slave 1 (32b)
                fub_axi_bid = lite5_32b_b.id[0:0];
                fub_axi_bresp = lite5_32b_b.resp;
                fub_axi_bvalid = lite5_32b_bvalid;
            end
            3'b001: begin  // Slave 0 (64b)
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            3'b010: begin  // Slave 1 (32b)
                fub_axi_arready = lite5_32b_arready;
            end
            3'b001: begin  // Slave 0 (64b)
    ...
    always_comb begin
        ...
        case (r_slave_select)
            3'b010: begin  // Slave 1 (32b)
                fub_axi_rid = lite5_32b_r.id[0:0];
                fub_axi_rdata = lite5_32b_r.data;
                fub_axi_rresp = lite5_32b_r.resp;
                fub_axi_rlast = lite5_32b_r.last;
                fub_axi_rvalid = lite5_32b_rvalid;
            end
            3'b001: begin  // Slave 0 (64b)
