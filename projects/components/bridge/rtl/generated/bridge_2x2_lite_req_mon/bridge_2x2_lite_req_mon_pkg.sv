...
package bridge_2x2_lite_req_mon_pkg;
    ...
    localparam int MASTER_ID_WIDTH = 1;  // widest master-side ID
    localparam int ID_PREFIX_WIDTH = 1;  // master-index bits prepended
    localparam int XBAR_ID_WIDTH   = 2;  // MASTER_ID_WIDTH + ID_PREFIX_WIDTH

    // AXI4 Write Address Channel (width-independent)
    // Note: ID width is 2-bit for this bridge
    typedef struct packed {
        logic [1:0]   id;      // Transaction ID
...
endpackage : bridge_2x2_lite_req_mon_pkg
