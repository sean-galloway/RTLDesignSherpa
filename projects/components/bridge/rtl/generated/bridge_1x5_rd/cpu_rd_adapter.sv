...
#(
    ...
    always_comb begin
        ...
        if (fub_axi_araddr <= 32'h0FFFFFFF) begin
            ...
            comb_slave_select_ar[3] = 1'b1;  // apb_periph
        end
    ...
    assign ar_path_active_32b = (comb_slave_select_ar[0] | comb_slave_select_ar[3] | comb_slave_select_ar[4]) && ar_gate_ok;
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[0] | r_slave_select[3] | r_slave_select[4];
    ...
    assign cpu_rd_64b_ar.qos    = fub_axi_arqos;
    assign cpu_rd_64b_ar.region = fub_axi_arregion;
    assign cpu_rd_64b_ar.user   = fub_axi_aruser;
