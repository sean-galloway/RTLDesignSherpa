...
#(
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ar_ptr <= '0;
        end else if (xbar_periph_rd_axi_arvalid && xbar_periph_rd_axi_arready) begin
            rd_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_bridge_id_ar;
            ar_ptr <= ar_ptr + 1'b1;
        end
    )

    // Pop on R response (xbar_periph_rd_axi_rvalid && xbar_periph_rd_axi_rready && xbar_periph_rd_axi_rlast)
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            r_ptr <= '0;
        end else if (xbar_periph_rd_axi_rvalid && xbar_periph_rd_axi_rready && xbar_periph_rd_axi_rlast) begin
            r_ptr <= r_ptr + 1'b1;
        end
    )
    ...
    assign xbar_periph_rd_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_periph_rd_axi_arvalid && xbar_periph_rd_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_periph_rd_axi_arid;
            if (xbar_periph_rd_axi_rvalid && xbar_periph_rd_axi_rready && xbar_periph_rd_axi_rlast) begin
                if (xbar_periph_rd_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned R out of AR order -- ",
                           ...
                           "wrong master.", xbar_periph_rd_axi_rid,
...
`endif
    ...
    axi4_master_rd #(
        ...
        .fub_axi_arvalid(xbar_periph_rd_axi_arvalid && !rd_trk_full),
