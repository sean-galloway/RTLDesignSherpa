...
module bridge_1x2_rd_axi5c
    import bridge_1x2_rd_axi5c_pkg::*;
(
    input  logic aclk,
    input  logic aresetn,
    ...
    input  logic         cpu_rd_axi_archunken,

    output  logic [3:0]  cpu_rd_axi_rid,
    output  logic [127:0]  cpu_rd_axi_rdata,
    ...
    output  logic         cpu_rd_axi_rchunkv,
    output  logic [3:0]  cpu_rd_axi_rchunknum,
    output  logic         cpu_rd_axi_rchunkstrb,
    ...
    input  logic [127:0]  ddr_rd_axi_rdata,
    ...
    output  logic         sram_rd_axi_archunken,

    input  logic [3:0]  sram_rd_axi_rid,
    input  logic [127:0]  sram_rd_axi_rdata,
    ...
    input  logic         sram_rd_axi_rchunkv,
    input  logic [3:0]  sram_rd_axi_rchunknum,
    input  logic         sram_rd_axi_rchunkstrb,
    ...
    // ddr_rd (AXI4, 128b AXI4 interface)
    ...
    logic [127:0] xbar_ddr_rd_axi_rdata;
    ...
    // sram_rd (AXI5, 128b AXI4 interface)
    ...
    logic [127:0] xbar_sram_rd_axi_rdata;
    ...
    logic                       xbar_sram_rd_axi_archunken;  // AXI5 sideband (chunking)
    logic                       xbar_sram_rd_axi_rtrace;  // AXI5 sideband (trace)
    logic                       xbar_sram_rd_axi_rchunkv;  // AXI5 sideband (chunking)
    logic [3:0]               xbar_sram_rd_axi_rchunknum;  // AXI5 sideband (chunking)
    logic                       xbar_sram_rd_axi_rchunkstrb;  // AXI5 sideband (chunking)
    ...
    cpu_rd_adapter u_cpu_rd_adapter (
        ...
        .cpu_rd_axi_archunken(cpu_rd_axi_archunken),
        ...
        .cpu_rd_axi_rchunkv(cpu_rd_axi_rchunkv),
        .cpu_rd_axi_rchunknum(cpu_rd_axi_rchunknum),
        .cpu_rd_axi_rchunkstrb(cpu_rd_axi_rchunkstrb),
    ...
    // ================================================================
    bridge_1x2_rd_axi5c_xbar u_xbar (
        .aclk(aclk),
        .aresetn(aresetn),
        ...
        .sram_rd_axi_archunken(xbar_sram_rd_axi_archunken),
        .sram_rd_axi_rtrace(xbar_sram_rd_axi_rtrace),
        .sram_rd_axi_rchunkv(xbar_sram_rd_axi_rchunkv),
        .sram_rd_axi_rchunknum(xbar_sram_rd_axi_rchunknum),
        .sram_rd_axi_rchunkstrb(xbar_sram_rd_axi_rchunkstrb),
    ...
    sram_rd_adapter u_sram_rd_adapter (
        ...
        .xbar_sram_rd_axi_archunken(xbar_sram_rd_axi_archunken),
        .xbar_sram_rd_axi_rtrace(xbar_sram_rd_axi_rtrace),
        .xbar_sram_rd_axi_rchunkv(xbar_sram_rd_axi_rchunkv),
        .xbar_sram_rd_axi_rchunknum(xbar_sram_rd_axi_rchunknum),
        .xbar_sram_rd_axi_rchunkstrb(xbar_sram_rd_axi_rchunkstrb),
        ...
        .sram_rd_axi_archunken(sram_rd_axi_archunken),
        ...
        .sram_rd_axi_rchunkv(sram_rd_axi_rchunkv),
        .sram_rd_axi_rchunknum(sram_rd_axi_rchunknum),
        .sram_rd_axi_rchunkstrb(sram_rd_axi_rchunkstrb),
