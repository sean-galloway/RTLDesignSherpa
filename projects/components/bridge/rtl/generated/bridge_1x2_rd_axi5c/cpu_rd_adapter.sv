...
#(
    ...
    axi5_slave_rd #(
        ...
        .s_axi_armecid('0),
        .s_axi_arunique('0),
        .s_axi_archunken(cpu_rd_axi_archunken),
        .s_axi_artagop('0),
        ...
        .s_axi_rpoison(),
        .s_axi_rchunkv(cpu_rd_axi_rchunkv),
        .s_axi_rchunknum(cpu_rd_axi_rchunknum),
        .s_axi_rchunkstrb(cpu_rd_axi_rchunkstrb),
        .s_axi_rtag(),
        .s_axi_rtagmatch(),
    ...
    // Requests: fub_axi_* → cpu_rd_128b_*
    // Responses: cpu_rd_128b_* → MUX → fub_axi_*
    // ================================================================

    // AR channel (request: fub → output)
    assign cpu_rd_128b_ar.id     = fub_axi_arid;
    assign cpu_rd_128b_ar.addr   = fub_axi_araddr;
    assign cpu_rd_128b_ar.len    = fub_axi_arlen;
    assign cpu_rd_128b_ar.size   = fub_axi_arsize;
    assign cpu_rd_128b_ar.burst  = fub_axi_arburst;
    assign cpu_rd_128b_ar.lock   = fub_axi_arlock;
    assign cpu_rd_128b_ar.cache  = fub_axi_arcache;
    assign cpu_rd_128b_ar.prot   = fub_axi_arprot;
    assign cpu_rd_128b_ar.qos    = fub_axi_arqos;
    assign cpu_rd_128b_ar.region = 4'b0;  // AXI5 has no REGION
    assign cpu_rd_128b_ar.user   = fub_axi_aruser;
    assign cpu_rd_128b_ar.trace = fub_axi_artrace;  // AXI5 sideband
    assign cpu_rd_128b_ar.chunken = fub_axi_archunken;  // AXI5 sideband
    assign cpu_rd_128b_arvalid   = fub_axi_arvalid && ar_path_active_128b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign cpu_rd_128b_rready = fub_axi_rready && r_path_active_128b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            3'b001: begin  // Slave 0 (128b)
                fub_axi_arready = cpu_rd_128b_arready;
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            3'b001: begin  // Slave 0 (128b)
                fub_axi_rid = cpu_rd_128b_r.id[3:0];
                fub_axi_rdata = cpu_rd_128b_r.data;
                fub_axi_rresp = cpu_rd_128b_r.resp;
                fub_axi_rlast = cpu_rd_128b_r.last;
                fub_axi_rvalid = cpu_rd_128b_rvalid;
                r_slave_trace = cpu_rd_128b_r.trace;
                fub_axi_rchunkv = cpu_rd_128b_r.chunkv;
                fub_axi_rchunknum = cpu_rd_128b_r.chunknum;
                fub_axi_rchunkstrb = cpu_rd_128b_r.chunkstrb;
            end
            3'b010: begin  // Slave 1 (128b)
                fub_axi_rid = cpu_rd_128b_r.id[3:0];
                fub_axi_rdata = cpu_rd_128b_r.data;
