...
#(
    ...
    output  logic [127:0]  xbar_ddr_rd_axi_rdata,
    ...
    assign xbar_ddr_rd_axi_arready = w_sub_arready && !rd_trk_full;
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_ddr_rd_axi_arvalid && xbar_ddr_rd_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_ddr_rd_axi_arid;
            if (xbar_ddr_rd_axi_rvalid && xbar_ddr_rd_axi_rready && xbar_ddr_rd_axi_rlast) begin
                if (xbar_ddr_rd_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
                    $error({"BRIDGE-010: slave returned R out of AR order -- ",
                            ...
                            "wrong master."}, xbar_ddr_rd_axi_rid,
...
`endif
    ...
    axi4_master_rd #(
        ...
        .fub_axi_arvalid(xbar_ddr_rd_axi_arvalid && !rd_trk_full),
