...
#(
    ...
    input  logic [10:0]  xbar_subtractive_axi_awid,
    ...
    input  logic [255:0]  xbar_subtractive_axi_wdata,
    input  logic [31:0]  xbar_subtractive_axi_wstrb,
    ...
    output  logic [10:0]  xbar_subtractive_axi_bid,
    ...
    input  logic [10:0]  xbar_subtractive_axi_arid,
    ...
    output  logic [10:0]  xbar_subtractive_axi_rid,
    ...
    output  logic [10:0]  subtractive_awid,
    ...
    output  logic [255:0]  subtractive_wdata,
    output  logic [31:0]  subtractive_wstrb,
    ...
    input  logic [10:0]  subtractive_bid,
    ...
    output  logic [10:0]  subtractive_arid,
    ...
    input  logic [10:0]  subtractive_rid,
...
`ifndef SYNTHESIS
    ...
    logic [11-1:0] wr_id_fifo [WR_FIFO_DEPTH];
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
        end else begin
...
`ifndef SYNTHESIS
    // synthesis translate_off
    logic [11-1:0] rd_id_fifo [RD_FIFO_DEPTH];
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
        end else begin
