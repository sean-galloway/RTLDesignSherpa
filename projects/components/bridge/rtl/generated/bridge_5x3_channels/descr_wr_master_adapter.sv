...
#(
    ...
    assign descr_wr_master_256b_aw.id     = xbar_axi_awid;
    ...
    assign descr_wr_master_256b_aw.qos    = fub_axi_awqos;
    assign descr_wr_master_256b_aw.region = fub_axi_awregion;
    assign descr_wr_master_256b_aw.user   = fub_axi_awuser;
    ...
    assign descr_wr_master_256b_w.user  = fub_axi_wuser;
    assign descr_wr_master_256b_wvalid  = fub_axi_wvalid && w_path_active_256b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign descr_wr_master_256b_bready = fub_axi_bready && b_path_active_256b;
