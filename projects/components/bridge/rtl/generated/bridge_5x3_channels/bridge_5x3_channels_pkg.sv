...
package bridge_5x3_channels_pkg;
    ...
    localparam int XBAR_ID_WIDTH   = 11;  // MASTER_ID_WIDTH + ID_PREFIX_WIDTH

    // AXI4 Write Address Channel (width-independent)
    // Note: ID width is 11-bit for this bridge
    typedef struct packed {
        logic [10:0]   id;      // Transaction ID
...
endpackage : bridge_5x3_channels_pkg
