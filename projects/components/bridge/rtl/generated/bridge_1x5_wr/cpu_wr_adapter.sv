...
#(
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr <= 32'h0FFFFFFF) begin
            ...
            comb_slave_select_aw[4] = 1'b1;  // axil_periph
        end
        else begin  // Full address range (catch-all)
            comb_slave_select_aw[5] = 1'b1;  // subtractive
        end
    end
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[0] | comb_slave_select_aw[3] | comb_slave_select_aw[4]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[0] | w_slave_select[3] | w_slave_select[4];
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[0] | b_slave_select[3] | b_slave_select[4];
    ...
    assign aw_path_active_128b = (comb_slave_select_aw[2] | comb_slave_select_aw[5]) && aw_gate_ok;
    logic w_path_active_128b;
    assign w_path_active_128b = w_slave_select[2] | w_slave_select[5];
    logic b_path_active_128b;
    assign b_path_active_128b = b_slave_select[2] | b_slave_select[5];
    ...
    assign cpu_wr_64b_aw.qos    = fub_axi_awqos;
    assign cpu_wr_64b_aw.region = fub_axi_awregion;
    assign cpu_wr_64b_aw.user   = fub_axi_awuser;
    ...
    assign cpu_wr_64b_w.user  = fub_axi_wuser;
    ...
    assign cpu_wr_64b_bready = fub_axi_bready && b_path_active_64b;
