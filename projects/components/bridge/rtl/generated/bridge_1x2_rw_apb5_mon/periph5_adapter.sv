...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_periph5_axi_awvalid && xbar_periph5_axi_awready)
                wr_id_fifo[wr_ptr[$clog2(WR_FIFO_DEPTH)-1:0]] <= xbar_periph5_axi_awid;
            if (xbar_periph5_axi_bvalid && xbar_periph5_axi_bready) begin
                if (xbar_periph5_axi_bid !== wr_id_fifo[rd_ptr[$clog2(WR_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned B out of AW order -- ",
                           ...
                           "wrong master.", xbar_periph5_axi_bid,
...
`ifndef SYNTHESIS
    ...
    `ALWAYS_FF_RST(aclk, aresetn,
        if (`RST_ASSERTED(aresetn)) begin
            ...
            if (xbar_periph5_axi_arvalid && xbar_periph5_axi_arready)
                rd_id_fifo[ar_ptr[$clog2(RD_FIFO_DEPTH)-1:0]] <= xbar_periph5_axi_arid;
            if (xbar_periph5_axi_rvalid && xbar_periph5_axi_rready && xbar_periph5_axi_rlast) begin
                if (xbar_periph5_axi_rid !== rd_id_fifo[r_ptr[$clog2(RD_FIFO_DEPTH)-1:0]]) begin
                    $error("BRIDGE-010: slave returned R out of AR order -- ",
                           ...
                           "wrong master.", xbar_periph5_axi_rid,
...
`endif
    ...
    // ============================================================
    logic [3:0] periph5_mon_axi_awid;
    logic [31:0] periph5_mon_axi_awaddr;
    logic [7:0]  periph5_mon_axi_awlen;
    logic [2:0]  periph5_mon_axi_awsize;
    logic [1:0]  periph5_mon_axi_awburst;
    logic        periph5_mon_axi_awlock;
    logic [3:0]  periph5_mon_axi_awcache;
    logic [2:0]  periph5_mon_axi_awprot;
    logic [3:0]  periph5_mon_axi_awqos;
    logic [3:0]  periph5_mon_axi_awregion;
    logic        periph5_mon_axi_awuser;
    logic        periph5_mon_axi_awvalid;
    logic        periph5_mon_axi_awready;
    logic [31:0] periph5_mon_axi_wdata;
    logic [3:0] periph5_mon_axi_wstrb;
    logic        periph5_mon_axi_wlast;
    logic        periph5_mon_axi_wuser;
    logic        periph5_mon_axi_wvalid;
    logic        periph5_mon_axi_wready;
    logic [3:0] periph5_mon_axi_bid;
    logic [1:0]  periph5_mon_axi_bresp;
    logic        periph5_mon_axi_buser;
    logic        periph5_mon_axi_bvalid;
    logic        periph5_mon_axi_bready;
    logic [3:0] periph5_mon_axi_arid;
    logic [31:0] periph5_mon_axi_araddr;
    logic [7:0]  periph5_mon_axi_arlen;
    logic [2:0]  periph5_mon_axi_arsize;
    logic [1:0]  periph5_mon_axi_arburst;
    logic        periph5_mon_axi_arlock;
    logic [3:0]  periph5_mon_axi_arcache;
    logic [2:0]  periph5_mon_axi_arprot;
    logic [3:0]  periph5_mon_axi_arqos;
    logic [3:0]  periph5_mon_axi_arregion;
    logic        periph5_mon_axi_aruser;
    logic        periph5_mon_axi_arvalid;
    logic        periph5_mon_axi_arready;
    logic [3:0] periph5_mon_axi_rid;
    logic [31:0] periph5_mon_axi_rdata;
    logic [1:0]  periph5_mon_axi_rresp;
    logic        periph5_mon_axi_rlast;
    logic        periph5_mon_axi_ruser;
    logic        periph5_mon_axi_rvalid;
    ...
    axi4_master_wr_mon #(
        ...
        .fub_axi_awid(xbar_periph5_axi_awid),
        .fub_axi_awaddr(xbar_periph5_axi_awaddr),
        .fub_axi_awlen(xbar_periph5_axi_awlen),
        .fub_axi_awsize(xbar_periph5_axi_awsize),
        .fub_axi_awburst(xbar_periph5_axi_awburst),
        .fub_axi_awlock(xbar_periph5_axi_awlock),
        .fub_axi_awcache(xbar_periph5_axi_awcache),
        .fub_axi_awprot(xbar_periph5_axi_awprot),
        ...
        .fub_axi_wuser(xbar_periph5_axi_wuser),
        .fub_axi_wvalid(xbar_periph5_axi_wvalid),
        .fub_axi_wready(xbar_periph5_axi_wready),
        .fub_axi_bid(xbar_periph5_axi_bid),
        .fub_axi_bresp(xbar_periph5_axi_bresp),
        .fub_axi_buser(xbar_periph5_axi_buser),
        .fub_axi_bvalid(xbar_periph5_axi_bvalid),
        .fub_axi_bready(xbar_periph5_axi_bready),

        // External side (m_axi)
        .m_axi_awid(periph5_mon_axi_awid),
        .m_axi_awaddr(periph5_mon_axi_awaddr),
        .m_axi_awlen(periph5_mon_axi_awlen),
        .m_axi_awsize(periph5_mon_axi_awsize),
        .m_axi_awburst(periph5_mon_axi_awburst),
        .m_axi_awlock(periph5_mon_axi_awlock),
        .m_axi_awcache(periph5_mon_axi_awcache),
        .m_axi_awprot(periph5_mon_axi_awprot),
        .m_axi_awqos(periph5_mon_axi_awqos),
        .m_axi_awregion(periph5_mon_axi_awregion),
        .m_axi_awuser(periph5_mon_axi_awuser),
        .m_axi_awvalid(periph5_mon_axi_awvalid),
        .m_axi_awready(periph5_mon_axi_awready),
        .m_axi_wdata(periph5_mon_axi_wdata),
        .m_axi_wstrb(periph5_mon_axi_wstrb),
        .m_axi_wlast(periph5_mon_axi_wlast),
        .m_axi_wuser(periph5_mon_axi_wuser),
        .m_axi_wvalid(periph5_mon_axi_wvalid),
        .m_axi_wready(periph5_mon_axi_wready),
        .m_axi_bid(periph5_mon_axi_bid),
        .m_axi_bresp(periph5_mon_axi_bresp),
        .m_axi_buser(periph5_mon_axi_buser),
        .m_axi_bvalid(periph5_mon_axi_bvalid),
        .m_axi_bready(periph5_mon_axi_bready),
    ...
    axi4_master_rd_mon #(
        ...
        // Bridge-internal side (fub_axi)
        .fub_axi_arid(xbar_periph5_axi_arid),
        .fub_axi_araddr(xbar_periph5_axi_araddr),
        .fub_axi_arlen(xbar_periph5_axi_arlen),
        .fub_axi_arsize(xbar_periph5_axi_arsize),
        .fub_axi_arburst(xbar_periph5_axi_arburst),
        .fub_axi_arlock(xbar_periph5_axi_arlock),
        .fub_axi_arcache(xbar_periph5_axi_arcache),
        .fub_axi_arprot(xbar_periph5_axi_arprot),
        ...
        .fub_axi_rlast(xbar_periph5_axi_rlast),
        .fub_axi_ruser(xbar_periph5_axi_ruser),
        .fub_axi_rvalid(xbar_periph5_axi_rvalid),
        .fub_axi_rready(xbar_periph5_axi_rready),

        // External side (m_axi)
        .m_axi_arid(periph5_mon_axi_arid),
        .m_axi_araddr(periph5_mon_axi_araddr),
        .m_axi_arlen(periph5_mon_axi_arlen),
        .m_axi_arsize(periph5_mon_axi_arsize),
        .m_axi_arburst(periph5_mon_axi_arburst),
        .m_axi_arlock(periph5_mon_axi_arlock),
        .m_axi_arcache(periph5_mon_axi_arcache),
        .m_axi_arprot(periph5_mon_axi_arprot),
        .m_axi_arqos(periph5_mon_axi_arqos),
        .m_axi_arregion(periph5_mon_axi_arregion),
        .m_axi_aruser(periph5_mon_axi_aruser),
        .m_axi_arvalid(periph5_mon_axi_arvalid),
        .m_axi_arready(periph5_mon_axi_arready),
        .m_axi_rid(periph5_mon_axi_rid),
        .m_axi_rdata(periph5_mon_axi_rdata),
        .m_axi_rresp(periph5_mon_axi_rresp),
        .m_axi_rlast(periph5_mon_axi_rlast),
        .m_axi_ruser(periph5_mon_axi_ruser),
        .m_axi_rvalid(periph5_mon_axi_rvalid),
        .m_axi_rready(periph5_mon_axi_rready),
    ...
    axi4_to_apb5_shim #(
        ...
        .s_axi_awid(periph5_mon_axi_awid),
        .s_axi_awaddr(periph5_mon_axi_awaddr),
        .s_axi_awlen(periph5_mon_axi_awlen),
        .s_axi_awsize(periph5_mon_axi_awsize),
        .s_axi_awburst(periph5_mon_axi_awburst),
        .s_axi_awlock(periph5_mon_axi_awlock),
        .s_axi_awcache(periph5_mon_axi_awcache),
        .s_axi_awprot(periph5_mon_axi_awprot),
        .s_axi_awqos(periph5_mon_axi_awqos),
        .s_axi_awregion(periph5_mon_axi_awregion),
        .s_axi_awuser(periph5_mon_axi_awuser),
        .s_axi_awvalid(periph5_mon_axi_awvalid),
        .s_axi_awready(periph5_mon_axi_awready),
        .s_axi_wdata(periph5_mon_axi_wdata),
        .s_axi_wstrb(periph5_mon_axi_wstrb),
        .s_axi_wlast(periph5_mon_axi_wlast),
        .s_axi_wuser(periph5_mon_axi_wuser),
        .s_axi_wvalid(periph5_mon_axi_wvalid),
        .s_axi_wready(periph5_mon_axi_wready),
        .s_axi_bid(periph5_mon_axi_bid),
        .s_axi_bresp(periph5_mon_axi_bresp),
        .s_axi_buser(periph5_mon_axi_buser),
        .s_axi_bvalid(converter_bvalid),
        .s_axi_bready(converter_bready),

        // AXI4 read channels (from crossbar)
        .s_axi_arid(periph5_mon_axi_arid),
        .s_axi_araddr(periph5_mon_axi_araddr),
        .s_axi_arlen(periph5_mon_axi_arlen),
        .s_axi_arsize(periph5_mon_axi_arsize),
        .s_axi_arburst(periph5_mon_axi_arburst),
        .s_axi_arlock(periph5_mon_axi_arlock),
        .s_axi_arcache(periph5_mon_axi_arcache),
        .s_axi_arprot(periph5_mon_axi_arprot),
        .s_axi_arqos(periph5_mon_axi_arqos),
        .s_axi_arregion(periph5_mon_axi_arregion),
        .s_axi_aruser(periph5_mon_axi_aruser),
        .s_axi_arvalid(periph5_mon_axi_arvalid),
        .s_axi_arready(periph5_mon_axi_arready),
        .s_axi_rid(periph5_mon_axi_rid),
        .s_axi_rdata(periph5_mon_axi_rdata),
        .s_axi_rresp(periph5_mon_axi_rresp),
        .s_axi_rlast(converter_rlast),
        .s_axi_ruser(periph5_mon_axi_ruser),
    ...
    assign periph5_mon_axi_bvalid = converter_bvalid;
    assign converter_bready = periph5_mon_axi_bready;
    assign periph5_mon_axi_rvalid = converter_rvalid;
    assign converter_rready = periph5_mon_axi_rready;
    assign periph5_mon_axi_rlast = converter_rlast;
