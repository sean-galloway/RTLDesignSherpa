...
# ------------------------------------------------------------
# Bridge Micro-Architecture Specification PDF Generator
# ------------------------------------------------------------
# Usage:
...
#
# This script builds the Bridge MAS document
# (DOCX and PDF) from Markdown sources using md_to_docx.py.
# ------------------------------------------------------------

# Default values
REV="1.1"
ASSETS="bridge_mas/assets"
MAS_INDEX="bridge_mas/bridge_mas_index.md"
...
Description:
  This script generates a DOCX and PDF version of the Bridge MAS
...
# ------------------------------------------------------------
OUTPUT_BASENAME="Bridge_MAS_v${REV}"
...
# ------------------------------------------------------------
echo "------------------------------------------------------------"
echo " Generating Bridge Micro-Architecture Specification"
echo "------------------------------------------------------------"
echo "  Version:     ${REV}"
...
STYLE_SRC="bridge_mas/bridge_mas_styles.yaml"
