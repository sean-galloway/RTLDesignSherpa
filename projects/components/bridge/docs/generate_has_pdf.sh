...
# ------------------------------------------------------------
# Bridge Hardware Architecture Specification PDF Generator
# ------------------------------------------------------------
# Usage:
...
#
# This script builds the Bridge HAS document
...
Description:
  This script generates a DOCX and PDF version of the Bridge HAS
...
# ------------------------------------------------------------
OUTPUT_BASENAME="Bridge_HAS_v${REV}"
...
# ------------------------------------------------------------
echo "------------------------------------------------------------"
echo " Generating Bridge Hardware Architecture Specification"
echo "------------------------------------------------------------"
echo "  Version:     ${REV}"
