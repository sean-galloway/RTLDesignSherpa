...
# ------------------------------------------------------------
# Bridge Specification PDF Generator
# ------------------------------------------------------------
# Usage:
...
#
# This script builds the Bridge specification document
# (DOCX and PDF) from Markdown sources using md_to_docx.py.
# ------------------------------------------------------------

# Default values
REV="0.90"
ASSETS="bridge_spec/assets"
...
Description:
  This script generates a DOCX and PDF version of the Bridge specification
...
# ------------------------------------------------------------
OUTPUT_BASENAME="Bridge_Specification_v${REV}"
...
# ------------------------------------------------------------
echo "------------------------------------------------------------"
echo " Generating Bridge Specification"
echo "------------------------------------------------------------"
echo "  Version:     ${REV}"
