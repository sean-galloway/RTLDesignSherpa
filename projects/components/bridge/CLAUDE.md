...
there are FIVE strings, not one:
...
"bridge_generator.py" appears in no generated file; matching on it finds
nothing, and matching only on BridgeModuleGenerator finds 1 file in 5.
