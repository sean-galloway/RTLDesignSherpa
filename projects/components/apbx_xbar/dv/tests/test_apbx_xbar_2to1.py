...
This test validates the arbitration functionality of apbx_xbar_2to1,
...
def test_apbx_xbar_2to1(request, aw, dw):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/apbx_xbar/rtl/filelists/wrapper/apbx_xbar_2to1_wrap.f'
    )
