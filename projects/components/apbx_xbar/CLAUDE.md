...
**📖 Complete Specification:** `projects/components/apbx_xbar/PRD.md` ← **Always reference this for technical details**
...
```
projects/components/apbx_xbar/
├── rtl/
│   ├── apbx_xbar_1to1.sv        Core crossbar modules
│   ├── apbx_xbar_2to1.sv
│   ├── apbx_xbar_1to4.sv
│   ├── apbx_xbar_2to4.sv
│   ├── apbx_xbar_thin.sv
...
```bash
cd projects/components/apbx_xbar/bin/
python generate_xbars.py --masters 3 --slaves 8   # writes apbx_xbar_3to8.sv next to the script
...
```bash
cd projects/components/apbx_xbar/dv/tests/
...
**Test coverage:**
- **test_apbx_xbar_1to1**: 100+ transactions (passthrough)
...
ls projects/components/apbx_xbar/rtl/*.sv
...
# Check documentation
cat projects/components/apbx_xbar/PRD.md
cat projects/components/apbx_xbar/README.md
```
