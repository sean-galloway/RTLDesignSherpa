...
This test validates the address decoding functionality of apb4_xbar_1to4,
...
async def apb4_xbar_1to4_test(dut):
...
def test_apb4_xbar_1to4(request, aw, dw):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/apb4_xbar/rtl/filelists/wrapper/apb4_xbar_1to4_wrap.f'
    )
    ...
    test_name = f'test_apb4_xbar_1to4_aw{aw:03d}_dw{dw:03d}'
