...
This test validates the arbitration functionality of apb4_xbar_2to1,
...
async def apb4_xbar_2to1_test(dut):
...
def test_apb4_xbar_2to1(request, aw, dw):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/apb4_xbar/rtl/filelists/wrapper/apb4_xbar_2to1_wrap.f'
    )
    ...
    test_name = f'test_apb4_xbar_2to1_aw{aw:03d}_dw{dw:03d}'
