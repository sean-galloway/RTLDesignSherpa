...
1. **APB Crossbar Architecture (2x4 Example)**
   - Source: [assets/graphviz/apb4_xbar_architecture.gv](assets/graphviz/apb4_xbar_architecture.gv)
   - Rendered: [assets/png/apb4_xbar_architecture.png](assets/png/apb4_xbar_architecture.png)
...
| Module | M×N | Use Case |
|--------|-----|----------|
| apb4_xbar_1to1 | 1×1 | Passthrough, protocol conversion |
| apb4_xbar_2to1 | 2×1 | Multi-master arbitration |
| apb4_xbar_1to4 | 1×4 | Simple SoC peripheral bus |
| apb4_xbar_2to4 | 2×4 | Typical SoC with CPU+DMA |
| apb4_xbar_thin | 1×1 | Minimal overhead passthrough |
...
- **[APB Crossbar HAS](../apb4_xbar_has/apb4_xbar_has_index.md)** - Hardware Architecture Specification (high-level)
...
- **Core Modules:** `../../rtl/apb4_xbar_*.sv` - Pre-generated crossbars
