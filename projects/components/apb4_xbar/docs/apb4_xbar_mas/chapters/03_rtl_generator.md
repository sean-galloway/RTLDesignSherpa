...
└── (repo root)/bin/rtl_generators/amba/
    └── apb4_xbar_generator.py          ← Core generator engine
```

**Why Two Files?**
1. **Core Generator** (`apb4_xbar_generator.py`): Reusable library function
   - Can be imported by other scripts
   - Contains `generate_apb4_xbar()` function
...
module_name = f"apb4_xbar_{M}to{N}"                 # Module name
```
...
**Generated File:** `apb4_xbar_2to10.sv`
...
**Generated File:** `apb4_xbar_4to4.sv`
...
**Generated File:** `apb4_xbar_1to8.sv`
...
```systemverilog
// Generated file: apb4_xbar_3to6.sv
...
```bash
cd ../../rtl/
verilator --lint-only apb4_xbar_2to4.sv
```

**3. Run Functional Tests**
```bash
cd ../../dv/tests/
pytest test_apb4_xbar_2to4.py -v
```
...
from bin.rtl_generators.amba.apb4_xbar_generator import generate_apb4_xbar
...
### Issue: "ModuleNotFoundError: No module named 'amba.apb4_xbar_generator'"
...
ls -la bin/apb4_xbar_generator.py
