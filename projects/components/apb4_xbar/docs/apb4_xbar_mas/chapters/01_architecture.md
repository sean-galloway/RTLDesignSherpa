...
![APB Crossbar Architecture (2x4 Example)](../assets/png/apb4_xbar_architecture.png)
...
|--------|-----|-----|----------|
| `apb4_xbar_1to1` | 1×1 | ~200 | Passthrough, protocol conversion |
| `apb4_xbar_2to1` | 2×1 | ~400 | Multi-master arbitration |
| `apb4_xbar_1to4` | 1×4 | ~500 | Simple SoC peripheral bus |
| `apb4_xbar_2to4` | 2×4 | ~1000 | Typical SoC with CPU+DMA |
| `apb4_xbar_thin` | 1×1 | ~150 | Minimal overhead passthrough |
