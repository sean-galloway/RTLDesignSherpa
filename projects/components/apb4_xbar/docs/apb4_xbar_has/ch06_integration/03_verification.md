...
|---------|-------------------|--------|
| apb4_xbar_1to1 | 100+ | Pass |
| apb4_xbar_2to1 | 130+ | Pass |
| apb4_xbar_1to4 | 200+ | Pass |
| apb4_xbar_2to4 | 350+ | Pass |
...
# Generate waveforms
pytest test_apb4_xbar_2to4.py --vcd=debug.vcd
...
- **[APB Crossbar MAS](../apb4_xbar_mas/apb4_xbar_mas_index.md)** - Detailed implementation
