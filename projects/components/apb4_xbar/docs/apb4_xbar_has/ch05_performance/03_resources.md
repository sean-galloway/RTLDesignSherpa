...
|---------|------|-----|-------------|
| apb4_xbar_thin | ~50 | ~20 | Minimal passthrough |
| apb4_xbar_1to1 | ~150 | ~80 | Full 1x1 with buffering |
| apb4_xbar_2to1 | ~300 | ~150 | 2 masters, arbitration |
| apb4_xbar_1to4 | ~400 | ~200 | 4 slaves, decode |
| apb4_xbar_2to4 | ~800 | ~400 | Full 2x4 crossbar |
...
|---------|---------------|---------|------------|
| apb4_xbar_thin | ~150 | 1 | Low |
| apb4_xbar_1to1 | ~200 | 3 | Low |
| apb4_xbar_2to1 | ~400 | 5 | Medium |
| apb4_xbar_1to4 | ~500 | 7 | Medium |
| apb4_xbar_2to4 | ~1000 | 11 | Medium-High |
...
Relative area comparison (normalized to apb4_xbar_1to1):

| Variant | Relative Area |
|---------|---------------|
| apb4_xbar_thin | 0.3x |
| apb4_xbar_1to1 | 1.0x (baseline) |
| apb4_xbar_2to1 | 2.0x |
| apb4_xbar_1to4 | 2.5x |
| apb4_xbar_2to4 | 5.0x |
