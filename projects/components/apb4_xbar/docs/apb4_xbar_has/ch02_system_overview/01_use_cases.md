...
- 1 Master
- 1 Slave
- Variant: `apb4_xbar_1to1` or `apb4_xbar_thin`
...
|----------|---------------------|-----------|
| Simple peripheral bus | `apb4_xbar_1to4` | Most common SoC configuration |
| CPU + DMA system | `apb4_xbar_2to4` | Fair access for both masters |
| Timing isolation | `apb4_xbar_thin` | Minimal overhead passthrough |
| Multi-master arbitration | `apb4_xbar_2to1` | Focus on arbitration only |
