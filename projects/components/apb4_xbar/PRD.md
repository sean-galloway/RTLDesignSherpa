...
![APB Crossbar Architecture (2x4 Example)](docs/apb4_xbar_mas/assets/svg/apb4_xbar_architecture.svg)
*Figure: APB Crossbar top-level architecture showing 2 masters connected to 4 slaves. [Source: docs/apb4_xbar_mas/assets/graphviz/apb4_xbar_architecture.gv](docs/apb4_xbar_mas/assets/graphviz/apb4_xbar_architecture.gv) | [SVG](docs/apb4_xbar_mas/assets/svg/apb4_xbar_architecture.svg)*
...
![Address Decode Flow](docs/apb4_xbar_mas/assets/svg/address_decode_flow.svg)
*Figure: Address decode flow showing how address 0x10023456 routes to Slave 2. [Source: docs/apb4_xbar_mas/assets/graphviz/address_decode_flow.gv](docs/apb4_xbar_mas/assets/graphviz/address_decode_flow.gv) | [SVG](docs/apb4_xbar_mas/assets/svg/address_decode_flow.svg)*
...
![Round-Robin Arbitration Timing](docs/apb4_xbar_mas/assets/wavedrom/arbitration_round_robin.svg)
*Figure: Round-robin arbitration timing showing 2 masters competing for Slave 0. Master priority rotates after each grant to ensure fair access. [Source: docs/apb4_xbar_mas/assets/wavedrom/arbitration_round_robin.json](docs/apb4_xbar_mas/assets/wavedrom/arbitration_round_robin.json)*
...
|--------|---------|--------|----------|-----------|
| **apb4_xbar_1to1** | 1 | 1 | Protocol conversion, testing | ~200 LOC |
| **apb4_xbar_2to1** | 2 | 1 | Multi-master arbitration | ~400 LOC |
| **apb4_xbar_1to4** | 1 | 4 | Address decode, simple SoC | ~500 LOC |
| **apb4_xbar_2to4** | 2 | 4 | Full crossbar, typical SoC | ~1000 LOC |
| **apb4_xbar_thin** | 1 | 1 | Minimal passthrough | ~150 LOC |
...
|---------|---------------|---------|
| `apb4_xbar_1to1_wrap` | 1×1 | Simple connection |
| `apb4_xbar_2to1_wrap` | 2×1 | Dual-master arbitration |
| `apb4_xbar_1to4_wrap` | 1×4 | Single-master decode |
| `apb4_xbar_2to4_wrap` | 2×4 | Full SoC crossbar |
| `apb4_xbar_wrap_m10_s10` | 10×10 | Large crossbar |
| `apb4_xbar_thin_wrap_m10_s10` | 10×10 | Minimal version |
...
```bash
# Available in projects/components/apb4_xbar/rtl/
apb4_xbar_1to1.sv
apb4_xbar_2to1.sv
apb4_xbar_1to4.sv
apb4_xbar_2to4.sv
...
|------|--------------|--------|----------|
| **test_apb4_xbar_1to1** | 100+ | ✅ Pass | Basic connectivity |
| **test_apb4_xbar_2to1** | 130+ | ✅ Pass | Arbitration stress |
| **test_apb4_xbar_1to4** | 200+ | ✅ Pass | Address decode |
| **test_apb4_xbar_2to4** | 350+ | ✅ Pass | Full crossbar stress |
...
- `projects/components/apb4_xbar/bin/apb4_xbar_generator.py` - Main generator
