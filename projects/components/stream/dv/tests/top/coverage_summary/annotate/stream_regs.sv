...
%000000     logic cpuif_wr_err;
 ...
 000020     logic decoded_req;
 000014     logic decoded_req_is_wr;
%000000     logic [31:0] decoded_wr_data;
%000001     logic [31:0] decoded_wr_biten;
        
%000001     always_comb begin
%000001         decoded_reg_strb.GLOBAL_CTRL = cpuif_req_masked & (cpuif_addr == 10'h100);
%000001         decoded_reg_strb.GLOBAL_STATUS = cpuif_req_masked & (cpuif_addr == 10'h104);
%000001         decoded_reg_strb.VERSION = cpuif_req_masked & (cpuif_addr == 10'h108);
%000001         decoded_reg_strb.CHANNEL_ENABLE = cpuif_req_masked & (cpuif_addr == 10'h120);
%000001         decoded_reg_strb.CHANNEL_RESET = cpuif_req_masked & (cpuif_addr == 10'h124);
%000001         decoded_reg_strb.CHANNEL_IDLE = cpuif_req_masked & (cpuif_addr == 10'h140);
%000001         decoded_reg_strb.DESC_ENGINE_IDLE = cpuif_req_masked & (cpuif_addr == 10'h144);
%000001         decoded_reg_strb.SCHEDULER_IDLE = cpuif_req_masked & (cpuif_addr == 10'h148);
%000001         for(int i0=0; i0<8; i0++) begin
%000008             decoded_reg_strb.CH_STATE[i0].STATE = cpuif_req_masked & (cpuif_addr == 10'h150 + (10)'(i0) * 10'h4);
                end
%000001         decoded_reg_strb.SCHED_TIMEOUT_CYCLES = cpuif_req_masked & (cpuif_addr == 10'h200);
%000001         decoded_reg_strb.SCHED_CONFIG = cpuif_req_masked & (cpuif_addr == 10'h204);
%000001         decoded_reg_strb.DESCENG_CONFIG = cpuif_req_masked & (cpuif_addr == 10'h220);
%000001         decoded_reg_strb.DESCENG_ADDR0_BASE = cpuif_req_masked & (cpuif_addr == 10'h224);
%000001         decoded_reg_strb.DESCENG_ADDR0_LIMIT = cpuif_req_masked & (cpuif_addr == 10'h228);
%000001         decoded_reg_strb.DESCENG_ADDR1_BASE = cpuif_req_masked & (cpuif_addr == 10'h22c);
%000001         decoded_reg_strb.DESCENG_ADDR1_LIMIT = cpuif_req_masked & (cpuif_addr == 10'h230);
%000001         decoded_reg_strb.DAXMON_ENABLE = cpuif_req_masked & (cpuif_addr == 10'h240);
%000001         decoded_reg_strb.DAXMON_TIMEOUT = cpuif_req_masked & (cpuif_addr == 10'h244);
%000001         decoded_reg_strb.DAXMON_LATENCY_THRESH = cpuif_req_masked & (cpuif_addr == 10'h248);
%000001         decoded_reg_strb.DAXMON_PKT_MASK = cpuif_req_masked & (cpuif_addr == 10'h24c);
%000001         decoded_reg_strb.DAXMON_ERR_CFG = cpuif_req_masked & (cpuif_addr == 10'h250);
%000001         decoded_reg_strb.DAXMON_MASK1 = cpuif_req_masked & (cpuif_addr == 10'h254);
%000001         decoded_reg_strb.DAXMON_MASK2 = cpuif_req_masked & (cpuif_addr == 10'h258);
%000001         decoded_reg_strb.DAXMON_MASK3 = cpuif_req_masked & (cpuif_addr == 10'h25c);
%000001         decoded_reg_strb.RDMON_ENABLE = cpuif_req_masked & (cpuif_addr == 10'h260);
%000001         decoded_reg_strb.RDMON_TIMEOUT = cpuif_req_masked & (cpuif_addr == 10'h264);
%000001         decoded_reg_strb.RDMON_LATENCY_THRESH = cpuif_req_masked & (cpuif_addr == 10'h268);
%000001         decoded_reg_strb.RDMON_PKT_MASK = cpuif_req_masked & (cpuif_addr == 10'h26c);
%000001         decoded_reg_strb.RDMON_ERR_CFG = cpuif_req_masked & (cpuif_addr == 10'h270);
%000001         decoded_reg_strb.RDMON_MASK1 = cpuif_req_masked & (cpuif_addr == 10'h274);
%000001         decoded_reg_strb.RDMON_MASK2 = cpuif_req_masked & (cpuif_addr == 10'h278);
%000001         decoded_reg_strb.RDMON_MASK3 = cpuif_req_masked & (cpuif_addr == 10'h27c);
%000001         decoded_reg_strb.WRMON_ENABLE = cpuif_req_masked & (cpuif_addr == 10'h280);
%000001         decoded_reg_strb.WRMON_TIMEOUT = cpuif_req_masked & (cpuif_addr == 10'h284);
%000001         decoded_reg_strb.WRMON_LATENCY_THRESH = cpuif_req_masked & (cpuif_addr == 10'h288);
%000001         decoded_reg_strb.WRMON_PKT_MASK = cpuif_req_masked & (cpuif_addr == 10'h28c);
%000001         decoded_reg_strb.WRMON_ERR_CFG = cpuif_req_masked & (cpuif_addr == 10'h290);
%000001         decoded_reg_strb.WRMON_MASK1 = cpuif_req_masked & (cpuif_addr == 10'h294);
%000001         decoded_reg_strb.WRMON_MASK2 = cpuif_req_masked & (cpuif_addr == 10'h298);
%000001         decoded_reg_strb.WRMON_MASK3 = cpuif_req_masked & (cpuif_addr == 10'h29c);
%000001         decoded_reg_strb.AXI_XFER_CONFIG = cpuif_req_masked & (cpuif_addr == 10'h2a0);
%000001         decoded_reg_strb.PERF_CONFIG = cpuif_req_masked & (cpuif_addr == 10'h2b0);
            end
 ...
 010968         next_c = field_storage.GLOBAL_CTRL.GLOBAL_EN.value;
 010968         load_next_c = '0;
 000018         if(decoded_reg_strb.GLOBAL_CTRL && decoded_req_is_wr) begin // SW write
 000018             next_c = (field_storage.GLOBAL_CTRL.GLOBAL_EN.value & ~decoded_wr_biten[0:0]) | (decoded_wr_data[0:0] & decoded_wr_biten[0:0]);
 000018             load_next_c = '1;
                end
 010968         field_combo.GLOBAL_CTRL.GLOBAL_EN.next = next_c;
 010968         field_combo.GLOBAL_CTRL.GLOBAL_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.GLOBAL_CTRL.GLOBAL_EN.value <= 1'h0;
 001151         end else begin
%000002             if(field_combo.GLOBAL_CTRL.GLOBAL_EN.load_next) begin
%000002                 field_storage.GLOBAL_CTRL.GLOBAL_EN.value <= field_combo.GLOBAL_CTRL.GLOBAL_EN.next;
                    end
                end
            end
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.GLOBAL_CTRL.GLOBAL_RST.value;
 010968         load_next_c = '0;
 000018         if(decoded_reg_strb.GLOBAL_CTRL && decoded_req_is_wr) begin // SW write
 000018             next_c = (field_storage.GLOBAL_CTRL.GLOBAL_RST.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
 000018             load_next_c = '1;
                end
 010968         field_combo.GLOBAL_CTRL.GLOBAL_RST.next = next_c;
 010968         field_combo.GLOBAL_CTRL.GLOBAL_RST.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.GLOBAL_CTRL.GLOBAL_RST.value <= 1'h0;
 001151         end else begin
%000002             if(field_combo.GLOBAL_CTRL.GLOBAL_RST.load_next) begin
%000002                 field_storage.GLOBAL_CTRL.GLOBAL_RST.value <= field_combo.GLOBAL_CTRL.GLOBAL_RST.next;
                    end
                end
            end
 ...
 010968     always_comb begin
                ...
                automatic logic load_next_c;
 010968         next_c = field_storage.CHANNEL_ENABLE.CH_EN.value;
 010968         load_next_c = '0;
 000018         if(decoded_reg_strb.CHANNEL_ENABLE && decoded_req_is_wr) begin // SW write
 000018             next_c = (field_storage.CHANNEL_ENABLE.CH_EN.value & ~decoded_wr_biten[7:0]) | (decoded_wr_data[7:0] & decoded_wr_biten[7:0]);
 000018             load_next_c = '1;
                end
 010968         field_combo.CHANNEL_ENABLE.CH_EN.next = next_c;
 010968         field_combo.CHANNEL_ENABLE.CH_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.CHANNEL_ENABLE.CH_EN.value <= 8'h0;
 001151         end else begin
%000002             if(field_combo.CHANNEL_ENABLE.CH_EN.load_next) begin
%000002                 field_storage.CHANNEL_ENABLE.CH_EN.value <= field_combo.CHANNEL_ENABLE.CH_EN.next;
                    end
                end
            end
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.CHANNEL_RESET.CH_RST.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.CHANNEL_RESET.CH_RST.next = next_c;
 010968         field_combo.CHANNEL_RESET.CH_RST.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.CHANNEL_RESET.CH_RST.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.CHANNEL_RESET.CH_RST.value <= field_combo.CHANNEL_RESET.CH_RST.next;
 ...
 010968     always_comb begin
                ...
                automatic logic load_next_c;
 010968         next_c = field_storage.SCHED_TIMEOUT_CYCLES.TIMEOUT_CYCLES.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.SCHED_TIMEOUT_CYCLES.TIMEOUT_CYCLES.next = next_c;
 010968         field_combo.SCHED_TIMEOUT_CYCLES.TIMEOUT_CYCLES.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.SCHED_TIMEOUT_CYCLES.TIMEOUT_CYCLES.value <= 16'h3e8;
 001151         end else begin
...
%000000                 field_storage.SCHED_TIMEOUT_CYCLES.TIMEOUT_CYCLES.value <= field_combo.SCHED_TIMEOUT_CYCLES.TIMEOUT_CYCLES.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.SCHED_CONFIG.SCHED_EN.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.SCHED_CONFIG.SCHED_EN.next = next_c;
 010968         field_combo.SCHED_CONFIG.SCHED_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.SCHED_CONFIG.SCHED_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.SCHED_CONFIG.SCHED_EN.value <= field_combo.SCHED_CONFIG.SCHED_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.SCHED_CONFIG.TIMEOUT_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.SCHED_CONFIG && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.SCHED_CONFIG.TIMEOUT_EN.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
%000000             load_next_c = '1;
                end
 010968         field_combo.SCHED_CONFIG.TIMEOUT_EN.next = next_c;
 010968         field_combo.SCHED_CONFIG.TIMEOUT_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.SCHED_CONFIG.TIMEOUT_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.SCHED_CONFIG.TIMEOUT_EN.value <= field_combo.SCHED_CONFIG.TIMEOUT_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.SCHED_CONFIG.ERR_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.SCHED_CONFIG && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.SCHED_CONFIG.ERR_EN.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
%000000             load_next_c = '1;
                end
 010968         field_combo.SCHED_CONFIG.ERR_EN.next = next_c;
 010968         field_combo.SCHED_CONFIG.ERR_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.SCHED_CONFIG.ERR_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.SCHED_CONFIG.ERR_EN.value <= field_combo.SCHED_CONFIG.ERR_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.SCHED_CONFIG.COMPL_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.SCHED_CONFIG && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.SCHED_CONFIG.COMPL_EN.value & ~decoded_wr_biten[3:3]) | (decoded_wr_data[3:3] & decoded_wr_biten[3:3]);
%000000             load_next_c = '1;
                end
 010968         field_combo.SCHED_CONFIG.COMPL_EN.next = next_c;
 010968         field_combo.SCHED_CONFIG.COMPL_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.SCHED_CONFIG.COMPL_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.SCHED_CONFIG.COMPL_EN.value <= field_combo.SCHED_CONFIG.COMPL_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.SCHED_CONFIG.PERF_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.SCHED_CONFIG && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.SCHED_CONFIG.PERF_EN.value & ~decoded_wr_biten[4:4]) | (decoded_wr_data[4:4] & decoded_wr_biten[4:4]);
%000000             load_next_c = '1;
                end
 010968         field_combo.SCHED_CONFIG.PERF_EN.next = next_c;
 010968         field_combo.SCHED_CONFIG.PERF_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.SCHED_CONFIG.PERF_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.SCHED_CONFIG.PERF_EN.value <= field_combo.SCHED_CONFIG.PERF_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DESCENG_CONFIG.DESCENG_EN.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DESCENG_CONFIG.DESCENG_EN.next = next_c;
 010968         field_combo.DESCENG_CONFIG.DESCENG_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DESCENG_CONFIG.DESCENG_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.DESCENG_CONFIG.DESCENG_EN.value <= field_combo.DESCENG_CONFIG.DESCENG_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DESCENG_CONFIG.PREFETCH_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DESCENG_CONFIG && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DESCENG_CONFIG.PREFETCH_EN.next = next_c;
 010968         field_combo.DESCENG_CONFIG.PREFETCH_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DESCENG_CONFIG.PREFETCH_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.DESCENG_CONFIG.PREFETCH_EN.value <= field_combo.DESCENG_CONFIG.PREFETCH_EN.next;
 ...
 010968     always_comb begin
                ...
                automatic logic load_next_c;
 010968         next_c = field_storage.DESCENG_CONFIG.FIFO_THRESH.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DESCENG_CONFIG && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DESCENG_CONFIG.FIFO_THRESH.next = next_c;
 010968         field_combo.DESCENG_CONFIG.FIFO_THRESH.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DESCENG_CONFIG.FIFO_THRESH.value <= 4'h8;
 001151         end else begin
...
%000000                 field_storage.DESCENG_CONFIG.FIFO_THRESH.value <= field_combo.DESCENG_CONFIG.FIFO_THRESH.next;
 ...
 010968     always_comb begin
                ...
                automatic logic load_next_c;
 010968         next_c = field_storage.DESCENG_ADDR0_BASE.ADDR0_BASE.value;
 010968         load_next_c = '0;
 000018         if(decoded_reg_strb.DESCENG_ADDR0_BASE && decoded_req_is_wr) begin // SW write
 000018             next_c = (field_storage.DESCENG_ADDR0_BASE.ADDR0_BASE.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
 000018             load_next_c = '1;
                end
 010968         field_combo.DESCENG_ADDR0_BASE.ADDR0_BASE.next = next_c;
 010968         field_combo.DESCENG_ADDR0_BASE.ADDR0_BASE.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DESCENG_ADDR0_BASE.ADDR0_BASE.value <= 32'h0;
 001151         end else begin
%000002             if(field_combo.DESCENG_ADDR0_BASE.ADDR0_BASE.load_next) begin
%000002                 field_storage.DESCENG_ADDR0_BASE.ADDR0_BASE.value <= field_combo.DESCENG_ADDR0_BASE.ADDR0_BASE.next;
                    end
                end
            end
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.value;
 010968         load_next_c = '0;
 000018         if(decoded_reg_strb.DESCENG_ADDR0_LIMIT && decoded_req_is_wr) begin // SW write
 000018             next_c = (field_storage.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
 000018             load_next_c = '1;
                end
 010968         field_combo.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.next = next_c;
 010968         field_combo.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.value <= 32'hffffffff;
 001151         end else begin
%000002             if(field_combo.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.load_next) begin
%000002                 field_storage.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.value <= field_combo.DESCENG_ADDR0_LIMIT.ADDR0_LIMIT.next;
                    end
                end
            end
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DESCENG_ADDR1_BASE.ADDR1_BASE.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DESCENG_ADDR1_BASE.ADDR1_BASE.next = next_c;
 010968         field_combo.DESCENG_ADDR1_BASE.ADDR1_BASE.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DESCENG_ADDR1_BASE.ADDR1_BASE.value <= 32'h0;
 001151         end else begin
...
%000000                 field_storage.DESCENG_ADDR1_BASE.ADDR1_BASE.value <= field_combo.DESCENG_ADDR1_BASE.ADDR1_BASE.next;
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DESCENG_ADDR1_LIMIT.ADDR1_LIMIT.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DESCENG_ADDR1_LIMIT.ADDR1_LIMIT.next = next_c;
 010968         field_combo.DESCENG_ADDR1_LIMIT.ADDR1_LIMIT.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DESCENG_ADDR1_LIMIT.ADDR1_LIMIT.value <= 32'hffffffff;
 001151         end else begin
...
%000000                 field_storage.DESCENG_ADDR1_LIMIT.ADDR1_LIMIT.value <= field_combo.DESCENG_ADDR1_LIMIT.ADDR1_LIMIT.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_ENABLE.MON_EN.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_ENABLE.MON_EN.next = next_c;
 010968         field_combo.DAXMON_ENABLE.MON_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_ENABLE.MON_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.DAXMON_ENABLE.MON_EN.value <= field_combo.DAXMON_ENABLE.MON_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_ENABLE.ERR_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.DAXMON_ENABLE.ERR_EN.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
%000000             load_next_c = '1;
                end
 010968         field_combo.DAXMON_ENABLE.ERR_EN.next = next_c;
 010968         field_combo.DAXMON_ENABLE.ERR_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_ENABLE.ERR_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.DAXMON_ENABLE.ERR_EN.value <= field_combo.DAXMON_ENABLE.ERR_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_ENABLE.COMPL_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.DAXMON_ENABLE.COMPL_EN.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
%000000             load_next_c = '1;
                end
 010968         field_combo.DAXMON_ENABLE.COMPL_EN.next = next_c;
 010968         field_combo.DAXMON_ENABLE.COMPL_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_ENABLE.COMPL_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.DAXMON_ENABLE.COMPL_EN.value <= field_combo.DAXMON_ENABLE.COMPL_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_ENABLE.TIMEOUT_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.DAXMON_ENABLE.TIMEOUT_EN.value & ~decoded_wr_biten[3:3]) | (decoded_wr_data[3:3] & decoded_wr_biten[3:3]);
%000000             load_next_c = '1;
                end
 010968         field_combo.DAXMON_ENABLE.TIMEOUT_EN.next = next_c;
 010968         field_combo.DAXMON_ENABLE.TIMEOUT_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_ENABLE.TIMEOUT_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.DAXMON_ENABLE.TIMEOUT_EN.value <= field_combo.DAXMON_ENABLE.TIMEOUT_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_ENABLE.PERF_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.DAXMON_ENABLE.PERF_EN.value & ~decoded_wr_biten[4:4]) | (decoded_wr_data[4:4] & decoded_wr_biten[4:4]);
%000000             load_next_c = '1;
                end
 010968         field_combo.DAXMON_ENABLE.PERF_EN.next = next_c;
 010968         field_combo.DAXMON_ENABLE.PERF_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_ENABLE.PERF_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.DAXMON_ENABLE.PERF_EN.value <= field_combo.DAXMON_ENABLE.PERF_EN.next;
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_TIMEOUT.TIMEOUT_CYCLES.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_TIMEOUT.TIMEOUT_CYCLES.next = next_c;
 010968         field_combo.DAXMON_TIMEOUT.TIMEOUT_CYCLES.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_TIMEOUT.TIMEOUT_CYCLES.value <= 32'h2710;
 001151         end else begin
...
%000000                 field_storage.DAXMON_TIMEOUT.TIMEOUT_CYCLES.value <= field_combo.DAXMON_TIMEOUT.TIMEOUT_CYCLES.next;
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_LATENCY_THRESH.LATENCY_THRESH.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_LATENCY_THRESH.LATENCY_THRESH.next = next_c;
 010968         field_combo.DAXMON_LATENCY_THRESH.LATENCY_THRESH.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_LATENCY_THRESH.LATENCY_THRESH.value <= 32'h1388;
 001151         end else begin
...
%000000                 field_storage.DAXMON_LATENCY_THRESH.LATENCY_THRESH.value <= field_combo.DAXMON_LATENCY_THRESH.LATENCY_THRESH.next;
 ...
 010968     always_comb begin
                automatic logic [15:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_PKT_MASK.PKT_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_PKT_MASK.PKT_MASK.next = next_c;
 010968         field_combo.DAXMON_PKT_MASK.PKT_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_PKT_MASK.PKT_MASK.value <= 16'hffff;
 001151         end else begin
...
%000000                 field_storage.DAXMON_PKT_MASK.PKT_MASK.value <= field_combo.DAXMON_PKT_MASK.PKT_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [3:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_ERR_CFG.ERR_SELECT.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_ERR_CFG.ERR_SELECT.next = next_c;
 010968         field_combo.DAXMON_ERR_CFG.ERR_SELECT.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_ERR_CFG.ERR_SELECT.value <= 4'h0;
 001151         end else begin
...
%000000                 field_storage.DAXMON_ERR_CFG.ERR_SELECT.value <= field_combo.DAXMON_ERR_CFG.ERR_SELECT.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_ERR_CFG.ERR_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_ERR_CFG && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_ERR_CFG.ERR_MASK.next = next_c;
 010968         field_combo.DAXMON_ERR_CFG.ERR_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_ERR_CFG.ERR_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.DAXMON_ERR_CFG.ERR_MASK.value <= field_combo.DAXMON_ERR_CFG.ERR_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_MASK1.TIMEOUT_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_MASK1.TIMEOUT_MASK.next = next_c;
 010968         field_combo.DAXMON_MASK1.TIMEOUT_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_MASK1.TIMEOUT_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.DAXMON_MASK1.TIMEOUT_MASK.value <= field_combo.DAXMON_MASK1.TIMEOUT_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_MASK1.COMPL_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_MASK1 && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_MASK1.COMPL_MASK.next = next_c;
 010968         field_combo.DAXMON_MASK1.COMPL_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_MASK1.COMPL_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.DAXMON_MASK1.COMPL_MASK.value <= field_combo.DAXMON_MASK1.COMPL_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_MASK2.THRESH_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_MASK2.THRESH_MASK.next = next_c;
 010968         field_combo.DAXMON_MASK2.THRESH_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_MASK2.THRESH_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.DAXMON_MASK2.THRESH_MASK.value <= field_combo.DAXMON_MASK2.THRESH_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_MASK2.PERF_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_MASK2 && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_MASK2.PERF_MASK.next = next_c;
 010968         field_combo.DAXMON_MASK2.PERF_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_MASK2.PERF_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.DAXMON_MASK2.PERF_MASK.value <= field_combo.DAXMON_MASK2.PERF_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_MASK3.ADDR_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_MASK3.ADDR_MASK.next = next_c;
 010968         field_combo.DAXMON_MASK3.ADDR_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_MASK3.ADDR_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.DAXMON_MASK3.ADDR_MASK.value <= field_combo.DAXMON_MASK3.ADDR_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.DAXMON_MASK3.DEBUG_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.DAXMON_MASK3 && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.DAXMON_MASK3.DEBUG_MASK.next = next_c;
 010968         field_combo.DAXMON_MASK3.DEBUG_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.DAXMON_MASK3.DEBUG_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.DAXMON_MASK3.DEBUG_MASK.value <= field_combo.DAXMON_MASK3.DEBUG_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_ENABLE.MON_EN.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_ENABLE.MON_EN.next = next_c;
 010968         field_combo.RDMON_ENABLE.MON_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_ENABLE.MON_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.RDMON_ENABLE.MON_EN.value <= field_combo.RDMON_ENABLE.MON_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_ENABLE.ERR_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.RDMON_ENABLE.ERR_EN.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
%000000             load_next_c = '1;
                end
 010968         field_combo.RDMON_ENABLE.ERR_EN.next = next_c;
 010968         field_combo.RDMON_ENABLE.ERR_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_ENABLE.ERR_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.RDMON_ENABLE.ERR_EN.value <= field_combo.RDMON_ENABLE.ERR_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_ENABLE.COMPL_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.RDMON_ENABLE.COMPL_EN.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
%000000             load_next_c = '1;
                end
 010968         field_combo.RDMON_ENABLE.COMPL_EN.next = next_c;
 010968         field_combo.RDMON_ENABLE.COMPL_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_ENABLE.COMPL_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.RDMON_ENABLE.COMPL_EN.value <= field_combo.RDMON_ENABLE.COMPL_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_ENABLE.TIMEOUT_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.RDMON_ENABLE.TIMEOUT_EN.value & ~decoded_wr_biten[3:3]) | (decoded_wr_data[3:3] & decoded_wr_biten[3:3]);
%000000             load_next_c = '1;
                end
 010968         field_combo.RDMON_ENABLE.TIMEOUT_EN.next = next_c;
 010968         field_combo.RDMON_ENABLE.TIMEOUT_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_ENABLE.TIMEOUT_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.RDMON_ENABLE.TIMEOUT_EN.value <= field_combo.RDMON_ENABLE.TIMEOUT_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_ENABLE.PERF_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.RDMON_ENABLE.PERF_EN.value & ~decoded_wr_biten[4:4]) | (decoded_wr_data[4:4] & decoded_wr_biten[4:4]);
%000000             load_next_c = '1;
                end
 010968         field_combo.RDMON_ENABLE.PERF_EN.next = next_c;
 010968         field_combo.RDMON_ENABLE.PERF_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_ENABLE.PERF_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.RDMON_ENABLE.PERF_EN.value <= field_combo.RDMON_ENABLE.PERF_EN.next;
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_TIMEOUT.TIMEOUT_CYCLES.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_TIMEOUT.TIMEOUT_CYCLES.next = next_c;
 010968         field_combo.RDMON_TIMEOUT.TIMEOUT_CYCLES.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_TIMEOUT.TIMEOUT_CYCLES.value <= 32'h2710;
 001151         end else begin
...
%000000                 field_storage.RDMON_TIMEOUT.TIMEOUT_CYCLES.value <= field_combo.RDMON_TIMEOUT.TIMEOUT_CYCLES.next;
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_LATENCY_THRESH.LATENCY_THRESH.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_LATENCY_THRESH.LATENCY_THRESH.next = next_c;
 010968         field_combo.RDMON_LATENCY_THRESH.LATENCY_THRESH.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_LATENCY_THRESH.LATENCY_THRESH.value <= 32'h1388;
 001151         end else begin
...
%000000                 field_storage.RDMON_LATENCY_THRESH.LATENCY_THRESH.value <= field_combo.RDMON_LATENCY_THRESH.LATENCY_THRESH.next;
 ...
 010968     always_comb begin
                automatic logic [15:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_PKT_MASK.PKT_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_PKT_MASK.PKT_MASK.next = next_c;
 010968         field_combo.RDMON_PKT_MASK.PKT_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_PKT_MASK.PKT_MASK.value <= 16'hffff;
 001151         end else begin
...
%000000                 field_storage.RDMON_PKT_MASK.PKT_MASK.value <= field_combo.RDMON_PKT_MASK.PKT_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [3:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_ERR_CFG.ERR_SELECT.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_ERR_CFG.ERR_SELECT.next = next_c;
 010968         field_combo.RDMON_ERR_CFG.ERR_SELECT.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_ERR_CFG.ERR_SELECT.value <= 4'h0;
 001151         end else begin
...
%000000                 field_storage.RDMON_ERR_CFG.ERR_SELECT.value <= field_combo.RDMON_ERR_CFG.ERR_SELECT.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_ERR_CFG.ERR_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_ERR_CFG && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_ERR_CFG.ERR_MASK.next = next_c;
 010968         field_combo.RDMON_ERR_CFG.ERR_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_ERR_CFG.ERR_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.RDMON_ERR_CFG.ERR_MASK.value <= field_combo.RDMON_ERR_CFG.ERR_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_MASK1.TIMEOUT_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_MASK1.TIMEOUT_MASK.next = next_c;
 010968         field_combo.RDMON_MASK1.TIMEOUT_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_MASK1.TIMEOUT_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.RDMON_MASK1.TIMEOUT_MASK.value <= field_combo.RDMON_MASK1.TIMEOUT_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_MASK1.COMPL_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_MASK1 && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_MASK1.COMPL_MASK.next = next_c;
 010968         field_combo.RDMON_MASK1.COMPL_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_MASK1.COMPL_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.RDMON_MASK1.COMPL_MASK.value <= field_combo.RDMON_MASK1.COMPL_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_MASK2.THRESH_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_MASK2.THRESH_MASK.next = next_c;
 010968         field_combo.RDMON_MASK2.THRESH_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_MASK2.THRESH_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.RDMON_MASK2.THRESH_MASK.value <= field_combo.RDMON_MASK2.THRESH_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_MASK2.PERF_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_MASK2 && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.RDMON_MASK2.PERF_MASK.value & ~decoded_wr_biten[15:8]) | (decoded_wr_data[15:8] & decoded_wr_biten[15:8]);
%000000             load_next_c = '1;
                end
 010968         field_combo.RDMON_MASK2.PERF_MASK.next = next_c;
 010968         field_combo.RDMON_MASK2.PERF_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_MASK2.PERF_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.RDMON_MASK2.PERF_MASK.value <= field_combo.RDMON_MASK2.PERF_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_MASK3.ADDR_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_MASK3.ADDR_MASK.next = next_c;
 010968         field_combo.RDMON_MASK3.ADDR_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_MASK3.ADDR_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.RDMON_MASK3.ADDR_MASK.value <= field_combo.RDMON_MASK3.ADDR_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.RDMON_MASK3.DEBUG_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.RDMON_MASK3 && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.RDMON_MASK3.DEBUG_MASK.next = next_c;
 010968         field_combo.RDMON_MASK3.DEBUG_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.RDMON_MASK3.DEBUG_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.RDMON_MASK3.DEBUG_MASK.value <= field_combo.RDMON_MASK3.DEBUG_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_ENABLE.MON_EN.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_ENABLE.MON_EN.next = next_c;
 010968         field_combo.WRMON_ENABLE.MON_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_ENABLE.MON_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.WRMON_ENABLE.MON_EN.value <= field_combo.WRMON_ENABLE.MON_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_ENABLE.ERR_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.WRMON_ENABLE.ERR_EN.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
%000000             load_next_c = '1;
                end
 010968         field_combo.WRMON_ENABLE.ERR_EN.next = next_c;
 010968         field_combo.WRMON_ENABLE.ERR_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_ENABLE.ERR_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.WRMON_ENABLE.ERR_EN.value <= field_combo.WRMON_ENABLE.ERR_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_ENABLE.COMPL_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.WRMON_ENABLE.COMPL_EN.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
%000000             load_next_c = '1;
                end
 010968         field_combo.WRMON_ENABLE.COMPL_EN.next = next_c;
 010968         field_combo.WRMON_ENABLE.COMPL_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_ENABLE.COMPL_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.WRMON_ENABLE.COMPL_EN.value <= field_combo.WRMON_ENABLE.COMPL_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_ENABLE.TIMEOUT_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.WRMON_ENABLE.TIMEOUT_EN.value & ~decoded_wr_biten[3:3]) | (decoded_wr_data[3:3] & decoded_wr_biten[3:3]);
%000000             load_next_c = '1;
                end
 010968         field_combo.WRMON_ENABLE.TIMEOUT_EN.next = next_c;
 010968         field_combo.WRMON_ENABLE.TIMEOUT_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_ENABLE.TIMEOUT_EN.value <= 1'h1;
 001151         end else begin
...
%000000                 field_storage.WRMON_ENABLE.TIMEOUT_EN.value <= field_combo.WRMON_ENABLE.TIMEOUT_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_ENABLE.PERF_EN.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_ENABLE && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.WRMON_ENABLE.PERF_EN.value & ~decoded_wr_biten[4:4]) | (decoded_wr_data[4:4] & decoded_wr_biten[4:4]);
%000000             load_next_c = '1;
                end
 010968         field_combo.WRMON_ENABLE.PERF_EN.next = next_c;
 010968         field_combo.WRMON_ENABLE.PERF_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_ENABLE.PERF_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.WRMON_ENABLE.PERF_EN.value <= field_combo.WRMON_ENABLE.PERF_EN.next;
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_TIMEOUT.TIMEOUT_CYCLES.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_TIMEOUT.TIMEOUT_CYCLES.next = next_c;
 010968         field_combo.WRMON_TIMEOUT.TIMEOUT_CYCLES.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_TIMEOUT.TIMEOUT_CYCLES.value <= 32'h2710;
 001151         end else begin
...
%000000                 field_storage.WRMON_TIMEOUT.TIMEOUT_CYCLES.value <= field_combo.WRMON_TIMEOUT.TIMEOUT_CYCLES.next;
 ...
 010968     always_comb begin
                automatic logic [31:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_LATENCY_THRESH.LATENCY_THRESH.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_LATENCY_THRESH.LATENCY_THRESH.next = next_c;
 010968         field_combo.WRMON_LATENCY_THRESH.LATENCY_THRESH.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_LATENCY_THRESH.LATENCY_THRESH.value <= 32'h1388;
 001151         end else begin
...
%000000                 field_storage.WRMON_LATENCY_THRESH.LATENCY_THRESH.value <= field_combo.WRMON_LATENCY_THRESH.LATENCY_THRESH.next;
 ...
 010968     always_comb begin
                automatic logic [15:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_PKT_MASK.PKT_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_PKT_MASK.PKT_MASK.next = next_c;
 010968         field_combo.WRMON_PKT_MASK.PKT_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_PKT_MASK.PKT_MASK.value <= 16'hffff;
 001151         end else begin
...
%000000                 field_storage.WRMON_PKT_MASK.PKT_MASK.value <= field_combo.WRMON_PKT_MASK.PKT_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [3:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_ERR_CFG.ERR_SELECT.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_ERR_CFG.ERR_SELECT.next = next_c;
 010968         field_combo.WRMON_ERR_CFG.ERR_SELECT.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_ERR_CFG.ERR_SELECT.value <= 4'h0;
 001151         end else begin
...
%000000                 field_storage.WRMON_ERR_CFG.ERR_SELECT.value <= field_combo.WRMON_ERR_CFG.ERR_SELECT.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_ERR_CFG.ERR_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_ERR_CFG && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_ERR_CFG.ERR_MASK.next = next_c;
 010968         field_combo.WRMON_ERR_CFG.ERR_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_ERR_CFG.ERR_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.WRMON_ERR_CFG.ERR_MASK.value <= field_combo.WRMON_ERR_CFG.ERR_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_MASK1.TIMEOUT_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_MASK1.TIMEOUT_MASK.next = next_c;
 010968         field_combo.WRMON_MASK1.TIMEOUT_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_MASK1.TIMEOUT_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.WRMON_MASK1.TIMEOUT_MASK.value <= field_combo.WRMON_MASK1.TIMEOUT_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_MASK1.COMPL_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_MASK1 && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_MASK1.COMPL_MASK.next = next_c;
 010968         field_combo.WRMON_MASK1.COMPL_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_MASK1.COMPL_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.WRMON_MASK1.COMPL_MASK.value <= field_combo.WRMON_MASK1.COMPL_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_MASK2.THRESH_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_MASK2.THRESH_MASK.next = next_c;
 010968         field_combo.WRMON_MASK2.THRESH_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_MASK2.THRESH_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.WRMON_MASK2.THRESH_MASK.value <= field_combo.WRMON_MASK2.THRESH_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_MASK2.PERF_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_MASK2 && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.WRMON_MASK2.PERF_MASK.value & ~decoded_wr_biten[15:8]) | (decoded_wr_data[15:8] & decoded_wr_biten[15:8]);
%000000             load_next_c = '1;
                end
 010968         field_combo.WRMON_MASK2.PERF_MASK.next = next_c;
 010968         field_combo.WRMON_MASK2.PERF_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_MASK2.PERF_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.WRMON_MASK2.PERF_MASK.value <= field_combo.WRMON_MASK2.PERF_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_MASK3.ADDR_MASK.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_MASK3.ADDR_MASK.next = next_c;
 010968         field_combo.WRMON_MASK3.ADDR_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_MASK3.ADDR_MASK.value <= 8'hff;
 001151         end else begin
...
%000000                 field_storage.WRMON_MASK3.ADDR_MASK.value <= field_combo.WRMON_MASK3.ADDR_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.WRMON_MASK3.DEBUG_MASK.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.WRMON_MASK3 && decoded_req_is_wr) begin // SW write
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.WRMON_MASK3.DEBUG_MASK.next = next_c;
 010968         field_combo.WRMON_MASK3.DEBUG_MASK.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.WRMON_MASK3.DEBUG_MASK.value <= 8'h0;
 001151         end else begin
...
%000000                 field_storage.WRMON_MASK3.DEBUG_MASK.value <= field_combo.WRMON_MASK3.DEBUG_MASK.next;
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.AXI_XFER_CONFIG.RD_XFER_BEATS.value;
 010968         load_next_c = '0;
 000018         if(decoded_reg_strb.AXI_XFER_CONFIG && decoded_req_is_wr) begin // SW write
 000018             next_c = (field_storage.AXI_XFER_CONFIG.RD_XFER_BEATS.value & ~decoded_wr_biten[7:0]) | (decoded_wr_data[7:0] & decoded_wr_biten[7:0]);
 000018             load_next_c = '1;
                end
 010968         field_combo.AXI_XFER_CONFIG.RD_XFER_BEATS.next = next_c;
 010968         field_combo.AXI_XFER_CONFIG.RD_XFER_BEATS.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.AXI_XFER_CONFIG.RD_XFER_BEATS.value <= 8'hf;
 001151         end else begin
%000002             if(field_combo.AXI_XFER_CONFIG.RD_XFER_BEATS.load_next) begin
%000002                 field_storage.AXI_XFER_CONFIG.RD_XFER_BEATS.value <= field_combo.AXI_XFER_CONFIG.RD_XFER_BEATS.next;
                    end
                end
            end
 ...
 010968     always_comb begin
                automatic logic [7:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.AXI_XFER_CONFIG.WR_XFER_BEATS.value;
 010968         load_next_c = '0;
 000018         if(decoded_reg_strb.AXI_XFER_CONFIG && decoded_req_is_wr) begin // SW write
 000018             next_c = (field_storage.AXI_XFER_CONFIG.WR_XFER_BEATS.value & ~decoded_wr_biten[15:8]) | (decoded_wr_data[15:8] & decoded_wr_biten[15:8]);
 000018             load_next_c = '1;
                end
 010968         field_combo.AXI_XFER_CONFIG.WR_XFER_BEATS.next = next_c;
 010968         field_combo.AXI_XFER_CONFIG.WR_XFER_BEATS.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.AXI_XFER_CONFIG.WR_XFER_BEATS.value <= 8'hf;
 001151         end else begin
%000002             if(field_combo.AXI_XFER_CONFIG.WR_XFER_BEATS.load_next) begin
%000002                 field_storage.AXI_XFER_CONFIG.WR_XFER_BEATS.value <= field_combo.AXI_XFER_CONFIG.WR_XFER_BEATS.next;
                    end
                end
            end
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.PERF_CONFIG.PERF_EN.value;
 010968         load_next_c = '0;
...
%000000             load_next_c = '1;
 ...
 010968         field_combo.PERF_CONFIG.PERF_EN.next = next_c;
 010968         field_combo.PERF_CONFIG.PERF_EN.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.PERF_CONFIG.PERF_EN.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.PERF_CONFIG.PERF_EN.value <= field_combo.PERF_CONFIG.PERF_EN.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.PERF_CONFIG.PERF_MODE.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.PERF_CONFIG && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.PERF_CONFIG.PERF_MODE.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
%000000             load_next_c = '1;
                end
 010968         field_combo.PERF_CONFIG.PERF_MODE.next = next_c;
 010968         field_combo.PERF_CONFIG.PERF_MODE.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.PERF_CONFIG.PERF_MODE.value <= 1'h0;
 001151         end else begin
...
%000000                 field_storage.PERF_CONFIG.PERF_MODE.value <= field_combo.PERF_CONFIG.PERF_MODE.next;
 ...
 010968     always_comb begin
                automatic logic [0:0] next_c;
                automatic logic load_next_c;
 010968         next_c = field_storage.PERF_CONFIG.PERF_CLEAR.value;
 010968         load_next_c = '0;
%000000         if(decoded_reg_strb.PERF_CONFIG && decoded_req_is_wr) begin // SW write
%000000             next_c = (field_storage.PERF_CONFIG.PERF_CLEAR.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
%000000             load_next_c = '1;
                end
 010968         field_combo.PERF_CONFIG.PERF_CLEAR.next = next_c;
 010968         field_combo.PERF_CONFIG.PERF_CLEAR.load_next = load_next_c;
            end
 001162     always_ff @(posedge clk) begin
 000011         if(rst) begin
 000011             field_storage.PERF_CONFIG.PERF_CLEAR.value <= 1'h0;
 001151         end else begin
...
%000001         readback_done = decoded_req & ~decoded_req_is_wr;
%000001         readback_err = '0;
%000001         readback_data_var = '0;
%000001         for(int i=0; i<49; i++) readback_data_var |= readback_array[i];
%000001         readback_data = readback_data_var;
            end
