"""
AXI Read Engine Test Runner

Test runner for the axi_read_engine.sv module using the CocoTB framework.
Tests streaming AXI4 read pipeline with SRAM buffering.

The read engine is a high-performance streaming design with NO FSM - uses
...
from tbclasses.axi_read_engine_tb import AXIReadEngineTB, TestScenario
...
async def cocotb_test_basic_single_burst(dut):
    ...
    # Run basic test
    success = await tb.run_basic_single_burst(addr=0x1000, burst_len=16)
...
def generate_axi_read_engine_params():
    """
    Generate test parameters for AXI read engine tests
...
axi_read_engine_params = generate_axi_read_engine_params()

# ===========================================================================
# PYTEST WRAPPER FUNCTIONS
# ===========================================================================

@pytest.mark.parametrize("addr_width, data_width, id_width, max_burst_len, sram_depth", axi_read_engine_params)
def test_basic_single_burst(request, addr_width, data_width, id_width, max_burst_len, sram_depth):
    """AXI read engine basic single burst test"""
