...
def load_legal_config():
    ...
    try:
        ...
        from projects.components.stream.dv.stream_coverage.coverage_config import LegalCoverageConfig
...
def main():
    ...
    if not files['summaries']:
        ...
        print("  COVERAGE=1 pytest projects/components/stream/dv/tests/fub/ -v")
        return 1
