...
1. **APB Crossbar Architecture (2x4 Example)**
   ...
   - Rendered: [assets/png/apb_xbar_architecture.png](assets/png/apb_xbar_architecture.png)
...
- **[APB Crossbar HAS](../apb_xbar_has/apb_xbar_has_index.md)** - Hardware Architecture Specification (high-level)
