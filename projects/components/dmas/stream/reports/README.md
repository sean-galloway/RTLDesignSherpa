...
```bash
cd /mnt/data/github/rtldesignsherpa/projects/components/dmas/stream/dv/tests/performance_tests
...
```bash
cd /mnt/data/github/rtldesignsherpa/projects/components/dmas/stream
