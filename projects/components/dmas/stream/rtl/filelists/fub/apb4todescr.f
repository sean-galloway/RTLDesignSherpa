# Filelist for apb4todescr module (APB-to-Descriptor Router)
# Location: projects/components/dmas/stream/rtl/filelists/fub/apb4todescr.f
...
$STREAM_ROOT/rtl/fub/apb4todescr.sv
