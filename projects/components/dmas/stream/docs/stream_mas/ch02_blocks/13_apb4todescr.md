...
The `apb4todescr` module is an APB-to-descriptor engine router that handles address-based routing of APB writes to descriptor engine kick-off ports. It decodes the APB address to determine the target channel and routes the 64-bit descriptor address using a two-write sequence.
...
![APB to Descriptor FSM](../assets/mermaid/02_apb4todescr_fsm.png)

**Source:** [02_apb4todescr_fsm.mmd](../assets/mermaid/02_apb4todescr_fsm.mmd)
...
![APB Normal Write](../assets/wavedrom/apb4todescr_normal_write.svg)

**Source:** [apb4todescr_normal_write.json](../assets/wavedrom/apb4todescr_normal_write.json)
...
![APB Backpressure Write](../assets/wavedrom/apb4todescr_backpressure_write.svg)

**Source:** [apb4todescr_backpressure_write.json](../assets/wavedrom/apb4todescr_backpressure_write.json)

### Channel Kick-off Examples

#### Waveform 2.13.3: Channel 0 Kick-off

![Channel 0 Kick-off](../assets/wavedrom/apb4todescr_ch0_kickoff.svg)

**Source:** [apb4todescr_ch0_kickoff.json](../assets/wavedrom/apb4todescr_ch0_kickoff.json)

#### Waveform 2.13.4: Channel 7 Kick-off

![Channel 7 Kick-off](../assets/wavedrom/apb4todescr_ch7_kickoff.svg)

**Source:** [apb4todescr_ch7_kickoff.json](../assets/wavedrom/apb4todescr_ch7_kickoff.json)
...
![Multi-Channel Kick-off](../assets/wavedrom/apb4todescr_multi_channel.svg)

**Source:** [apb4todescr_multi_channel.json](../assets/wavedrom/apb4todescr_multi_channel.json)
...
**Root Cause:** Parameter mismatch between `apb4todescr` and parent modules. The `ADDR_WIDTH` parameter (12 bits, for APB decode) was incorrectly used as the descriptor address output width. Parent modules expected 32-bit descriptor addresses but received 12-bit values routed to 32-bit wires, causing SystemVerilog to re-slice the bits and place the HIGH word (all-0s) on odd channels.
