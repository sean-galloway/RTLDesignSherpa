...
### View Testplan
```bash
cat projects/components/dmas/stream/dv/testplans/scheduler_testplan.yaml
```
...
# Integration test
pytest projects/components/dmas/stream/dv/tests/macro/test_stream_core.py -v
```

### Generate Coverage Report
```bash
# Run with coverage enabled
COVERAGE=1 pytest projects/components/dmas/stream/dv/tests/fub/ -v
...
- **STREAM PRD**: `projects/components/dmas/stream/PRD.md`
