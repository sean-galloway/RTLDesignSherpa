...
```python
from projects.components.dmas.stream.dv.tbclasses.stream_core_tb import StreamRegisterMap
...
```
projects/components/dmas/stream/rtl/macro/stream_regs.rdl
```

Generated RTL:
```
projects/components/dmas/stream/regs/generated/rtl/stream_regs.sv
projects/components/dmas/stream/regs/generated/rtl/stream_regs_pkg.sv
```
...
- `projects/components/dmas/stream/rtl/macro/stream_regs.rdl` - Register definitions
- `projects/components/dmas/stream/dv/tbclasses/stream_core_tb.py` - Implementation
