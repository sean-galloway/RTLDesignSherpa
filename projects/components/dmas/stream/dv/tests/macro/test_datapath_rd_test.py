...
from projects.components.dmas.stream.dv.tbclasses.datapath_rd_test_tb import DatapathRdTestTB
...
def test_datapath_rd(request, test_type, data_width, num_channels, sram_depth, test_level, enable_pipeline, xfer_beats, timing_profile):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root, filelist_path='projects/components/dmas/stream/rtl/filelists/macro/datapath_rd_test.f')
