...
from projects.components.dmas.stream.dv.tbclasses.datapath_wr_test_tb import DatapathWrTestTB
...
def test_v1_baseline_write_performance(request, config):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/stream/rtl/filelists/fub/datapath_wr_test.f'
    )
