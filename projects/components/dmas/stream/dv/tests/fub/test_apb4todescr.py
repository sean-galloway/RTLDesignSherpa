...
from projects.components.dmas.stream.dv.tbclasses.apb4todescr_tb import APBToDescrTB
...
async def cocotb_test_apb4todescr(dut):
    ...
    test_name = os.environ.get('COVERAGE_TEST_NAME', f'apb4todescr_{test_type}')
...
apb4todescr_params = generate_apb4todescr_test_params()

# ===========================================================================
# PYTEST WRAPPER FUNCTION - Single wrapper for all test types
# ===========================================================================

@pytest.mark.parametrize("test_type, addr_width, data_width, num_channels", apb4todescr_params)
def test_apb4todescr(request, test_type, addr_width, data_width, num_channels, test_level):
    """Pytest wrapper for APB-to-Descriptor tests - handles all test types."""
    module, repo_root, tests_dir, log_dir, rtl_dict = get_paths({
        'rtl_stream_macro': '../../../../rtl/stream_macro'
    })

    dut_name = "apb4todescr"
    # Get verilog sources and includes from filelist
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/stream/rtl/filelists/fub/apb4todescr.f'
    )
    ...
    try:
        run(
            ...
            toplevel=dut_name,
            module=module,
            testcase="cocotb_test_apb4todescr",  # ← Single cocotb test
