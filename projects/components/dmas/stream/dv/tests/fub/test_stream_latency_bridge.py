...
# Import testbench
from projects.components.dmas.stream.dv.tbclasses.stream_latency_bridge_tb import StreamLatencyBridgeTB
...
def test_stream_latency_bridge(request, test_type, data_width, timing_profile):
    ...
    run(
        python_search=[tests_dir, os.path.join(repo_root, 'projects/components/dmas/stream/dv/tbclasses')],
