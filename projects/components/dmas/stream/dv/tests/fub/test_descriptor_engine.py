...
from projects.components.dmas.stream.dv.tbclasses.descriptor_engine_tb import DescriptorEngineTB, DelayProfile
...
def test_descriptor_engine(request, test_type, channel_id, num_channels, addr_width, axi_id_width, fifo_depth, timing_profile, prefetch, test_level):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/stream/rtl/filelists/fub/descriptor_engine.f'
    )
