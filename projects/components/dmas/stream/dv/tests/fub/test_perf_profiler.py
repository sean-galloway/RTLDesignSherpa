...
from projects.components.dmas.stream.dv.tbclasses.perf_profiler_tb import PerfProfilerTB
...
def test_perf_profiler(request, test_type, num_channels, timestamp_width, fifo_depth, test_level):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/stream/rtl/filelists/fub/perf_profiler.f'
    )
