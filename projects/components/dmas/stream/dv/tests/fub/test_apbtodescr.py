...
from projects.components.dmas.stream.dv.tbclasses.apbtodescr_tb import APBToDescrTB
...
def test_apbtodescr(request, test_type, addr_width, data_width, num_channels, test_level):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/stream/rtl/filelists/fub/apbtodescr.f'
    )
