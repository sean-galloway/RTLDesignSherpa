...
**File**: `projects/components/dmas/stream/rtl/fub/axi_write_engine.sv`
...
SEED=6 TIMING_PROFILE=mixed \
  pytest "projects/components/dmas/stream/dv/tests/macro/test_stream_core.py::test_stream_core_single_channel[params0]"
```
