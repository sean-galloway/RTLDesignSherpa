...
**Location:**
- File: `projects/components/dmas/rapids/rtl/rapids_fub/scheduler.sv`
- Lines: 567-570
...
3. Create test: `projects/components/dmas/rapids/dv/tests/integration_tests/test_sink_timeout.py`
...
**Related Files:**
- `projects/components/dmas/rapids/rtl/rapids_fub/sink_axi_write_engine.sv` (add timeout logic)
- `projects/components/dmas/rapids/rtl/rapids_macro/sink_data_path.sv` (wire timeout signal)
- `projects/components/dmas/rapids/known_issues/sink_data_path.md` (issue documentation)
- Create: `projects/components/dmas/rapids/dv/tests/integration_tests/test_sink_timeout.py`
...
**Current State:**
- 32 test files in `projects/components/dmas/rapids/dv/tests/`
...
4. **Refactor Existing Tests** (3-5 hours)
   - [ ] Update `projects/components/dmas/rapids/dv/tests/fub_tests/scheduler/` to import TB classes
   - [ ] Update `projects/components/dmas/rapids/dv/tests/fub_tests/descriptor_engine/` to import TB classes
   - [ ] Update `projects/components/dmas/rapids/dv/tests/integration_tests/` to import TB classes
...
3. Run full test suite: `pytest projects/components/dmas/rapids/dv/tests/ -v`
4. Verify all tests pass
5. Update documentation

**Related Files:**
- Create: `bin/TBClasses/rapids/*.py`
- Update: All test files in `projects/components/dmas/rapids/dv/tests/`
- Update: `projects/components/dmas/rapids/CLAUDE.md` with examples
...
```
projects/components/dmas/rapids/dv/tests/integration_tests/
...
3. Run: `pytest projects/components/dmas/rapids/dv/tests/integration_tests/ -v`
4. Measure coverage: `pytest projects/components/dmas/rapids/dv/tests/integration_tests/ --cov=projects/components/dmas/rapids/rtl/`
...
**Test Files to Create:**
```
projects/components/dmas/rapids/dv/tests/system_tests/
...
3. Run: `pytest projects/components/dmas/rapids/dv/tests/system_tests/ -v`
...
**Verification Steps:**
1. Create `projects/components/dmas/rapids/README.md`
...
**Related Files:**
- Create: `projects/components/dmas/rapids/README.md`
- Reference: `projects/components/dmas/rapids/PRD.md`, `projects/components/dmas/rapids/CLAUDE.md`
...
**Related Files:**
- Modify: `projects/components/dmas/rapids/rtl/rapids_fub/sink_sram_control.sv`
- Update: `projects/components/dmas/rapids/known_issues/sink_sram_control.md`
- Create: `projects/components/dmas/rapids/dv/tests/performance_tests/test_multi_read.py`
...
**Related Files:**
- Create: `projects/components/dmas/rapids/rtl/rapids_fub/rapids_perf_monitor.sv`
- Update: `projects/components/dmas/rapids/rtl/rapids_macro/rapids_top.sv` (integrate monitor)
- Create: `projects/components/dmas/rapids/dv/tests/performance_tests/test_perf_monitor.py`
...
4. **Verification:** Run full regression after each task: `pytest projects/components/dmas/rapids/dv/tests/ -v`
5. **Coverage:** Track coverage metrics: `pytest projects/components/dmas/rapids/dv/tests/ --cov=projects/components/dmas/rapids/rtl/`
...
**Related Files:**
- Modify: `projects/components/dmas/rapids/rtl/rapids_fub/descriptor_engine.sv`
- Modify: `projects/components/dmas/rapids/rtl/rapids_macro/scheduler_group.sv`
- Update: `projects/components/dmas/rapids/dv/tbclasses/descriptor_engine_tb.py`
- Create: `projects/components/dmas/rapids/dv/tests/fub_tests/descriptor_engine/test_autonomous_chaining.py`
- Update: `projects/components/dmas/rapids/PRD.md` (document chaining architecture)
...
**Related Files:**
- Modify: `projects/components/dmas/rapids/rtl/rapids_fub/scheduler.sv`
- Modify: `projects/components/dmas/rapids/rtl/rapids_fub/descriptor_engine.sv`
- Modify: `projects/components/dmas/rapids/rtl/rapids_fub/program_engine.sv`
- Modify: `projects/components/dmas/rapids/rtl/rapids_macro/scheduler_group.sv`
- Update: `projects/components/dmas/rapids/PRD.md` (document channel_idle architecture)
- Create: `projects/components/dmas/rapids/dv/tests/integration_tests/test_channel_idle.py`
...
- STREAM implementation (projects/components/dmas/stream/PRD.md Section 5.2) serves as reference
