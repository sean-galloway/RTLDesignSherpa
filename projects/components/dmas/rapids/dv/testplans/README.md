...
```bash
# All FUB tests
pytest projects/components/dmas/rapids/dv/tests/fub/ -v
...
```bash
# FUB Legacy
pytest projects/components/dmas/rapids/dv/tests/fub/test_ctrlrd_engine.py -v
pytest projects/components/dmas/rapids/dv/tests/fub/test_ctrlwr_engine.py -v
...
pytest projects/components/dmas/rapids/dv/tests/fub_beats/test_alloc_ctrl_beats.py -v
pytest projects/components/dmas/rapids/dv/tests/fub_beats/test_drain_ctrl_beats.py -v
pytest projects/components/dmas/rapids/dv/tests/fub_beats/test_latency_bridge_beats.py -v

# MACRO Beats
pytest projects/components/dmas/rapids/dv/tests/macro_beats/test_scheduler_group_beats.py -v
pytest projects/components/dmas/rapids/dv/tests/macro_beats/test_snk_sram_controller_beats.py -v
pytest projects/components/dmas/rapids/dv/tests/macro_beats/test_src_sram_controller_beats.py -v
...
- RAPIDS TB Classes: `projects/components/dmas/rapids/dv/tbclasses/`
- RAPIDS Coverage: `projects/components/dmas/rapids/dv/tests/rapids_coverage/`
