...
from projects.components.dmas.rapids.dv.tbclasses.src_sram_controller_tb import SrcSRAMControllerTB
...
def _run_src_sram_controller_test(request, testcase_name, num_channels, data_width, sram_depth, timing_profile='default'):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/macro_beats/src_sram_controller_beats.f'
    )
