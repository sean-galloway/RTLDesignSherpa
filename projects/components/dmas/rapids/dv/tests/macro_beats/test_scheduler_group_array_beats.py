...
from projects.components.dmas.rapids.dv.tbclasses.scheduler_group_array_beats_tb import SchedulerGroupArrayBeatsTB
...
def _run_beats_scheduler_group_array_test(request, testcase_name, num_channels, addr_width, data_width, axi_id_width, timing_profile='default'):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/macro_beats/scheduler_group_array_beats.f'
    )
