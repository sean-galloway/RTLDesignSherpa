"""RAPIDS Macro-Beats test configuration for pytest.
...
RAPIDS-Macro-Beats-specific bits.
...
AREA_NAME = 'RAPIDS Macro-Beats'
LOG_BASENAME = 'pytest_rapids_macro_beats.log'
MARKERS = (
    'coverage: Tests that collect coverage data',
    'protocol_coverage: Tests that collect protocol coverage',
    'macro_beats: Macro-level beats architecture tests',
    'beats_scheduler_group: Beats scheduler-group tests',
    'beats_scheduler_group_array: Beats scheduler-group-array tests',
