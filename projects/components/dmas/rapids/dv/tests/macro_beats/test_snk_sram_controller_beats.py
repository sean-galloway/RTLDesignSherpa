...
from projects.components.dmas.rapids.dv.tbclasses.snk_sram_controller_tb import SnkSRAMControllerTB
...
def _run_snk_sram_controller_test(request, testcase_name, num_channels, data_width, sram_depth, timing_profile='default'):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/macro_beats/snk_sram_controller_beats.f'
    )
