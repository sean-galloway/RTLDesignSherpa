...
from projects.components.dmas.rapids.dv.tbclasses.scheduler_group_beats_tb import SchedulerGroupBeatsTB
...
def _run_beats_scheduler_group_test(request, testcase_name, channel_id, addr_width, data_width, axi_id_width, timing_profile='default'):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/macro_beats/scheduler_group_beats.f'
    )
