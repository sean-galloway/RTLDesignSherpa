...
async def cocotb_test_basic_descriptor_flow(dut):
    ...
    from projects.components.dmas.rapids.dv.tbclasses.snk_data_path_axis_test_beats_tb import SnkDataPathAxisTestBeatsTB
...
def _run_sink_axis_test(request, testcase_name, num_channels, addr_width, data_width, axi_id_width, sram_depth,
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/macro_beats/snk_data_path_axis_test_beats.f'
    )
