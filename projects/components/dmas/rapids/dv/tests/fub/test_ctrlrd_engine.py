...
This test file imports the reusable CtrlrdEngineTB class from:
  projects/components/dmas/rapids/dv/tbclasses/ctrlrd_engine_tb.py
...
from projects.components.dmas.rapids.dv.tbclasses.ctrlrd_engine_tb import CtrlrdEngineTB, DelayProfile, TestScenario
...
def _run_ctrlrd_test(request, testcase_name, channel_id, num_channels, addr_width, axi_data_width):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/fub/ctrlrd_engine.f'
    )
