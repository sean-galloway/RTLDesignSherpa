...
This test file imports the reusable CtrlwrEngineTB class from:
  projects/components/dmas/rapids/dv/tbclasses/ctrlwr_engine_tb.py
...
from projects.components.dmas.rapids.dv.tbclasses.ctrlwr_engine_tb import CtrlwrEngineTB, DelayProfile, TestScenario
...
def _run_ctrlwr_test(request, testcase_name, channel_id, num_channels, addr_width):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/fub/ctrlwr_engine.f'
    )
