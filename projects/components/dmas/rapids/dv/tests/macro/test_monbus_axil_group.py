...
This test file imports the reusable MonbusAxilGroupTB class from:
  bin/TBClasses/rapids/monbus_axil_group_tb.py
...
from projects.components.dmas.rapids.dv.tbclasses.monbus_axil_group_tb import MonbusAxilGroupTB
...
def run_monbus_axil_test(testcase_name, fifo_depth_err, fifo_depth_write, addr_width, data_width, num_protocols):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/macro/monbus_axil_group.f'
    )
