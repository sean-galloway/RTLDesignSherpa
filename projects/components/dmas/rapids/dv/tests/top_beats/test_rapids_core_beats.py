...
from projects.components.dmas.rapids.dv.tbclasses.rapids_core_beats_tb import RapidsCoreBeatsTB
...
def _run_core_beats(request, test_type, data_width):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/dmas/rapids/rtl/filelists/macro_beats/rapids_core_beats.f'
    )
