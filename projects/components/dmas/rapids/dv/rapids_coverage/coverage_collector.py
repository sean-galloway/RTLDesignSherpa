...
# Purpose: Main coverage collector for RAPIDS component
#
...
"""
Coverage Collector for RAPIDS Component
...
Usage in testbench:
    from projects.components.dmas.rapids.dv.rapids_coverage import CoverageCollector
...
class CoverageCollector:
    """
    Main coverage collector for RAPIDS component.
