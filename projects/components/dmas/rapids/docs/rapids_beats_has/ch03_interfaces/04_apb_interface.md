...
|---------------|--------|---------|
| 0x000-0x03F | `rapids_regs` (staged descriptor addresses) | Per-channel `CH*_DESC_ADDR_{LOW,HIGH}`, stride 0x8 |
| 0x040 | `rapids_regs` (`KICK_ENABLE`) | Per-channel launch bits (singlepulse) |
