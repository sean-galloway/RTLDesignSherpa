...
| 0.8 | 2026-09-21 | seang | Documentation hygiene: removed 30 `**Source:**` links pointing at `assets/mermaid/*.mmd` files that were never created (authored dead in `a1760aaf6`, 2026-07-17). None had an image above it, so no figure was lost; the 3 source links that resolve are unchanged. |
