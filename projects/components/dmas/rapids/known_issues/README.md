...
### Location
**File**: `projects/components/dmas/rapids/rtl/path/to/file.sv`
**Lines**: Line numbers
...
grep -r "Scheduler" projects/components/dmas/rapids/known_issues/

# Search for specific bug type
grep -r "timeout" projects/components/dmas/rapids/known_issues/

# Find all high-severity issues
grep -r "Severity.*High" projects/components/dmas/rapids/known_issues/active/
```
