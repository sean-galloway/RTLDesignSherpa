...
- [x] ONE apb4_slave -> hand-written 3-way cmd demux: SRC-kick 0x000-0x03F (paddr[12:6]==0) ->
      u_kick_src (kick block) -> core.src_apb_*; SNK-kick 0x1000-0x103F -> u_kick_snk ->
...
- [x] rapids_beats_top_tb.py rewritten as the AXIS-boundary sibling of the core TB. Config BY NAME
      ...
      0x1000 (SNK) -> SRC.GLOBAL_CTRL@0x100, SNK@0x1100. Descriptor kick over the APB kick windows:
...
- [x] cocotb harness TB (projects/fpga-systems/Genesys2/rapids_characterization/flows-rapids-beats/dv/
      ...
      via desc-RAM host write ports (create_axi4_master_wr, 256b); kicked over the APB kick windows.
