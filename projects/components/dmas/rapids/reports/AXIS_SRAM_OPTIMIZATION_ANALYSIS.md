...
**Code Reference:** `projects/components/dmas/rapids/rtl/rapids_fub/sink_sram_control.sv:94`
```systemverilog
...
**Code Reference:** `projects/components/dmas/rapids/rtl/rapids_fub/source_sram_control.sv:104`
```systemverilog
...
**File:** `projects/components/dmas/rapids/rtl/rapids_fub/sink_sram_control.sv:93`
