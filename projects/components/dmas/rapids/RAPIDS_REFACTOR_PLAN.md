...
```
projects/components/dmas/rapids/rtl/
├── rapids_fub/
...
cp projects/components/dmas/stream/rtl/fub/simple_sram.sv \
   projects/components/dmas/rapids/rtl/rapids_fub/

cp projects/components/dmas/stream/rtl/fub/stream_latency_bridge.sv \
   projects/components/dmas/rapids/rtl/rapids_fub/

cp projects/components/dmas/stream/rtl/fub/axi_read_engine.sv \
   projects/components/dmas/rapids/rtl/rapids_fub/

cp projects/components/dmas/stream/rtl/fub/axi_write_engine.sv \
   projects/components/dmas/rapids/rtl/rapids_fub/

cp projects/components/dmas/stream/rtl/fub/stream_alloc_ctrl.sv \
   projects/components/dmas/rapids/rtl/rapids_fub/

cp projects/components/dmas/stream/rtl/fub/stream_drain_ctrl.sv \
   projects/components/dmas/rapids/rtl/rapids_fub/
```
