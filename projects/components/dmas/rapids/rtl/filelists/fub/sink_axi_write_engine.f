...
# Location: projects/components/dmas/rapids/rtl/filelists/fub/sink_axi_write_engine.f
...
# DUT module
$REPO_ROOT/projects/components/dmas/rapids/rtl/fub/sink_axi_write_engine.sv
