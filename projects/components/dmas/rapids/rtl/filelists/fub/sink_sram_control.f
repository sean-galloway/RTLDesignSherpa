# RAPIDS Sink SRAM Control FUB File List (Chunk-based)
# Location: projects/components/dmas/rapids/rtl/filelists/fub/sink_sram_control.f
# Purpose: Sink SRAM control module (original RAPIDS, chunk mode)
...
# DUT module
$REPO_ROOT/projects/components/dmas/rapids/rtl/fub/sink_sram_control.sv
