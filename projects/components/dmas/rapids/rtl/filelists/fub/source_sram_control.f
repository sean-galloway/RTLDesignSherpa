# RAPIDS Source SRAM Control FUB File List (Chunk-based)
# Location: projects/components/dmas/rapids/rtl/filelists/fub/source_sram_control.f
# Purpose: Source SRAM control module (original RAPIDS, chunk mode)
...
# DUT module
$REPO_ROOT/projects/components/dmas/rapids/rtl/fub/source_sram_control.sv
