...
module rapids_core_beats #(
    ...
    output logic [CIW-1:0]              snk_active_channel_id,
    output logic                        snk_active_channel_valid
);
    ...
    rapids_snk_beats #(
        ...
        .o_active_channel_id           (snk_active_channel_id),
        .o_active_channel_valid        (snk_active_channel_valid)
    );
