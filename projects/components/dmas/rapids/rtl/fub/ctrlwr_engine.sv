...
//
// Documentation: projects/components/dmas/rapids_fub/PRD.md
                ...
                WRITE_ERROR: begin
                    if (w_address_error) begin
                        ...
                        r_mon_packet    <= create_monitor_packet(
                            PktTypeError,
                            PROTOCOL_AXI,
                            (r_write_resp == 2'b10) ? monitor_amba4_pkg::AXI_ERR_RESP_SLVERR : monitor_amba4_pkg::AXI_ERR_RESP_DECERR,
                            MON_CHANNEL_ID,
                            MON_UNIT_ID,
                            MON_AGENT_ID,
