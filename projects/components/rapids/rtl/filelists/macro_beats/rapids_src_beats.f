...
# Location: projects/components/rapids/rtl/filelists/macro_beats/rapids_src_beats.f
...
# DUT module
$REPO_ROOT/projects/components/rapids/rtl/macro_beats/rapids_src_beats.sv
