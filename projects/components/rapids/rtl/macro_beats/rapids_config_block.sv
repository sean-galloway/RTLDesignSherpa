...
// Purpose: Configuration Mapping Block - PeakRDL to RAPIDS beats core
//
// Description:
//   Maps PeakRDL-generated register outputs (rapids_regs) to rapids_core_beats config inputs.
//   This module provides a clean interface layer between the register file and
//   the RAPIDS beats DMA engine core + rd/wr monitor block.
//
//   Key Functions:
...
module rapids_config_block #(
    ...
    //=========================================================================
    // RAPIDS core / monitor configuration outputs
    //=========================================================================
