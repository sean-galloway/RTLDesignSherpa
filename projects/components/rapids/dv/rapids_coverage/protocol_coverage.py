...
"""
Protocol Coverage Collector for RAPIDS Component

Extends the shared ProtocolCoverageBase to add RAPIDS-specific:
...
class ProtocolCoverage(ProtocolCoverageBase):
    ...
    Extends ProtocolCoverageBase with RAPIDS-specific:
    ...
    def _init_handshake_coverage(self):
        """Initialize RAPIDS-specific valid/ready handshake coverage points."""
        # Common handshake interfaces in RAPIDS
        handshakes = [
    ...
    def _init_scenario_coverage(self):
        """Initialize RAPIDS-specific functional scenario coverage."""
        scenarios = [
