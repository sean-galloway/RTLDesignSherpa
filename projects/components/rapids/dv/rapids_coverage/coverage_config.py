...
# Purpose: Configuration for RAPIDS coverage collection
#
# Documentation: projects/components/rapids/PRD.md
# Subsystem: rapids/dv/coverage
#
# Author: sean galloway
# Created: 2025-01-10

"""
Coverage Configuration for RAPIDS Component

Extends the shared coverage configuration base classes with RAPIDS-specific:
- Module lists
- Coverage goals
...
Usage:
    ...
    config = RapidsCoverageConfig.from_environment()  # Set COVERAGE_LEGAL=1
...
@dataclass
class RapidsCoverageGoals(CoverageGoals):
    """Coverage goals for RAPIDS component - higher than defaults."""
    # Override defaults with RAPIDS-specific targets
...
@dataclass
class RapidsCoverageConfig(CoverageConfigBase):
    """RAPIDS-specific coverage configuration."""

    # Override goals with RAPIDS-specific targets
    goals: RapidsCoverageGoals = field(default_factory=RapidsCoverageGoals)

    # Coverage bin definitions (RAPIDS-specific)
...
CoverageConfig = RapidsCoverageConfig
...
class LegalCoverageConfig(LegalCoverageConfigBase):
    ...
    Extends LegalCoverageConfigBase with RAPIDS-specific defaults.
    ...
    name: str = "rapids"
    description: str = "RAPIDS DMA engine legal coverage points"
    ...
    # AXI burst length bins that RAPIDS uses
    ...
    def load(cls, config_name: str = 'rapids') -> 'LegalCoverageConfig':
        ...
        # Create RAPIDS config with loaded values
        config = cls(
