...
def pytest_configure(config):
    """Register RAPIDS-specific pytest markers and configure logging"""
    ...
    # Feature markers (ADDED - these were missing!)
    config.addinivalue_line("markers", "credit: Credit management tests")
