...
#
# Module: test_src_sram_controller
# Purpose: RAPIDS Source SRAM Controller Macro Validation Test - Phase 1
#
...
"""
RAPIDS Source SRAM Controller Macro Validation Test - Phase 1

Test suite for the src_sram_controller module:
...
from projects.components.rapids.dv.tbclasses.src_sram_controller_tb import SrcSRAMControllerTB
...
def generate_src_sram_controller_test_params():
    """Generate test parameters for src_sram_controller tests.
...
src_sram_controller_params = generate_src_sram_controller_test_params()
...
@pytest.mark.parametrize("num_channels, data_width, sram_depth", src_sram_controller_params)
...
def _run_src_sram_controller_test(request, testcase_name, num_channels, data_width, sram_depth):
    ...
    dut_name = "src_sram_controller_beats"

    # Get Verilog sources from file list
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/rapids/rtl/filelists/macro_beats/src_sram_controller_beats.f'
    )
...
if __name__ == "__main__":
    ...
    print("Running basic src_sram_controller test...")
