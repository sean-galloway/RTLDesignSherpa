...
This test file imports the reusable AllocCtrlBeatsTB class from:
  projects/components/rapids/dv/tbclasses/alloc_ctrl_beats_tb.py
...
from projects.components.rapids.dv.tbclasses.alloc_ctrl_beats_tb import AllocCtrlBeatsTB
...
def _run_beats_alloc_ctrl_test(request, testcase_name, depth, almost_wr_margin, almost_rd_margin):
    ...
    dut_name = "alloc_ctrl_beats"

    # Get Verilog sources from file list
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/rapids/rtl/filelists/fub_beats/alloc_ctrl_beats.f'
    )
