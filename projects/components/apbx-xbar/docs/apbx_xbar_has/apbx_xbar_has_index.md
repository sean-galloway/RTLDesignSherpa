...
**Version:** 1.0
**Date:** 2026-01-03
**Purpose:** High-level hardware architecture specification for APB Crossbar component
...
- [Address Mapping](ch03_architecture/03_address_mapping.md)

### Chapter 4: Interfaces

- [Master-Side APB Interfaces](ch04_interfaces/01_master_side.md)
- [Slave-Side APB Interfaces](ch04_interfaces/02_slave_side.md)
...
- **[APB Crossbar MAS](../apbx_xbar_mas/apbx_xbar_mas_index.md)** - Micro-Architecture Specification (detailed block-level)
