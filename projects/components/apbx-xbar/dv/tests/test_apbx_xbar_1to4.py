...
This test validates the address decoding functionality of apbx_xbar_1to4,
...
def test_apbx_xbar_1to4(request, aw, dw, base):
    ...
    verilog_sources, includes = get_sources_from_filelist(
        repo_root=repo_root,
        filelist_path='projects/components/apbx-xbar/rtl/filelists/wrapper/apbx_xbar_1to4_wrap.f'
    )
