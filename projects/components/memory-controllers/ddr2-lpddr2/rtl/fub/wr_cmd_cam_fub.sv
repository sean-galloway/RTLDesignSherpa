...
//   wr2rd_forward_fub (write→read snarf path) and the rd_data_path.
//
// Documentation:
...
#(
    ...
    // Snapshot to wr2rd_forward_fub (combinational read of all slots)
