...
| `pumice_core_macro_testplan.yaml` | pumice_core_macro.sv | test_pumice_top.py | 6 |
| `dfi_v21_interface_macro_testplan.yaml` | dfi_v21_interface_macro.sv | test_pumice_top.py | 5 |
| `pumice_csr_slave_testplan.yaml` | pumice_csr_slave.sv | test_pumice_csr_slave.py | 13 |
...
| Test file | Passed | Failed |
|-----------|-------:|-------:|
| test_pumice_top.py | 6 | 4 (debug_only — G-01) |
...
```bash
# Run with coverage
cd projects/components/memory-controllers/pumice-ddr2-lpddr2
