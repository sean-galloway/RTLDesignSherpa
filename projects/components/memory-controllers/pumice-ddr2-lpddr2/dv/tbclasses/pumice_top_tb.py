...
"""Test-bench harness for pumice_top.
...
the dv/tb/pumice_top_tb_top.sv alias module (`phy_dfi_*` ports
...
class DDR2LPDDR2TopTB:
    """End-to-end TB for pumice_top."""

    REGMAP_FILE = os.path.join(
        os.path.dirname(__file__), "pumice_regmap.py"
    )
