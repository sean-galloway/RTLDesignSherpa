...
This chapter is the **wire-level** port list of the `pumice_ctrl` top module — the exact signal names, directions, widths, and parameter dependencies that the integration script and SoC top-level use.
...
The canonical machine-generated source is `regs/pumice_ctrl_ports.svh` — what follows is the human-readable mirror.
...
The full module declaration is in `regs/pumice_ctrl_ports.svh` (machine-generated).
