...
//          straight into pumice_core_macro and routes the core's
...
//   3. pumice_csr          — PeakRDL-generated register block
//   4. pumice_config_block — hwif_out → cfg_*_o + status/obs → hwif_in
//
// CSR map: docs/pumice_has/ch06_integration/03_csr_map.md
// RDL src: rtl/macro/pumice_csr.rdl
...
#(
    ...
    //=========================================================================
    pumice_csr__in_t   hwif_in;
    pumice_csr__out_t  hwif_out;
    ...
    pumice_config_block #(
        ...
        .cfg_t_rp_wait_o             (cfg_t_rp_wait_o),
        .cfg_t_rfc_wait_o            (cfg_t_rfc_wait_o),
