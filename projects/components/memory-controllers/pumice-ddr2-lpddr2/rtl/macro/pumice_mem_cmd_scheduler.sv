...
#(
    ...
    // ---- CAM sched ports (external: pumice_axi4_ifc) ----
    ...
    pumice_cmd_arbiter #(
        ...
        .wr_lu_valid_o(wr_lu_valid_o), .wr_lu_bank_o(wr_lu_bank_o), .wr_lu_row_o(wr_lu_row_o),
        .wr_lu_hit_i(wr_lu_hit_i), .wr_lu_slot_i(wr_lu_slot_i), .wr_lu_col_i(wr_lu_col_i),
        .wr_lu_id_i(wr_lu_id_i), .wr_lu_age_i(wr_lu_age_i),
        .wr_oldest_valid_i(wr_oldest_valid_i), .wr_oldest_bank_i(wr_oldest_bank_i),
        .wr_oldest_row_i(wr_oldest_row_i), .wr_oldest_slot_i(wr_oldest_slot_i),
        .wr_commit_valid_o(wr_commit_valid_o), .wr_commit_slot_o(wr_commit_slot_o),
        .rd_lu_valid_o(rd_lu_valid_o), .rd_lu_bank_o(rd_lu_bank_o), .rd_lu_row_o(rd_lu_row_o),
        .rd_lu_hit_i(rd_lu_hit_i), .rd_lu_slot_i(rd_lu_slot_i), .rd_lu_col_i(rd_lu_col_i),
        .rd_lu_id_i(rd_lu_id_i), .rd_lu_age_i(rd_lu_age_i),
        .rd_oldest_valid_i(rd_oldest_valid_i), .rd_oldest_bank_i(rd_oldest_bank_i),
        .rd_oldest_row_i(rd_oldest_row_i), .rd_oldest_slot_i(rd_oldest_slot_i),
