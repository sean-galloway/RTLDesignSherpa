# Filelist for dfi_v21_interface_macro (SKELETON)
# Location: projects/components/memory-controllers/pumice-ddr2-lpddr2/rtl/filelists/macro/dfi_v21_interface_macro.f
