...
The HAS-side algorithm view (`pumice_has/assets/mermaid/09_happy_predictor.png`) shows the query/update *flow*; the diagram above shows the FUB's *physical organization* — input ports, hash, table, gate logic.
