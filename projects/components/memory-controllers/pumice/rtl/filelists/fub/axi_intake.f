# Filelist for axi_intake
# Location: projects/components/memory-controllers/pumice/rtl/filelists/fub/axi_intake.f
#
...
# AMBA AXI4 slave-side protocol modules (instantiated by axi_intake)
