...
```bash
cd projects/components/timing_characterization/rtl/asic_only/syn
...
PYTHONPATH=bin:$PYTHONPATH pytest \
    projects/components/timing_characterization/dv/tests/ -v
```
...
```bash
cd projects/components/timing_characterization/assets
