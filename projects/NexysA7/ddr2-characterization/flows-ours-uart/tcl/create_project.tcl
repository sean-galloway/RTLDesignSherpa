...
foreach src $sv_sources {
    ...
    # a7ddrphy_stub.sv is the blackbox declaration — Vivado needs the REAL
    # a7ddrphy.v generated by LiteDRAM (see bin/gen_a7ddrphy.py). Until
    # that's committed, leave the stub in so synthesis proceeds; it emits a
    # black-box warning that we accept.
