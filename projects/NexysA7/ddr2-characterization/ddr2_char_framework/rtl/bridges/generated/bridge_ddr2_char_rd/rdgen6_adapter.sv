// RDGEN6 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for rdgen6 master

`timescale 1ns / 1ps


module rdgen6_adapter
...
#(
    ...
    // External AXI interface (from rdgen6 master)
    ...
    output axi4_ar_t     rdgen6_64b_ar,
    output logic         rdgen6_64b_arvalid,
    input  logic         rdgen6_64b_arready,

    input  axi4_r_64b_t  rdgen6_64b_r,
    input  logic         rdgen6_64b_rvalid,
    output logic         rdgen6_64b_rready
);
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(rdgen6_axi_arid),
        .s_axi_araddr(rdgen6_axi_araddr),
        .s_axi_arlen(rdgen6_axi_arlen),
        .s_axi_arsize(rdgen6_axi_arsize),
        .s_axi_arburst(rdgen6_axi_arburst),
        .s_axi_arlock(rdgen6_axi_arlock),
        .s_axi_arcache(rdgen6_axi_arcache),
        .s_axi_arprot(rdgen6_axi_arprot),
        .s_axi_arqos(rdgen6_axi_arqos),
        .s_axi_arregion(rdgen6_axi_arregion),
        .s_axi_aruser(rdgen6_axi_aruser),
        .s_axi_arvalid(rdgen6_axi_arvalid),
        .s_axi_arready(rdgen6_axi_arready),
        .s_axi_rid(rdgen6_axi_rid),
        .s_axi_rdata(rdgen6_axi_rdata),
        .s_axi_rresp(rdgen6_axi_rresp),
        .s_axi_rlast(rdgen6_axi_rlast),
        .s_axi_ruser(rdgen6_axi_ruser),
        .s_axi_rvalid(rdgen6_axi_rvalid),
        .s_axi_rready(rdgen6_axi_rready),
    ...
    // Requests: fub_axi_* → rdgen6_64b_*
    // Responses: rdgen6_64b_* → MUX → fub_axi_*
    // ================================================================

    // AR channel (request: fub → output)
    assign rdgen6_64b_ar.id     = fub_axi_arid;
    assign rdgen6_64b_ar.addr   = fub_axi_araddr;
    assign rdgen6_64b_ar.len    = fub_axi_arlen;
    assign rdgen6_64b_ar.size   = fub_axi_arsize;
    assign rdgen6_64b_ar.burst  = fub_axi_arburst;
    assign rdgen6_64b_ar.lock   = fub_axi_arlock;
    assign rdgen6_64b_ar.cache  = fub_axi_arcache;
    assign rdgen6_64b_ar.prot   = fub_axi_arprot;
    assign rdgen6_64b_ar.qos    = 4'b0;  // Tie to 0
    assign rdgen6_64b_ar.region = 4'b0;  // Tie to 0
    assign rdgen6_64b_ar.user   = 1'b0;  // Tie to 0
    assign rdgen6_64b_arvalid   = fub_axi_arvalid && ar_path_active_64b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign rdgen6_64b_rready = fub_axi_rready && r_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_arready = rdgen6_64b_arready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_rid = rdgen6_64b_r.id;
                fub_axi_rdata = rdgen6_64b_r.data;
                fub_axi_rresp = rdgen6_64b_r.resp;
                fub_axi_rlast = rdgen6_64b_r.last;
                fub_axi_rvalid = rdgen6_64b_rvalid;
            end
            default: begin
