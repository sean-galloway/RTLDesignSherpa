// RDGEN4 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for rdgen4 master

`timescale 1ns / 1ps


module rdgen4_adapter
...
#(
    ...
    // External AXI interface (from rdgen4 master)
    ...
    output axi4_ar_t     rdgen4_64b_ar,
    output logic         rdgen4_64b_arvalid,
    input  logic         rdgen4_64b_arready,

    input  axi4_r_64b_t  rdgen4_64b_r,
    input  logic         rdgen4_64b_rvalid,
    output logic         rdgen4_64b_rready
);
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(rdgen4_axi_arid),
        .s_axi_araddr(rdgen4_axi_araddr),
        .s_axi_arlen(rdgen4_axi_arlen),
        .s_axi_arsize(rdgen4_axi_arsize),
        .s_axi_arburst(rdgen4_axi_arburst),
        .s_axi_arlock(rdgen4_axi_arlock),
        .s_axi_arcache(rdgen4_axi_arcache),
        .s_axi_arprot(rdgen4_axi_arprot),
        .s_axi_arqos(rdgen4_axi_arqos),
        .s_axi_arregion(rdgen4_axi_arregion),
        .s_axi_aruser(rdgen4_axi_aruser),
        .s_axi_arvalid(rdgen4_axi_arvalid),
        .s_axi_arready(rdgen4_axi_arready),
        .s_axi_rid(rdgen4_axi_rid),
        .s_axi_rdata(rdgen4_axi_rdata),
        .s_axi_rresp(rdgen4_axi_rresp),
        .s_axi_rlast(rdgen4_axi_rlast),
        .s_axi_ruser(rdgen4_axi_ruser),
        .s_axi_rvalid(rdgen4_axi_rvalid),
        .s_axi_rready(rdgen4_axi_rready),
    ...
    // Requests: fub_axi_* → rdgen4_64b_*
    // Responses: rdgen4_64b_* → MUX → fub_axi_*
    // ================================================================

    // AR channel (request: fub → output)
    assign rdgen4_64b_ar.id     = fub_axi_arid;
    assign rdgen4_64b_ar.addr   = fub_axi_araddr;
    assign rdgen4_64b_ar.len    = fub_axi_arlen;
    assign rdgen4_64b_ar.size   = fub_axi_arsize;
    assign rdgen4_64b_ar.burst  = fub_axi_arburst;
    assign rdgen4_64b_ar.lock   = fub_axi_arlock;
    assign rdgen4_64b_ar.cache  = fub_axi_arcache;
    assign rdgen4_64b_ar.prot   = fub_axi_arprot;
    assign rdgen4_64b_ar.qos    = 4'b0;  // Tie to 0
    assign rdgen4_64b_ar.region = 4'b0;  // Tie to 0
    assign rdgen4_64b_ar.user   = 1'b0;  // Tie to 0
    assign rdgen4_64b_arvalid   = fub_axi_arvalid && ar_path_active_64b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign rdgen4_64b_rready = fub_axi_rready && r_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_arready = rdgen4_64b_arready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_rid = rdgen4_64b_r.id;
                fub_axi_rdata = rdgen4_64b_r.data;
                fub_axi_rresp = rdgen4_64b_r.resp;
                fub_axi_rlast = rdgen4_64b_r.last;
                fub_axi_rvalid = rdgen4_64b_rvalid;
            end
            default: begin
