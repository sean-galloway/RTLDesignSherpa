// RDGEN5 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for rdgen5 master

`timescale 1ns / 1ps


module rdgen5_adapter
...
#(
    ...
    // External AXI interface (from rdgen5 master)
    ...
    output axi4_ar_t     rdgen5_64b_ar,
    output logic         rdgen5_64b_arvalid,
    input  logic         rdgen5_64b_arready,

    input  axi4_r_64b_t  rdgen5_64b_r,
    input  logic         rdgen5_64b_rvalid,
    output logic         rdgen5_64b_rready
);
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(rdgen5_axi_arid),
        .s_axi_araddr(rdgen5_axi_araddr),
        .s_axi_arlen(rdgen5_axi_arlen),
        .s_axi_arsize(rdgen5_axi_arsize),
        .s_axi_arburst(rdgen5_axi_arburst),
        .s_axi_arlock(rdgen5_axi_arlock),
        .s_axi_arcache(rdgen5_axi_arcache),
        .s_axi_arprot(rdgen5_axi_arprot),
        .s_axi_arqos(rdgen5_axi_arqos),
        .s_axi_arregion(rdgen5_axi_arregion),
        .s_axi_aruser(rdgen5_axi_aruser),
        .s_axi_arvalid(rdgen5_axi_arvalid),
        .s_axi_arready(rdgen5_axi_arready),
        .s_axi_rid(rdgen5_axi_rid),
        .s_axi_rdata(rdgen5_axi_rdata),
        .s_axi_rresp(rdgen5_axi_rresp),
        .s_axi_rlast(rdgen5_axi_rlast),
        .s_axi_ruser(rdgen5_axi_ruser),
        .s_axi_rvalid(rdgen5_axi_rvalid),
        .s_axi_rready(rdgen5_axi_rready),
    ...
    // Requests: fub_axi_* → rdgen5_64b_*
    // Responses: rdgen5_64b_* → MUX → fub_axi_*
    // ================================================================

    // AR channel (request: fub → output)
    assign rdgen5_64b_ar.id     = fub_axi_arid;
    assign rdgen5_64b_ar.addr   = fub_axi_araddr;
    assign rdgen5_64b_ar.len    = fub_axi_arlen;
    assign rdgen5_64b_ar.size   = fub_axi_arsize;
    assign rdgen5_64b_ar.burst  = fub_axi_arburst;
    assign rdgen5_64b_ar.lock   = fub_axi_arlock;
    assign rdgen5_64b_ar.cache  = fub_axi_arcache;
    assign rdgen5_64b_ar.prot   = fub_axi_arprot;
    assign rdgen5_64b_ar.qos    = 4'b0;  // Tie to 0
    assign rdgen5_64b_ar.region = 4'b0;  // Tie to 0
    assign rdgen5_64b_ar.user   = 1'b0;  // Tie to 0
    assign rdgen5_64b_arvalid   = fub_axi_arvalid && ar_path_active_64b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign rdgen5_64b_rready = fub_axi_rready && r_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_arready = rdgen5_64b_arready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_rid = rdgen5_64b_r.id;
                fub_axi_rdata = rdgen5_64b_r.data;
                fub_axi_rresp = rdgen5_64b_r.resp;
                fub_axi_rlast = rdgen5_64b_r.last;
                fub_axi_rvalid = rdgen5_64b_rvalid;
            end
            default: begin
