// WRGEN5 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for wrgen5 master

`timescale 1ns / 1ps


module wrgen5_adapter
    import bridge_ddr2_char_wr_pkg::*;
#(
    parameter NUM_SLAVES = 1,
    parameter BRIDGE_ID = 5,  // Unique ID for this master
    ...
    // External AXI interface (from wrgen5 master)
    ...
    output axi4_aw_t     wrgen5_64b_aw,
    output logic         wrgen5_64b_awvalid,
    input  logic         wrgen5_64b_awready,

    output axi4_w_64b_t  wrgen5_64b_w,
    output logic         wrgen5_64b_wvalid,
    input  logic         wrgen5_64b_wready,

    input  axi4_b_t      wrgen5_64b_b,
    input  logic         wrgen5_64b_bvalid,
    output logic         wrgen5_64b_bready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(wrgen5_axi_awid),
        .s_axi_awaddr(wrgen5_axi_awaddr),
        .s_axi_awlen(wrgen5_axi_awlen),
        .s_axi_awsize(wrgen5_axi_awsize),
        .s_axi_awburst(wrgen5_axi_awburst),
        .s_axi_awlock(wrgen5_axi_awlock),
        .s_axi_awcache(wrgen5_axi_awcache),
        .s_axi_awprot(wrgen5_axi_awprot),
        .s_axi_awqos(wrgen5_axi_awqos),
        .s_axi_awregion(wrgen5_axi_awregion),
        .s_axi_awuser(wrgen5_axi_awuser),
        .s_axi_awvalid(wrgen5_axi_awvalid),
        .s_axi_awready(wrgen5_axi_awready),
        .s_axi_wdata(wrgen5_axi_wdata),
        .s_axi_wstrb(wrgen5_axi_wstrb),
        .s_axi_wlast(wrgen5_axi_wlast),
        .s_axi_wuser(wrgen5_axi_wuser),
        .s_axi_wvalid(wrgen5_axi_wvalid),
        .s_axi_wready(wrgen5_axi_wready),
        .s_axi_bid(wrgen5_axi_bid),
        .s_axi_bresp(wrgen5_axi_bresp),
        .s_axi_buser(wrgen5_axi_buser),
        .s_axi_bvalid(wrgen5_axi_bvalid),
        .s_axi_bready(wrgen5_axi_bready),
    ...
    // Requests: fub_axi_* → wrgen5_64b_*
    // Responses: wrgen5_64b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign wrgen5_64b_aw.id     = fub_axi_awid;
    assign wrgen5_64b_aw.addr   = fub_axi_awaddr;
    assign wrgen5_64b_aw.len    = fub_axi_awlen;
    assign wrgen5_64b_aw.size   = fub_axi_awsize;
    assign wrgen5_64b_aw.burst  = fub_axi_awburst;
    assign wrgen5_64b_aw.lock   = fub_axi_awlock;
    assign wrgen5_64b_aw.cache  = fub_axi_awcache;
    assign wrgen5_64b_aw.prot   = fub_axi_awprot;
    assign wrgen5_64b_aw.qos    = 4'b0;  // Tie to 0
    assign wrgen5_64b_aw.region = 4'b0;  // Tie to 0
    assign wrgen5_64b_aw.user   = 1'b0;  // Tie to 0
    assign wrgen5_64b_awvalid   = fub_axi_awvalid && aw_path_active_64b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign wrgen5_64b_w.data  = fub_axi_wdata;
    assign wrgen5_64b_w.strb  = fub_axi_wstrb;
    assign wrgen5_64b_w.last  = fub_axi_wlast;
    assign wrgen5_64b_w.user  = 1'b0;  // Tie to 0
    assign wrgen5_64b_wvalid  = fub_axi_wvalid && w_path_active_64b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign wrgen5_64b_bready = fub_axi_bready && b_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_awready = wrgen5_64b_awready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_wready = wrgen5_64b_wready;
            end
            default: begin
    ...
    always_comb begin
        ...
        case (b_slave_select)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_bid = wrgen5_64b_b.id;
                fub_axi_bresp = wrgen5_64b_b.resp;
                fub_axi_bvalid = wrgen5_64b_bvalid;
            end
            default: begin
