// WRGEN2 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for wrgen2 master

`timescale 1ns / 1ps


module wrgen2_adapter
...
#(
    ...
    // External AXI interface (from wrgen2 master)
    ...
    output axi4_aw_t     wrgen2_64b_aw,
    output logic         wrgen2_64b_awvalid,
    input  logic         wrgen2_64b_awready,

    output axi4_w_64b_t  wrgen2_64b_w,
    output logic         wrgen2_64b_wvalid,
    input  logic         wrgen2_64b_wready,

    input  axi4_b_t      wrgen2_64b_b,
    input  logic         wrgen2_64b_bvalid,
    output logic         wrgen2_64b_bready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(wrgen2_axi_awid),
        .s_axi_awaddr(wrgen2_axi_awaddr),
        .s_axi_awlen(wrgen2_axi_awlen),
        .s_axi_awsize(wrgen2_axi_awsize),
        .s_axi_awburst(wrgen2_axi_awburst),
        .s_axi_awlock(wrgen2_axi_awlock),
        .s_axi_awcache(wrgen2_axi_awcache),
        .s_axi_awprot(wrgen2_axi_awprot),
        .s_axi_awqos(wrgen2_axi_awqos),
        .s_axi_awregion(wrgen2_axi_awregion),
        .s_axi_awuser(wrgen2_axi_awuser),
        .s_axi_awvalid(wrgen2_axi_awvalid),
        .s_axi_awready(wrgen2_axi_awready),
        .s_axi_wdata(wrgen2_axi_wdata),
        .s_axi_wstrb(wrgen2_axi_wstrb),
        .s_axi_wlast(wrgen2_axi_wlast),
        .s_axi_wuser(wrgen2_axi_wuser),
        .s_axi_wvalid(wrgen2_axi_wvalid),
        .s_axi_wready(wrgen2_axi_wready),
        .s_axi_bid(wrgen2_axi_bid),
        .s_axi_bresp(wrgen2_axi_bresp),
        .s_axi_buser(wrgen2_axi_buser),
        .s_axi_bvalid(wrgen2_axi_bvalid),
        .s_axi_bready(wrgen2_axi_bready),
    ...
    // Requests: fub_axi_* → wrgen2_64b_*
    // Responses: wrgen2_64b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign wrgen2_64b_aw.id     = fub_axi_awid;
    assign wrgen2_64b_aw.addr   = fub_axi_awaddr;
    assign wrgen2_64b_aw.len    = fub_axi_awlen;
    assign wrgen2_64b_aw.size   = fub_axi_awsize;
    assign wrgen2_64b_aw.burst  = fub_axi_awburst;
    assign wrgen2_64b_aw.lock   = fub_axi_awlock;
    assign wrgen2_64b_aw.cache  = fub_axi_awcache;
    assign wrgen2_64b_aw.prot   = fub_axi_awprot;
    assign wrgen2_64b_aw.qos    = 4'b0;  // Tie to 0
    assign wrgen2_64b_aw.region = 4'b0;  // Tie to 0
    assign wrgen2_64b_aw.user   = 1'b0;  // Tie to 0
    assign wrgen2_64b_awvalid   = fub_axi_awvalid && aw_path_active_64b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign wrgen2_64b_w.data  = fub_axi_wdata;
    assign wrgen2_64b_w.strb  = fub_axi_wstrb;
    assign wrgen2_64b_w.last  = fub_axi_wlast;
    assign wrgen2_64b_w.user  = 1'b0;  // Tie to 0
    assign wrgen2_64b_wvalid  = fub_axi_wvalid && w_path_active_64b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign wrgen2_64b_bready = fub_axi_bready && b_path_active_64b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_awready = wrgen2_64b_awready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_wready = wrgen2_64b_wready;
            end
            default: begin
    ...
    always_comb begin
        ...
        case (b_slave_select)
            1'b1: begin  // Slave 0 (64b)
                fub_axi_bid = wrgen2_64b_b.id;
                fub_axi_bresp = wrgen2_64b_b.resp;
                fub_axi_bvalid = wrgen2_64b_bvalid;
            end
            default: begin
