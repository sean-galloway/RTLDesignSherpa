#==============================================================================
# build_all.tcl — synth + impl + bitstream for rapids_char
#==============================================================================
# Usage:  REPO_ROOT=... vivado -mode batch -source build_all.tcl
# (bin/gen.sh sets REPO_ROOT and calls this.)
#==============================================================================

set script_dir   [file dirname [file normalize [info script]]]
set project_root [file normalize "$script_dir/.."]
set project_file "$project_root/build/vivado_project/rapids_char.xpr"

puts "========================================================================"
puts "RAPIDS beats Characterization — Full Build"
puts "========================================================================"
...
# independent of implementation success/failure. This is the number to watch
# for the 100T (RAPIDS beats is BRAM/LUT heavy at 512-bit datapath width).
...
# Full failing-path detail (post-route).
report_timing -setup \
    -slack_lesser_than 0 \
    -max_paths 100000 \
    -nworst 1 \
