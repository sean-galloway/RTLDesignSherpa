...
module desc_ram_adapter #(
   ...
   ,parameter bit USE_MONITOR_RD = 1'b1
    ...
    // ============================================================
    logic [3:0] desc_ram_mon_axi_awid;
    logic [31:0] desc_ram_mon_axi_awaddr;
    logic [7:0]  desc_ram_mon_axi_awlen;
    logic [2:0]  desc_ram_mon_axi_awsize;
    logic [1:0]  desc_ram_mon_axi_awburst;
    logic        desc_ram_mon_axi_awlock;
    logic [3:0]  desc_ram_mon_axi_awcache;
    logic [2:0]  desc_ram_mon_axi_awprot;
    logic [3:0]  desc_ram_mon_axi_awqos;
    logic [3:0]  desc_ram_mon_axi_awregion;
    logic        desc_ram_mon_axi_awuser;
    logic        desc_ram_mon_axi_awvalid;
    logic        desc_ram_mon_axi_awready;
    logic [31:0] desc_ram_mon_axi_wdata;
    logic [3:0] desc_ram_mon_axi_wstrb;
    logic        desc_ram_mon_axi_wlast;
    logic        desc_ram_mon_axi_wuser;
    logic        desc_ram_mon_axi_wvalid;
    logic        desc_ram_mon_axi_wready;
    logic [3:0] desc_ram_mon_axi_bid;
    logic [1:0]  desc_ram_mon_axi_bresp;
    logic        desc_ram_mon_axi_buser;
    logic        desc_ram_mon_axi_bvalid;
    logic        desc_ram_mon_axi_bready;
    logic [3:0] desc_ram_mon_axi_arid;
    logic [31:0] desc_ram_mon_axi_araddr;
    logic [7:0]  desc_ram_mon_axi_arlen;
    logic [2:0]  desc_ram_mon_axi_arsize;
    logic [1:0]  desc_ram_mon_axi_arburst;
    logic        desc_ram_mon_axi_arlock;
    logic [3:0]  desc_ram_mon_axi_arcache;
    logic [2:0]  desc_ram_mon_axi_arprot;
    logic [3:0]  desc_ram_mon_axi_arqos;
    logic [3:0]  desc_ram_mon_axi_arregion;
    logic        desc_ram_mon_axi_aruser;
    logic        desc_ram_mon_axi_arvalid;
    logic        desc_ram_mon_axi_arready;
    logic [3:0] desc_ram_mon_axi_rid;
    logic [31:0] desc_ram_mon_axi_rdata;
    logic [1:0]  desc_ram_mon_axi_rresp;
    logic        desc_ram_mon_axi_rlast;
    logic        desc_ram_mon_axi_ruser;
    logic        desc_ram_mon_axi_rvalid;
    logic        desc_ram_mon_axi_rready;
    ...
    axi4_master_wr_mon #(
        ...
        // External side (m_axi)
        .m_axi_awid(desc_ram_mon_axi_awid),
        .m_axi_awaddr(desc_ram_mon_axi_awaddr),
        .m_axi_awlen(desc_ram_mon_axi_awlen),
        .m_axi_awsize(desc_ram_mon_axi_awsize),
        .m_axi_awburst(desc_ram_mon_axi_awburst),
        .m_axi_awlock(desc_ram_mon_axi_awlock),
        .m_axi_awcache(desc_ram_mon_axi_awcache),
        .m_axi_awprot(desc_ram_mon_axi_awprot),
        .m_axi_awqos(desc_ram_mon_axi_awqos),
        .m_axi_awregion(desc_ram_mon_axi_awregion),
        .m_axi_awuser(desc_ram_mon_axi_awuser),
        .m_axi_awvalid(desc_ram_mon_axi_awvalid),
        .m_axi_awready(desc_ram_mon_axi_awready),
        .m_axi_wdata(desc_ram_mon_axi_wdata),
        .m_axi_wstrb(desc_ram_mon_axi_wstrb),
        .m_axi_wlast(desc_ram_mon_axi_wlast),
        .m_axi_wuser(desc_ram_mon_axi_wuser),
        .m_axi_wvalid(desc_ram_mon_axi_wvalid),
        .m_axi_wready(desc_ram_mon_axi_wready),
        .m_axi_bid(desc_ram_mon_axi_bid),
        .m_axi_bresp(desc_ram_mon_axi_bresp),
        .m_axi_buser(desc_ram_mon_axi_buser),
        .m_axi_bvalid(desc_ram_mon_axi_bvalid),
        .m_axi_bready(desc_ram_mon_axi_bready),
    ...
    axi4_master_rd_mon #(
        ...
        // External side (m_axi)
        .m_axi_arid(desc_ram_mon_axi_arid),
        .m_axi_araddr(desc_ram_mon_axi_araddr),
        .m_axi_arlen(desc_ram_mon_axi_arlen),
        .m_axi_arsize(desc_ram_mon_axi_arsize),
        .m_axi_arburst(desc_ram_mon_axi_arburst),
        .m_axi_arlock(desc_ram_mon_axi_arlock),
        .m_axi_arcache(desc_ram_mon_axi_arcache),
        .m_axi_arprot(desc_ram_mon_axi_arprot),
        .m_axi_arqos(desc_ram_mon_axi_arqos),
        .m_axi_arregion(desc_ram_mon_axi_arregion),
        .m_axi_aruser(desc_ram_mon_axi_aruser),
        .m_axi_arvalid(desc_ram_mon_axi_arvalid),
        .m_axi_arready(desc_ram_mon_axi_arready),
        .m_axi_rid(desc_ram_mon_axi_rid),
        .m_axi_rdata(desc_ram_mon_axi_rdata),
        .m_axi_rresp(desc_ram_mon_axi_rresp),
        .m_axi_rlast(desc_ram_mon_axi_rlast),
        .m_axi_ruser(desc_ram_mon_axi_ruser),
        .m_axi_rvalid(desc_ram_mon_axi_rvalid),
        .m_axi_rready(desc_ram_mon_axi_rready),
    ...
    axi4_to_axil4_wr #(
        ...
        .s_axi_awid(desc_ram_mon_axi_awid),
        .s_axi_awaddr(desc_ram_mon_axi_awaddr),
        .s_axi_awlen(desc_ram_mon_axi_awlen),
        .s_axi_awsize(desc_ram_mon_axi_awsize),
        .s_axi_awburst(desc_ram_mon_axi_awburst),
        .s_axi_awlock(desc_ram_mon_axi_awlock),
        .s_axi_awcache(desc_ram_mon_axi_awcache),
        .s_axi_awprot(desc_ram_mon_axi_awprot),
        .s_axi_awqos(desc_ram_mon_axi_awqos),
        .s_axi_awregion(desc_ram_mon_axi_awregion),
        .s_axi_awuser(desc_ram_mon_axi_awuser),
        .s_axi_awvalid(desc_ram_mon_axi_awvalid),
        .s_axi_awready(desc_ram_mon_axi_awready),
        .s_axi_wdata(desc_ram_mon_axi_wdata),
        .s_axi_wstrb(desc_ram_mon_axi_wstrb),
        .s_axi_wlast(desc_ram_mon_axi_wlast),
        .s_axi_wuser(desc_ram_mon_axi_wuser),
        .s_axi_wvalid(desc_ram_mon_axi_wvalid),
        .s_axi_wready(desc_ram_mon_axi_wready),
        .s_axi_bid(desc_ram_mon_axi_bid),
        .s_axi_bresp(desc_ram_mon_axi_bresp),
        .s_axi_buser(desc_ram_mon_axi_buser),
    ...
    axi4_to_axil4_rd #(
        ...
        .s_axi_arid(desc_ram_mon_axi_arid),
        .s_axi_araddr(desc_ram_mon_axi_araddr),
        .s_axi_arlen(desc_ram_mon_axi_arlen),
        .s_axi_arsize(desc_ram_mon_axi_arsize),
        .s_axi_arburst(desc_ram_mon_axi_arburst),
        .s_axi_arlock(desc_ram_mon_axi_arlock),
        .s_axi_arcache(desc_ram_mon_axi_arcache),
        .s_axi_arprot(desc_ram_mon_axi_arprot),
        .s_axi_arqos(desc_ram_mon_axi_arqos),
        .s_axi_arregion(desc_ram_mon_axi_arregion),
        .s_axi_aruser(desc_ram_mon_axi_aruser),
        .s_axi_arvalid(desc_ram_mon_axi_arvalid),
        .s_axi_arready(desc_ram_mon_axi_arready),
        .s_axi_rid(desc_ram_mon_axi_rid),
        .s_axi_rdata(desc_ram_mon_axi_rdata),
        .s_axi_rresp(desc_ram_mon_axi_rresp),
        .s_axi_rlast(converter_rlast),
        .s_axi_ruser(desc_ram_mon_axi_ruser),
    ...
    assign desc_ram_mon_axi_bvalid = converter_bvalid;
    assign converter_bready = desc_ram_mon_axi_bready;
    assign desc_ram_mon_axi_rvalid = converter_rvalid;
    assign converter_rready = desc_ram_mon_axi_rready;
    assign desc_ram_mon_axi_rlast = converter_rlast;
