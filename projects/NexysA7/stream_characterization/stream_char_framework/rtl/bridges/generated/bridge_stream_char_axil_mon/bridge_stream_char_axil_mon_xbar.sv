...
module bridge_stream_char_axil_mon_xbar (
    ...
    output logic [BRIDGE_ID_WIDTH-1:0] bridge_trace_sram_axi_bridge_id_aw,
    input  logic [BRIDGE_ID_WIDTH-1:0] bridge_trace_sram_axi_bid_bridge_id,
    input  logic                       bridge_trace_sram_axi_bid_valid,

    output logic [BRIDGE_ID_WIDTH-1:0] bridge_trace_sram_axi_bridge_id_ar,
    input  logic [BRIDGE_ID_WIDTH-1:0] bridge_trace_sram_axi_rid_bridge_id,
    input  logic                       bridge_trace_sram_axi_rid_valid,

    output  logic [3:0]  bridge_trace_sram_axi_awid,
    output  logic [31:0]  bridge_trace_sram_axi_awaddr,
    output  logic [7:0]  bridge_trace_sram_axi_awlen,
    output  logic [2:0]  bridge_trace_sram_axi_awsize,
    output  logic [1:0]  bridge_trace_sram_axi_awburst,
    output  logic         bridge_trace_sram_axi_awlock,
    output  logic [3:0]  bridge_trace_sram_axi_awcache,
    output  logic [2:0]  bridge_trace_sram_axi_awprot,
    output  logic [3:0]  bridge_trace_sram_axi_awqos,
    output  logic [3:0]  bridge_trace_sram_axi_awregion,
    output  logic         bridge_trace_sram_axi_awuser,
    output  logic         bridge_trace_sram_axi_awvalid,
    input  logic         bridge_trace_sram_axi_awready,

    output  logic [63:0]  bridge_trace_sram_axi_wdata,
    output  logic [7:0]  bridge_trace_sram_axi_wstrb,
    output  logic         bridge_trace_sram_axi_wlast,
    output  logic         bridge_trace_sram_axi_wuser,
    output  logic         bridge_trace_sram_axi_wvalid,
    input  logic         bridge_trace_sram_axi_wready,

    input  logic [3:0]  bridge_trace_sram_axi_bid,
    input  logic [1:0]  bridge_trace_sram_axi_bresp,
    input  logic         bridge_trace_sram_axi_buser,
    input  logic         bridge_trace_sram_axi_bvalid,
    output  logic         bridge_trace_sram_axi_bready,

    output  logic [3:0]  bridge_trace_sram_axi_arid,
    output  logic [31:0]  bridge_trace_sram_axi_araddr,
    output  logic [7:0]  bridge_trace_sram_axi_arlen,
    output  logic [2:0]  bridge_trace_sram_axi_arsize,
    output  logic [1:0]  bridge_trace_sram_axi_arburst,
    output  logic         bridge_trace_sram_axi_arlock,
    output  logic [3:0]  bridge_trace_sram_axi_arcache,
    output  logic [2:0]  bridge_trace_sram_axi_arprot,
    output  logic [3:0]  bridge_trace_sram_axi_arqos,
    output  logic [3:0]  bridge_trace_sram_axi_arregion,
    output  logic         bridge_trace_sram_axi_aruser,
    output  logic         bridge_trace_sram_axi_arvalid,
    input  logic         bridge_trace_sram_axi_arready,

    input  logic [3:0]  bridge_trace_sram_axi_rid,
    input  logic [63:0]  bridge_trace_sram_axi_rdata,
    input  logic [1:0]  bridge_trace_sram_axi_rresp,
    input  logic         bridge_trace_sram_axi_rlast,
    input  logic         bridge_trace_sram_axi_ruser,
    input  logic         bridge_trace_sram_axi_rvalid,
    output  logic         bridge_trace_sram_axi_rready,

    // Slave 7: desc_mon_trace_sram
    output logic [BRIDGE_ID_WIDTH-1:0] desc_mon_trace_sram_axi_bridge_id_aw,
    input  logic [BRIDGE_ID_WIDTH-1:0] desc_mon_trace_sram_axi_bid_bridge_id,
    input  logic                       desc_mon_trace_sram_axi_bid_valid,

    output logic [BRIDGE_ID_WIDTH-1:0] desc_mon_trace_sram_axi_bridge_id_ar,
    input  logic [BRIDGE_ID_WIDTH-1:0] desc_mon_trace_sram_axi_rid_bridge_id,
    input  logic                       desc_mon_trace_sram_axi_rid_valid,

    output  logic [3:0]  desc_mon_trace_sram_axi_awid,
    output  logic [31:0]  desc_mon_trace_sram_axi_awaddr,
    output  logic [7:0]  desc_mon_trace_sram_axi_awlen,
    output  logic [2:0]  desc_mon_trace_sram_axi_awsize,
    output  logic [1:0]  desc_mon_trace_sram_axi_awburst,
    output  logic         desc_mon_trace_sram_axi_awlock,
    output  logic [3:0]  desc_mon_trace_sram_axi_awcache,
    output  logic [2:0]  desc_mon_trace_sram_axi_awprot,
    output  logic [3:0]  desc_mon_trace_sram_axi_awqos,
    output  logic [3:0]  desc_mon_trace_sram_axi_awregion,
    output  logic         desc_mon_trace_sram_axi_awuser,
    output  logic         desc_mon_trace_sram_axi_awvalid,
    input  logic         desc_mon_trace_sram_axi_awready,

    output  logic [63:0]  desc_mon_trace_sram_axi_wdata,
    output  logic [7:0]  desc_mon_trace_sram_axi_wstrb,
    output  logic         desc_mon_trace_sram_axi_wlast,
    output  logic         desc_mon_trace_sram_axi_wuser,
    output  logic         desc_mon_trace_sram_axi_wvalid,
    input  logic         desc_mon_trace_sram_axi_wready,

    input  logic [3:0]  desc_mon_trace_sram_axi_bid,
    input  logic [1:0]  desc_mon_trace_sram_axi_bresp,
    input  logic         desc_mon_trace_sram_axi_buser,
    input  logic         desc_mon_trace_sram_axi_bvalid,
    output  logic         desc_mon_trace_sram_axi_bready,

    output  logic [3:0]  desc_mon_trace_sram_axi_arid,
    output  logic [31:0]  desc_mon_trace_sram_axi_araddr,
    output  logic [7:0]  desc_mon_trace_sram_axi_arlen,
    output  logic [2:0]  desc_mon_trace_sram_axi_arsize,
    output  logic [1:0]  desc_mon_trace_sram_axi_arburst,
    output  logic         desc_mon_trace_sram_axi_arlock,
    output  logic [3:0]  desc_mon_trace_sram_axi_arcache,
    output  logic [2:0]  desc_mon_trace_sram_axi_arprot,
    output  logic [3:0]  desc_mon_trace_sram_axi_arqos,
    output  logic [3:0]  desc_mon_trace_sram_axi_arregion,
    output  logic         desc_mon_trace_sram_axi_aruser,
    output  logic         desc_mon_trace_sram_axi_arvalid,
    input  logic         desc_mon_trace_sram_axi_arready,

    input  logic [3:0]  desc_mon_trace_sram_axi_rid,
    input  logic [63:0]  desc_mon_trace_sram_axi_rdata,
    input  logic [1:0]  desc_mon_trace_sram_axi_rresp,
    input  logic         desc_mon_trace_sram_axi_rlast,
    input  logic         desc_mon_trace_sram_axi_ruser,
    input  logic         desc_mon_trace_sram_axi_rvalid,
    output  logic         desc_mon_trace_sram_axi_rready
);
    ...
    // AW channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_aw_to_stream_err = ((host_64b_aw.addr >= 32'h00030000) && (host_64b_aw.addr <= 32'h00030fff));
    assign stream_err_axi_awid     = host_64b_aw_to_stream_err ? host_64b_aw.id : '0;
    assign stream_err_axi_awaddr   = host_64b_aw_to_stream_err ? host_64b_aw.addr : '0;
    assign stream_err_axi_awlen    = host_64b_aw_to_stream_err ? host_64b_aw.len : '0;
    assign stream_err_axi_awsize   = host_64b_aw_to_stream_err ? host_64b_aw.size : '0;
    assign stream_err_axi_awburst  = host_64b_aw_to_stream_err ? host_64b_aw.burst : '0;
    assign stream_err_axi_awlock   = host_64b_aw_to_stream_err ? host_64b_aw.lock : '0;
    assign stream_err_axi_awcache  = host_64b_aw_to_stream_err ? host_64b_aw.cache : '0;
    assign stream_err_axi_awprot   = host_64b_aw_to_stream_err ? host_64b_aw.prot : '0;
    assign stream_err_axi_awvalid  = host_64b_aw_to_stream_err && host_64b_awvalid;

    // AW->W tracking FIFO for this (master,slave) pair
    logic host_64b_w_to_stream_err;
    logic [3:0] host_64b_aw_to_stream_err_w_wptr, host_64b_aw_to_stream_err_w_rptr;
    logic host_64b_aw_to_stream_err_w_mem [16];
    logic host_64b_aw_to_stream_err_w_push, host_64b_aw_to_stream_err_w_pop;
    assign host_64b_aw_to_stream_err_w_push = host_64b_awvalid && host_64b_awready && host_64b_aw_to_stream_err;
    assign host_64b_aw_to_stream_err_w_pop  = host_64b_wvalid && host_64b_wready && host_64b_w.last && host_64b_w_to_stream_err;
    always_ff @(posedge aclk or negedge aresetn) begin
        if (!aresetn) begin
            host_64b_aw_to_stream_err_w_wptr <= '0;
            host_64b_aw_to_stream_err_w_rptr <= '0;
        end else begin
            if (host_64b_aw_to_stream_err_w_push) begin
                host_64b_aw_to_stream_err_w_mem[host_64b_aw_to_stream_err_w_wptr] <= 1'b1;
                host_64b_aw_to_stream_err_w_wptr <= host_64b_aw_to_stream_err_w_wptr + 1'b1;
            end
            if (host_64b_aw_to_stream_err_w_pop) begin
                host_64b_aw_to_stream_err_w_rptr <= host_64b_aw_to_stream_err_w_rptr + 1'b1;
            end
        end
    end
    assign host_64b_w_to_stream_err = (host_64b_aw_to_stream_err_w_wptr != host_64b_aw_to_stream_err_w_rptr) ? host_64b_aw_to_stream_err_w_mem[host_64b_aw_to_stream_err_w_rptr] : 1'b0;


    // W channel (gated by aw_to_<slave> FIFO head)
    assign stream_err_axi_wdata  = host_64b_w_to_stream_err ? host_64b_w.data : '0;
    assign stream_err_axi_wstrb  = host_64b_w_to_stream_err ? host_64b_w.strb : '0;
    assign stream_err_axi_wlast  = host_64b_w_to_stream_err ? host_64b_w.last : '0;
    assign stream_err_axi_wvalid = host_64b_w_to_stream_err && host_64b_wvalid;

    // Bready (master → slave) — gated on bid_valid so the path stays
    // open through the entire B handshake, not just the AW phase.
    assign stream_err_axi_bready = ((stream_err_axi_bid_bridge_id == 0) && stream_err_axi_bid_valid) ? host_64b_bready : '0;

    // Bridge ID (master → slave)
    assign stream_err_axi_bridge_id_aw = host_64b_aw_to_stream_err ? host_bridge_id_aw : '0;

    // AR channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_ar_to_stream_err = ((host_64b_ar.addr >= 32'h00030000) && (host_64b_ar.addr <= 32'h00030fff));
    assign stream_err_axi_arid     = host_64b_ar_to_stream_err ? host_64b_ar.id : '0;
    assign stream_err_axi_araddr   = host_64b_ar_to_stream_err ? host_64b_ar.addr : '0;
    assign stream_err_axi_arlen    = host_64b_ar_to_stream_err ? host_64b_ar.len : '0;
    assign stream_err_axi_arsize   = host_64b_ar_to_stream_err ? host_64b_ar.size : '0;
    assign stream_err_axi_arburst  = host_64b_ar_to_stream_err ? host_64b_ar.burst : '0;
    assign stream_err_axi_arlock   = host_64b_ar_to_stream_err ? host_64b_ar.lock : '0;
    assign stream_err_axi_arcache  = host_64b_ar_to_stream_err ? host_64b_ar.cache : '0;
    assign stream_err_axi_arprot   = host_64b_ar_to_stream_err ? host_64b_ar.prot : '0;
    assign stream_err_axi_arvalid  = host_64b_ar_to_stream_err && host_64b_arvalid;

    // Rready (master → slave) — gated on rid_valid so the path stays
    // open through the entire R handshake, not just the AR phase.
    assign stream_err_axi_rready = ((stream_err_axi_rid_bridge_id == 0) && stream_err_axi_rid_valid) ? host_64b_rready : '0;

    // Bridge ID (master → slave)
    assign stream_err_axi_bridge_id_ar = host_64b_ar_to_stream_err ? host_bridge_id_ar : '0;
    ...
    // ================================================================
    // Slave 6: bridge_trace_sram (64b)
    // ================================================================
    // Single master: host → bridge_trace_sram
    // Master width: 32b, Slave width: 64b
    // Using 64b path from adapter

    // AW channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_aw_to_bridge_trace_sram = ((host_64b_aw.addr >= 32'h000c0000) && (host_64b_aw.addr <= 32'h000cffff));
    assign bridge_trace_sram_axi_awid     = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.id : '0;
    assign bridge_trace_sram_axi_awaddr   = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.addr : '0;
    assign bridge_trace_sram_axi_awlen    = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.len : '0;
    assign bridge_trace_sram_axi_awsize   = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.size : '0;
    assign bridge_trace_sram_axi_awburst  = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.burst : '0;
    assign bridge_trace_sram_axi_awlock   = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.lock : '0;
    assign bridge_trace_sram_axi_awcache  = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.cache : '0;
    assign bridge_trace_sram_axi_awprot   = host_64b_aw_to_bridge_trace_sram ? host_64b_aw.prot : '0;
    assign bridge_trace_sram_axi_awvalid  = host_64b_aw_to_bridge_trace_sram && host_64b_awvalid;

    // AW->W tracking FIFO for this (master,slave) pair
    logic host_64b_w_to_bridge_trace_sram;
    logic [3:0] host_64b_aw_to_bridge_trace_sram_w_wptr, host_64b_aw_to_bridge_trace_sram_w_rptr;
    logic host_64b_aw_to_bridge_trace_sram_w_mem [16];
    logic host_64b_aw_to_bridge_trace_sram_w_push, host_64b_aw_to_bridge_trace_sram_w_pop;
    assign host_64b_aw_to_bridge_trace_sram_w_push = host_64b_awvalid && host_64b_awready && host_64b_aw_to_bridge_trace_sram;
    assign host_64b_aw_to_bridge_trace_sram_w_pop  = host_64b_wvalid && host_64b_wready && host_64b_w.last && host_64b_w_to_bridge_trace_sram;
    always_ff @(posedge aclk or negedge aresetn) begin
        if (!aresetn) begin
            host_64b_aw_to_bridge_trace_sram_w_wptr <= '0;
            host_64b_aw_to_bridge_trace_sram_w_rptr <= '0;
        end else begin
            if (host_64b_aw_to_bridge_trace_sram_w_push) begin
                host_64b_aw_to_bridge_trace_sram_w_mem[host_64b_aw_to_bridge_trace_sram_w_wptr] <= 1'b1;
                host_64b_aw_to_bridge_trace_sram_w_wptr <= host_64b_aw_to_bridge_trace_sram_w_wptr + 1'b1;
            end
            if (host_64b_aw_to_bridge_trace_sram_w_pop) begin
                host_64b_aw_to_bridge_trace_sram_w_rptr <= host_64b_aw_to_bridge_trace_sram_w_rptr + 1'b1;
            end
        end
    end
    assign host_64b_w_to_bridge_trace_sram = (host_64b_aw_to_bridge_trace_sram_w_wptr != host_64b_aw_to_bridge_trace_sram_w_rptr) ? host_64b_aw_to_bridge_trace_sram_w_mem[host_64b_aw_to_bridge_trace_sram_w_rptr] : 1'b0;


    // W channel (gated by aw_to_<slave> FIFO head)
    assign bridge_trace_sram_axi_wdata  = host_64b_w_to_bridge_trace_sram ? host_64b_w.data : '0;
    assign bridge_trace_sram_axi_wstrb  = host_64b_w_to_bridge_trace_sram ? host_64b_w.strb : '0;
    assign bridge_trace_sram_axi_wlast  = host_64b_w_to_bridge_trace_sram ? host_64b_w.last : '0;
    assign bridge_trace_sram_axi_wvalid = host_64b_w_to_bridge_trace_sram && host_64b_wvalid;

    // Bready (master → slave) — gated on bid_valid so the path stays
    // open through the entire B handshake, not just the AW phase.
    assign bridge_trace_sram_axi_bready = ((bridge_trace_sram_axi_bid_bridge_id == 0) && bridge_trace_sram_axi_bid_valid) ? host_64b_bready : '0;

    // Bridge ID (master → slave)
    assign bridge_trace_sram_axi_bridge_id_aw = host_64b_aw_to_bridge_trace_sram ? host_bridge_id_aw : '0;

    // AR channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_ar_to_bridge_trace_sram = ((host_64b_ar.addr >= 32'h000c0000) && (host_64b_ar.addr <= 32'h000cffff));
    assign bridge_trace_sram_axi_arid     = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.id : '0;
    assign bridge_trace_sram_axi_araddr   = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.addr : '0;
    assign bridge_trace_sram_axi_arlen    = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.len : '0;
    assign bridge_trace_sram_axi_arsize   = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.size : '0;
    assign bridge_trace_sram_axi_arburst  = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.burst : '0;
    assign bridge_trace_sram_axi_arlock   = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.lock : '0;
    assign bridge_trace_sram_axi_arcache  = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.cache : '0;
    assign bridge_trace_sram_axi_arprot   = host_64b_ar_to_bridge_trace_sram ? host_64b_ar.prot : '0;
    assign bridge_trace_sram_axi_arvalid  = host_64b_ar_to_bridge_trace_sram && host_64b_arvalid;

    // Rready (master → slave) — gated on rid_valid so the path stays
    // open through the entire R handshake, not just the AR phase.
    assign bridge_trace_sram_axi_rready = ((bridge_trace_sram_axi_rid_bridge_id == 0) && bridge_trace_sram_axi_rid_valid) ? host_64b_rready : '0;

    // Bridge ID (master → slave)
    assign bridge_trace_sram_axi_bridge_id_ar = host_64b_ar_to_bridge_trace_sram ? host_bridge_id_ar : '0;


    // ================================================================
    // Slave 7: desc_mon_trace_sram (64b)
    // ================================================================
    // Single master: host → desc_mon_trace_sram
    // Master width: 32b, Slave width: 64b
    // Using 64b path from adapter

    // AW channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_aw_to_desc_mon_trace_sram = ((host_64b_aw.addr >= 32'h000d0000) && (host_64b_aw.addr <= 32'h000dffff));
    assign desc_mon_trace_sram_axi_awid     = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.id : '0;
    assign desc_mon_trace_sram_axi_awaddr   = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.addr : '0;
    assign desc_mon_trace_sram_axi_awlen    = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.len : '0;
    assign desc_mon_trace_sram_axi_awsize   = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.size : '0;
    assign desc_mon_trace_sram_axi_awburst  = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.burst : '0;
    assign desc_mon_trace_sram_axi_awlock   = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.lock : '0;
    assign desc_mon_trace_sram_axi_awcache  = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.cache : '0;
    assign desc_mon_trace_sram_axi_awprot   = host_64b_aw_to_desc_mon_trace_sram ? host_64b_aw.prot : '0;
    assign desc_mon_trace_sram_axi_awvalid  = host_64b_aw_to_desc_mon_trace_sram && host_64b_awvalid;

    // AW->W tracking FIFO for this (master,slave) pair
    logic host_64b_w_to_desc_mon_trace_sram;
    logic [3:0] host_64b_aw_to_desc_mon_trace_sram_w_wptr, host_64b_aw_to_desc_mon_trace_sram_w_rptr;
    logic host_64b_aw_to_desc_mon_trace_sram_w_mem [16];
    logic host_64b_aw_to_desc_mon_trace_sram_w_push, host_64b_aw_to_desc_mon_trace_sram_w_pop;
    assign host_64b_aw_to_desc_mon_trace_sram_w_push = host_64b_awvalid && host_64b_awready && host_64b_aw_to_desc_mon_trace_sram;
    assign host_64b_aw_to_desc_mon_trace_sram_w_pop  = host_64b_wvalid && host_64b_wready && host_64b_w.last && host_64b_w_to_desc_mon_trace_sram;
    always_ff @(posedge aclk or negedge aresetn) begin
        if (!aresetn) begin
            host_64b_aw_to_desc_mon_trace_sram_w_wptr <= '0;
            host_64b_aw_to_desc_mon_trace_sram_w_rptr <= '0;
        end else begin
            if (host_64b_aw_to_desc_mon_trace_sram_w_push) begin
                host_64b_aw_to_desc_mon_trace_sram_w_mem[host_64b_aw_to_desc_mon_trace_sram_w_wptr] <= 1'b1;
                host_64b_aw_to_desc_mon_trace_sram_w_wptr <= host_64b_aw_to_desc_mon_trace_sram_w_wptr + 1'b1;
            end
            if (host_64b_aw_to_desc_mon_trace_sram_w_pop) begin
                host_64b_aw_to_desc_mon_trace_sram_w_rptr <= host_64b_aw_to_desc_mon_trace_sram_w_rptr + 1'b1;
            end
        end
    end
    assign host_64b_w_to_desc_mon_trace_sram = (host_64b_aw_to_desc_mon_trace_sram_w_wptr != host_64b_aw_to_desc_mon_trace_sram_w_rptr) ? host_64b_aw_to_desc_mon_trace_sram_w_mem[host_64b_aw_to_desc_mon_trace_sram_w_rptr] : 1'b0;


    // W channel (gated by aw_to_<slave> FIFO head)
    assign desc_mon_trace_sram_axi_wdata  = host_64b_w_to_desc_mon_trace_sram ? host_64b_w.data : '0;
    assign desc_mon_trace_sram_axi_wstrb  = host_64b_w_to_desc_mon_trace_sram ? host_64b_w.strb : '0;
    assign desc_mon_trace_sram_axi_wlast  = host_64b_w_to_desc_mon_trace_sram ? host_64b_w.last : '0;
    assign desc_mon_trace_sram_axi_wvalid = host_64b_w_to_desc_mon_trace_sram && host_64b_wvalid;

    // Bready (master → slave) — gated on bid_valid so the path stays
    // open through the entire B handshake, not just the AW phase.
    assign desc_mon_trace_sram_axi_bready = ((desc_mon_trace_sram_axi_bid_bridge_id == 0) && desc_mon_trace_sram_axi_bid_valid) ? host_64b_bready : '0;

    // Bridge ID (master → slave)
    assign desc_mon_trace_sram_axi_bridge_id_aw = host_64b_aw_to_desc_mon_trace_sram ? host_bridge_id_aw : '0;

    // AR channel (gated by address re-decode -- see _addr_decode_expr)
    wire host_64b_ar_to_desc_mon_trace_sram = ((host_64b_ar.addr >= 32'h000d0000) && (host_64b_ar.addr <= 32'h000dffff));
    assign desc_mon_trace_sram_axi_arid     = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.id : '0;
    assign desc_mon_trace_sram_axi_araddr   = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.addr : '0;
    assign desc_mon_trace_sram_axi_arlen    = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.len : '0;
    assign desc_mon_trace_sram_axi_arsize   = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.size : '0;
    assign desc_mon_trace_sram_axi_arburst  = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.burst : '0;
    assign desc_mon_trace_sram_axi_arlock   = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.lock : '0;
    assign desc_mon_trace_sram_axi_arcache  = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.cache : '0;
    assign desc_mon_trace_sram_axi_arprot   = host_64b_ar_to_desc_mon_trace_sram ? host_64b_ar.prot : '0;
    assign desc_mon_trace_sram_axi_arvalid  = host_64b_ar_to_desc_mon_trace_sram && host_64b_arvalid;

    // Rready (master → slave) — gated on rid_valid so the path stays
    // open through the entire R handshake, not just the AR phase.
    assign desc_mon_trace_sram_axi_rready = ((desc_mon_trace_sram_axi_rid_bridge_id == 0) && desc_mon_trace_sram_axi_rid_valid) ? host_64b_rready : '0;

    // Bridge ID (master → slave)
    assign desc_mon_trace_sram_axi_bridge_id_ar = host_64b_ar_to_desc_mon_trace_sram ? host_bridge_id_ar : '0;
    ...
    assign host_64b_awready = 
        (host_64b_aw_to_stream_err ? stream_err_axi_awready : '0) |
        (host_64b_aw_to_debug_sram ? debug_sram_axi_awready : '0) |
        (host_64b_aw_to_bridge_trace_sram ? bridge_trace_sram_axi_awready : '0) |
        (host_64b_aw_to_desc_mon_trace_sram ? desc_mon_trace_sram_axi_awready : '0);

    assign host_64b_wready = 
        (host_64b_w_to_stream_err ? stream_err_axi_wready : '0) |
        (host_64b_w_to_debug_sram ? debug_sram_axi_wready : '0) |
        (host_64b_w_to_bridge_trace_sram ? bridge_trace_sram_axi_wready : '0) |
        (host_64b_w_to_desc_mon_trace_sram ? desc_mon_trace_sram_axi_wready : '0);
    ...
    assign host_64b_b.id = 
        ...
        ((bridge_trace_sram_axi_bid_bridge_id == 0) && bridge_trace_sram_axi_bid_valid ? bridge_trace_sram_axi_bid : '0) |
        ((desc_mon_trace_sram_axi_bid_bridge_id == 0) && desc_mon_trace_sram_axi_bid_valid ? desc_mon_trace_sram_axi_bid : '0);
    ...
    assign host_64b_b.resp = 
        ...
        ((bridge_trace_sram_axi_bid_bridge_id == 0) && bridge_trace_sram_axi_bid_valid ? bridge_trace_sram_axi_bresp : '0) |
        ((desc_mon_trace_sram_axi_bid_bridge_id == 0) && desc_mon_trace_sram_axi_bid_valid ? desc_mon_trace_sram_axi_bresp : '0);
    ...
    assign host_64b_bvalid = 
        ...
        ((bridge_trace_sram_axi_bid_bridge_id == 0) && bridge_trace_sram_axi_bid_valid ? bridge_trace_sram_axi_bvalid : '0) |
        ((desc_mon_trace_sram_axi_bid_bridge_id == 0) && desc_mon_trace_sram_axi_bid_valid ? desc_mon_trace_sram_axi_bvalid : '0);

    assign host_64b_arready = 
        (host_64b_ar_to_stream_err ? stream_err_axi_arready : '0) |
        (host_64b_ar_to_debug_sram ? debug_sram_axi_arready : '0) |
        (host_64b_ar_to_bridge_trace_sram ? bridge_trace_sram_axi_arready : '0) |
        (host_64b_ar_to_desc_mon_trace_sram ? desc_mon_trace_sram_axi_arready : '0);
    ...
    assign host_64b_r.id = 
        ...
        ((bridge_trace_sram_axi_rid_bridge_id == 0) && bridge_trace_sram_axi_rid_valid ? bridge_trace_sram_axi_rid : '0) |
        ((desc_mon_trace_sram_axi_rid_bridge_id == 0) && desc_mon_trace_sram_axi_rid_valid ? desc_mon_trace_sram_axi_rid : '0);

    assign host_64b_r.data = 
        ((stream_err_axi_rid_bridge_id == 0) && stream_err_axi_rid_valid ? stream_err_axi_rdata : 64'b0) |
        ((debug_sram_axi_rid_bridge_id == 0) && debug_sram_axi_rid_valid ? debug_sram_axi_rdata : 64'b0) |
        ((bridge_trace_sram_axi_rid_bridge_id == 0) && bridge_trace_sram_axi_rid_valid ? bridge_trace_sram_axi_rdata : 64'b0) |
        ((desc_mon_trace_sram_axi_rid_bridge_id == 0) && desc_mon_trace_sram_axi_rid_valid ? desc_mon_trace_sram_axi_rdata : 64'b0);
    ...
    assign host_64b_r.resp = 
        ...
        ((bridge_trace_sram_axi_rid_bridge_id == 0) && bridge_trace_sram_axi_rid_valid ? bridge_trace_sram_axi_rresp : '0) |
        ((desc_mon_trace_sram_axi_rid_bridge_id == 0) && desc_mon_trace_sram_axi_rid_valid ? desc_mon_trace_sram_axi_rresp : '0);
    ...
    assign host_64b_r.last = 
        ...
        ((bridge_trace_sram_axi_rid_bridge_id == 0) && bridge_trace_sram_axi_rid_valid ? bridge_trace_sram_axi_rlast : '0) |
        ((desc_mon_trace_sram_axi_rid_bridge_id == 0) && desc_mon_trace_sram_axi_rid_valid ? desc_mon_trace_sram_axi_rlast : '0);
    ...
    assign host_64b_rvalid = 
        ...
        ((bridge_trace_sram_axi_rid_bridge_id == 0) && bridge_trace_sram_axi_rid_valid ? bridge_trace_sram_axi_rvalid : '0) |
        ((desc_mon_trace_sram_axi_rid_bridge_id == 0) && desc_mon_trace_sram_axi_rid_valid ? desc_mon_trace_sram_axi_rvalid : '0);
