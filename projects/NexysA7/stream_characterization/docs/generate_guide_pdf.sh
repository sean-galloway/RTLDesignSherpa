...
# ------------------------------------------------------------
# STREAM Characterization — Project Guide PDF Generator
# ------------------------------------------------------------
# Usage:
...
OUTPUT_BASENAME="STREAM_Characterization_Guide_v${REV}"
...
echo "------------------------------------------------------------"
echo " Generating STREAM Characterization Project Guide"
echo "------------------------------------------------------------"
echo "  Version:   ${REV}"
