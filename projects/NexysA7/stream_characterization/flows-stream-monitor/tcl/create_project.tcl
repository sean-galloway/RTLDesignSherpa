...
# Top:    stream_mon_genesys2_top  (8 channels, USE_AXI_MONITORS=1, profile tally)
# Usage:  REPO_ROOT=... STREAM_ROOT=... CONVERTERS_ROOT=... MISC_ROOT=... \
#         STREAM_CHAR_ROOT=... FRAMEWORK_ROOT=... vivado -mode batch -source create_project.tcl
# The Makefile sets these env vars for you.
#==============================================================================

set project_name "stream_mon"
...
set top_name       "stream_mon_genesys2_top"
set top_flist_name "stream_mon_genesys2_top.f"
set xdc_name       "stream_mon_genesys2_top.xdc"
...
# Override via env: STREAM_NUM_CHANNELS, MON_TALLY_PROFILE_MODE, MON_N_PROFILE,
...
if {[info exists ::env(MON_TALLY_PROFILE_MODE)]}   { lappend generics "MON_TALLY_PROFILE_MODE=$::env(MON_TALLY_PROFILE_MODE)" }
