...
module stream_mon_harness #(
    ...
    bridge_stream_mon_axil u_bridge (
        ...
        .slave_monbus_wr_araddr (32'h0), .slave_monbus_wr_arprot (3'h0),
        .slave_monbus_wr_arvalid(1'b0),  .slave_monbus_wr_arready(),
        .slave_monbus_wr_rdata  (),      .slave_monbus_wr_rresp  (),
        .slave_monbus_wr_rvalid (),      .slave_monbus_wr_rready (1'b1),
    ...
    dma_slave_monitors #(
        ...
        // READ monitor config — all classes enabled.
        .cfg_rd_monitor_enable(1'b1), .cfg_rd_error_enable(1'b1),
        .cfg_rd_compl_enable  (1'b1), .cfg_rd_timeout_enable(1'b1),
        .cfg_rd_perf_enable   (1'b1), .cfg_rd_threshold_enable(1'b1),
        .cfg_rd_debug_enable  (1'b1), .cfg_rd_timeout_cycles(16'hFFFF),
        // WRITE monitor config — all classes enabled (independent of read).
        .cfg_wr_monitor_enable(1'b1), .cfg_wr_error_enable(1'b1),
        .cfg_wr_compl_enable  (1'b1), .cfg_wr_timeout_enable(1'b1),
        .cfg_wr_perf_enable   (1'b1), .cfg_wr_threshold_enable(1'b1),
        .cfg_wr_debug_enable  (1'b1), .cfg_wr_timeout_cycles(16'hFFFF),
