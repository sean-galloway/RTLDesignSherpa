#==============================================================================
# build_all.tcl — synth + impl + bitstream for vivado_mcdma
#==============================================================================
...
set project_file "$project_root/build/vivado_project/vivado_mcdma.xpr"

puts "========================================================================"
puts "Vivado MCDMA Characterization — Full Build"
puts "========================================================================"
...
set bit_src "$project_root/build/vivado_project/vivado_mcdma.runs/impl_1/vivado_mcdma_top.bit"
set bit_dst "$project_root/bitstream/vivado_mcdma.bit"
