...
# Timing Characterization Hardware Architecture Specification Index

**Version:** 1.0
**Date:** 2026-03-18
**Purpose:** High-level hardware architecture specification for the Timing Characterization component
...
- [FUB Catalog](ch03_architecture/03_fub_catalog.md)

### Chapter 4: Interfaces
- [Top-Level Ports](ch04_interfaces/01_top_level_ports.md)
- [Parameters](ch04_interfaces/02_parameters.md)
- [Clock and Reset](ch04_interfaces/03_clock_reset.md)

### Chapter 5: Performance
- [Synthesis Targets](ch05_performance/01_synthesis_targets.md)
- [Expected Trends](ch05_performance/02_expected_trends.md)
- [Resource Estimates](ch05_performance/03_resources.md)

### Chapter 6: Integration
- [Synthesis Workflow](ch06_integration/01_synthesis_workflow.md)
- [SDC Constraints](ch06_integration/02_sdc_constraints.md)
...
- **[Timing Characterization MAS](../timing_char_mas/timing_char_mas_index.md)** -- Micro-Architecture Specification (detailed block-level)
