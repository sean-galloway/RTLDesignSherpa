...
Configures the test environment for char_top integration tests.
"""
...
def pytest_configure(config):
    ...
    # Configure log file
    config.option.log_file = os.path.join(log_dir, "pytest_timing_char_top.log")
...
def pytest_sessionfinish(session, exitstatus):
    ...
    logging.info("Timing characterization top-level test session finished.")
