...
### Core Testbench (`apb4_monitor_core_tb.py`)
...
python test_apb4_monitor.py debug
python test_apb4_monitor.py completion
python test_apb4_monitor.py error
python test_apb4_monitor.py timeout
python test_apb4_monitor.py performance
```

### Pytest Execution
```bash
# Run all focused tests
pytest test_apb4_monitor.py
...
- Verify event generation priority in `apb4_monitor.sv`
