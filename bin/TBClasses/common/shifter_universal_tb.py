...
#
# Module: ShifterUniversalTB
# Purpose: Testbench for shifter_universal
# Subsystem: framework
#
# Extracted from val/common/test_shifter_universal.py so the runner holds only the parameter grid and the
