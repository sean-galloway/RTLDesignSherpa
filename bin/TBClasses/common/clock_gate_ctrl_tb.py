...
#
# Module: ClockGateCtrlTB
# Purpose: Testbench for clock_gate_ctrl
# Subsystem: framework
#
# Extracted from val/common/test_clock_gate_ctrl.py so the runner holds only the parameter grid and the
