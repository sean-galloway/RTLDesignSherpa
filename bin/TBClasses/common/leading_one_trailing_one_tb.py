...
# Purpose: Testbench for leading_one_trailing_one
# Subsystem: framework
#
# Extracted from val/common/test_leading_one_trailing_one.py so the runner holds only the parameter grid and the
