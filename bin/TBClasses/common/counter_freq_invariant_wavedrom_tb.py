...
# Purpose: Testbench for counter_freq_invariant_wavedrom
# Subsystem: framework
#
# Extracted from val/common/test_counter_freq_invariant_wavedrom.py so the runner holds only the parameter grid and the
