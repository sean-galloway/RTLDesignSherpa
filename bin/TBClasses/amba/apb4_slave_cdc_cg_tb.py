...
# Purpose: Testbench for apb4_slave_cdc_cg
# Subsystem: framework
#
# Extracted from val/amba/test_apb4_slave_cdc_cg.py so the runner holds only the parameter grid and the
...
class APBSlaveCDCCGTB(TBBase):
    ...
    async def send_apb_transaction(self, is_write, addr, data=None, strobe=None):
        ...
        await self.wait_for_queue_empty(self.apb4_master, timeout=15000)
