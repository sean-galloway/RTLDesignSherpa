...
AXIL-master-write member of the monbus_<p1>_<p2>_group family
(`rtl/amba/monitor/monbus_wb4_axil4_group.sv`). The other family
...
class MonbusWb4AxilGroupTB(TBBase):
    """
    ...
    def __init__(self, dut, axi_aclk=None, axi_aresetn=None):
        ...
        self.mon = MonbusGroupHarness(
            ...
            # The drain port is Wishbone here; the record-write master is
            # still AXI4-Lite, which is what makes this the wb4/axil4 group.
            drain_proto="wb4", trace_proto="axil",
            drain_prefix="s_wb_", trace_prefix="m_axil_",
    ...
    def finalize_monbus_capture(self):
        ...
        meta = {
            "test": "test_monbus_wb4_axil4_group",
    ...
    async def test_error_fifo_decode(self, count: int = 8) -> Tuple[bool, Dict[str, Any]]:
        """Drive known error packets, drain via the Wishbone slave-read port, and
