...
#
# Module: APB5SlaveCDCBasicTB
# Purpose: Testbench for apb5_slave_cdc
# Subsystem: framework
#
# Extracted from val/amba/test_apb5_slave_cdc.py so the runner holds only the parameter grid and the
