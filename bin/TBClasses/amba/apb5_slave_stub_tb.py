...
#
# Module: APB5SlaveStubBasicTB
# Purpose: Testbench for apb5_slave_stub
# Subsystem: framework
#
# Extracted from val/amba/test_apb5_slave_stub.py so the runner holds only the parameter grid and the
