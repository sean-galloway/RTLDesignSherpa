...
#
# Module: AXIS5SlaveCGBasicTB
# Purpose: Testbench for axis5_slave_cg
# Subsystem: framework
#
# Extracted from val/amba/test_axis5_slave_cg.py so the runner holds only the parameter grid and the
