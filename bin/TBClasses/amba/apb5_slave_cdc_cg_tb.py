...
#
# Module: APB5SlaveCDCCGBasicTB
# Purpose: Testbench for apb5_slave_cdc_cg
# Subsystem: framework
#
# Extracted from val/amba/test_apb5_slave_cdc_cg.py so the runner holds only the parameter grid and the
