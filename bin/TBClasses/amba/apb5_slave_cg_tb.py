...
#
# Module: APB5SlaveCGBasicTB
# Purpose: Testbench for apb5_slave_cg
# Subsystem: framework
#
# Extracted from val/amba/test_apb5_slave_cg.py so the runner holds only the parameter grid and the
