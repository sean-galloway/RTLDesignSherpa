...
#
# Module: APB5MasterCGBasicTB
# Purpose: Testbench for apb5_master_cg
# Subsystem: framework
#
# Extracted from val/amba/test_apb5_master_cg.py so the runner holds only the parameter grid and the
