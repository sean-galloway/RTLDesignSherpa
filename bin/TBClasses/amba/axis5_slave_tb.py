...
#
# Module: AXIS5SlaveBasicTB
# Purpose: Testbench for axis5_slave
# Subsystem: framework
#
# Extracted from val/amba/test_axis5_slave.py so the runner holds only the parameter grid and the
