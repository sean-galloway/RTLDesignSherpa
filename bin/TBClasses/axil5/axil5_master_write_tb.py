...
#
# Module: AXIL5MasterWriteTB
# Purpose: Drive the AXI5-Lite write master RTL with AXI5-Lite BFMs
#
# Subsystem: framework

"""AXI5-Lite write master testbench.

:class:`AXIL4MasterWriteTB` with the component factories swapped for their AXI5-Lite
...
therefore has to leave every group off. Here the DUT is ``axil5_master_write``, whose
ENABLE_* parameters all default to 1, so the RTL carries
AxUSER/AxTRACE/AxLOOP/AxMPAM/AxMECID/AxNSAID/AxLOCK on AW/W/B -- and the BFMs
...
from TBClasses.axil4.axil4_master_write_tb import AXIL4MasterWriteTB


class AXIL5MasterWriteTB(AXIL4MasterWriteTB):
    """AXI5-Lite write master RTL, optional groups enabled."""
