...
#
# Module: AXIL5SlaveWriteTB
# Purpose: Drive the AXI5-Lite write slave RTL with AXI5-Lite BFMs
#
# Subsystem: framework

"""AXI5-Lite write slave testbench.

:class:`AXIL4SlaveWriteTB` with the component factories swapped for their AXI5-Lite
...
therefore has to leave every group off. Here the DUT is ``axil5_slave_write``, whose
...
class AXIL5SlaveWriteTB(AXIL4SlaveWriteTB):
    """AXI5-Lite write slave RTL, optional groups enabled."""
