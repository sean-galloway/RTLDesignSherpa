...
#
# Module: AXIL5MasterMonitorTB
# Purpose: Drive the AXI5-Lite master monitor RTL with AXI5-Lite BFMs
#
# Subsystem: framework

"""AXI5-Lite master monitor testbench.

:class:`AXIL4MasterMonitorTB` with the component factories swapped and the AXI5-Lite
...
class AXIL5MasterMonitorTB(AXIL4MasterMonitorTB):
    """AXI5-Lite master monitor RTL, optional groups enabled."""
