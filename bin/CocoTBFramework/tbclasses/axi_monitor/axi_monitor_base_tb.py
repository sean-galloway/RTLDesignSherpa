...
from .axi_errmon_basic_test import AXIMonitorBasicTest
# Comment out test imports until implemented
# from .axi_errmon_fifo_test import AXIMonitorFIFOTest
# from .axi_errmon_error_test import AXIMonitorErrorTest
# from .axi_errmon_multichannel_test import AXIMonitorMultiChannelTest
# from .axi_errmon_random_test import AXIMonitorRandomTest
# from .axi_errmon_intrbus_test import AXIMonitorIntrBusTest
...
class AXIMonitorTB(TBBase):
    ...
    def _create_test_classes(self):
        ...
        self.basic_test = AXIMonitorBasicTest(self)
        # Comment out test class creation until implemented
        # self.fifo_test = AXIMonitorFIFOTest(self)
        # self.error_test = AXIMonitorErrorTest(self)
        # self.multichannel_test = AXIMonitorMultiChannelTest(self)
        # self.random_test = AXIMonitorRandomTest(self)
        # self.intrbus_test = AXIMonitorIntrBusTest(self)
