...
- [59:57] - protocol:    3 bits (AXI/Network/APB/ARB/CORE) - ✅ INCREASED from 2 to 3 bits
...
class PktType(IntEnum):
    ...
    PktTypeCredit     = 0x5  # Credit status (Network)
    PktTypeChannel    = 0x6  # Channel status (Network)
    PktTypeStream     = 0x7  # Stream event (Network)
...
# =============================================================================
# Network PROTOCOL EVENT CODES (Partial - for reference) 
# =============================================================================

class MNOCErrorCode(IntEnum):
    """Network Error Event Codes"""
    NETWORK_ERR_PARITY            = 0x0  # Parity error
    NETWORK_ERR_PROTOCOL          = 0x1  # Protocol violation
    NETWORK_ERR_OVERFLOW          = 0x2  # Buffer/Credit overflow
