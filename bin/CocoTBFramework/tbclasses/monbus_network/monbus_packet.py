...
def create_monbus_field_config() -> FieldConfig:
    ...
    # [59:57] - protocol: 3 bits (AXI/Network/APB/ARB/CORE) ✅ UPDATED: 3 bits
...
class MonbusPacket:
    ...
    def is_network_protocol(self) -> bool:
        """Check if this is an Network protocol packet"""
        return self.protocol == ProtocolType.PROTOCOL_MNOC.value
