...
class HPETMediumTests:
    ...
    async def test_timer_periodic(self, timer_id: int = 1) -> bool:
        ...
        try:
            ...
            max_wait_time = (expected_interrupts + 1) * period_ns  # Enough time for interrupts
    ...
    async def test_multiple_timers(self) -> bool:
        ...
        try:
            ...
            start_time = get_sim_time('ns')
            timeout = 10000  # 10us timeout - Timer 1 needs 5000ns
    ...
    async def test_timer_mode_switching(self, timer_id: int = 0) -> bool:
        ...
        try:
            ...
            fire_count = 0
            start_time = get_sim_time('ns')
            periodic_wait_time = periodic_comparator * self.tb.HPET_CLOCK_PERIOD * 3  # Wait for up to 3 periods
