...
from .axi4_slave_rd_fub_intf_incl import (
    ErrorType, 
...
class Axi4SlaveRdTests(TBBase):
    ...
    def __init__(self, dut, fub_intf, axi4_intf):
        ...
        Args:
            ...
            fub_intf: Fub interface instance (Axi4SlaveRdFubIntf)
    ...
    async def test_01_basic_read(self):
        ...
        for j, (m_rand, s_rand) in enumerate(rand_keys):
            self.fub_intf.set_error_readiness(m_rand)
            self.axi4_intf.set_fub_ar_timing(m_rand)
    ...
    async def test_03_r_timeout_test(self):
        ...
        Issues a read with beats on the fub_ar channel, accepts it immediately,
