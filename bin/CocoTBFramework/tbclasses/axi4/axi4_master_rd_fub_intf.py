"""
AXI4 Master Read Fub Interface
...
class Axi4MasterRdFubIntf(TBBase):
    """
    Interface for the fub-facing components of the AXI4 Master Read module.
    ...
    def __init__(self, dut):
        """
        Initialize the AXI4 Master Read Fub Interface.
