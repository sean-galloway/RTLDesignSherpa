...
class Axi4SlaveRdFubIntf(TBBase):
    """
    Interface for the fub-facing components of the AXI4 Slave Read module.
    ...
    def __init__(self, dut):
        """
        Initialize the AXI4 Slave Read Fub Interface.
    ...
    async def reset_interfaces(self):
        ...
        self.log.info("Fub interface reset")
