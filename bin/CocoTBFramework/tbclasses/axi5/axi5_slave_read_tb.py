...
#
# Module: AXI5SlaveReadTB
# Purpose: AXI5 Read Slave Testbench
#
...
"""
AXI5 Read Slave Testbench

Simple testbench for testing AXI5 read slave functionality using the CocoTB
...
class AXI5SlaveReadTB(TBBase):
    """
    Simple AXI5 Read Slave testbench for baseline testing.

    Tests basic read functionality using AR and R channels with the
    axi5_slave_rd_stub.sv RTL module, including AXI5-specific features.
    """
    ...
    def __init__(self, dut, aclk=None, aresetn=None):
        ...
        msg = '\n'
        msg += '='*80 + "\n"
        msg += ' AXI5 Read Slave Test Configuration:\n'
        msg += '-'*80 + "\n"
        ...
        try:
            ...
            self.log.info("AXI5 Master Read components created (driving slave interface)")
        ...
        self.log.info("AXI5 Read Slave testbench initialized successfully")
