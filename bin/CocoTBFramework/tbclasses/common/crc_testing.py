...
#
# Module: CRCTB
# Purpose: The CRC Testbench with all of the confiuration listings
#
...
"""The CRC Testbench with all of the confiuration listings"""
...
class CRCTB(TBBase):
    ...
    def print_settings(self):
        ...
        msg = f'    DATA_WIDTH: {self.data_width}'
        self.log.info(msg)
        msg = f'    CHUNKS:     {self.chunks}'
        self.log.info(msg)
        msg = f'    CRC_WIDTH:  {self.crc_width}'
        self.log.info(msg)
        msg = f'    POLY:       0x{hex(self.crc_poly)[2:].zfill(self.crc_width // 4)}'
        self.log.info(msg)
        msg = f'    POLY_INIT:  0x{hex(self.crc_poly_initial)[2:].zfill(self.crc_width // 4)}'
        self.log.info(msg)
        msg = f'    REFIN:      {self.reflected_input}'
        self.log.info(msg)
        msg = f'    REFOUT:     {self.reflected_output}'
        self.log.info(msg)
        msg = f'    XOROUT:     0x{hex(self.xor_output)[2:].zfill(self.crc_width // 4)}'
        self.log.info(msg)
        self.log.info('-------------------------------------------')
