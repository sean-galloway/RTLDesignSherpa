...
| `pit_8254_mas` | APB PIT 8254 Specification - Table of Contents | 12 | 10 | ~80k | 1 |
| `rtc_mas` | APB RTC Specification - Table of Contents | 5 | 7 | ~85k | 1 |
| `apb` | RTL AMBA APB4 | 10 | 9 | ~96k | 1 |
| `apb5` | RTL AMBA APB5 | 10 | 9 | ~99k | 1 |
...
| `axil4` | RTL AMBA AXI4-Lite | 18 | 16 | ~270k | 2 |
| `axil5` | RTL AMBA AXI5-Lite | 17 | 16 | ~288k | 2 |
| `monitor` | RTL AMBA Monitor Subsystem | 36 | 33 | ~431k | 4 |
| `math` | RTL Math Library | 28 | 39 | ~431k | 3 |
| `axi5` | RTL AMBA AXI5 | 18 | 17 | ~433k | 3 |
| `bridge_mas` | Bridge Micro-Architecture Specification Index | 26 | 24 | ~448k | 3 |
| `axi4` | RTL AMBA AXI4 | 27 | 24 | ~460k | 3 |
