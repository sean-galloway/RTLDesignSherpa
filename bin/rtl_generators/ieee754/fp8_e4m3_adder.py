...
#
# Module: FP8E4M3Adder
# Purpose: FP8 E4M3 Adder Generator
#
# Implements floating-point addition for FP8 E4M3 format.
# FP8 E4M3: [7]=sign, [6:3]=exp (bias=7), [2:0]=mantissa
#
# Extended mantissa: 7 bits (3 mant + 1 implicit + 3 GRS)
#
...
def generate_fp8_e4m3_adder(output_path):
    """
    Generate FP8 E4M3 floating-point adder.
    ...
    module_name = 'math_fp8_e4m3_adder'
...
'''
    ...
    header = generate_rtl_header(
        ...
        generator_script='fp8_e4m3_adder.py'
    )
...
if __name__ == '__main__':
    ...
    module_name = generate_fp8_e4m3_adder(output_path)
