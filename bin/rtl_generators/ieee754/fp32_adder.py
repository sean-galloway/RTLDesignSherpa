...
#
# Module: FP32Adder
# Purpose: IEEE 754-2008 FP32 Floating-Point Adder Generator
#
...
def generate_fp32_adder(output_path):
    """
    Generate IEEE 754-2008 FP32 floating-point adder.

    The adder is generated as a complete module with:
    ...
    module_name = 'math_ieee754_2008_fp32_adder'
...
'''
    ...
    header = generate_rtl_header(
        ...
        generator_script='fp32_adder.py'
    )
...
if __name__ == '__main__':
    ...
    module_name = generate_fp32_adder(output_path)
