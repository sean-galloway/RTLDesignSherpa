...
The AMBA (Advanced Microcontroller Bus Architecture) directory within the verification framework provides specialized testbench classes for AMBA protocol verification with a focus on power management, randomization control, and clock domain crossing verification.
