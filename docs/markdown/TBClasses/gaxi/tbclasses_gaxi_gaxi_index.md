...
# TBClasses/gaxi Directory Index

This directory contains GAXI (Generic AXI-like) testbench classes for RTL Design Sherpa. These components provide comprehensive testbench functionality for GAXI buffer components, data collection modules, and protocol verification.
...
- Compatible with cocotb-framework (PyPI) component architecture
