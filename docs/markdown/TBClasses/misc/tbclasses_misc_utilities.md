...
Common utilities for path management, environment setup, and tool integration in the verification framework. This module provides essential functions for automating development environment setup, path resolution, and simulator integration.
