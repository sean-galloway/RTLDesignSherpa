...
Base testbench class providing common infrastructure and standardized patterns for all testbenches in the verification framework. This module establishes the foundation for consistent testbench development with built-in logging, configuration management, and component lifecycle handling.
...
The TBBase class is designed to work seamlessly with other cocotb-framework components:
