...
# AXIL5 Master Write Monitor, Clock-Gated

**Module:** `axil5_master_wr_mon_cg.sv`
**Location:** `rtl/amba/axil5/`
**AXI4-Lite counterpart:** [`axil4_master_wr_mon_cg`](../axil4/axil4_master_wr_mon_cg.md)

---

## Overview

The AXIL5 Master Write Monitor, Clock-Gated provides a buffered AXI5-Lite write interface for master devices.
...
axil5_master_wr_mon_cg #(
    ...
    .ENABLE_POISON       (1),
    .ENABLE_LOCK         (1)
) u_axil5_master_wr_mon_cg (
    // clock/reset
    .aclk                (aclk),
    .aresetn             (aresetn),
    // status
    .cam_clear           (cam_clear),
    // ... `fub_axil_awaddr`, `fub_axil_awprot`, `fub_axil_awlock`, +36 more
    // m_axil_aw
...
- [`axil4_master_wr_mon_cg`](../axil4/axil4_master_wr_mon_cg.md) -- the AXI4-Lite counterpart
