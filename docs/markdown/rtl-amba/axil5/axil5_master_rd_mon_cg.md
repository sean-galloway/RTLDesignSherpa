...
# AXIL5 Master Read Monitor, Clock-Gated

**Module:** `axil5_master_rd_mon_cg.sv`
**Location:** `rtl/amba/axil5/`
**AXI4-Lite counterpart:** [`axil4_master_rd_mon_cg`](../axil4/axil4_master_rd_mon_cg.md)

---

## Overview

The AXIL5 Master Read Monitor, Clock-Gated provides a buffered AXI5-Lite read interface for master devices.
...
- [`axil4_master_rd_mon_cg`](../axil4/axil4_master_rd_mon_cg.md) -- the AXI4-Lite counterpart
