...
Every parameter of [wb4_slave](wb4_slave.md), plus the derived widths:
...
|---|---|---|
| `cmd_valid` / `cmd_ready` | Output / Input | Command handshake |
| `cmd_data [CPW-1:0]` | Output | Packed command |
