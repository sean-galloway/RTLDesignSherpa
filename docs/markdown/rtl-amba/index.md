...
**[Back to Main Index](../index.md)** | **[rtl-amba Overview](overview.md)**
...
- **[Clock Domain Crossing](../rtl-cdc/cdc.md)** - Single reference for all CDC: decision guide, reset behavior, and every building block (`cdc_synchronizer`, `cdc_open_loop`, `cdc_2_phase_handshake`, `cdc_4_phase_handshake`, async FIFO pointers)
