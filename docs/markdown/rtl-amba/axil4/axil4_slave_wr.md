...
- **[axil4_slave_wr_mon](../axil4/axil4_slave_wr_mon.md)** - Slave write with monitoring (`rtl/amba/monitor/`)
...
`val/amba/test_axil4_slave_wr.py` drives this module with the AXI4-Lite BFMs from `TBClasses/axil4`. It collects 3 parameter cases at the default `REG_LEVEL`. Run it with:
