...
![APB Write](../../assets/WAVES/apb4_master/apb_write_sequence_001.png)

**WaveJSON:** [apb_write_sequence_001.json](../../assets/WAVES/apb4_master/apb_write_sequence_001.json)
...
![APB Read](../../assets/WAVES/apb4_master/apb_read_sequence_001.png)

**WaveJSON:** [apb_read_sequence_001.json](../../assets/WAVES/apb4_master/apb_read_sequence_001.json)
...
![B2B Writes](../../assets/WAVES/apb4_master/apb_back_to_back_writes_001.png)

**WaveJSON:** [apb_back_to_back_writes_001.json](../../assets/WAVES/apb4_master/apb_back_to_back_writes_001.json)
...
![B2B Reads](../../assets/WAVES/apb4_master/apb_back_to_back_reads_001.png)

**WaveJSON:** [apb_back_to_back_reads_001.json](../../assets/WAVES/apb4_master/apb_back_to_back_reads_001.json)
...
![Write-to-Read](../../assets/WAVES/apb4_master/apb_write_to_read_001.png)

**WaveJSON:** [apb_write_to_read_001.json](../../assets/WAVES/apb4_master/apb_write_to_read_001.json)
...
![Read-to-Write](../../assets/WAVES/apb4_master/apb_read_to_write_001.png)

**WaveJSON:** [apb_read_to_write_001.json](../../assets/WAVES/apb4_master/apb_read_to_write_001.json)
...
For power-sensitive applications, use `apb4_master_cg`. It wraps `apb4_master` in
