...
if want monitor; then
  # monitor-lite/ is the same subsystem at a fifth of the gates (amba/monitor-lite TASK-001); it books with the monitors.
...
amba_book wb4    "RTL AMBA Wishbone B4"   RTL_AMBA_WB4           wb4
