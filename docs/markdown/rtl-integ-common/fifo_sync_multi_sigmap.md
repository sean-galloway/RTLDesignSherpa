...
> (`rtl/integ_common/filelists/fifo_sync_multi_sigmap.f`), tests in `val/integ_common/`, and a
> formal harness under `formal/integ_common/fifo_sync_multi_sigmap/`.
...
- `rtl/integ_common/fifo_sync_multi_sigmap.sv`
