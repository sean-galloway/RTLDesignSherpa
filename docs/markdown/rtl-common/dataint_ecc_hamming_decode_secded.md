...
`val/**/test_dataint_ecc_hamming_decode_secded.py`, and no module that instantiates this one has a testbench either, so nothing in the repository exercises it.
