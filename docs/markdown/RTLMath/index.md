...
# RTLMath Modules Index

The `math_*` arithmetic library: adders, subtractors, multipliers, compressors,
prefix cells, and the BF16 / FP8 / FP16 / FP32 / IEEE-754 floating-point
modules.

**RTL:** `rtl/math/` (171 modules) · **Tests:** `val/math/` ·
**Common building blocks:** [RTLCommon](../RTLCommon/index.md)
...
- **[mod_3_compress](../RTLCommon/mod_3_compress.md)** - Combinational `X - (X mod 3)` carry-save rounding (monbus record packing)
...
- [RTLCommon index](../RTLCommon/index.md) - counters, FIFOs, arbiters, CDC,
  data integrity
