...
- [`glitch_free_n_dff_arn`](../RTLCommon/glitch_free_n_dff_arn.md),
  [`fifo_control`](../RTLCommon/fifo_control.md),
  [`counter_bin`](../RTLCommon/counter_bin.md) - [RTLCommon](../RTLCommon/index.md)
- [`gaxi_skid_buffer`](../RTLAmba/gaxi/gaxi_skid_buffer.md) - [RTLAmba](../RTLAmba/index.md)

The APB/APB5 CDC slaves that consume this area are documented with their
protocol: [apb_slave_cdc](../RTLAmba/apb/apb_slave_cdc.md),
[apb5_slave_cdc](../RTLAmba/apb5/apb5_slave_cdc.md).
