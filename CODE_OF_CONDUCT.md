...
the RTL Design Sherpa community a harassment-free experience for
...
welcoming, diverse, inclusive, and healthy community focused on learning
and improving hardware design and verification skills.
...
- Focusing on what is best for the overall community and the learners
  who use this project
- Helping less-experienced contributors understand the codebase and its
  conventions
...
requests, discussions, and any other forums associated with the project
...
be reported to the project maintainer at **sean.galloway@outlook.com**.
